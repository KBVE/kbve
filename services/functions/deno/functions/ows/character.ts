...
export async function handleCharacter(req: OwsRequest): Promise<Response> {
  ...
  switch (req.action) {
    ...
    default:
      return jsonResponse(
        {
          error: `Unknown action: ${req.action}. Available: ${
...
async function remove(req: OwsRequest): Promise<Response> {
  ...
  await deleteFrom("charabilitybars", {
    customerguid: cg,
    characterid: charId,
  });
  await deleteFrom("charhasabilities", {
    customerguid: cg,
    characterid: charId,
  });
  ...
  await deleteFrom("customcharacterdata", {
    customerguid: cg,
    characterid: charId,
  });
  await deleteFrom("charonmapinstance", {
    customerguid: cg,
    characterid: charId,
  });
  await deleteFrom("playergroupcharacters", {
    customerguid: cg,
    characterid: charId,
  });
