...
export const tokens = {
	color: {
		bg: 'var(--sl-color-black, #121312)',
		bgSubtle: 'color-mix(in srgb, var(--sl-color-white) 3%, transparent)',
		surface: 'var(--bento-cell-bg, var(--sl-color-black, #1b1814))',
		surfaceAlt: 'color-mix(in srgb, var(--sl-color-white) 4%, transparent)',
		border: 'var(--bento-hairline-strong, var(--sl-color-hairline, #3a2f1f))',
		primary: 'var(--sl-color-accent-high, #c9a56a)',
		primaryDeep: 'var(--sl-color-accent-high, #a67d43)',
		bronze: 'var(--sl-color-accent-low, #7a5a2e)',
		onPrimary: 'var(--sl-color-black, #1b1814)',
		text: 'var(--sl-color-white, #f5ecd8)',
