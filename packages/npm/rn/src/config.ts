...
export const KBVE_SUPABASE_URL =
	env['EXPO_PUBLIC_SUPABASE_URL'] ?? DEFAULT_SUPABASE_URL;

export const KBVE_SUPABASE_ANON_KEY =
	env['EXPO_PUBLIC_SUPABASE_ANON_KEY'] ?? DEFAULT_SUPABASE_ANON_KEY;

const DEFAULT_HCAPTCHA_SITE_KEY = 'e19cf4a6-2168-49a2-88fe-716e97569e88';

export const KBVE_HCAPTCHA_SITE_KEY =
	env['EXPO_PUBLIC_HCAPTCHA_SITE_KEY'] ?? DEFAULT_HCAPTCHA_SITE_KEY;

const DEFAULT_API_URL = 'https://kbve.com';

export const KBVE_API_URL = env['EXPO_PUBLIC_API_URL'] ?? DEFAULT_API_URL;

const DEFAULT_CHAT_URL = 'wss://chat.kbve.com';

export const KBVE_CHAT_URL = env['EXPO_PUBLIC_CHAT_URL'] ?? DEFAULT_CHAT_URL;
