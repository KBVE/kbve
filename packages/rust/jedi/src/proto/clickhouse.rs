...
pub mod click_house_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn query_logs(
            &mut self,
            request: impl tonic::IntoRequest<super::LogQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::LogQueryResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/QueryLogs");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clickhouse.ClickHouseService", "QueryLogs"));
        ...
        ) -> std::result::Result<tonic::Response<super::LogStatsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/QueryLogStats");
            let mut req = request.into_request();
        ...
        ) -> std::result::Result<tonic::Response<super::RawQueryResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/RawQuery");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clickhouse.ClickHouseService", "RawQuery"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn insert(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/Insert");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clickhouse.ClickHouseService", "Insert"));
            self.inner.unary(req, path, codec).await
        }
        /// DDL execution (admin auth required).
        pub async fn execute_ddl(
            &mut self,
            request: impl tonic::IntoRequest<super::DdlRequest>,
        ) -> std::result::Result<tonic::Response<super::DdlResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/ExecuteDdl");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "clickhouse.ClickHouseService",
                "ExecuteDdl",
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/clickhouse.ClickHouseService/TailLogs");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("clickhouse.ClickHouseService", "TailLogs"));
...
pub mod click_house_service_server {
    ...
    pub trait ClickHouseService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn query_logs(
            &self,
            request: tonic::Request<super::LogQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::LogQueryResponse>, tonic::Status>;
        /// Aggregated log statistics.
        async fn query_log_stats(
            &self,
            request: tonic::Request<super::LogStatsRequest>,
        ) -> std::result::Result<tonic::Response<super::LogStatsResponse>, tonic::Status>;
        /// Raw SQL passthrough (service_role auth required).
        async fn raw_query(
            &self,
        ...
        async fn execute_ddl(
            &self,
            request: tonic::Request<super::DdlRequest>,
        ) -> std::result::Result<tonic::Response<super::DdlResponse>, tonic::Status>;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/clickhouse.ClickHouseService/QueryLogs" => {
                    #[allow(non_camel_case_types)]
                    struct QueryLogsSvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService> tonic::server::UnaryService<super::LogQueryRequest> for QueryLogsSvc<T> {
                        type Response = super::LogQueryResponse;
                ...
                "/clickhouse.ClickHouseService/QueryLogStats" => {
                    #[allow(non_camel_case_types)]
                    struct QueryLogStatsSvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService> tonic::server::UnaryService<super::LogStatsRequest>
                        for QueryLogStatsSvc<T>
                    {
                        type Response = super::LogStatsResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::LogStatsRequest>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClickHouseService>::query_log_stats(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/clickhouse.ClickHouseService/RawQuery" => {
                    #[allow(non_camel_case_types)]
                    struct RawQuerySvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService> tonic::server::UnaryService<super::RawQueryRequest> for RawQuerySvc<T> {
                ...
                "/clickhouse.ClickHouseService/Insert" => {
                    #[allow(non_camel_case_types)]
                    struct InsertSvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService> tonic::server::UnaryService<super::InsertRequest> for InsertSvc<T> {
                ...
                "/clickhouse.ClickHouseService/ExecuteDdl" => {
                    #[allow(non_camel_case_types)]
                    struct ExecuteDdlSvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService> tonic::server::UnaryService<super::DdlRequest> for ExecuteDdlSvc<T> {
                        type Response = super::DdlResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::DdlRequest>,
                ...
                "/clickhouse.ClickHouseService/TailLogs" => {
                    #[allow(non_camel_case_types)]
                    struct TailLogsSvc<T: ClickHouseService>(pub Arc<T>);
                    impl<T: ClickHouseService>
    ...
    pub const SERVICE_NAME: &str = "clickhouse.ClickHouseService";
