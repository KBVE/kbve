...
pub mod redis_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_command(
            ...
            let path = http::uri::PathAndQuery::from_static("/redis.RedisService/SendCommand");
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/redis.RedisService/SendCommand" => {
                    ...
                    impl<T: RedisService> tonic::server::UnaryService<super::RedisCommand> for SendCommandSvc<T> {
