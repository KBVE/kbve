...
fn id_to_item(id: u16) -> Option<RareItem> {
    match id {
        ...
        212 => Some(RareItem::RawChicken),
        213 => Some(RareItem::Feather),
        214 => Some(RareItem::RawMutton),
        215 => Some(RareItem::Wool),
        216 => Some(RareItem::RawBeef),
        217 => Some(RareItem::Leather),
