...
pub use sim::{
    ...
    PendingPilotOps, PersistedEnvLog, PersistedEnvObject, PilotOp, Piloting, PlacedBy,
    PlayerSlotTag, PlayerStore, RespawnOnDeath, ReturnedFromInstance, SIM_TICK_HZ, ShopStock,
    ...
    ground_item_bundle, ground_item_bundle_stack, has_clearance, level_attack, level_max_hp,
    mint_item_id, run_sim_loop, spawn_bush, spawn_env_object, spawn_npc_from_spec, spawn_tree,
    tree_at, xp_to_next,
};
