...
pub use sim::{
    ...
    FurnitureRot, HazardZone, HealAura, Health, Inventory, ItemPrices, Loot, ManaAura, MoveProfile,
    NpcLevel, NpcSpec, PendingPilotOps, PersistedEnvLog, PersistedEnvObject, PilotOp, Piloting,
    PlayerSlotTag, PlayerStore, RespawnOnDeath, SIM_TICK_HZ, ShopStock, SimClock, SimConfig,
    SimSeed, SimSet, StatusEffect, StatusEffects, TREE_DENSITY_PER_MILLE, TREE_REF, TREE_VARIANTS,
    Terrain, TreeState, Wander, XpState, build_app, bush_at, ground_item_bundle, has_clearance,
    level_attack, level_max_hp, run_sim_loop, spawn_bush, spawn_env_object, spawn_npc_from_spec,
