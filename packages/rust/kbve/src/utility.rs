...
pub async fn global_map_init(pool: Arc<Pool>) -> Result<DashMap<String, String>, &'static str> {
...
pub async fn health_check(
    ...
    match connection_result {
        Ok(Ok(_conn)) => Ok(Json(WizardResponse {
            data: serde_json::json!({"status": "online"}),
