...
import { YStack, Input, Button, TextArea, Text, Form as TamaguiForm, Spinner } from 'tamagui';
...
export function TamaOnboard({
	...
	const { register, handleSubmit, formState: { errors } } = useForm<UserCardFormData>({
