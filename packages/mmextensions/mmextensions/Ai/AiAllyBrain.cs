...
namespace KBVE.MMExtensions.Ai
{
    public class AiAllyBrain : AIBrain
    {
        ...
        protected virtual void SetupDecisionsAndActions()
        {
            ...
            distanceToTargetDecision = CreateDistanceToTarget2DDecision(2f, AIDecisionDistanceToTarget.ComparisonModes.LowerThan);
        ...
        private AIState CreateChaseEnemyState()
        {
            ...
            chaseEnemyState.Transitions = new AITransitionsList
            {
                ...
                new AITransition()
                {
                    Decision = targetIsAliveDecision,
                    FalseState = "Idle"
                }
            };
        ...
        private AIDecisionDetectTargetRadius2D CreateDetectTarget2DDecision(int targetLayerInt, float radius)
        {
        ...
        private AIDecisionDistanceToTarget CreateDistanceToTarget2DDecision(float distance, AIDecisionDistanceToTarget.ComparisonModes comparisonMode)
        {
            AIDecisionDistanceToTarget detectDistanceToTarget = gameObject.AddComponent<AIDecisionDistanceToTarget>();
