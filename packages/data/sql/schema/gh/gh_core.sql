...
--   Denormalized append-only audit trail of manual gh.issue_event requeues.
--   No FK to gh.issue_event so retention sweeps of delivered events do not
--   take audit history with them. service_role only.
-- ============================================================================
...
'Denormalized append-only audit trail of manual gh.issue_event requeues. No FK to gh.issue_event so retention sweeps preserve audit history. service_role only.';
