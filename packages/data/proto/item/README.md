...
> Gathering/production economics (skill type, xp, gather time, resource node ref) live in **professiondb** — the cross-engine source of truth. `ItemDef` reserves the old `skilling`/`compress` fields.
