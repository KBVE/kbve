...
export const DispatchWorkflowRequestSchema = z
	.object({
...
export type DispatchWorkflowRequest = z.infer<typeof DispatchWorkflowRequestSchema>;
...
export const GitHubWorkflowsResponseSchema = z
	.object({
		total_count: z.number(),
		workflows: z.array(GitHubWorkflowSchema).optional(),
	});

export type GitHubWorkflowsResponse = z.infer<typeof GitHubWorkflowsResponseSchema>;
...
// GitHubIssueType
export const GitHubIssueTypeSchema = z
	.object({
		id: z.number(),
		name: z.string(),
...
// GitHubStatusChecks
export const GitHubStatusChecksSchema = z
	.object({
		strict: z.boolean(),
...
// GitHubEnforceAdmins
export const GitHubEnforceAdminsSchema = z
	.object({
		enabled: z.boolean(),
	});
...
// GitHubCommitDetail
export const GitHubCommitDetailSchema = z
	.object({
		message: z.string(),
...
// GitHubMergeResult
export const GitHubMergeResultSchema = z
	.object({
		sha: z.string(),
		merged: z.boolean(),
		message: z.string(),
