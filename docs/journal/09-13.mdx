...
bento:
    ...
    title: 'September 13,'
    accent: every year.
    lede: 'The September 13th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Sep 14 →'
          href: /journal/09-14/
    related:
        - title: 'Previous · Sep 12'
          copy: 'Step back a day to the September 12th log.'
          href: /journal/09-12/
          icon: calendar
        - title: 'Next · Sep 14'
          copy: 'Jump ahead to the September 14th log.'
          href: /journal/09-14/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1691427954002-688e16d6cfc3?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
