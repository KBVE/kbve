...
bento:
    ...
    title: 'September 22,'
    accent: every year.
    lede: 'The September 22nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 23 →'
          href: /journal/09-23/
    related:
        - title: 'Previous · Sep 21'
          copy: 'Step back a day to the September 21st log.'
          href: /journal/09-21/
          icon: calendar
        - title: 'Next · Sep 23'
          copy: 'Jump ahead to the September 23rd log.'
          href: /journal/09-23/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1694191711762-6ed1400d7b86?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
