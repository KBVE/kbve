...
bento:
    ...
    title: 'March 1,'
    accent: every year.
    lede: 'The March 1st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 2 →'
          href: /journal/03-02/
    related:
        - title: 'Previous · Feb 29'
          copy: 'Step back a day to the February 29th log.'
          href: /journal/02-29/
          icon: calendar
        - title: 'Next · Mar 2'
          copy: 'Jump ahead to the March 2nd log.'
          href: /journal/03-02/
          icon: arrow
        - title: 'Journal hub'
