...
bento:
    ...
    title: 'September 18,'
    accent: every year.
    lede: 'The September 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Sep 19 →'
          href: /journal/09-19/
    related:
        - title: 'Previous · Sep 17'
          copy: 'Step back a day to the September 17th log.'
          href: /journal/09-17/
          icon: calendar
        - title: 'Next · Sep 19'
          copy: 'Jump ahead to the September 19th log.'
          href: /journal/09-19/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1693483923875-cdd9ef4a8046?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
