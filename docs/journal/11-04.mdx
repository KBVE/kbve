...
bento:
    ...
    title: 'November 4,'
    accent: every year.
    lede: 'The November 4th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Nov 5 →'
          href: /journal/11-05/
    related:
        - title: 'Previous · Nov 3'
          copy: 'Step back a day to the November 3rd log.'
          href: /journal/11-03/
          icon: calendar
        - title: 'Next · Nov 5'
          copy: 'Jump ahead to the November 5th log.'
          href: /journal/11-05/
          icon: arrow
        - title: 'Journal hub'
