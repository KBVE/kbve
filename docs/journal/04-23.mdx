...
bento:
    ...
    title: 'April 23,'
    accent: every year.
    lede: 'The April 23rd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 24 →'
          href: /journal/04-24/
    related:
        - title: 'Previous · Apr 22'
          copy: 'Step back a day to the April 22nd log.'
          href: /journal/04-22/
          icon: calendar
        - title: 'Next · Apr 24'
          copy: 'Jump ahead to the April 24th log.'
          href: /journal/04-24/
          icon: arrow
        - title: 'Journal hub'
