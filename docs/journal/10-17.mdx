...
bento:
    ...
    title: 'October 17,'
    accent: every year.
    lede: 'The October 17th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 18 →'
          href: /journal/10-18/
    related:
        - title: 'Previous · Oct 16'
          copy: 'Step back a day to the October 16th log.'
          href: /journal/10-16/
          icon: calendar
        - title: 'Next · Oct 18'
          copy: 'Jump ahead to the October 18th log.'
          href: /journal/10-18/
          icon: arrow
        - title: 'Journal hub'
