...
bento:
    ...
    title: 'February 18,'
    accent: every year.
    lede: 'The February 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#quote'
          primary: true
        ...
        - label: 'Feb 19 →'
          href: /journal/02-19/
    related:
        - title: 'Previous · Feb 17'
          copy: 'Step back a day to the February 17th log.'
          href: /journal/02-17/
          icon: calendar
        - title: 'Next · Feb 19'
          copy: 'Jump ahead to the February 19th log.'
          href: /journal/02-19/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1739911013843-0380d6504480?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
