...
bento:
    ...
    title: 'March 2,'
    accent: every year.
    lede: 'The March 2nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 3 →'
          href: /journal/03-03/
    related:
        - title: 'Previous · Mar 1'
          copy: 'Step back a day to the March 1st log.'
          href: /journal/03-01/
          icon: calendar
        - title: 'Next · Mar 3'
          copy: 'Jump ahead to the March 3rd log.'
          href: /journal/03-03/
          icon: arrow
        - title: 'Journal hub'
