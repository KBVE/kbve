...
bento:
    ...
    title: 'September 24,'
    accent: every year.
    lede: 'The September 24th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 25 →'
          href: /journal/09-25/
    related:
        - title: 'Previous · Sep 23'
          copy: 'Step back a day to the September 23rd log.'
          href: /journal/09-23/
          icon: calendar
        - title: 'Next · Sep 25'
          copy: 'Jump ahead to the September 25th log.'
          href: /journal/09-25/
          icon: arrow
        - title: 'Journal hub'
