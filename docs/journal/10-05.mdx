...
bento:
    ...
    title: 'October 5,'
    accent: every year.
    lede: 'The October 5th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 6 →'
          href: /journal/10-06/
    related:
        - title: 'Previous · Oct 4'
          copy: 'Step back a day to the October 4th log.'
          href: /journal/10-04/
          icon: calendar
        - title: 'Next · Oct 6'
          copy: 'Jump ahead to the October 6th log.'
          href: /journal/10-06/
          icon: arrow
        - title: 'Journal hub'
