...
bento:
    ...
    title: 'May 28,'
    accent: every year.
    lede: 'The May 28th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 29 →'
          href: /journal/05-29/
    related:
        - title: 'Previous · May 27'
          copy: 'Step back a day to the May 27th log.'
          href: /journal/05-27/
          icon: calendar
        - title: 'Next · May 29'
          copy: 'Jump ahead to the May 29th log.'
          href: /journal/05-29/
          icon: arrow
        - title: 'Journal hub'
