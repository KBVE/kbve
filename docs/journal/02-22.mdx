...
bento:
    ...
    title: 'February 22,'
    accent: every year.
    lede: 'The February 22nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 23 →'
          href: /journal/02-23/
    related:
        - title: 'Previous · Feb 21'
          copy: 'Step back a day to the February 21st log.'
          href: /journal/02-21/
          icon: calendar
        - title: 'Next · Feb 23'
          copy: 'Jump ahead to the February 23rd log.'
          href: /journal/02-23/
          icon: arrow
        - title: 'Journal hub'
