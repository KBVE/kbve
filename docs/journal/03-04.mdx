...
bento:
    ...
    title: 'March 4,'
    accent: every year.
    lede: 'The March 4th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 5 →'
          href: /journal/03-05/
    related:
        - title: 'Previous · Mar 3'
          copy: 'Step back a day to the March 3rd log.'
          href: /journal/03-03/
          icon: calendar
        - title: 'Next · Mar 5'
          copy: 'Jump ahead to the March 5th log.'
          href: /journal/03-05/
          icon: arrow
        - title: 'Journal hub'
