...
bento:
    ...
    title: 'November 20,'
    accent: every year.
    lede: 'The November 20th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Nov 21 →'
          href: /journal/11-21/
    related:
        - title: 'Previous · Nov 19'
          copy: 'Step back a day to the November 19th log.'
          href: /journal/11-19/
          icon: calendar
        - title: 'Next · Nov 21'
          copy: 'Jump ahead to the November 21st log.'
          href: /journal/11-21/
          icon: arrow
        - title: 'Journal hub'
