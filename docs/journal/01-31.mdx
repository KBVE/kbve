...
bento:
    ...
    title: 'January 31,'
    accent: every year.
    lede: 'The January 31st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Feb 1 →'
          href: /journal/02-01/
    related:
        - title: 'Previous · Jan 30'
          copy: 'Step back a day to the January 30th log.'
          href: /journal/01-30/
          icon: calendar
        - title: 'Next · Feb 1'
          copy: 'Jump ahead to the February 1st log.'
          href: /journal/02-01/
          icon: arrow
        - title: 'Journal hub'
