...
bento:
    ...
    title: 'July 12,'
    accent: every year.
    lede: 'The July 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 13 →'
          href: /journal/07-13/
    related:
        - title: 'Previous · Jul 11'
          copy: 'Step back a day to the July 11th log.'
          href: /journal/07-11/
          icon: calendar
        - title: 'Next · Jul 13'
          copy: 'Jump ahead to the July 13th log.'
          href: /journal/07-13/
          icon: arrow
        - title: 'Journal hub'
