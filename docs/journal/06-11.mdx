...
bento:
    ...
    title: 'June 11,'
    accent: every year.
    lede: 'The June 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 12 →'
          href: /journal/06-12/
    related:
        - title: 'Previous · Jun 10'
          copy: 'Step back a day to the June 10th log.'
          href: /journal/06-10/
          icon: calendar
        - title: 'Next · Jun 12'
          copy: 'Jump ahead to the June 12th log.'
          href: /journal/06-12/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   12:30PM
    ...
    The agent mode for the co-pilot has been interesting for the most part, I spent a decent amount of time looking through it and its been okay.
    There is room for improvements, but for the most part the software has been great.
    I am not too sure if it will operate well within the mono repo but we will find out.
