...
bento:
    ...
    title: 'April 11,'
    accent: every year.
    lede: 'The April 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Apr 12 →'
          href: /journal/04-12/
    related:
        - title: 'Previous · Apr 10'
          copy: 'Step back a day to the April 10th log.'
          href: /journal/04-10/
          icon: calendar
        - title: 'Next · Apr 12'
          copy: 'Jump ahead to the April 12th log.'
          href: /journal/04-12/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1538439907460-1596cafd4eff?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
