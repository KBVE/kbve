...
bento:
    ...
    title: 'February 25,'
    accent: every year.
    lede: 'The February 25th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 26 →'
          href: /journal/02-26/
    related:
        - title: 'Previous · Feb 24'
          copy: 'Step back a day to the February 24th log.'
          href: /journal/02-24/
          icon: calendar
        - title: 'Next · Feb 26'
          copy: 'Jump ahead to the February 26th log.'
          href: /journal/02-26/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1505672678657-cc7037095e60?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
