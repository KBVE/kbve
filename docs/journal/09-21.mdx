...
bento:
    ...
    title: 'September 21,'
    accent: every year.
    lede: 'The September 21st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 22 →'
          href: /journal/09-22/
    related:
        - title: 'Previous · Sep 20'
          copy: 'Step back a day to the September 20th log.'
          href: /journal/09-20/
          icon: calendar
        - title: 'Next · Sep 22'
          copy: 'Jump ahead to the September 22nd log.'
          href: /journal/09-22/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1694682845794-5054f706b885?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
