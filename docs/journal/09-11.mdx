...
bento:
    ...
    title: 'September 11,'
    accent: every year.
    lede: 'The September 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Sep 12 →'
          href: /journal/09-12/
    related:
        - title: 'Previous · Sep 10'
          copy: 'Step back a day to the September 10th log.'
          href: /journal/09-10/
          icon: calendar
        - title: 'Next · Sep 12'
          copy: 'Jump ahead to the September 12th log.'
          href: /journal/09-12/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1692653055277-acb45c75f1f?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Nvidia 225 Put Assignment

-   11:15PM

    Looks like I am wheeling around another couple hundred shares, so I will have an interesting week looking at trying to off load those.
    However the couple grand from the whole swing was worth it.

### MMORPG Bevy WebGPU

-   09:00PM

    We will have to fork the egui under KBVE, just to resolve that wasm build failure.
    I found that it is a bit annoying that we have to do this, just to get the wasm to actually be multi threaded.
