...
bento:
    ...
    title: 'June 26,'
    accent: every year.
    lede: 'The June 26th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 27 →'
          href: /journal/06-27/
    related:
        - title: 'Previous · Jun 25'
          copy: 'Step back a day to the June 25th log.'
          href: /journal/06-25/
          icon: calendar
        - title: 'Next · Jun 27'
          copy: 'Jump ahead to the June 27th log.'
          href: /journal/06-27/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1718871395011-32cafdd68d4b?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   04:05PM
    ...
    After 11 hours of memes, research and jumping around, I think I was able to resolve the bug.
    Had to change the vite configuration for react and even then, I am not too sure if I had solved the issue.
    I am hoping that its done with, so I can actually get back to programming and building the core.
