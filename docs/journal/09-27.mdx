...
bento:
    ...
    title: 'September 27,'
    accent: every year.
    lede: 'The September 27th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 28 →'
          href: /journal/09-28/
    related:
        - title: 'Previous · Sep 26'
          copy: 'Step back a day to the September 26th log.'
          href: /journal/09-26/
          icon: calendar
        - title: 'Next · Sep 28'
          copy: 'Jump ahead to the September 28th log.'
          href: /journal/09-28/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1693550345119-ec1c806d74c2?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
