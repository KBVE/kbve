...
bento:
    ...
    title: 'December 5,'
    accent: every year.
    lede: 'The December 5th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Dec 6 →'
          href: /journal/12-06/
    related:
        - title: 'Previous · Dec 4'
          copy: 'Step back a day to the December 4th log.'
          href: /journal/12-04/
          icon: calendar
        - title: 'Next · Dec 6'
          copy: 'Jump ahead to the December 6th log.'
          href: /journal/12-06/
          icon: arrow
        - title: 'Journal hub'
