...
bento:
    ...
    title: 'July 31,'
    accent: every year.
    lede: 'The July 31st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Aug 1 →'
          href: /journal/08-01/
    related:
        - title: 'Previous · Jul 30'
          copy: 'Step back a day to the July 30th log.'
          href: /journal/07-30/
          icon: calendar
        - title: 'Next · Aug 1'
          copy: 'Jump ahead to the August 1st log.'
          href: /journal/08-01/
          icon: arrow
        - title: 'Journal hub'
...
### July Bills End of The Month. 

-   07:15PM

    The end of the month is always a pain, this is going to be rough too.
    My expenses have risen by over 10% since last year, maybe even closer to 20%.
    This means my funds and balance sheet will go into a debt-based operation within the decade.
    Thus the runway is now 3 years, maybe even less if things get worse before they get better.

### BTC Movement into RH

-   11:00PM 

    It might be time to start selling some of the crypto off, at least to build a bit of a slushy fund.
    The war chest needs to keep growing but the capital that we have access to is starting to get a bit rough.
