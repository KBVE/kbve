...
bento:
    ...
    title: 'November 10,'
    accent: every year.
    lede: 'The November 10th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Nov 11 →'
          href: /journal/11-11/
    related:
        - title: 'Previous · Nov 9'
          copy: 'Step back a day to the November 9th log.'
          href: /journal/11-09/
          icon: calendar
        - title: 'Next · Nov 11'
          copy: 'Jump ahead to the November 11th log.'
          href: /journal/11-11/
          icon: arrow
        - title: 'Journal hub'
