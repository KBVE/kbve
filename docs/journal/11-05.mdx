...
bento:
    ...
    title: 'November 5,'
    accent: every year.
    lede: 'The November 5th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Nov 6 →'
          href: /journal/11-06/
    related:
        - title: 'Previous · Nov 4'
          copy: 'Step back a day to the November 4th log.'
          href: /journal/11-04/
          icon: calendar
        - title: 'Next · Nov 6'
          copy: 'Jump ahead to the November 6th log.'
          href: /journal/11-06/
          icon: arrow
        - title: 'Journal hub'
