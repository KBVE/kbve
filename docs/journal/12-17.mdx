...
bento:
    ...
    title: 'December 17,'
    accent: every year.
    lede: 'The December 17th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Dec 18 →'
          href: /journal/12-18/
    related:
        - title: 'Previous · Dec 16'
          copy: 'Step back a day to the December 16th log.'
          href: /journal/12-16/
          icon: calendar
        - title: 'Next · Dec 18'
          copy: 'Jump ahead to the December 18th log.'
          href: /journal/12-18/
          icon: arrow
        - title: 'Journal hub'
