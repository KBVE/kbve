...
bento:
    ...
    title: 'February 4,'
    accent: every year.
    lede: 'The February 4th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Feb 5 →'
          href: /journal/02-05/
    related:
        - title: 'Previous · Feb 3'
          copy: 'Step back a day to the February 3rd log.'
          href: /journal/02-03/
          icon: calendar
        - title: 'Next · Feb 5'
          copy: 'Jump ahead to the February 5th log.'
          href: /journal/02-05/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1560697024-fd4affa63094?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
