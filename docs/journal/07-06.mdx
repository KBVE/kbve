...
bento:
    ...
    title: 'July 6,'
    accent: every year.
    lede: 'The July 6th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 7 →'
          href: /journal/07-07/
    related:
        - title: 'Previous · Jul 5'
          copy: 'Step back a day to the July 5th log.'
          href: /journal/07-05/
          icon: calendar
        - title: 'Next · Jul 7'
          copy: 'Jump ahead to the July 7th log.'
          href: /journal/07-07/
          icon: arrow
        - title: 'Journal hub'
...
-   09:50PM
    ...
    Decided to do a deep dive into the whole bitcraft game!
    There is a bunch for me to learn, I am enjoying their sailing but it feels a bit slow.
    As for the other parts of the game, the lack of world content is definitely noticable after about 50 hours of gameplay.
    However it has a great idle loop, but needs to focus more on the community building.
    Traveling around the world is interesting, I do wish they made it a bit easier to sail, its a bit annoying to click around every few seconds.
