...
bento:
    ...
    title: 'November 7,'
    accent: every year.
    lede: 'The November 7th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Nov 8 →'
          href: /journal/11-08/
    related:
        - title: 'Previous · Nov 6'
          copy: 'Step back a day to the November 6th log.'
          href: /journal/11-06/
          icon: calendar
        - title: 'Next · Nov 8'
          copy: 'Jump ahead to the November 8th log.'
          href: /journal/11-08/
          icon: arrow
        - title: 'Journal hub'
