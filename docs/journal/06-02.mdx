...
bento:
    ...
    title: 'June 2,'
    accent: every year.
    lede: 'The June 2nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 3 →'
          href: /journal/06-03/
    related:
        - title: 'Previous · Jun 1'
          copy: 'Step back a day to the June 1st log.'
          href: /journal/06-01/
          icon: calendar
        - title: 'Next · Jun 3'
          copy: 'Jump ahead to the June 3rd log.'
          href: /journal/06-03/
          icon: arrow
        - title: 'Journal hub'
