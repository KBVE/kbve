...
bento:
    ...
    title: 'July 7,'
    accent: every year.
    lede: 'The July 7th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 8 →'
          href: /journal/07-08/
    related:
        - title: 'Previous · Jul 6'
          copy: 'Step back a day to the July 6th log.'
          href: /journal/07-06/
          icon: calendar
        - title: 'Next · Jul 8'
          copy: 'Jump ahead to the July 8th log.'
          href: /journal/07-08/
          icon: arrow
        - title: 'Journal hub'
