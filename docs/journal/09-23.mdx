...
bento:
    ...
    title: 'September 23,'
    accent: every year.
    lede: 'The September 23rd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 24 →'
          href: /journal/09-24/
    related:
        - title: 'Previous · Sep 22'
          copy: 'Step back a day to the September 22nd log.'
          href: /journal/09-22/
          icon: calendar
        - title: 'Next · Sep 24'
          copy: 'Jump ahead to the September 24th log.'
          href: /journal/09-24/
          icon: arrow
        - title: 'Journal hub'
