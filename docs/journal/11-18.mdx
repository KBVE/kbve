...
bento:
    ...
    title: 'November 18,'
    accent: every year.
    lede: 'The November 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Nov 19 →'
          href: /journal/11-19/
    related:
        - title: 'Previous · Nov 17'
          copy: 'Step back a day to the November 17th log.'
          href: /journal/11-17/
          icon: calendar
        - title: 'Next · Nov 19'
          copy: 'Jump ahead to the November 19th log.'
          href: /journal/11-19/
          icon: arrow
        - title: 'Journal hub'
