...
bento:
    ...
    title: 'September 17,'
    accent: every year.
    lede: 'The September 17th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 18 →'
          href: /journal/09-18/
    related:
        - title: 'Previous · Sep 16'
          copy: 'Step back a day to the September 16th log.'
          href: /journal/09-16/
          icon: calendar
        - title: 'Next · Sep 18'
          copy: 'Jump ahead to the September 18th log.'
          href: /journal/09-18/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1692095296815-943c0e214cd0?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
