...
bento:
    ...
    title: 'April 19,'
    accent: every year.
    lede: 'The April 19th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 20 →'
          href: /journal/04-20/
    related:
        - title: 'Previous · Apr 18'
          copy: 'Step back a day to the April 18th log.'
          href: /journal/04-18/
          icon: calendar
        - title: 'Next · Apr 20'
          copy: 'Jump ahead to the April 20th log.'
          href: /journal/04-20/
          icon: arrow
        - title: 'Journal hub'
