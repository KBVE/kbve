...
bento:
    ...
    title: 'September 15,'
    accent: every year.
    lede: 'The September 15th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 16 →'
          href: /journal/09-16/
    related:
        - title: 'Previous · Sep 14'
          copy: 'Step back a day to the September 14th log.'
          href: /journal/09-14/
          icon: calendar
        - title: 'Next · Sep 16'
          copy: 'Jump ahead to the September 16th log.'
          href: /journal/09-16/
          icon: arrow
        - title: 'Journal hub'
