...
bento:
    ...
    title: 'October 12,'
    accent: every year.
    lede: 'The October 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 13 →'
          href: /journal/10-13/
    related:
        - title: 'Previous · Oct 11'
          copy: 'Step back a day to the October 11th log.'
          href: /journal/10-11/
          icon: calendar
        - title: 'Next · Oct 13'
          copy: 'Jump ahead to the October 13th log.'
          href: /journal/10-13/
          icon: arrow
        - title: 'Journal hub'
