...
bento:
    ...
    title: 'October 6,'
    accent: every year.
    lede: 'The October 6th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 7 →'
          href: /journal/10-07/
    related:
        - title: 'Previous · Oct 5'
          copy: 'Step back a day to the October 5th log.'
          href: /journal/10-05/
          icon: calendar
        - title: 'Next · Oct 7'
          copy: 'Jump ahead to the October 7th log.'
          href: /journal/10-07/
          icon: arrow
        - title: 'Journal hub'
