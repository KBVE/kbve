...
bento:
    ...
    title: 'September 28,'
    accent: every year.
    lede: 'The September 28th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 29 →'
          href: /journal/09-29/
    related:
        - title: 'Previous · Sep 27'
          copy: 'Step back a day to the September 27th log.'
          href: /journal/09-27/
          icon: calendar
        - title: 'Next · Sep 29'
          copy: 'Jump ahead to the September 29th log.'
          href: /journal/09-29/
          icon: arrow
        - title: 'Journal hub'
