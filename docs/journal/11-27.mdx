...
bento:
    ...
    title: 'November 27,'
    accent: every year.
    lede: 'The November 27th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Nov 28 →'
          href: /journal/11-28/
    related:
        - title: 'Previous · Nov 26'
          copy: 'Step back a day to the November 26th log.'
          href: /journal/11-26/
          icon: calendar
        - title: 'Next · Nov 28'
          copy: 'Jump ahead to the November 28th log.'
          href: /journal/11-28/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1732279446743-324499ebbeba?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
