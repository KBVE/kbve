...
bento:
    ...
    title: 'October 1,'
    accent: every year.
    lede: 'The October 1st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 2 →'
          href: /journal/10-02/
    related:
        - title: 'Previous · Sep 30'
          copy: 'Step back a day to the September 30th log.'
          href: /journal/09-30/
          icon: calendar
        - title: 'Next · Oct 2'
          copy: 'Jump ahead to the October 2nd log.'
          href: /journal/10-02/
          icon: arrow
        - title: 'Journal hub'
