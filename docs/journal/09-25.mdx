...
bento:
    ...
    title: 'September 25,'
    accent: every year.
    lede: 'The September 25th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 26 →'
          href: /journal/09-26/
    related:
        - title: 'Previous · Sep 24'
          copy: 'Step back a day to the September 24th log.'
          href: /journal/09-24/
          icon: calendar
        - title: 'Next · Sep 26'
          copy: 'Jump ahead to the September 26th log.'
          href: /journal/09-26/
          icon: arrow
        - title: 'Journal hub'
