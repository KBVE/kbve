...
bento:
    ...
    title: 'February 12,'
    accent: every year.
    lede: 'The February 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 13 →'
          href: /journal/02-13/
    related:
        - title: 'Previous · Feb 11'
          copy: 'Step back a day to the February 11th log.'
          href: /journal/02-11/
          icon: calendar
        - title: 'Next · Feb 13'
          copy: 'Jump ahead to the February 13th log.'
          href: /journal/02-13/
          icon: arrow
        - title: 'Journal hub'
