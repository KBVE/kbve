...
bento:
    ...
    title: 'September 20,'
    accent: every year.
    lede: 'The September 20th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Sep 21 →'
          href: /journal/09-21/
    related:
        - title: 'Previous · Sep 19'
          copy: 'Step back a day to the September 19th log.'
          href: /journal/09-19/
          icon: calendar
        - title: 'Next · Sep 21'
          copy: 'Jump ahead to the September 21st log.'
          href: /journal/09-21/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1691335799851-ea2799a51ff0?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
