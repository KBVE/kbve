...
bento:
    ...
    title: 'May 26,'
    accent: every year.
    lede: 'The May 26th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 27 →'
          href: /journal/05-27/
    related:
        - title: 'Previous · May 25'
          copy: 'Step back a day to the May 25th log.'
          href: /journal/05-25/
          icon: calendar
        - title: 'Next · May 27'
          copy: 'Jump ahead to the May 27th log.'
          href: /journal/05-27/
          icon: arrow
        - title: 'Journal hub'
