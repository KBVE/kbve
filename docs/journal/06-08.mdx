...
bento:
    ...
    title: 'June 8,'
    accent: every year.
    lede: 'The June 8th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 9 →'
          href: /journal/06-09/
    related:
        - title: 'Previous · Jun 7'
          copy: 'Step back a day to the June 7th log.'
          href: /journal/06-07/
          icon: calendar
        - title: 'Next · Jun 9'
          copy: 'Jump ahead to the June 9th log.'
          href: /journal/06-09/
          icon: arrow
        - title: 'Journal hub'
