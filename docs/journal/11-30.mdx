...
bento:
    ...
    title: 'November 30,'
    accent: every year.
    lede: 'The November 30th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2024'
          primary: true
        ...
        - label: 'Dec 1 →'
          href: /journal/12-01/
    related:
        - title: 'Previous · Nov 29'
          copy: 'Step back a day to the November 29th log.'
          href: /journal/11-29/
          icon: calendar
        - title: 'Next · Dec 1'
          copy: 'Jump ahead to the December 1st log.'
          href: /journal/12-01/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1722790892030-a4298d6df175?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
