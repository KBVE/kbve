...
bento:
    ...
    title: 'September 12,'
    accent: every year.
    lede: 'The September 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Sep 13 →'
          href: /journal/09-13/
    related:
        - title: 'Previous · Sep 11'
          copy: 'Step back a day to the September 11th log.'
          href: /journal/09-11/
          icon: calendar
        - title: 'Next · Sep 13'
          copy: 'Jump ahead to the September 13th log.'
          href: /journal/09-13/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1691862867327-d07c3fe827f5?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   04:16PM
    ...
    The first v0.1.0 was shipped, now the main issue is that the assets seem to 404.
    What we can do first is clear up the action router, so that we can speed up builds.
    My plan for this weekend is to get a functional mmorpg under lightyear that we can play on itch.
    Afterwards we can handle the auth sessions, using something similar to the bbs style.
