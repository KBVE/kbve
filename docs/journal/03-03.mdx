...
bento:
    ...
    title: 'March 3,'
    accent: every year.
    lede: 'The March 3rd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 4 →'
          href: /journal/03-04/
    related:
        - title: 'Previous · Mar 2'
          copy: 'Step back a day to the March 2nd log.'
          href: /journal/03-02/
          icon: calendar
        - title: 'Next · Mar 4'
          copy: 'Jump ahead to the March 4th log.'
          href: /journal/03-04/
          icon: arrow
        - title: 'Journal hub'
...
```javascript
    ...
    <iframe src="https://kbve.com/arcade/fishchip/itch/" height="1024px" width="100%" frameBorder="0" scrolling="no" >Your browser doesnot support iframes<a href="https://kbve.com/arcade/fishchip/" data-astro-prefetch> click here to view the page directly. </a></iframe>
