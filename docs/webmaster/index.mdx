...
jsonld:
    faq:
        - question: What does a webmaster actually do?
          answer: A webmaster keeps a site online, fast, and discoverable — DNS, deploys, SEO, monitoring, backups, and compliance. On small teams it is one person; on larger teams the checklist splits across SRE, marketing, and platform engineering.
        - question: Is the KBVE webmaster tool free?
          answer: Yes. Drop a domain in the box and one-click into Google Search Console, Bing Webmaster, PageSpeed, SSL Labs, Wayback, and a few dozen other audits. Recent domains are remembered locally — no account, no tracking, no server round-trip.
        - question: What Core Web Vitals targets should I aim for?
          answer: LCP under 2.5 seconds, CLS under 0.1, and INP under 200 milliseconds on a mid-tier Android over 4G. That is the "good" threshold and the only one Search Console grades you on.
        - question: Does robots.txt protect private files?
          answer: No. Files and directories listed in robots.txt can still be accessed directly through their URLs, and malicious bots ignore the file entirely. It manages crawler traffic, not security.
        - question: Which structured data format should I use?
          answer: JSON-LD is the only format Google fully supports. Drop it in a script tag of type application/ld+json in the head, mark up only what the user sees, and validate with validator.schema.org.
        - question: Do I need an XML sitemap?
          answer: Yes for anything beyond a handful of pages. It lists your URLs with lastmod metadata so search engines discover updates quickly. Submit it through Google Search Console and Bing Webmaster Tools.
bento:
    badge: tools · seo · operations
    title: Keep the site fast, found, and
    accent: online
    lede: >-
        The webmaster's job is DNS, deploys, SEO, backups, and the 2 AM incident —
        this page is the toolbox and the checklist. Drop a domain in the box and
        one-click into twenty-six audits, then work through the guide below.
    ctas:
    ...
    aside:
        icon: bolt
        title: One box, every audit
        body: >-
            Enter a domain once and every tool link on the page lights up —
            Search Console, PageSpeed, SSL Labs, Wayback, Whois, and more.
        points:
            - <strong>No account</strong> — recent domains are remembered locally.
            - <strong>No tracking</strong> — no server round-trip, ever.
            - <strong>26 tools</strong> — SEO, performance, security, DNS, tech, validators.
    stats:
        - { label: Audit tools, value: '26', icon: bolt }
        - { label: Categories, value: '6', icon: gears }
        - { label: LCP target, value: '< 2.5 s', icon: activity }
        - { label: Data stored, value: Local only, icon: shield }
    related:
        - title: Developer tools
          href: /tools/
          copy: The rest of the KBVE tool belt — utilities, references, and calculators.
          icon: gears
        - title: Applications
          href: /application/
          copy: Guides for the languages and frameworks behind the sites you run.
          icon: code
    theme:
        accent: '#38bdf8'
        accent2: '#818cf8'
...
<BentoShell
	id="tool"
	eyebrow="Launchpad"
	heading="Webmaster tools"
	sub="Enter a domain and launch SEO, performance, security, and tech audits in one click.">
	<AstroWebmasterTool />
</BentoShell>

<BentoProse id="role" eyebrow="The job" heading="Webmaster">
...
<BentoProse id="pagespeed" eyebrow="Performance" heading="Page Speed">
...
<BentoProse id="seo" eyebrow="Search" heading="SEO">
...
<BentoProse id="uxui" eyebrow="Design" heading="UX & UI">
...
<BentoProse id="marketing" eyebrow="Growth" heading="Marketing">
...
<BentoProse id="compliance" eyebrow="Legal" heading="Compliance">
...
<BentoProse id="accessibility" eyebrow="Inclusive by default" heading="Accessibility">
...
<BentoProse id="robots" eyebrow="Crawlers" heading="Robots">
...
<BentoProse id="sitemap" eyebrow="Indexing" heading="Sitemap">
...
<BentoProse id="mobile" eyebrow="Small screens first" heading="Mobile">
...
<BentoProse id="schema" eyebrow="Structured data" heading="Schema">
...
<BentoProse id="languages" eyebrow="i18n" heading="Languages">
...
<BentoProse id="hosting" eyebrow="Infrastructure" heading="Hosting">
...
<BentoProse id="recovery" eyebrow="Backups" heading="Recovery">
