...
version: "0.1.42"
source_path: services/firecracker
version_toml: services/firecracker/version.toml
version_target: services/firecracker/Cargo.toml
...
bento:
    ...
    ctas:
        - label: View source
          href: https://github.com/KBVE/kbve/tree/main/services/firecracker
          primary: true
          external: true
        - label: Overview
          href: "#overview"
...
| **License** | KBVE |
| **Source** | [`services/firecracker`](https://github.com/KBVE/kbve/tree/main/services/firecracker) |
