...
version: "0.0.1"
source_path: services/iot
version_toml: services/iot/version.toml
version_target: services/iot/version.toml
...
bento:
    ...
    ctas:
        - label: View source
          href: https://github.com/KBVE/kbve/tree/main/services/iot
          primary: true
          external: true
        - label: Overview
          href: "#overview"
