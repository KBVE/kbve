...
type ElementsParamList = {
	Pro: { productId: string };
	// Add other screens and their required parameters as needed
};

interface ElementsProps {
	navigation: StackNavigationProp<ElementsParamList>;
}
...
class Elements extends React.Component<ElementsProps, ElementsState> {
	state: ElementsState = {
		'switch-1': true,
		'switch-2': false,
	};

	toggleSwitch = (switchId: keyof ElementsState) => {
		...
		return (
			<Block flex style={styles.group}>
				...
				<Block style={{ paddingHorizontal: argonTheme.SIZES.BASE }}>
					<Text
						h1
						style={{ marginBottom: argonTheme.SIZES.BASE / 2 }}
			...
			<Block flex style={styles.group}>
				...
				<Block style={{ paddingHorizontal: argonTheme.SIZES.BASE }}>
					<Block
						...
						middle
						space="between"
						style={{ marginBottom: argonTheme.SIZES.BASE }}>
			...
			<Block flex style={styles.group}>
				...
				<Block style={{ paddingHorizontal: argonTheme.SIZES.BASE }}>
					<Block style={styles.rows}>
						<TouchableOpacity
							onPress={() => navigation.navigate({ name: 'Pro', params: { productId: '123' } })}>
							<Block
								row
								middle
								space="between"
					...
					<Block row center space="between">
						<Block flex middle right>
							<GaButton
								...
								iconSize={argonTheme.SIZES.BASE * 1.625}
	...
	renderNavigation = () => {
		return (
			<Block flex style={styles.group}>
				...
				<Block>
					<Block style={{ marginBottom: argonTheme.SIZES.BASE }}>
						<Header
							back
							title="Title"
...
const styles = StyleSheet.create({
	...
	group: {
		paddingTop: argonTheme.SIZES.BASE * 2,
	},
	shadow: {
		shadowColor: 'black',
	...
	button: {
		marginBottom: argonTheme.SIZES.BASE,
	...
	social: {
		width: argonTheme.SIZES.BASE * 3.5,
		height: argonTheme.SIZES.BASE * 3.5,
		borderRadius: argonTheme.SIZES.BASE * 1.75,
  ...
  rows: {
    ...
    justifyContent: 'space-between', // Distribute children evenly and align them at start and end
    alignItems: 'center', // Align children vertically in the center
    marginBottom: 10, // Add some margin at the bottom of each row
    // Add any other styling you need for your rows
  },
