...
name: Building
title: Building Icon
description: Building glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
...
Building — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
