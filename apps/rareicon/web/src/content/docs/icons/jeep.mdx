...
name: Jeep
title: Jeep Icon
description: Jeep glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://phosphoricons.com/?q=jeep"
  commercial_use: true
