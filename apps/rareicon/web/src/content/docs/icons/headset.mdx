...
name: Headset
title: Headset Icon
description: Headset glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/headset"
  commercial_use: true
...
Headset — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
