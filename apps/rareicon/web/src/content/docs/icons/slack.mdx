...
name: Slack
title: Slack Icon
description: Slack glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/slack"
  commercial_use: true
...
Slack — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
