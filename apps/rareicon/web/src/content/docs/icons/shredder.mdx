...
name: Shredder
title: Shredder Icon
description: Shredder glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/shredder"
  commercial_use: true
...
Shredder — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
