...
name: Csharp
title: Csharp Icon
description: Csharp glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=csharp"
  commercial_use: true
