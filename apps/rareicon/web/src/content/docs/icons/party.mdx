...
name: Party
title: Party Icon
description: Party glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/party"
  commercial_use: true
...
Party — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
