...
name: Diameter
title: Diameter Icon
description: Diameter glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/diameter"
  commercial_use: true
...
Diameter — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
