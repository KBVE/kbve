...
name: Sunset
title: Sunset Icon
description: Sunset glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/sunset"
  commercial_use: true
...
Sunset — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
