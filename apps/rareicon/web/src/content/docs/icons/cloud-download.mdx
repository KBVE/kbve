...
description: Cloud Download glyph from the akar-icons icon library, 1 variant — recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [akar-icons-generated, akar-icons]
search:
  keywords: ["cloud-download","cloud","download","cloud download"]
  primary_category: tech
default_license:
  license: mit
  ...
  source_url: "https://akaricons.com/cloud-download"
  commercial_use: true
...
Cloud Download — glyph from the [Akar Icons icon library](https://akaricons.com/).
