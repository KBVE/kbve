...
ref: treasure-map
name: Treasure Map
title: Treasure Map Icon
description: Treasure Map glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["treasure-map","treasure","map","treasure map"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/treasure-map"
  commercial_use: true
