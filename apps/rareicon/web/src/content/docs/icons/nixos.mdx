...
name: NixOS
title: NixOS Icon
description: NixOS brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/nixos"
  commercial_use: true
...
NixOS — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
