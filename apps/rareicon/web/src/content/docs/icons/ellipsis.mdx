...
name: Ellipsis
title: Ellipsis Icon
description: Ellipsis glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/ellipsis"
  commercial_use: true
...
Ellipsis — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
