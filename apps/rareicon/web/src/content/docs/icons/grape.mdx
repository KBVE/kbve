...
name: Grape
title: Grape Icon
description: Grape glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/grape"
  commercial_use: true
...
Grape — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
