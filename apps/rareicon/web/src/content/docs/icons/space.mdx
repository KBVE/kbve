...
name: Space
title: Space Icon
description: Space glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/space"
  commercial_use: true
...
icons:
  - ref: "outline"
    ...
    tags: [lucide]
    svg_body: |
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1"/></svg>
pagefindFilters: [lucide, ui]
---

import IconTermPanel from '@/components/icons/IconTermPanel.astro';

Space — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
