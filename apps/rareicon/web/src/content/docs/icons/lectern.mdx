...
name: Lectern
title: Lectern Icon
description: Lectern glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/lectern"
  commercial_use: true
...
Lectern — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
