...
name: Brush
title: Brush Icon
description: Brush glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["brush", "cleaning"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/brush"
  commercial_use: true
...
Brush — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
