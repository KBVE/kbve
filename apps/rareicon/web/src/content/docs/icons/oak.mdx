...
name: Oak
title: Oak Icon
description: Oak glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://game-icons.net/1x1/oak"
  commercial_use: true
