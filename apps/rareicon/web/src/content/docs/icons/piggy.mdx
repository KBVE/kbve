...
name: Piggy
title: Piggy Icon
description: Piggy glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/piggy"
  commercial_use: true
...
Piggy — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
