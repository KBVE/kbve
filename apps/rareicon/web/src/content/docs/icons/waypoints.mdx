...
ref: waypoints
name: Waypoints
title: Waypoints Icon
description: Waypoints glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/waypoints"
  commercial_use: true
...
Waypoints — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
