...
name: Mastodon
title: Mastodon Icon
description: Mastodon brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/mastodon"
  commercial_use: true
...
Mastodon — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
