...
const ICONS_DIR = path.resolve(WORKSPACE_ROOT, 'apps/rareicon/web/src/content/docs/icons');
...
const PACKS = [
	...
	{
		prefix: 'logos',
		bundle: 'node_modules/@iconify-json/logos/icons.json',
		suffix: 'logos',
		genTag: 'logos-generated',
		license: 'cc0',
		licenseLine: 'SVG Logos (https://svgporn.com/) — CC0 — Gil Barbara',
		author: 'Gil Barbara',
		homeUrl: 'https://svgporn.com/',
		sourceUrlPrefix: 'https://svgporn.com/logos/',
		pagefindFilter: 'logos',
		curated: [
			// Languages
			{ slug: 'rust', ref: 'rust', cat: 'tech' },
			{ slug: 'python', ref: 'python', cat: 'tech' },
			{ slug: 'typescript', ref: 'typescript', cat: 'tech' },
			{ slug: 'javascript', ref: 'javascript', cat: 'tech' },
			{ slug: 'kotlin-icon', ref: 'kotlin', cat: 'tech' },
			{ slug: 'swift', ref: 'swift', cat: 'tech' },
			{ slug: 'dart', ref: 'dart', cat: 'tech' },
			{ slug: 'elixir', ref: 'elixir', cat: 'tech' },
			{ slug: 'lua', ref: 'lua', cat: 'tech' },
			{ slug: 'haskell-icon', ref: 'haskell', cat: 'tech' },
			// Frameworks
			{ slug: 'react', ref: 'react', cat: 'tech' },
			{ slug: 'vue', ref: 'vue', cat: 'tech' },
			{ slug: 'svelte-icon', ref: 'svelte', cat: 'tech' },
			{ slug: 'astro-icon', ref: 'astro', cat: 'tech' },
			{ slug: 'nextjs-icon', ref: 'next-js', cat: 'tech' },
			{ slug: 'tailwindcss-icon', ref: 'tailwindcss', cat: 'tech' },
			// Runtimes
			{ slug: 'nodejs-icon', ref: 'node-js', cat: 'tech' },
			{ slug: 'deno', ref: 'deno', cat: 'tech' },
			{ slug: 'bun', ref: 'bun', cat: 'tech' },
			// DBs
			{ slug: 'postgresql', ref: 'postgresql', cat: 'tech' },
			{ slug: 'mongodb-icon', ref: 'mongodb', cat: 'tech' },
			{ slug: 'redis', ref: 'redis', cat: 'tech' },
			{ slug: 'sqlite', ref: 'sqlite', cat: 'tech' },
			// DevOps
			{ slug: 'docker-icon', ref: 'docker', cat: 'tech' },
			{ slug: 'kubernetes', ref: 'kubernetes', cat: 'tech' },
			{ slug: 'terraform-icon', ref: 'terraform', cat: 'tech' },
			{ slug: 'github-icon', ref: 'github', cat: 'tech' },
			{ slug: 'githubactions', ref: 'github-actions', cat: 'tech' },
			// Cloud
			{ slug: 'aws', ref: 'aws', cat: 'tech' },
			{ slug: 'google-cloud', ref: 'google-cloud', cat: 'tech' },
			{ slug: 'cloudflare', ref: 'cloudflare', cat: 'tech' },
			{ slug: 'vercel-icon', ref: 'vercel', cat: 'tech' },
			{ slug: 'netlify', ref: 'netlify', cat: 'tech' },
			// Game engines / creative
			{ slug: 'unity', ref: 'unity', cat: 'gaming' },
			{ slug: 'unreal-engine', ref: 'unreal-engine', cat: 'gaming' },
			{ slug: 'godot-icon', ref: 'godot', cat: 'gaming' },
			{ slug: 'blender', ref: 'blender', cat: 'gaming' },
			// AI / ML
			{ slug: 'openai-icon', ref: 'openai', cat: 'tech' },
			{ slug: 'pytorch-icon', ref: 'pytorch', cat: 'tech' },
			{ slug: 'tensorflow', ref: 'tensorflow', cat: 'tech' },
			{ slug: 'huggingface-icon', ref: 'hugging-face', cat: 'tech' },
			// Social
			{ slug: 'discord-icon', ref: 'discord', cat: 'tech' },
			{ slug: 'figma', ref: 'figma', cat: 'tech' },
		],
	},
	{
		prefix: 'devicon',
		bundle: 'node_modules/@iconify-json/devicon/icons.json',
		suffix: 'devicon',
		genTag: 'devicon-generated',
		license: 'mit',
		licenseLine: 'Devicon (https://devicon.dev/) — MIT License',
		author: 'Devicon contributors',
		homeUrl: 'https://devicon.dev/',
		sourceUrlPrefix: 'https://devicon.dev/?icon=',
		pagefindFilter: 'devicon',
		curated: [
			// Languages
			{ slug: 'rust', ref: 'rust', cat: 'tech' },
			{ slug: 'go', ref: 'go', cat: 'tech' },
			{ slug: 'python', ref: 'python', cat: 'tech' },
			{ slug: 'typescript', ref: 'typescript', cat: 'tech' },
			{ slug: 'javascript', ref: 'javascript', cat: 'tech' },
			{ slug: 'kotlin', ref: 'kotlin', cat: 'tech' },
			{ slug: 'swift', ref: 'swift', cat: 'tech' },
			{ slug: 'dart', ref: 'dart', cat: 'tech' },
			{ slug: 'elixir', ref: 'elixir', cat: 'tech' },
			{ slug: 'csharp', ref: 'csharp', cat: 'tech' },
			{ slug: 'cplusplus', ref: 'cplusplus', cat: 'tech' },
			{ slug: 'java', ref: 'java', cat: 'tech' },
			{ slug: 'ruby', ref: 'ruby', cat: 'tech' },
			{ slug: 'lua', ref: 'lua', cat: 'tech' },
			{ slug: 'haskell', ref: 'haskell', cat: 'tech' },
			{ slug: 'scala', ref: 'scala', cat: 'tech' },
			{ slug: 'clojure', ref: 'clojure', cat: 'tech' },
			{ slug: 'erlang', ref: 'erlang', cat: 'tech' },
			{ slug: 'nim', ref: 'nim', cat: 'tech' },
			{ slug: 'crystal', ref: 'crystal', cat: 'tech' },
			// Web frameworks
			{ slug: 'react', ref: 'react', cat: 'tech' },
			{ slug: 'vuejs', ref: 'vuejs', cat: 'tech' },
			{ slug: 'angular', ref: 'angular', cat: 'tech' },
			{ slug: 'svelte', ref: 'svelte', cat: 'tech' },
			{ slug: 'astro', ref: 'astro', cat: 'tech' },
			{ slug: 'nextjs', ref: 'nextjs', cat: 'tech' },
			{ slug: 'nuxtjs', ref: 'nuxtjs', cat: 'tech' },
			{ slug: 'tailwindcss', ref: 'tailwindcss', cat: 'tech' },
			// Backend / runtimes
			{ slug: 'nodejs', ref: 'nodejs', cat: 'tech' },
			{ slug: 'deno', ref: 'deno', cat: 'tech' },
			{ slug: 'bun', ref: 'bun', cat: 'tech' },
			{ slug: 'rails', ref: 'rails', cat: 'tech' },
			{ slug: 'django', ref: 'django', cat: 'tech' },
			{ slug: 'flask', ref: 'flask', cat: 'tech' },
			{ slug: 'fastapi', ref: 'fastapi', cat: 'tech' },
			{ slug: 'spring', ref: 'spring', cat: 'tech' },
			// DBs / data
			{ slug: 'postgresql', ref: 'postgresql', cat: 'tech' },
			{ slug: 'mysql', ref: 'mysql', cat: 'tech' },
			{ slug: 'mongodb', ref: 'mongodb', cat: 'tech' },
			{ slug: 'redis', ref: 'redis', cat: 'tech' },
			{ slug: 'sqlite', ref: 'sqlite', cat: 'tech' },
			{ slug: 'graphql', ref: 'graphql', cat: 'tech' },
			// DevOps
			{ slug: 'docker', ref: 'docker', cat: 'tech' },
			{ slug: 'kubernetes', ref: 'kubernetes', cat: 'tech' },
			{ slug: 'terraform', ref: 'terraform', cat: 'tech' },
			{ slug: 'ansible', ref: 'ansible', cat: 'tech' },
			{ slug: 'githubactions', ref: 'githubactions', cat: 'tech' },
			{ slug: 'jenkins', ref: 'jenkins', cat: 'tech' },
			{ slug: 'nginx', ref: 'nginx', cat: 'tech' },
			// Game engines / 3D / creative
			{ slug: 'unity', ref: 'unity', cat: 'gaming' },
			{ slug: 'unrealengine', ref: 'unreal-engine', cat: 'gaming' },
			{ slug: 'godot', ref: 'godot', cat: 'gaming' },
			{ slug: 'blender', ref: 'blender', cat: 'gaming' },
		],
	},
	{
