 ...
 *   node apps/rareicon/web/scripts/gen-simple-icons.mjs
 *   node apps/rareicon/web/scripts/gen-simple-icons.mjs --dry-run
 *   node apps/rareicon/web/scripts/gen-simple-icons.mjs --no-clean
 */
