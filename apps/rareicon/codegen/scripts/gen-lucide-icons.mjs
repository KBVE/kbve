 ...
 *
 * Usage:
 *   node apps/rareicon/web/scripts/gen-lucide-icons.mjs
 *   node apps/rareicon/web/scripts/gen-lucide-icons.mjs --limit 400
 *   node apps/rareicon/web/scripts/gen-lucide-icons.mjs --dry-run
 *   node apps/rareicon/web/scripts/gen-lucide-icons.mjs --no-clean
 */
...
const LUCIDE_ICONS_DIR = path.resolve(PACKAGE_ROOT, 'node_modules/lucide/dist/esm/icons');
