...
ref: brain-circuit
name: Brain Circuit
title: Brain Circuit Icon
description: Brain Circuit glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["brain-circuit", "brain", "circuit"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/brain-circuit"
  commercial_use: true
...
Brain Circuit — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
