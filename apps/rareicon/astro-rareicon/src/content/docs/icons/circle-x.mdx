...
name: Circle X
title: Circle X Icon
description: Circle X glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["circle-x", "circle"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/circle-x"
  commercial_use: true
...
Circle X — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
