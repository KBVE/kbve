...
description: Epic Games brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: gaming
categories: [gaming, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["epic-games","epic","games","epic games","epicgames"]
  primary_category: gaming
default_license:
  license: cc0
  ...
  source_url: "https://simpleicons.org/icons/epicgames"
  commercial_use: true
...
Epic Games — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
