...
description: Clipboard glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
Clipboard — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
