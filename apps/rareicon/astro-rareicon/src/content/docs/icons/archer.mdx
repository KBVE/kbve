...
name: Archer
title: Archer Icon
description: Archer glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://game-icons.net/1x1/archer"
  commercial_use: true
