...
name: Clock 4
title: Clock 4 Icon
description: Clock 4 glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["clock-4", "clock"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clock-4"
  commercial_use: true
...
Clock 4 — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
