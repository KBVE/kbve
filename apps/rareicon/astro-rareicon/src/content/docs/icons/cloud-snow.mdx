...
description: Cloud Snow glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/cloud-snow"
  commercial_use: true
...
Cloud Snow — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
