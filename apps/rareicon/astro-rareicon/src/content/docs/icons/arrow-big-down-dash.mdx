---
ref: arrow-big-down-dash
name: Arrow Big Down Dash
title: Arrow Big Down Dash Icon
description: Arrow Big Down Dash glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/arrow-big-down-dash"
  commercial_use: true
...
Arrow Big Down Dash — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
