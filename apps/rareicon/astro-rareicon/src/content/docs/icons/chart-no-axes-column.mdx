---
ref: chart-no-axes-column
name: Chart No Axes Column
title: Chart No Axes Column Icon
description: Chart No Axes Column glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["chart-no-axes-column", "chart", "no", "axes", "column"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/chart-no-axes-column"
  commercial_use: true
...
Chart No Axes Column — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
