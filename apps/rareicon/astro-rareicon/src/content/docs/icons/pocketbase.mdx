...
ref: pocketbase
name: PocketBase
title: PocketBase Icon
description: PocketBase brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/pocketbase"
  commercial_use: true
