...
name: Java
title: Java Icon
description: Java glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=java"
  commercial_use: true
