...
name: Spool
title: Spool Icon
description: Spool glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/spool"
  commercial_use: true
...
Spool — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
