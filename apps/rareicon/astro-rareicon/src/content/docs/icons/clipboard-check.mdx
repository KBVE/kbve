...
description: Clipboard Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/clipboard-check"
  commercial_use: true
...
Clipboard Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
