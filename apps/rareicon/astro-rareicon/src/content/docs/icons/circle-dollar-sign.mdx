---
ref: circle-dollar-sign
name: Circle Dollar Sign
title: Circle Dollar Sign Icon
description: Circle Dollar Sign glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/circle-dollar-sign"
  commercial_use: true
...
Circle Dollar Sign — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
