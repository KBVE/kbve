...
title: Clipboard Clock Icon
description: Clipboard Clock glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: file
categories: [file, library]
tags: [lucide, outline]
search:
  keywords: ["clipboard-clock", "clipboard", "clock"]
  primary_category: file
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clipboard-clock"
  commercial_use: true
...
Clipboard Clock — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
