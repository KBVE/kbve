...
description: Creative Commons glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/creative-commons"
  commercial_use: true
...
Creative Commons — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
