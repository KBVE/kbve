...
name: Tree
title: Tree Icon
description: Tree glyph set from the Lucide icon library (ISC), 3 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["tree", "deciduous", "palm", "pine"]
  primary_category: ui
default_license:
  license: isc
...
Tree — 3 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
