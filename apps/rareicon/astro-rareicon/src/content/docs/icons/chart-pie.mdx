...
description: Chart Pie glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chart-pie"
  commercial_use: true
...
Chart Pie — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
