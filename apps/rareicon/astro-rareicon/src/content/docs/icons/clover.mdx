...
name: Clover
title: Clover Icon
description: Clover glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/clover"
  commercial_use: true
...
Clover — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
