...
name: Landmark
title: Landmark Icon
description: Landmark glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/landmark"
  commercial_use: true
...
Landmark — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
