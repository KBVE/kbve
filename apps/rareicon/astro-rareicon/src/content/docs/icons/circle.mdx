...
name: Circle
title: Circle Icon
description: Circle glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Circle — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
