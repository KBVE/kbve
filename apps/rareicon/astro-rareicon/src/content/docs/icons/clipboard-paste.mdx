...
title: Clipboard Paste Icon
description: Clipboard Paste glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: file
categories: [file, library]
tags: [lucide, outline]
search:
  keywords: ["clipboard-paste", "clipboard", "paste"]
  primary_category: file
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clipboard-paste"
  commercial_use: true
...
Clipboard Paste — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
