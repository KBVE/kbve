...
ref: heart-mingcute
name: Heart Mingcute
title: Heart Mingcute Icon
description: Heart Mingcute glyph from the mingcute icon library, 1 variant — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [mingcute-generated, mingcute]
search:
  keywords: ["heart-mingcute","heart","mingcute","heart-line","heart mingcute"]
  primary_category: social
default_license:
  license: apache_2
  ...
  source_url: "https://www.mingcute.com/?keyword=heart-line"
  commercial_use: true
...
Heart Mingcute — glyph from the [Mingcute icon library](https://www.mingcute.com/).
