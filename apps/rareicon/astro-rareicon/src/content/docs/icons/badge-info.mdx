...
ref: badge-info
name: Badge Info
title: Badge Info Icon
description: Badge Info glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-info", "badge", "info"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-info"
  commercial_use: true
...
Badge Info — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
