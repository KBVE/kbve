...
ref: axe-phosphor
name: Axe Phosphor
title: Axe Phosphor Icon
description: Axe Phosphor glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["axe-phosphor","axe","phosphor","axe phosphor"]
  primary_category: game
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=axe"
  commercial_use: true
...
Axe Phosphor — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
