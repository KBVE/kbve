...
ref: frog-prince
name: Frog Prince
title: Frog Prince Icon
description: Frog Prince glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["frog-prince","frog","prince","frog prince"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/frog-prince"
  commercial_use: true
