...
name: Percent
title: Percent Icon
description: Percent glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/percent"
  commercial_use: true
...
Percent — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
