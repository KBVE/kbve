---
ref: settings-fluent
name: Settings Fluent
title: Settings Fluent Icon
description: Settings Fluent glyph from the fluent icon library, 1 variant — recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [fluent-generated, fluent]
search:
  keywords: ["settings-fluent","settings","fluent","settings-24-regular","settings fluent"]
  primary_category: tech
default_license:
  license: mit
  ...
  source_url: "https://github.com/microsoft/fluentui-system-icons/tree/main/assets/settings-24-regular"
  commercial_use: true
