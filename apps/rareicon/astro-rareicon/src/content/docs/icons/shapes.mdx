...
name: Shapes
title: Shapes Icon
description: Shapes glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/shapes"
  commercial_use: true
...
Shapes — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
