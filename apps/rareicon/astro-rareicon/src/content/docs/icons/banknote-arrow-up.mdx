---
ref: banknote-arrow-up
name: Banknote Arrow Up
title: Banknote Arrow Up Icon
description: Banknote Arrow Up glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: commerce
categories: [commerce, library]
tags: [lucide, outline]
search:
  keywords: ["banknote-arrow-up", "banknote", "arrow", "up"]
  primary_category: commerce
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/banknote-arrow-up"
  commercial_use: true
...
Banknote Arrow Up — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
