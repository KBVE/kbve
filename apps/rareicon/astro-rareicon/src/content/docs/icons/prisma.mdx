...
name: Prisma
title: Prisma Icon
description: Prisma brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/prisma"
  commercial_use: true
