...
ref: banknote-x
name: Banknote X
title: Banknote X Icon
description: Banknote X glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: commerce
categories: [commerce, library]
tags: [lucide, outline]
search:
  keywords: ["banknote-x", "banknote"]
  primary_category: commerce
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/banknote-x"
  commercial_use: true
...
Banknote X — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
