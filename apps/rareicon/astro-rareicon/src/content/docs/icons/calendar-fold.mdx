...
ref: calendar-fold
name: Calendar Fold
title: Calendar Fold Icon
description: Calendar Fold glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["calendar-fold", "calendar", "fold"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/calendar-fold"
  commercial_use: true
...
Calendar Fold — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
