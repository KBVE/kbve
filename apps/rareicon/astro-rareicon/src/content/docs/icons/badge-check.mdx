...
description: Badge Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-check", "badge", "check"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-check"
  commercial_use: true
...
Badge Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
