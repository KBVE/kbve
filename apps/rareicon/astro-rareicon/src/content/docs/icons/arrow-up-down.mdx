...
description: Arrow Up Down glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: navigation
categories: [navigation, library]
tags: [lucide, outline]
search:
  keywords: ["arrow-up-down", "arrow", "up", "down"]
  primary_category: navigation
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/arrow-up-down"
  commercial_use: true
...
Arrow Up Down — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
