...
name: WhatsApp
title: WhatsApp Icon
description: WhatsApp brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/whatsapp"
  commercial_use: true
...
WhatsApp — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
