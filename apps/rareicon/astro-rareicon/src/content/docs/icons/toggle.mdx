...
name: Toggle
title: Toggle Icon
description: Toggle glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["toggle", "left", "right"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/toggle"
  commercial_use: true
...
icons:
  - ref: "left"
    ...
    tags: [lucide]
    svg_body: |
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="12" r="3"/><rect width="20" height="14" x="2" y="5" rx="7"/></svg>
  - ref: "right"
    label: "Right"
    style: outline
    format: svg
...
Toggle — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
