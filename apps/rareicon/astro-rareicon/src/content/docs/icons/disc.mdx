...
name: Disc
title: Disc Icon
description: Disc glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Disc — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
