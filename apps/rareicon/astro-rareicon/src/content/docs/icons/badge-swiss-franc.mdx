---
ref: badge-swiss-franc
name: Badge Swiss Franc
title: Badge Swiss Franc Icon
description: Badge Swiss Franc glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-swiss-franc", "badge", "swiss", "franc"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-swiss-franc"
  commercial_use: true
...
Badge Swiss Franc — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
