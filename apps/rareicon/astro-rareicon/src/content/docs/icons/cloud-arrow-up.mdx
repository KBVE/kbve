...
ref: cloud-arrow-up
name: Cloud Arrow Up
title: Cloud Arrow Up Icon
description: Cloud Arrow Up glyph from the heroicons icon library, 1 variant — recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [heroicons-generated, heroicons]
search:
  keywords: ["cloud-arrow-up","cloud","arrow","up","cloud arrow up"]
  primary_category: tech
default_license:
  license: mit
  ...
  source_url: "https://heroicons.com/cloud-arrow-up"
  commercial_use: true
...
Cloud Arrow Up — glyph from the [Heroicons icon library](https://heroicons.com/).
