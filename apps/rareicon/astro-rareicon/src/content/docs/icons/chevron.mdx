...
name: Chevron
title: Chevron Icon
description: Chevron glyph set from the Lucide icon library (ISC), 6 variants — outline stroke, recolor via currentColor.
primary_category: navigation
categories: [navigation, library]
tags: [lucide, outline]
search:
  keywords: ["chevron", "down", "first", "last", "left", "right", "up"]
  primary_category: navigation
default_license:
  license: isc
...
Chevron — 6 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
