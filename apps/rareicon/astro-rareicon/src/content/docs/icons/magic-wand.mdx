...
description: Magic Wand glyph from the Tabler Icons library (MIT), 1 variant — outline stroke, recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [tabler-generated, outline]
search:
  keywords: ["magic-wand","magic","wand","magic wand"]
  primary_category: game
default_license:
  license: mit
