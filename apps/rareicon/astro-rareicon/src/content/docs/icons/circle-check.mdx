...
description: Circle Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/circle-check"
  commercial_use: true
...
Circle Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
