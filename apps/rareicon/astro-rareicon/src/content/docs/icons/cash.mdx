...
name: Cash
title: Cash Icon
description: Cash glyph from the Tabler Icons library (MIT), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://tabler.io/icons/icon/cash"
  commercial_use: true
...
Cash — outline glyph from the [Tabler Icons library](https://tabler.io/icons) (MIT).
