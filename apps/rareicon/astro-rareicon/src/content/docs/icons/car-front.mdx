...
ref: car-front
name: Car Front
title: Car Front Icon
description: Car Front glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["car-front", "car", "front"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/car-front"
  commercial_use: true
...
Car Front — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
