...
name: Image
title: Image Icon
description: Image glyph set from the Lucide icon library (ISC), 8 variants — outline stroke, recolor via currentColor.
primary_category: media
categories: [media, library]
tags: [lucide, outline]
search:
  keywords: ["image", "down", "minus", "off", "play", "plus", "up", "upscale"]
  primary_category: media
default_license:
  license: isc
...
Image — 8 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
