...
name: Fly.io
title: Fly.io Icon
description: Fly.io brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: tech
categories: [tech, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["fly-io","fly","io","fly.io","flydotio"]
  primary_category: tech
default_license:
  license: cc0
  ...
  source_url: "https://simpleicons.org/icons/flydotio"
  commercial_use: true
