...
description: Calendar Sync glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["calendar-sync", "calendar", "sync"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/calendar-sync"
  commercial_use: true
...
Calendar Sync — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
