...
description: Cigarette glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Cigarette — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
