...
ref: cigarette
name: Cigarette
title: Cigarette Icon
description: Cigarette glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/cigarette"
  commercial_use: true
...
Cigarette — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
