---
ref: circle-check-big
name: Circle Check Big
title: Circle Check Big Icon
description: Circle Check Big glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["circle-check-big", "circle", "check", "big"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/circle-check-big"
  commercial_use: true
...
Circle Check Big — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
