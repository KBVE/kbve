...
name: Ban
title: Ban Icon
description: Ban glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/ban"
  commercial_use: true
...
Ban — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
