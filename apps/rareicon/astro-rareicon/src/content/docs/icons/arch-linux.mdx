...
ref: arch-linux
name: Arch Linux
title: Arch Linux Icon
description: Arch Linux brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: tech
categories: [tech, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["arch-linux","arch","linux","arch linux","archlinux"]
  primary_category: tech
default_license:
  license: cc0
  ...
  source_url: "https://simpleicons.org/icons/archlinux"
  commercial_use: true
...
Arch Linux — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
