...
name: Car
title: Car Icon
description: Car glyph set from the Lucide icon library (ISC), 3 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["car", "front", "taxi-front"]
  primary_category: ui
default_license:
  license: isc
...
Car — 3 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
