...
description: Butterfly glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://phosphoricons.com/?q=butterfly"
  commercial_use: true
