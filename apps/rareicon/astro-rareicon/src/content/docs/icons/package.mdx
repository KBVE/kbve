...
name: Package
title: Package Icon
description: Package glyph set from the Lucide icon library (ISC), 8 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["package", "2", "check", "minus", "open", "plus", "search", "x"]
  primary_category: ui
default_license:
  license: isc
