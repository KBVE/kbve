...
ref: shadow-grasp
name: Shadow Grasp
title: Shadow Grasp Icon
description: Shadow Grasp glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["shadow-grasp","shadow","grasp","shadow grasp"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/shadow-grasp"
  commercial_use: true
