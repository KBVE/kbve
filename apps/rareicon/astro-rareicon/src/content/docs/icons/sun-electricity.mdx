...
title: Sun Electricity Icon
description: Sun Electricity glyph from the Tabler Icons library (MIT), 1 variant — outline stroke, recolor via currentColor.
primary_category: weather
categories: [weather, library]
tags: [tabler-generated, outline]
search:
  keywords: ["sun-electricity","sun","electricity","sun electricity"]
  primary_category: weather
default_license:
  license: mit
  ...
  source_url: "https://tabler.io/icons/icon/sun-electricity"
  commercial_use: true
...
Sun Electricity — outline glyph from the [Tabler Icons library](https://tabler.io/icons) (MIT).
