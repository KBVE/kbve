...
description: Circle Plus glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/circle-plus"
  commercial_use: true
...
Circle Plus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
