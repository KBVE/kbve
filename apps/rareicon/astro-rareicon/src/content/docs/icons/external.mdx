...
name: External
title: External Icon
description: External glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/external"
  commercial_use: true
...
External — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
