...
name: Credit
title: Credit Icon
description: Credit glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/credit"
  commercial_use: true
...
Credit — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
