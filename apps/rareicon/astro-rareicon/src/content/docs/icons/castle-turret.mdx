...
ref: castle-turret
name: Castle Turret
title: Castle Turret Icon
description: Castle Turret glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["castle-turret","castle","turret","castle turret"]
  primary_category: game
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=castle-turret"
  commercial_use: true
