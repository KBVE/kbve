...
name: Smile
title: Smile Icon
description: Smile glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/smile"
  commercial_use: true
...
icons:
  ...
  - ref: "plus"
    ...
    tags: [lucide]
    svg_body: |
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11v1a10 10 0 1 1-9-10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" x2="9.01" y1="9" y2="9"/><line x1="15" x2="15.01" y1="9" y2="9"/><path d="M16 5h6"/><path d="M19 2v6"/></svg>
pagefindFilters: [lucide, social]
---

import IconTermPanel from '@/components/icons/IconTermPanel.astro';

Smile — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
