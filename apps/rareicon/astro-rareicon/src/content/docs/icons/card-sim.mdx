...
name: Card Sim
title: Card Sim Icon
description: Card Sim glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["card-sim", "card", "sim"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/card-sim"
  commercial_use: true
...
Card Sim — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
