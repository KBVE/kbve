...
name: Plant
title: Plant Icon
description: Plant glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://phosphoricons.com/?q=plant"
  commercial_use: true
