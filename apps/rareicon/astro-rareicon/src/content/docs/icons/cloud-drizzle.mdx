...
description: Cloud Drizzle glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [lucide, outline]
search:
  keywords: ["cloud-drizzle", "cloud", "drizzle"]
  primary_category: tech
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/cloud-drizzle"
  commercial_use: true
...
Cloud Drizzle — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
