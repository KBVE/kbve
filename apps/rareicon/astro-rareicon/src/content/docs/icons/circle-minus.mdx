...
ref: circle-minus
name: Circle Minus
title: Circle Minus Icon
description: Circle Minus glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/circle-minus"
  commercial_use: true
...
Circle Minus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
