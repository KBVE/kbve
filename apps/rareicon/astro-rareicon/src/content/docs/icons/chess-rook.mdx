...
description: Chess Rook glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chess-rook"
  commercial_use: true
...
Chess Rook — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
