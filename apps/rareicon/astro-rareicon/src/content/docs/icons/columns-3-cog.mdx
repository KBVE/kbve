...
ref: columns-3-cog
name: Columns 3 Cog
title: Columns 3 Cog Icon
description: Columns 3 Cog glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["columns-3-cog", "columns", "cog"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/columns-3-cog"
  commercial_use: true
...
Columns 3 Cog — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
