...
name: At Sign
title: At Sign Icon
description: At Sign glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/at-sign"
  commercial_use: true
...
At Sign — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
