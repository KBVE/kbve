...
name: Tauri
title: Tauri Icon
description: Tauri brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/tauri"
  commercial_use: true
