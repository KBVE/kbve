...
ref: badge-plus
name: Badge Plus
title: Badge Plus Icon
description: Badge Plus glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-plus", "badge", "plus"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-plus"
  commercial_use: true
...
Badge Plus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
