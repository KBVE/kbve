...
description: Bow Arrow glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["bow-arrow", "bow", "arrow"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/bow-arrow"
  commercial_use: true
...
Bow Arrow — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
