...
ref: docker-tabler
name: Docker Tabler
title: Docker Tabler Icon
description: Docker Tabler glyph from the Tabler Icons library (MIT), 1 variant — outline stroke, recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [tabler-generated, outline]
search:
  keywords: ["docker-tabler","docker","tabler","brand-docker","docker tabler"]
  primary_category: tech
default_license:
  license: mit
  ...
  source_url: "https://tabler.io/icons/icon/brand-docker"
  commercial_use: true
...
Docker Tabler — outline glyph from the [Tabler Icons library](https://tabler.io/icons) (MIT).
