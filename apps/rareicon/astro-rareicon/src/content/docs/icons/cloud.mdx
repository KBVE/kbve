...
name: Cloud
title: Cloud Icon
description: Cloud glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
Cloud — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
