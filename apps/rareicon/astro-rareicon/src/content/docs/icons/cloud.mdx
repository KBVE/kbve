...
name: Cloud
title: Cloud Icon
description: Cloud glyph set from the Lucide icon library (ISC), 20 variants — outline stroke, recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [lucide, outline]
search:
  keywords: ["cloud", "alert", "backup", "check", "cog", "download", "drizzle", "fog", "hail", "lightning", "moon", "moon-rain", "off", "rain", "rain-wind", "snow", "sun", "sun-rain", "sync", "upload"]
  primary_category: tech
default_license:
  license: isc
