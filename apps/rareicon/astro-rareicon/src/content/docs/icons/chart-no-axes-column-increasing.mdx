---
ref: chart-no-axes-column-increasing
name: Chart No Axes Column Increasing
title: Chart No Axes Column Increasing Icon
description: Chart No Axes Column Increasing glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["chart-no-axes-column-increasing", "chart", "no", "axes", "column", "increasing"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/chart-no-axes-column-increasing"
  commercial_use: true
...
Chart No Axes Column Increasing — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
