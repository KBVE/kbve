...
ref: meat-cleaver
name: Meat Cleaver
title: Meat Cleaver Icon
description: Meat Cleaver glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["meat-cleaver","meat","cleaver","meat cleaver"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/meat-cleaver"
  commercial_use: true
