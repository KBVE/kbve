...
name: Bandcamp
title: Bandcamp Icon
description: Bandcamp brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/bandcamp"
  commercial_use: true
...
icons:
  - ref: "filled"
    ...
    svg_body: |
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z"/></svg>
pagefindFilters: [simple-icons, media, brand]
---

import IconTermPanel from '@/components/icons/IconTermPanel.astro';

Bandcamp — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
