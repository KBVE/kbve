...
name: Clock 2
title: Clock 2 Icon
description: Clock 2 glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["clock-2", "clock"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clock-2"
  commercial_use: true
...
Clock 2 — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
