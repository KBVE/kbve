...
title: Book Headphones Icon
description: Book Headphones glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["book-headphones", "book", "headphones"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/book-headphones"
  commercial_use: true
...
Book Headphones — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
