...
name: Bookmark
title: Bookmark Icon
description: Bookmark glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Bookmark — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
