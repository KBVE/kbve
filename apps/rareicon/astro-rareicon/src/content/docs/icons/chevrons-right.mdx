...
description: Chevrons Right glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["chevrons-right", "chevrons", "right"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/chevrons-right"
  commercial_use: true
...
Chevrons Right — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
