...
name: Soap
title: Soap Icon
description: Soap glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["soap", "dispenser-droplet"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/soap"
  commercial_use: true
  modifications_allowed: true
default_offering:
  offering: free
icons:
  - ref: "dispenser-droplet"
    label: "Dispenser Droplet"
    style: outline
    format: svg
...
Soap — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
