...
title: Book Open Check Icon
description: Book Open Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["book-open-check", "book", "open", "check"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/book-open-check"
  commercial_use: true
...
Book Open Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
