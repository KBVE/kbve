...
ref: clock-fading
name: Clock Fading
title: Clock Fading Icon
description: Clock Fading glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["clock-fading", "clock", "fading"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clock-fading"
  commercial_use: true
...
Clock Fading — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
