...
ref: badge-minus
name: Badge Minus
title: Badge Minus Icon
description: Badge Minus glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-minus", "badge", "minus"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-minus"
  commercial_use: true
...
Badge Minus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
