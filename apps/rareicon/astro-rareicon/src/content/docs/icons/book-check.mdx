...
ref: book-check
name: Book Check
title: Book Check Icon
description: Book Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["book-check", "book", "check"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/book-check"
  commercial_use: true
...
Book Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
