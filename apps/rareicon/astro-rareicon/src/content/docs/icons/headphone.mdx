...
description: Headphone glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
Headphone — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
