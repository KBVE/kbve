...
ref: clipboard-type
name: Clipboard Type
title: Clipboard Type Icon
description: Clipboard Type glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: file
categories: [file, library]
tags: [lucide, outline]
search:
  keywords: ["clipboard-type", "clipboard", "type"]
  primary_category: file
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/clipboard-type"
  commercial_use: true
...
Clipboard Type — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
