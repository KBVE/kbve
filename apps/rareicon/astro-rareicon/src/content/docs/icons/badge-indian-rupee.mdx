---
ref: badge-indian-rupee
name: Badge Indian Rupee
title: Badge Indian Rupee Icon
description: Badge Indian Rupee glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-indian-rupee", "badge", "indian", "rupee"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-indian-rupee"
  commercial_use: true
...
Badge Indian Rupee — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
