...
ref: smiley-sad
name: Smiley Sad
title: Smiley Sad Icon
description: Smiley Sad glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["smiley-sad","smiley","sad","smiley sad"]
  primary_category: social
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=smiley-sad"
  commercial_use: true
...
Smiley Sad — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
