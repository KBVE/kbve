...
name: History
title: History Icon
description: History glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/history"
  commercial_use: true
...
History — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
