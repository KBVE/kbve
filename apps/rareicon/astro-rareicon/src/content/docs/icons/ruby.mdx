...
name: Ruby
title: Ruby Icon
description: Ruby glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=ruby"
  commercial_use: true
