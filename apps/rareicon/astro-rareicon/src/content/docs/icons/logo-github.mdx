...
ref: logo-github
name: Logo Github
title: Logo Github Icon
description: Logo Github glyph from the octicons icon library, 1 variant — recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [octicons-generated, octicons]
search:
  keywords: ["logo-github","logo","github","logo-github-24","logo github"]
  primary_category: tech
default_license:
  license: mit
  ...
  author: GitHub Inc.
  source_url: "https://primer.style/foundations/icons/logo-github-24"
  commercial_use: true
...
icons:
  - ref: "octicons"
    ...
    style: outline
    format: svg
    viewbox: { min_x: 0, min_y: 0, width: 74, height: 24 }
    render:
