...
name: Gauge
title: Gauge Icon
description: Gauge glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/gauge"
  commercial_use: true
...
Gauge — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
