---
ref: arrow-right-left
name: Arrow Right Left
title: Arrow Right Left Icon
description: Arrow Right Left glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: navigation
categories: [navigation, library]
tags: [lucide, outline]
search:
  keywords: ["arrow-right-left", "arrow", "right", "left"]
  primary_category: navigation
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/arrow-right-left"
  commercial_use: true
...
Arrow Right Left — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
