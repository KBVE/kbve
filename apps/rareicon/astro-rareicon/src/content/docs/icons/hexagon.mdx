...
name: Hexagon
title: Hexagon Icon
description: Hexagon glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/hexagon"
  commercial_use: true
...
Hexagon — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
