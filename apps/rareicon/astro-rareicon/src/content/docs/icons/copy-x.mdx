...
name: Copy X
title: Copy X Icon
description: Copy X glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: action
categories: [action, library]
tags: [lucide, outline]
search:
  keywords: ["copy-x", "copy"]
  primary_category: action
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/copy-x"
  commercial_use: true
...
Copy X — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
