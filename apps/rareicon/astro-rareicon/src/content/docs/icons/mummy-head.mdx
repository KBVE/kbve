...
ref: mummy-head
name: Mummy Head
title: Mummy Head Icon
description: Mummy Head glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["mummy-head","mummy","head","mummy head"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/mummy-head"
  commercial_use: true
