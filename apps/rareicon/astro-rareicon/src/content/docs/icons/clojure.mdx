...
name: Clojure
title: Clojure Icon
description: Clojure glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=clojure"
  commercial_use: true
