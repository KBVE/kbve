...
name: Swatch
title: Swatch Icon
description: Swatch glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/swatch"
  commercial_use: true
...
Swatch — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
