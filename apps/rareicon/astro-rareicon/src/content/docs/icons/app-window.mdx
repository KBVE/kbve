...
ref: app-window
name: App Window
title: App Window Icon
description: App Window glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["app-window", "app", "window"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/app-window"
  commercial_use: true
...
App Window — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
