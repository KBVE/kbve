---
ref: banknote-arrow-down
name: Banknote Arrow Down
title: Banknote Arrow Down Icon
description: Banknote Arrow Down glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: commerce
categories: [commerce, library]
tags: [lucide, outline]
search:
  keywords: ["banknote-arrow-down", "banknote", "arrow", "down"]
  primary_category: commerce
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/banknote-arrow-down"
  commercial_use: true
...
Banknote Arrow Down — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
