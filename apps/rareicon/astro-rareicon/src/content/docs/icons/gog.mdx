...
name: GOG
title: GOG Icon
description: GOG brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: gaming
categories: [gaming, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["gog","gogdotcom"]
  primary_category: gaming
default_license:
  license: cc0
  ...
  source_url: "https://simpleicons.org/icons/gogdotcom"
  commercial_use: true
...
GOG — filled brand glyph from the [Simple Icons library](https://simpleicons.org/) (CC0).
