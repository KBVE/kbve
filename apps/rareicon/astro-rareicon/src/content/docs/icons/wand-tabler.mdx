...
ref: wand-tabler
name: Wand Tabler
title: Wand Tabler Icon
description: Wand Tabler glyph from the Tabler Icons library (MIT), 1 variant — outline stroke, recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [tabler-generated, outline]
search:
  keywords: ["wand-tabler","wand","tabler","wand tabler"]
  primary_category: game
default_license:
  license: mit
...
Wand Tabler — outline glyph from the [Tabler Icons library](https://tabler.io/icons) (MIT).
