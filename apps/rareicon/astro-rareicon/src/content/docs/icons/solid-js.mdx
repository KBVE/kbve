...
name: SolidJS
title: SolidJS Icon
description: SolidJS brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: tech
categories: [tech, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["solid-js","solid","js","solidjs"]
  primary_category: tech
default_license:
  license: cc0
  ...
  source_url: "https://simpleicons.org/icons/solid"
  commercial_use: true
