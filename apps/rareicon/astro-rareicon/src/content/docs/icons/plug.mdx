...
name: Plug
title: Plug Icon
description: Plug glyph set from the Lucide icon library (ISC), 3 variants — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/plug"
  commercial_use: true
...
icons:
  ...
  - ref: "2"
    ...
    tags: [lucide]
    svg_body: |
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2v6"/><path d="M15 2v6"/><path d="M12 17v5"/><path d="M5 8h14"/><path d="M6 11V8h12v3a6 6 0 1 1-12 0Z"/></svg>
  - ref: "zap"
    label: "Zap"
    style: outline
    format: svg
...
Plug — 3 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
