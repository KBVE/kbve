...
name: Theater
title: Theater Icon
description: Theater glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/theater"
  commercial_use: true
...
Theater — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
