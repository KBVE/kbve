...
description: Cassette Tape glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["cassette-tape", "cassette", "tape"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/cassette-tape"
  commercial_use: true
...
Cassette Tape — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
