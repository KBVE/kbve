...
ref: dice-multiple
name: Dice Multiple
title: Dice Multiple Icon
description: Dice Multiple glyph from the mdi icon library, 1 variant — recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [mdi-generated, mdi]
search:
  keywords: ["dice-multiple","dice","multiple","dice multiple"]
  primary_category: game
default_license:
  license: apache_2
  ...
  source_url: "https://pictogrammers.com/library/mdi/icon/dice-multiple"
  commercial_use: true
