...
name: Banknote
title: Banknote Icon
description: Banknote glyph set from the Lucide icon library (ISC), 4 variants — outline stroke, recolor via currentColor.
primary_category: commerce
categories: [commerce, library]
tags: [lucide, outline]
search:
  keywords: ["banknote", "arrow-down", "arrow-up", "x"]
  primary_category: commerce
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/banknote"
  commercial_use: true
...
Banknote — 4 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
