...
name: Banknote
title: Banknote Icon
description: Banknote glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
Banknote — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
