...
name: Orbit
title: Orbit Icon
description: Orbit glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/orbit"
  commercial_use: true
...
Orbit — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
