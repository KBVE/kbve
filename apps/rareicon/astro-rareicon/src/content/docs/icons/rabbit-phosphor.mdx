---
ref: rabbit-phosphor
name: Rabbit Phosphor
title: Rabbit Phosphor Icon
description: Rabbit Phosphor glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["rabbit-phosphor","rabbit","phosphor","rabbit phosphor"]
  primary_category: social
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=rabbit"
  commercial_use: true
...
Rabbit Phosphor — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
