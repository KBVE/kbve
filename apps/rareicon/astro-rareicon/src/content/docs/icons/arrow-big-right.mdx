...
title: Arrow Big Right Icon
description: Arrow Big Right glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/arrow-big-right"
  commercial_use: true
...
Arrow Big Right — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
