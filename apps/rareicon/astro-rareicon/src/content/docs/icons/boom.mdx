...
name: Boom
title: Boom Icon
description: Boom glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/boom"
  commercial_use: true
...
Boom — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
