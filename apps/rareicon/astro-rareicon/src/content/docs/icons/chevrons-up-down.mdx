...
description: Chevrons Up Down glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["chevrons-up-down", "chevrons", "up", "down"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/chevrons-up-down"
  commercial_use: true
...
Chevrons Up Down — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
