...
name: Snail
title: Snail Icon
description: Snail glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/snail"
  commercial_use: true
...
Snail — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
