---
ref: circle-user-round
name: Circle User Round
title: Circle User Round Icon
description: Circle User Round glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["circle-user-round", "circle", "user", "round"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/circle-user-round"
  commercial_use: true
...
Circle User Round — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
