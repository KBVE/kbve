...
ref: camera-off
name: Camera Off
title: Camera Off Icon
description: Camera Off glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: media
categories: [media, library]
tags: [lucide, outline]
search:
  keywords: ["camera-off", "camera", "off"]
  primary_category: media
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/camera-off"
  commercial_use: true
...
Camera Off — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
