...
ref: arrow-big-left
name: Arrow Big Left
title: Arrow Big Left Icon
description: Arrow Big Left glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/arrow-big-left"
  commercial_use: true
...
Arrow Big Left — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
