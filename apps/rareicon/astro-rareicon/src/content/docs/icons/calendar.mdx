...
name: Calendar
title: Calendar Icon
description: Calendar glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Calendar — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
