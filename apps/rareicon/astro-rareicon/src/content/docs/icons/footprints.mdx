...
ref: footprints
name: Footprints
title: Footprints Icon
description: Footprints glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/footprints"
  commercial_use: true
...
Footprints — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
