...
ref: book-heart
name: Book Heart
title: Book Heart Icon
description: Book Heart glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["book-heart", "book", "heart"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/book-heart"
  commercial_use: true
...
Book Heart — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
