...
name: Bed
title: Bed Icon
description: Bed glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Bed — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
