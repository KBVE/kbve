...
name: Castle
title: Castle Icon
description: Castle glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/castle"
  commercial_use: true
...
Castle — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
