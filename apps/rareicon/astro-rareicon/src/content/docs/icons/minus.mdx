...
name: Minus
title: Minus Icon
description: Minus glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/minus"
  commercial_use: true
...
Minus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
