...
ref: coins-phosphor
name: Coins Phosphor
title: Coins Phosphor Icon
description: Coins Phosphor glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: commerce
categories: [commerce, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["coins-phosphor","coins","phosphor","coins phosphor"]
  primary_category: commerce
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=coins"
  commercial_use: true
...
Coins Phosphor — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
