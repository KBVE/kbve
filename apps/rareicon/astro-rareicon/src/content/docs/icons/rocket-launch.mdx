...
description: Rocket Launch glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: tech
categories: [tech, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["rocket-launch","rocket","launch","rocket launch"]
  primary_category: tech
default_license:
  license: mit
