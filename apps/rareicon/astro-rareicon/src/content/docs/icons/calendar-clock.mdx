...
ref: calendar-clock
name: Calendar Clock
title: Calendar Clock Icon
description: Calendar Clock glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["calendar-clock", "calendar", "clock"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/calendar-clock"
  commercial_use: true
...
Calendar Clock — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
