...
name: Dollar
title: Dollar Icon
description: Dollar glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/dollar"
  commercial_use: true
...
Dollar — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
