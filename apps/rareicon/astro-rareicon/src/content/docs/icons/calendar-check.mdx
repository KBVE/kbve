...
ref: calendar-check
name: Calendar Check
title: Calendar Check Icon
description: Calendar Check glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/calendar-check"
  commercial_use: true
...
Calendar Check — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
