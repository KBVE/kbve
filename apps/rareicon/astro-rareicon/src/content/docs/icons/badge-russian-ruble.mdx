---
ref: badge-russian-ruble
name: Badge Russian Ruble
title: Badge Russian Ruble Icon
description: Badge Russian Ruble glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-russian-ruble", "badge", "russian", "ruble"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-russian-ruble"
  commercial_use: true
...
Badge Russian Ruble — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
