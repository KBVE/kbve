...
name: Folder
title: Folder Icon
description: Folder glyph set from the Lucide icon library (ISC), 31 variants — outline stroke, recolor via currentColor.
primary_category: file
categories: [file, library]
tags: [lucide, outline]
search:
  keywords: ["folder", "archive", "check", "clock", "closed", "code", "cog", "dot", "down", "folders", "git", "git-2", "heart", "input", "kanban", "key", "lock", "minus", "open", "open-dot", "output", "pen", "plus", "root", "search", "search-2", "symlink", "sync", "tree", "up", "x"]
  primary_category: file
default_license:
  license: isc
...
Folder — 31 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
