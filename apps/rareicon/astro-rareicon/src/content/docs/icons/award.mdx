...
name: Award
title: Award Icon
description: Award glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/award"
  commercial_use: true
...
Award — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
