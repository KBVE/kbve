...
ref: cat-phosphor
name: Cat Phosphor
title: Cat Phosphor Icon
description: Cat Phosphor glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["cat-phosphor","cat","phosphor","cat phosphor"]
  primary_category: social
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=cat"
  commercial_use: true
...
Cat Phosphor — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
