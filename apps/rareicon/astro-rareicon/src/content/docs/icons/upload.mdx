...
name: Upload
title: Upload Icon
description: Upload glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/upload"
  commercial_use: true
...
Upload — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
