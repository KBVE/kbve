...
name: Chef Hat
title: Chef Hat Icon
description: Chef Hat glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["chef-hat", "chef", "hat"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/chef-hat"
  commercial_use: true
...
Chef Hat — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
