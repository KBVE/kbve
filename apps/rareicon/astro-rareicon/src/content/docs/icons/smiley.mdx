...
name: Smiley
title: Smiley Icon
description: Smiley glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://phosphoricons.com/?q=smiley"
  commercial_use: true
...
Smiley — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
