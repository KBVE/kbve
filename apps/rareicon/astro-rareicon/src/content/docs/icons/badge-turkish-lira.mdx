---
ref: badge-turkish-lira
name: Badge Turkish Lira
title: Badge Turkish Lira Icon
description: Badge Turkish Lira glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-turkish-lira", "badge", "turkish", "lira"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-turkish-lira"
  commercial_use: true
...
Badge Turkish Lira — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
