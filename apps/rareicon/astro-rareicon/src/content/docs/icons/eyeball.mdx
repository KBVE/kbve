...
name: Eyeball
title: Eyeball Icon
description: Eyeball glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://game-icons.net/1x1/eyeball"
  commercial_use: true
