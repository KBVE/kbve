---
ref: corner-down-right
name: Corner Down Right
title: Corner Down Right Icon
description: Corner Down Right glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/corner-down-right"
  commercial_use: true
...
Corner Down Right — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
