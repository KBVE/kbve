...
ref: book-text
name: Book Text
title: Book Text Icon
description: Book Text glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/book-text"
  commercial_use: true
...
Book Text — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
