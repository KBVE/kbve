...
ref: arrow-big-up
name: Arrow Big Up
title: Arrow Big Up Icon
description: Arrow Big Up glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/arrow-big-up"
  commercial_use: true
...
Arrow Big Up — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
