---
ref: class-visored-helm
name: Class Visored Helm
title: Class Visored Helm Icon
description: Class Visored Helm glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["class-visored-helm","class","visored","helm","visored-helm","class visored helm"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/visored-helm"
  commercial_use: true
