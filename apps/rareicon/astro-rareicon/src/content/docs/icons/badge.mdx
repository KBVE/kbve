...
name: Badge
title: Badge Icon
description: Badge glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Badge — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
