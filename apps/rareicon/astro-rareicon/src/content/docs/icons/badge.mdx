...
name: Badge
title: Badge Icon
description: Badge glyph set from the Lucide icon library (ISC), 18 variants — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge", "alert", "cent", "check", "dollar-sign", "euro", "indian-rupee", "info", "japanese-yen", "minus", "percent", "plus", "pound-sterling", "question-mark", "russian-ruble", "swiss-franc", "turkish-lira", "x"]
  primary_category: ui
default_license:
  license: isc
