...
ref: badge-cent
name: Badge Cent
title: Badge Cent Icon
description: Badge Cent glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-cent", "badge", "cent"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-cent"
  commercial_use: true
...
Badge Cent — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
