...
description: Chevron Up glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chevron-up"
  commercial_use: true
...
Chevron Up — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
