...
ref: bus-front
name: Bus Front
title: Bus Front Icon
description: Bus Front glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["bus-front", "bus", "front"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/bus-front"
  commercial_use: true
...
Bus Front — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
