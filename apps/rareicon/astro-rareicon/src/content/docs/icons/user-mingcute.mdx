...
ref: user-mingcute
name: User Mingcute
title: User Mingcute Icon
description: User Mingcute glyph from the mingcute icon library, 1 variant — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [mingcute-generated, mingcute]
search:
  keywords: ["user-mingcute","user","mingcute","user-3-line","user mingcute"]
  primary_category: social
default_license:
  license: apache_2
  ...
  source_url: "https://www.mingcute.com/?keyword=user-3-line"
  commercial_use: true
...
User Mingcute — glyph from the [Mingcute icon library](https://www.mingcute.com/).
