...
ref: cplusplus
name: Cplusplus
title: Cplusplus Icon
description: Cplusplus glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=cplusplus"
  commercial_use: true
