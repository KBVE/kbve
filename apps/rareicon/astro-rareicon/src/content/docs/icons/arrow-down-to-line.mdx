---
ref: arrow-down-to-line
name: Arrow Down To Line
title: Arrow Down To Line Icon
description: Arrow Down To Line glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: navigation
categories: [navigation, library]
tags: [lucide, outline]
search:
  keywords: ["arrow-down-to-line", "arrow", "down", "to", "line"]
  primary_category: navigation
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/arrow-down-to-line"
  commercial_use: true
...
Arrow Down To Line — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
