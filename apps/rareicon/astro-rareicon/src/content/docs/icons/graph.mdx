...
name: Graph
title: Graph Icon
description: Graph glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://phosphoricons.com/?q=graph"
  commercial_use: true
...
Graph — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
