...
name: Copy
title: Copy Icon
description: Copy glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
Copy — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
