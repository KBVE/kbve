...
description: Chevron Down glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chevron-down"
  commercial_use: true
...
Chevron Down — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
