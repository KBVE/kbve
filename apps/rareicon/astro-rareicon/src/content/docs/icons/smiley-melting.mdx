...
ref: smiley-melting
name: Smiley Melting
title: Smiley Melting Icon
description: Smiley Melting glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["smiley-melting","smiley","melting","smiley melting"]
  primary_category: social
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=smiley-melting"
  commercial_use: true
