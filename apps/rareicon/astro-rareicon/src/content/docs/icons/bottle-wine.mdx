...
ref: bottle-wine
name: Bottle Wine
title: Bottle Wine Icon
description: Bottle Wine glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/bottle-wine"
  commercial_use: true
...
Bottle Wine — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
