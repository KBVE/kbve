...
name: Tickets
title: Tickets Icon
description: Tickets glyph set from the Lucide icon library (ISC), 2 variants — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/tickets"
  commercial_use: true
...
Tickets — 2 variants from the [Lucide icon library](https://lucide.dev/) (ISC).
