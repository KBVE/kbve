...
ref: visored-helm
name: Visored Helm
title: Visored Helm Icon
description: Visored Helm glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["visored-helm","visored","helm","visored helm"]
  primary_category: game
default_license:
  license: cc_by
...
Visored Helm — gamedev glyph from the [Game Icons library](https://game-icons.net/) (CC BY 3.0). Attribution required: see the source page for the per-artist credit.
