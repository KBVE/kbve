...
description: Cloud Sun Rain glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/cloud-sun-rain"
  commercial_use: true
...
Cloud Sun Rain — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
