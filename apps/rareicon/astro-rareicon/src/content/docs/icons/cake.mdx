...
name: Cake
title: Cake Icon
description: Cake glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Cake — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
