...
name: Cable
title: Cable Icon
description: Cable glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Cable — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
