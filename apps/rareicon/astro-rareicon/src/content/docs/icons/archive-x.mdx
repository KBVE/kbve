...
ref: archive-x
name: Archive X
title: Archive X Icon
description: Archive X glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: file
categories: [file, library]
tags: [lucide, outline]
search:
  keywords: ["archive-x", "archive"]
  primary_category: file
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/archive-x"
  commercial_use: true
...
Archive X — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
