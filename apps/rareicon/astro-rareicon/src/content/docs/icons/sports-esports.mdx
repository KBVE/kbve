...
ref: sports-esports
name: Sports Esports
title: Sports Esports Icon
description: Sports Esports glyph from the material-symbols icon library, 1 variant — recolor via currentColor.
primary_category: game
categories: [game, library]
tags: [material-symbols-generated, material-symbols]
search:
  keywords: ["sports-esports","sports","esports","sports esports"]
  primary_category: game
default_license:
  license: apache_2
  ...
  author: Google LLC
  source_url: "https://fonts.google.com/icons?icon.query=sports-esports"
  commercial_use: true
