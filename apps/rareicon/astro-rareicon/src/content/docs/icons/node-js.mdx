...
name: Node.js
title: Node.js Icon
description: Node.js brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: tech
categories: [tech, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["node-js","node","js","node.js","nodedotjs"]
  primary_category: tech
default_license:
  license: cc0
