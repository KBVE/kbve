...
name: Switch
title: Switch Icon
description: Switch glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/switch"
  commercial_use: true
...
Switch — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
