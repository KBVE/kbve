...
description: Chevron Right glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chevron-right"
  commercial_use: true
...
Chevron Right — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
