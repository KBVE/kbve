...
description: Arrow Up Right glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/arrow-up-right"
  commercial_use: true
...
Arrow Up Right — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
