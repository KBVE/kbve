...
ref: circle-alert
name: Circle Alert
title: Circle Alert Icon
description: Circle Alert glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["circle-alert", "circle", "alert"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/circle-alert"
  commercial_use: true
...
Circle Alert — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
