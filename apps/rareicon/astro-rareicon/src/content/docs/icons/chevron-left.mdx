...
description: Chevron Left glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/chevron-left"
  commercial_use: true
...
Chevron Left — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
