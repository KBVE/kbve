...
ref: diamond-plus
name: Diamond Plus
title: Diamond Plus Icon
description: Diamond Plus glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["diamond-plus", "diamond", "plus"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/diamond-plus"
  commercial_use: true
...
Diamond Plus — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
