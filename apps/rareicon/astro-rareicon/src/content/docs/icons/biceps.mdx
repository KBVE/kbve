...
name: Biceps
title: Biceps Icon
description: Biceps glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/biceps"
  commercial_use: true
...
Biceps — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
