...
name: Scala
title: Scala Icon
description: Scala glyph from the devicon icon library, 1 variant — recolor via currentColor.
...
default_license:
  ...
  source_url: "https://devicon.dev/?icon=scala"
  commercial_use: true
