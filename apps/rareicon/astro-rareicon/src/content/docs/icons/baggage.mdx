...
name: Baggage
title: Baggage Icon
description: Baggage glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/baggage"
  commercial_use: true
...
Baggage — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
