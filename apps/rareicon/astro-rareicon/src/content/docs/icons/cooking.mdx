...
name: Cooking
title: Cooking Icon
description: Cooking glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/cooking"
  commercial_use: true
...
Cooking — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
