...
name: Brush
title: Brush Icon
description: Brush glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
...
Brush — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
