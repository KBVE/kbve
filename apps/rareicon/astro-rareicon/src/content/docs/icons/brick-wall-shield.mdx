---
ref: brick-wall-shield
name: Brick Wall Shield
title: Brick Wall Shield Icon
description: Brick Wall Shield glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["brick-wall-shield", "brick", "wall", "shield"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/brick-wall-shield"
  commercial_use: true
...
Brick Wall Shield — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
