...
description: Unreal Engine brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
primary_category: gaming
categories: [gaming, library, brand]
tags: [simple-icons-generated, brand]
search:
  keywords: ["unreal-engine","unreal","engine","unreal engine","unrealengine"]
  primary_category: gaming
default_license:
  license: cc0
