...
ref: poison-bottle
name: Poison Bottle
title: Poison Bottle Icon
description: Poison Bottle glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["poison-bottle","poison","bottle","poison bottle"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/poison-bottle"
  commercial_use: true
