...
name: Badge X
title: Badge X Icon
description: Badge X glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["badge-x", "badge"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/badge-x"
  commercial_use: true
...
Badge X — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
