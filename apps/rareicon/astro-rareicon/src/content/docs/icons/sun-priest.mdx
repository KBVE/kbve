...
ref: sun-priest
name: Sun Priest
title: Sun Priest Icon
description: Sun Priest glyph from the Game Icons library (CC BY 3.0), 1 variant — filled, recolor via currentColor.
primary_category: game
categories: [game, library, gamedev]
tags: [game-icons-generated, gamedev, filled]
search:
  keywords: ["sun-priest","sun","priest","sun priest"]
  primary_category: game
default_license:
  license: cc_by
  ...
  source_url: "https://game-icons.net/1x1/sun-priest"
  commercial_use: true
