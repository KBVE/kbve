...
name: Beer Off
title: Beer Off Icon
description: Beer Off glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["beer-off", "beer", "off"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/beer-off"
  commercial_use: true
...
Beer Off — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
