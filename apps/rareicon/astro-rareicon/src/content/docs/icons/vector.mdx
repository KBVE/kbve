...
name: Vector
title: Vector Icon
description: Vector glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
categories: [ui, library]
tags: [lucide, outline]
search:
  keywords: ["vector", "square"]
  primary_category: ui
default_license:
  license: isc
  ...
  source_url: "https://lucide.dev/icons/vector"
  commercial_use: true
...
Vector — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
