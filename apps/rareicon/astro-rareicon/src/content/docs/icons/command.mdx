...
name: Command
title: Command Icon
description: Command glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/command"
  commercial_use: true
...
Command — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
