...
ref: smiley-x-eyes
name: Smiley X Eyes
title: Smiley X Eyes Icon
description: Smiley X Eyes glyph from the Phosphor Icons library (MIT), 1 weight — recolor via currentColor.
primary_category: social
categories: [social, library]
tags: [phosphor-generated, multi-weight]
search:
  keywords: ["smiley-x-eyes","smiley","eyes","smiley x eyes"]
  primary_category: social
default_license:
  license: mit
  ...
  source_url: "https://phosphoricons.com/?q=smiley-x-eyes"
  commercial_use: true
...
Smiley X Eyes — 1 weight from the [Phosphor Icons library](https://phosphoricons.com/) (MIT).
