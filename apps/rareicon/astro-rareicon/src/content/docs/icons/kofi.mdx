...
name: Ko-fi
title: Ko-fi Icon
description: Ko-fi brand glyph from the Simple Icons library (CC0), 1 variant — filled brand glyph, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://simpleicons.org/icons/kofi"
  commercial_use: true
