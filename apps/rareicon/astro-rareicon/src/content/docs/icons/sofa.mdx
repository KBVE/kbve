...
name: Sofa
title: Sofa Icon
description: Sofa glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/sofa"
  commercial_use: true
...
Sofa — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
