...
name: Linkedin
title: Linkedin Icon
description: Linkedin glyph set from the Lucide icon library (ISC), 1 variant — outline stroke, recolor via currentColor.
primary_category: ui
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/linkedin"
  commercial_use: true
...
Linkedin — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
