...
description: Clipboard List glyph from the Lucide icon library (ISC), outline style, recolor via currentColor.
...
default_license:
  ...
  source_url: "https://lucide.dev/icons/clipboard-list"
  commercial_use: true
...
Clipboard List — outline glyph from the [Lucide icon library](https://lucide.dev/) (ISC).
