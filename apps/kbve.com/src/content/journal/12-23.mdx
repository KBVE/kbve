...
- 2:45pm - Watching `The Rising of the Shield Hero` and going through more of the MDX migrations. Just finished adding the Legal documents, did a quick review of them but there might have to be some formating that still needs to be done.
