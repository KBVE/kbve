...
The major issue that is holding us back is that for some reason the nx release process is not including a copy of the `package.json` within in the distrib
