...
prompts:
  ...
  - ulid: 01J0YEVWK8ZA1Z0Q8B0GDG6871
    ...
    task: |
      ...
      Objectives: Prompt the user to input a song title with the band/artist within the title, select a genre from the specified set, and provide a YouTube link. Extract the YouTube ID from the link and generate a JSON output containing the title with artist/band, genre, and YouTube ID.
