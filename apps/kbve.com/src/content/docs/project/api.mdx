...
-   Official documentation will be provided for the API, which is written in [Rust](https://kbve.com/application/rust/), [Python](https://kbve.com/application/python/) and the database is in [SQL](https://kbve.com/application/sql/).
