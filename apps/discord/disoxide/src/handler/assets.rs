...
pub fn static_router() -> Router<SharedState> {
    ...
    Router::new()
        ...
        .nest_service("/data", ServeDir::new("dist/data").not_found_service(get(custom_404)))
        .nest_service("/websockets", ServeDir::new("dist/websockets").not_found_service(get(custom_404)))
        .nest_service("/login", ServeDir::new("dist/login").not_found_service(get(custom_404)))
        .nest_service("/callback", ServeDir::new("dist/callback").not_found_service(get(custom_404)))
        .nest_service("/register", ServeDir::new("dist/register").not_found_service(get(custom_404)))
        .nest_service("/logout", ServeDir::new("dist/logout").not_found_service(get(custom_404)))
        .nest_service("/cat", ServeDir::new("dist/cat").not_found_service(get(custom_404)))
        .nest_service("/docs", ServeDir::new("dist/docs").not_found_service(get(custom_404)))
        .nest_service("/features", ServeDir::new("dist/features").not_found_service(get(custom_404)))
        ...
        .nest_service("/richie", ServeDir::new("dist/richie").not_found_service(get(custom_404)))    
