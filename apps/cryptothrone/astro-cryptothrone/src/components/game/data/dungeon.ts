...
// packed per-biome atlas. Generated by gen-palette-atlas.mjs from the manifests
// in packages/data/codegen/palettes/; loaded here, never hand-authored.
// Presentation only — collision lives in the role grid.
// =============================================================================
