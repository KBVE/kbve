...
# Stalwart presents when calling the mail service MTA hook endpoint.
#
# Pipeline that:
...
#
# The mail deployment reads it as STALWART_HOOK_SECRET (optional
...
#   2. Commit + push — ArgoCD syncs it, reloader restarts mail
