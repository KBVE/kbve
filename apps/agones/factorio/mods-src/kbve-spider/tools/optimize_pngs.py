#!/usr/bin/env python3
"""
Lossless PNG recompression for the kbve-spider sprite sheets.
...
def optimize_one(png: Path, dry_run: bool) -> Result:
    ...
    # zopflipng's default 15 iterations × full filter sweep takes 10+ min on
    # 7680x4096 sheets. Scale iterations down for huge files; the marginal
    # gain past 5 iterations is <2% of size.
