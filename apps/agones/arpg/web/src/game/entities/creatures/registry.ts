...
// Refs may share a def (trainer renders as the dungeon goblin) so the packed
// sheet, anims, and sprite pool are shared instead of duplicated per ref.
...
/** Every distinct creature def, for the in-game bestiary/codex. */
export const CREATURES: CreatureDef[] = [
	...new Set(Object.values(CREATURE_REGISTRY)),
];
