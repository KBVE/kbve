	...
	function A(m, D, C, U, V) {
			...
			switch (Q) {
				...
				case 'object':
					switch (m.$$typeof) {
						...
						case H:
							return (
								(te = m._init), A(te(m._payload), D, C, U, V)
							);
					}
			}
		if (te)
		...
		if (pt(m))
			for (var ge = 0; ge < m.length; ge++)
				(U = m[ge]), (Q = ze + Et(U, ge)), (te += A(U, D, C, Q, V));
		else if (((ge = Ce(m)), typeof ge == 'function'))
			for (m = ge.call(m), ge = 0; !(U = m.next()).done; )
				(U = U.value), (Q = ze + Et(U, ge++)), (te += A(U, D, C, Q, V));
		else if (Q === 'object') {
				...
				H === 'style'
					? _.d.S(
							...
							typeof p.precedence == 'string'
								? p.precedence
								: void 0,
							{ crossOrigin: z, integrity: I, fetchPriority: Ce },
						)
					: H === 'script' &&
						_.d.X(x, {
							crossOrigin: z,
...
` +
	...
	var Fb = Mt && 'TextEvent' in window && !Ha,
	...
	function s_(e) {
		...
		function b(O, g, y, T) {
			return g === null || g.tag !== 6
				? ((g = gl(y, O.mode, T)), (g.return = O), g)
				: ((g = r(g, y)), (g.return = O), g);
		}
		function d(O, g, y, T) {
			var L = y.type;
			return L === He
				? E(O, g, y.props.children, T, y.key)
				: g !== null &&
					  (g.elementType === L ||
							(typeof L == 'object' &&
								L !== null &&
								L.$$typeof === Be &&
								Rn(L) === g.type))
					? ((g = r(g, y.props)), Xa(g, y), (g.return = O), g)
					: ((g = Uc(y.type, y.key, y.props, null, O.mode, T)),
						Xa(g, y),
						(g.return = O),
						g);
		}
		function w(O, g, y, T) {
			return g === null ||
				...
				? ((g = ml(y, O.mode, T)), (g.return = O), g)
				: ((g = r(g, y.children || [])), (g.return = O), g);
		}
		function E(O, g, y, T, L) {
			return g === null || g.tag !== 7
				? ((g = En(y, O.mode, T, L)), (g.return = O), g)
				: ((g = r(g, y)), (g.return = O), g);
		}
		function M(O, g, y) {
			if (
				...
				return (g = gl('' + g, O.mode, y)), (g.return = O), g;
			if (typeof g == 'object' && g !== null) {
				switch (g.$$typeof) {
					case Ce:
						return (
							(y = Uc(g.type, g.key, g.props, null, O.mode, y)),
							Xa(y, g),
							(y.return = O),
							y
						);
				...
				if (dt(g) || Le(g))
					return (g = En(g, O.mode, y, null)), (g.return = O), g;
		...
		function h(O, g, y, T) {
			...
			if (typeof y == 'object' && y !== null) {
				...
				if (dt(y) || Le(y))
					return L !== null ? null : E(O, g, y, T, null);
		...
		function v(O, g, y, T, L) {
			if (
				...
				return (O = O.get(y) || null), b(g, O, '' + T, L);
			if (typeof T == 'object' && T !== null) {
				...
				if (dt(T) || Le(T))
					return (O = O.get(y) || null), E(g, O, T, L, null);
	...
	function m_(e, t) {
		var c = e.callbacks;
		if (c !== null)
			for (e.callbacks = null, e = 0; e < c.length; e++) g_(c[e], t);
	}
	var ra = m(null),
		Zc = m(0);
	function O_(e, t) {
					...
					(E =
						...
						? (w ||
								...
								(typeof i.componentWillUpdate == 'function' &&
									i.componentWillUpdate(u, v, d),
								typeof i.UNSAFE_componentWillUpdate ==
									'function' &&
									i.UNSAFE_componentWillUpdate(u, v, d)),
	...
	function Sf(e, t, c) {
		...
		switch (((t.lanes = 0), t.tag)) {
			...
			case 1:
				return (
					(u = t.type), (r = Nn(u, t.pendingProps)), jf(e, t, u, r, c)
				);
			case 3:
				e: {
			...
			case 4:
				return (
					ze(t, t.stateNode.containerInfo),
					(u = t.pendingProps),
					e === null ? (t.child = Hn(t, null, u, c)) : Te(e, t, u, c),
					t.child
				);
			case 11:
			...
			case 13:
				Gt(e, c),
					...
					u & 64 &&
						...
						e !== null &&
							((e = e.dehydrated),
							e !== null && ((c = Ns.bind(null, c)), td(e, c))));
				break;
			case 22:
	...
	function Lf(e, t) {
		...
		switch (e.tag) {
			...
			case 22:
				...
				var d = c !== null && c.memoizedState !== null,
					w = Lt,
					E = we;
				if (
					((Lt = w || r),
		...
		switch (e.tag) {
			case 26:
				ba(e, t, c),
					e.flags & nc &&
						e.memoizedState !== null &&
						sd(c, mt, e.memoizedState, e.memoizedProps);
				break;
			case 5:
				ba(e, t, c);
				break;
	...
	gt(Wi, 'onAnimationEnd'),
		...
		gt('focusin', 'onFocus'),
		gt('focusout', 'onBlur'),
		gt(cs, 'onTransitionRun'),
		gt(us, 'onTransitionStart'),
		gt(ls, 'onTransitionCancel'),
				...
				e: {
					...
					if (
						...
						if (
							...
							(re = v == null ? h : Ta(v)),
							(y = N == null ? h : Ta(N)),
							(h = new q(T, g + 'leave', v, c, E)),
							(h.target = re),
							(h.relatedTarget = y),
							(T = null),
							Gn(E) === w &&
								((q = new q(O, g + 'enter', N, c, E)),
								(q.target = y),
								(q.relatedTarget = re),
								(T = q)),
							(re = T),
	...
	function yo(e, t, c, u, r) {
		for (var i = t._reactName, f = []; c !== null && c !== u; ) {
			...
			(b !== 5 && b !== 26 && b !== 27) ||
				...
				((d = w),
				r
					? ((w = Ma(c, i)), w != null && f.unshift(ic(c, w, d)))
					: r || ((w = Ma(c, i)), w != null && f.push(ic(c, w, d)))),
				(c = c.return);
		}
...
`,
	...
	function Me(e, t, c) {
		switch (t) {
			...
			case 'option':
				for (d in c)
					if (c.hasOwnProperty(d) && ((u = c[d]), u != null))
						switch (d) {
							case 'selected':
								e.selected =
									u &&
	...
	function Fs(e, t, c, u) {
		switch (t) {
			...
			case 'select':
				v = f = b = h = null;
				for (i in c)
					if (((d = c[i]), c.hasOwnProperty(i) && d != null))
						switch (i) {
							case 'value':
								break;
							case 'multiple':
		...
		if (Au) {
			...
			if (r === null) Hr(e, t, u, Tu, c), Jo(e, u);
				...
				for (; r !== null; ) {
					...
					if (
						((i = Kr(u)), i === null && Hr(e, t, u, Tu, c), i === r)
					)
						break;
					r = i;
				}
	...
	function yd(e, t, c, u, r) {
		switch (t) {
			...
			case 'gotpointercapture':
				return (
					(i = r.pointerId),
					dc.set(i, gc(dc.get(i) || null, e, t, c, u, r)),
					true
				);
		}
		return false;
	...
	function Mu(e) {
		...
		for (var t = e.targetContainers; 0 < t.length; ) {
			...
			if (c === null) {
				...
				return (
					(t = Vn(c)), t !== null && Wo(t), (e.blockedOn = c), false
				);
			t.shift();
		}
		return true;
		...
		(reactDomClient_production.hydrateRoot = function (e, t, c) {
			...
			return (
				c != null &&
					...
					c.formState !== void 0 && (d = c.formState)),
				(t = Yo(e, 1, true, t, c ?? null, u, r, d, i, f, b, Po)),
				(t.context = Xo(null)),
				(c = t.current),
				(u = nt()),
				(u = Vu(u)),
...
function __wasm_bindgen_func_elem_178472(n, a) {
	wasm.__wasm_bindgen_func_elem_178472(n, a);
}
function __wasm_bindgen_func_elem_61980(n, a) {
	wasm.__wasm_bindgen_func_elem_61980(n, a);
}
function __wasm_bindgen_func_elem_116256(n, a) {
	wasm.__wasm_bindgen_func_elem_116256(n, a);
}
function __wasm_bindgen_func_elem_13418(n, a, l) {
	wasm.__wasm_bindgen_func_elem_13418(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_126730(n, a, l) {
	wasm.__wasm_bindgen_func_elem_126730(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_163918(n, a, l) {
	wasm.__wasm_bindgen_func_elem_163918(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_188937(n, a, l) {
	wasm.__wasm_bindgen_func_elem_188937(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_10(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_10(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_11(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_11(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_12(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_12(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_13(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_13(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_14(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_14(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_15(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_15(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61968_16(n, a, l) {
	wasm.__wasm_bindgen_func_elem_61968_16(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_61967(n, a, l) {
...
function __wasm_bindgen_func_elem_188935(n, a, l) {
	try {
		const s = wasm.__wbindgen_add_to_stack_pointer(-16);
		wasm.__wasm_bindgen_func_elem_188935(s, n, a, addHeapObject(l));
		var _ = getDataViewMemory0().getInt32(s + 0, true),
			o = getDataViewMemory0().getInt32(s + 4, true);
		if (o) throw takeObject(_);
	} finally {
...
function __wasm_bindgen_func_elem_61972(n, a, l, _) {
...
function __wasm_bindgen_func_elem_192514(n, a, l, _) {
...
function Inventory() {
	var _a;
	const [n, a] = reactExports.useState(false),
			...
			const l = setInterval(() => {
				try {
					...
					o.kind === 'flower' &&
						...
						a({ name: H, screenX: p.x, screenY: p.y });
				} catch {
					a(null);
				}
			}, 50);
