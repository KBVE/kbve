...
const scriptRel = 'modulepreload',
	...
	__vitePreload = function (a, l, _) {
			...
			o = j(
				l.map((O) => {
					...
					if (
						...
						return new Promise((ve, Ee) => {
							(Q.addEventListener('load', ve),
		...
		function s(j) {
			...
			if (((S.payload = j), window.dispatchEvent(S), !S.defaultPrevented))
				throw j;
		}
		return o.then((j) => {
...
function requireReactJsxRuntime_production() {
	...
	return (
		(reactJsxRuntime_production.Fragment = a),
...
function requireReact_production() {
	...
	((Ze.prototype.isReactComponent = {}),
		(Ze.prototype.setState = function (m, D) {
	...
	function A(m, D, C, U, V) {
		...
		if (pt(m))
			for (var de = 0; de < m.length; de++)
				((U = m[de]), (W = Ce + Et(U, de)), (te += A(U, D, C, W, V)));
		else if (((de = ve(m)), typeof de == 'function'))
				...
				D.then(
					function (C) {
						(m._status === 0 || m._status === -1) &&
							((m._status = 1), (m._result = C));
					},
					function (C) {
						(m._status === 0 || m._status === -1) &&
							((m._status = 2), (m._result = C));
					},
				),
	...
	return (
		...
		(react_production.Component = Ze),
		(react_production.Fragment = l),
		(react_production.Profiler = o),
		(react_production.PureComponent = He),
		...
		(react_production.cloneElement = function (m, D, C) {
			...
			if (W === 1) U.children = C;
				...
				for (var te = Array(W), Ce = 0; Ce < W; Ce++)
		...
		(react_production.createContext = function (m) {
			return (
				...
				(m.Provider = m),
				(m.Consumer = { $$typeof: s, _context: m }),
				m
			);
		}),
		(react_production.createElement = function (m, D, C) {
			var U,
				...
				W = null;
			if (D != null)
				for (U in (D.key !== void 0 && (W = '' + D.key), D))
					Be.call(D, U) &&
						U !== 'key' &&
						U !== '__self' &&
						U !== '__source' &&
			...
			if (te === 1) V.children = C;
				...
				for (var Ce = Array(te), de = 0; de < te; de++)
		...
		(react_production.isValidElement = wt),
		...
		(react_production.startTransition = function (m) {
			...
			try {
				...
				(D !== null && C.types !== null && (D.types = C.types),
					(k.T = D));
			}
		}),
				...
				function at(A) {
					for (var z = l(O); z !== null; ) {
						if (z.callback === null) _(O);
							...
							(_(O), (z.sortIndex = z.expirationTime), a(v, z));
						else break;
						z = l(O);
					}
				}
	...
	return (
		...
		(reactDom_production.preinit = function (v, O) {
			if (typeof v == 'string' && O && typeof O.as == 'string') {
				var H = O.as,
					R = S(H, O.crossOrigin),
					Q = typeof O.integrity == 'string' ? O.integrity : void 0,
					ve =
				...
				H === 'style'
					? _.d.S(
							...
							typeof O.precedence == 'string'
								? O.precedence
								: void 0,
							{ crossOrigin: R, integrity: Q, fetchPriority: ve },
						)
					: H === 'script' &&
						_.d.X(v, {
							crossOrigin: R,
...
function requireReactDomClient_production() {
	...
	function mc(e) {
		(V.current === e && (D(U), D(V)),
			te.current === e && (D(te), (bc._currentValue = G)));
	}
	var Cu, $r;
	function jn(e) {
		if (Cu === void 0)
			...
			var u = {
				DetermineComponentFrameRoot: function () {
					try {
						...
						if (x && h && typeof x.stack == 'string')
							return [x.stack, h.stack];
					}
					return [null, null];
				},
			};
...
`);
				for (
					r = u = 0;
					u < g.length &&
					!g[u].includes('DetermineComponentFrameRoot');
				)
					u++;
				for (
					;
					r < y.length &&
					!y[r].includes('DetermineComponentFrameRoot');
				)
					r++;
				if (u === g.length || r === y.length)
					for (
						u = g.length - 1, r = y.length - 1;
						1 <= u && 0 <= r && g[u] !== y[r];
					)
						r--;
				for (; 1 <= u && 0 <= r; u--, r--)
...
` +
	...
	var Bu = Object.prototype.hasOwnProperty,
		...
		nb = n.unstable_shouldYield,
		ab = n.unstable_requestPaint,
		Fe = n.unstable_now,
		cb = n.unstable_getCurrentPriorityLevel,
		ei = n.unstable_ImmediatePriority,
		ti = n.unstable_UserBlockingPriority,
		Oc = n.unstable_NormalPriority,
		ub = n.unstable_LowPriority,
		ni = n.unstable_IdlePriority,
		lb = n.log,
		rb = n.unstable_setDisableYieldValue,
		Sa = null,
		Ke = null;
	function Zt(e) {
		if (
			(typeof lb == 'function' && rb(e),
	...
	var Je = Math.clz32 ? Math.clz32 : fb,
		ib = Math.log,
		_b = Math.LN2;
	function fb(e) {
	...
	function ci(e, t, c) {
		...
		((e.entangledLanes |= t),
			(e.entanglements[u] =
				e.entanglements[u] | 1073741824 | (c & 261930)));
	}
	function ui(e, t) {
	...
	var Ft = Math.random().toString(36).slice(2),
		...
		Xu = '__reactEvents$' + Ft,
		sb = '__reactListeners$' + Ft,
		gb = '__reactHandles$' + Ft,
	...
	function di(e) {
		...
		var c = t.getValue(),
			u = '';
		return (
			e && (u = gi(e) ? (e.checked ? 'true' : 'false') : e.value),
			(e = u),
			e !== c ? (t.setValue(e), true) : false
		);
	}
	function Sc(e) {
		if (
	...
	function Qn(e, t, c, u) {
		if (((e = e.options), t)) {
			...
			for (c = 0; c < e.length; c++)
				((r = t.hasOwnProperty('$' + e[c].value)),
					e[c].selected !== r && (e[c].selected = r),
					r && u && (e[c].defaultSelected = true));
		} else {
			for (c = '' + ct(c), t = null, r = 0; r < e.length; r++) {
				if (e[r].value === c) {
					((e[r].selected = true),
						u && (e[r].defaultSelected = true));
					return;
				}
	...
	function Oi(e, t, c) {
		if (
			t != null &&
			((t = '' + ct(t)), t !== e.value && (e.value = t), c == null)
		) {
				...
				!c.hasOwnProperty(u) ||
					...
					(u.indexOf('--') === 0
						...
						: u === 'float'
							...
							: (e[u] = ''));
			for (var r in t)
				((u = t[r]), t.hasOwnProperty(r) && c[r] !== u && ji(e, r, u));
	...
	function hi(e, t, c) {
		...
		try {
			...
			if (
				...
				(Zn !== null || Fn !== null) &&
					(bu(),
					Zn && ((t = Zn), (e = Fn), (Fn = Zn = null), yi(t), e)))
			)
				for (t = 0; t < e.length; t++) yi(e[t]);
		}
	}
	function Ma(e, t) {
		var c = e.stateNode;
	...
	var hn = {
		...
		Dc = R({}, Ra, {
			...
			movementX: function (e) {
				return 'movementX' in e
					...
					: (e !== Ha &&
							(Ha && e.type === 'mousemove'
								? ((el = e.screenX - Ha.screenX),
									(tl = e.screenY - Ha.screenY))
								: (tl = el = 0),
							(Ha = e)),
						el);
			},
		...
		xi = Ge(Dc),
		vb = R({}, Dc, { dataTransfer: 0 }),
		Sb = Ge(vb),
		xb = R({}, Ra, { relatedTarget: 0 }),
		nl = Ge(xb),
		Eb = R({}, hn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
		Ab = Ge(Eb),
		Tb = R({}, hn, {
	...
	var Nb = R({}, Ra, {
		...
		qb = Ge(Lb),
		Gb = R({}, hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
		Vb = Ge(Gb),
		Yb = R({}, Dc, {
			deltaX: function (e) {
				return 'deltaX' in e
	...
	function Ci(e, t, c, u) {
		(Zn ? (Fn ? Fn.push(u) : (Fn = [u])) : (Zn = u),
			(t = ju(t, 'onChange')),
			0 < t.length &&
				((c = new Mc('onChange', 'change', null, c, u)),
	...
	function $b(e, t, c) {
		e === 'focusin'
			? (Li(), (Ca = t), (Na = c), Ca.attachEvent('onpropertychange', qi))
			: e === 'focusout' && Li();
	}
	function Pb(e) {
	...
	function Vi(e, t) {
		...
		for (var u; c; ) {
			if (c.nodeType === 3) {
				if (((u = e + c.textContent.length), e <= t && u >= t))
	...
	function Qi(e, t, c) {
		...
		_l ||
			...
			(Ba && Ua(Ba, u)) ||
				...
				(u = ju(il, 'onSelect')),
				0 < u.length &&
					((t = new Mc('onSelect', 'select', null, t, c)),
		...
		if (((u = e), typeof e == 'function')) gl(e) && (f = 1);
			...
			e: switch (e) {
				...
				default:
					...
					((f = 29),
						(c = Error(_(130, e === null ? 'null' : typeof e, ''))),
						(u = null));
			}
		return (
			(t = Ie(f, c, t, r)),
	...
	function ta(e) {
		...
		if (
			...
			t === 27
				? ((t = fe),
					bn(e.type) ? ((e = Yr), (Yr = null), (fe = e)) : (fe = t))
				: (fe = Te ? bt(e.stateNode.nextSibling) : null);
		return true;
	}
	function An() {
		((fe = Te = null), (I = false));
	...
	function f_(e, t, c) {
		switch (
			((c = e[c]),
			c === void 0 ? e.push(t) : c !== t && (t.then(Tt, Tt), (t = c)),
			t.status)
		) {
			case 'fulfilled':
				return t.value;
	...
	function s_(e) {
		...
		function u(p) {
			for (var d = /* @__PURE__ */ new Map(); p !== null; )
		...
		function b(p, d, w, T) {
			return d === null || d.tag !== 6
				? ((d = dl(w, p.mode, T)), (d.return = p), d)
				: ((d = r(d, w)), (d.return = p), d);
		}
		function g(p, d, w, T) {
			var L = w.type;
			return L === ze
				? E(p, d, w.props.children, T, w.key)
				: d !== null &&
					  (d.elementType === L ||
							(typeof L == 'object' &&
								L !== null &&
								L.$$typeof === Be &&
								Rn(L) === d.type))
					? ((d = r(d, w.props)), Xa(d, w), (d.return = p), d)
					: ((d = Uc(w.type, w.key, w.props, null, p.mode, T)),
						Xa(d, w),
						(d.return = p),
						d);
		}
		function y(p, d, w, T) {
			return d === null ||
				...
				? ((d = ml(w, p.mode, T)), (d.return = p), d)
				: ((d = r(d, w.children || [])), (d.return = p), d);
		}
		function E(p, d, w, T, L) {
			return d === null || d.tag !== 7
				? ((d = En(w, p.mode, T, L)), (d.return = p), d)
				: ((d = r(d, w)), (d.return = p), d);
		}
		function M(p, d, w) {
			if (
				...
				return ((d = dl('' + d, p.mode, w)), (d.return = p), d);
			if (typeof d == 'object' && d !== null) {
				switch (d.$$typeof) {
					case ve:
						return (
							(w = Uc(d.type, d.key, d.props, null, p.mode, w)),
							Xa(w, d),
							(w.return = p),
							w
						);
				...
				if (gt(d) || Le(d))
					return ((d = En(d, p.mode, w, null)), (d.return = p), d);
		...
		function h(p, d, w, T) {
			...
			if (typeof w == 'object' && w !== null) {
				...
				if (gt(w) || Le(w))
					return L !== null ? null : E(p, d, w, T, null);
		...
		function x(p, d, w, T, L) {
			if (
				...
				return ((p = p.get(w) || null), b(d, p, '' + T, L));
			if (typeof T == 'object' && T !== null) {
				switch (T.$$typeof) {
					case ve:
						return (
							(p = p.get(T.key === null ? w : T.key) || null),
							g(d, p, T, L)
						);
					case Ee:
						return (
				...
				if (gt(T) || Le(T))
					return ((p = p.get(w) || null), E(d, p, T, L, null));
		...
		function N(p, d, w, T) {
			for (
				var L = null, $ = null, B = d, X = (d = 0), J = null;
				B !== null && X < w.length;
				X++
			) {
				...
				switch (w.$$typeof) {
					case ve:
						e: {
							...
							w.type === ze
								? ((T = En(w.props.children, p.mode, T, w.key)),
									(T.return = p),
									(p = T))
								: ((T = Uc(
										w.type,
	...
	function Za(e, t, c, u) {
		...
		if (b !== null) {
			...
			E !== null &&
				...
				(b = E.lastBaseUpdate),
				b !== f &&
					(b === null ? (E.firstBaseUpdate = y) : (b.next = y),
					(E.lastBaseUpdate = g)));
		}
		if (i !== null) {
			var M = r.baseState;
	...
	function m_(e, t) {
		var c = e.callbacks;
		if (c !== null)
			for (e.callbacks = null, e = 0; e < c.length; e++) d_(c[e], t);
	}
	var ra = m(null),
		Wc = m(0);
	function O_(e, t) {
	...
	function Zc(e) {
		for (var t = e; t !== null; ) {
			if (t.tag === 13) {
				...
				if (
					c !== null &&
					((c = c.dehydrated), c === null || Gr(c) || Vr(c))
				)
					return t;
			} else if (
				t.tag === 19 &&
	...
	function j_(e) {
		...
		e === null ||
			we ||
			((e = e.dependencies), e !== null && Lc(e) && (we = true));
	}
	function w_(e, t, c, u) {
		Y = e;
		var r = 0;
	...
	function Gl(e) {
		...
		if (
			...
			c === null && ((c = Jc()), (Y.updateQueue = c)),
			(c.memoCache = t),
			(c = t.data[t.index]),
			c === void 0)
		)
			for (c = t.data[t.index] = Array(e), u = 0; u < e; u++) c[u] = Ln;
		return (t.index++, c);
	}
	function Nt(e, t) {
		...
		if (((i = e.baseState), r === null)) e.memoizedState = i;
			...
			do {
				...
				if (M !== y.lane ? (K & M) === M : (Ct & M) === M) {
					...
					((M = y.action),
						Cn && c(i, M),
						(i = y.hasEagerState ? y.eagerState : c(i, M)));
				} else
					((h = {
						lane: M,
						revertLane: y.revertLane,
	...
	function Yl(e) {
		...
		if (r !== null) {
			...
			while (f !== r);
			(ke(i, t.memoizedState) || (we = true),
				(t.memoizedState = i),
				t.baseQueue === null && (t.baseState = i),
				(c.lastRenderedState = i));
		}
		return [i, u];
	}
	function y_(e, t, c) {
		...
		if (
			(f && ((r.memoizedState = c), (we = true)),
			(r = r.queue),
			Wl(S_.bind(null, u, r, e), [e]),
			r.getSnapshot !== t ||
				f ||
			...
			if (
				((u.flags |= 2048),
				fa(9, { destroy: void 0 }, v_.bind(null, u, r, c, t), null),
				_e === null)
			)
				throw Error(_(349));
			i || (Ct & 127) !== 0 || h_(u, t, c);
	...
	function ds(e, t, c, u, r) {
		...
		if (((e = t.action), e !== null)) {
			...
			(A.T !== null ? c(true) : (i.isTransition = false),
				u(i),
				(c = t.pending),
				c === null
					? ((i.next = t.pending = i), T_(t, i))
					: ((i.next = c.next), (t.pending = c.next = i)));
		}
	}
	function T_(e, t) {
		var c = t.action,
	...
	function D_(e, t, c) {
		((t.status = 'fulfilled'),
			...
			t !== null &&
				...
				c === t
					? (e.pending = null)
					: ((c = c.next), (t.next = c), T_(e, c))));
	}
	function Ql(e, t, c) {
		var u = e.pending;
		if (((e.pending = null), u !== null)) {
			u = u.next;
			do ((t.status = 'rejected'), (t.reason = c), R_(t), (t = t.next));
			while (t !== u);
		}
		e.action = null;
	}
	...
	function N_(e, t, c) {
		...
		return (
			c !== t.memoizedState &&
				((Y.flags |= 2048),
				fa(9, { destroy: void 0 }, ms.bind(null, r, c), null)),
			[u, i, e]
		);
	}
	function ms(e, t) {
	...
	function fa(e, t, c, u) {
		return (
			(e = { tag: e, create: c, deps: u, inst: t, next: null }),
			(t = Y.updateQueue),
	...
	function Pc(e, t, c, u) {
		...
		ue !== null && u !== null && Nl(u, ue.memoizedState.deps)
			? (r.memoizedState = fa(t, i, c, u))
			: ((Y.flags |= e), (r.memoizedState = fa(1 | t, i, c, u)));
	}
	function L_(e, t) {
		$c(8390656, 8, e, t);
	}
	...
	function Fl(e, t, c) {
		return c === void 0 || ((Ct & 1073741824) !== 0 && (K & 261930) === 0)
			? (e.memoizedState = t)
			: ((e.memoizedState = c), (e = Ff()), (Y.lanes |= e), (ln |= e), c);
	}
	function Z_(e, t, c, u) {
		return ke(c, t)
			? c
			: ra.current !== null
				? ((e = Fl(e, c, u)), ke(e, t) || (we = true), e)
				: (Ct & 42) === 0 ||
					  ((Ct & 1073741824) !== 0 && (K & 261930) === 0)
					? ((we = true), (e.memoizedState = c))
	...
	function F_(e, t, c, u, r) {
		...
		try {
			...
			((z.p = i),
				f !== null && b.types !== null && (f.types = b.types),
				(A.T = f));
		}
	}
	function ps() {}
			...
			if (
				...
				try {
					var f = t.lastRenderedState,
						b = i(f, c);
					if (
						((r.hasEagerState = true), (r.eagerState = b), ke(b, f))
					)
						return (Cc(e, t, r, 0), _e === null && zc(), false);
				} catch {
				} finally {
				}
			if (((c = sl(e, t, r, u)), c !== null))
				return (We(c, e, u), ef(c, t, u), true);
		}
		return false;
	}
	function kl(e, t, c, u) {
	...
	var tf = {
			...
			useImperativeHandle: function (e, t, c) {
				((c = c != null ? c.concat([e]) : null),
					$c(4194308, 4, Y_.bind(null, t, e), c));
			},
			...
			useSyncExternalStore: function (e, t, c) {
				...
				return (
					...
					(u.flags |= 2048),
					fa(9, { destroy: void 0 }, v_.bind(null, u, i, c, t), null),
					c
				);
			},
			useId: function () {
				...
				if (I) {
					var c = ht,
						u = yt;
					((c = (u & ~(1 << (32 - Je(u) - 1))).toString(32) + c),
						(t = '_' + t + 'R_' + c),
						(c = Kc++),
						0 < c && (t += 'H' + c.toString(32)),
						(t += '_'));
				} else
					((c = ss++), (t = '_' + t + 'r_' + c.toString(32) + '_'));
	...
	var nf = {
		...
		useOptimistic: function (e, t) {
			...
			return ue !== null
				? A_(c, ue, e, t)
				: ((c.baseState = e), [e, c.queue.dispatch]);
		},
		useMemoCache: Gl,
		useCacheRefresh: I_,
	};
	...
	function cf(e, t, c, u) {
		((e = t.state),
			typeof t.componentWillReceiveProps == 'function' &&
				t.componentWillReceiveProps(c, u),
			typeof t.UNSAFE_componentWillReceiveProps == 'function' &&
				t.UNSAFE_componentWillReceiveProps(c, u),
			...
			return (
				...
				t !== null
					? ((t.flags & 65536) === 0 && (t.flags |= 256),
						...
						(t.lanes = r),
						u !== jl &&
							((e = Error(_(422), { cause: u })), qa(rt(e, c))))
					: (u !== jl &&
							((t = Error(_(423), { cause: u })), qa(rt(t, c))),
	...
	function bf(e, t, c, u, r) {
		...
		return (
			...
			e !== null && !we
				? (Ll(e, t, r), Ut(e, t, r))
				: (I && b && Ol(t), (t.flags |= 1), De(e, t, u, r), t.child)
		);
	}
	function sf(e, t, c, u, r) {
		if (e === null) {
			...
			return typeof i == 'function' &&
				...
				c.compare === null
				? ((t.tag = 15), (t.type = i), gf(e, t, i, u, r))
				: ((e = Uc(c.type, null, u, t, t.mode, r)),
					(e.ref = t.ref),
					(e.return = t),
					(t.child = e));
		}
	...
	function gf(e, t, c, u, r) {
		if (e !== null) {
			...
			if (Ua(i, u) && e.ref === t.ref)
				if (((we = false), (t.pendingProps = u = i), _r(e, r)))
					(e.flags & 131072) !== 0 && (we = true);
	...
	function df(e, t, c, u) {
		...
		if (
			...
			if ((c & 536870912) !== 0)
				...
				return (
					(u = t.lanes = 536870912),
					mf(e, t, i !== null ? i.baseLanes | c : c, c, u)
				);
		} else
			i !== null
				? (Gc(t, i.cachePool), O_(t, i), an(), (t.memoizedState = null))
				: (e !== null && Gc(t, null), Hl(), an());
	...
	function mf(e, t, c, u, r) {
		...
		return (
			...
			(t.memoizedState = { baseLanes: c, cachePool: i }),
			e !== null && Gc(t, null),
			Hl(),
			p_(t),
	...
	function hs(e, t, c) {
		...
		if (i !== null) {
			var f = i.dehydrated;
			if ((Cl(t), r))
				if (t.flags & 256) ((t.flags &= -257), (t = Of(e, t, c)));
				...
				if (
					((u = _e),
					u !== null &&
						((f = li(u, c)), f !== 0 && f !== i.retryLane))
				)
					throw ((i.retryLane = f), xn(e, f), We(u, e, f), tr);
				(su(), (t = Of(e, t, c)));
			} else
				((e = i.treeContext),
					(fe = bt(f.nextSibling)),
	...
	function nr(e, t, c, u, r) {
		return (
			Mn(t),
			(c = Ul(e, t, c, u, void 0, r)),
			(u = Bl()),
			e !== null && !we
				? (Ll(e, t, r), Ut(e, t, r))
				: (I && u && Ol(t), (t.flags |= 1), De(e, t, c, r), t.child)
		);
	}
	function pf(e, t, c, u, r, i) {
		return (
			...
			e !== null && !we
				? (Ll(e, t, i), Ut(e, t, i))
				: (I && u && Ol(t), (t.flags |= 1), De(e, t, c, i), t.child)
		);
	}
	function jf(e, t, c, u, r) {
		if ((Mn(t), t.stateNode === null)) {
			...
			(typeof f == 'object' && f !== null && (i = Me(f)),
				...
				Tl(t),
				(f = c.contextType),
				(i.context = typeof f == 'object' && f !== null ? Me(f) : $n),
				(i.state = t.memoizedState),
				(f = c.getDerivedStateFromProps),
				typeof f == 'function' &&
					($l(t, c, f, u), (i.state = t.memoizedState)),
			...
			((i.state = h),
				...
				b || h !== y || Pt
					? (typeof M == 'function' &&
							($l(t, c, M, u), (y = t.memoizedState)),
						(g = Pt || af(t, c, g, u, h, y, f))
							? (E ||
					...
					(E =
						...
						? (y ||
								...
								(typeof i.componentWillUpdate == 'function' &&
									i.componentWillUpdate(u, x, g),
								typeof i.UNSAFE_componentWillUpdate ==
									'function' &&
									i.UNSAFE_componentWillUpdate(u, x, g)),
		...
		return (
			...
			i || u
				? ((i = t.stateNode),
					(c =
						u && typeof c.getDerivedStateFromError != 'function'
							? null
							: i.render()),
					(t.flags |= 1),
					e !== null && u
						? ((t.child = zn(t, e.child, null, r)),
							(t.child = zn(t, null, c, r)))
						: De(e, t, c, r),
	...
	function yf(e, t, c) {
			...
			return (
				...
				r
					? (an(),
						...
						(t.child = b),
						(u = t.child),
						(u.memoizedState = cr(c)),
						(u.childLanes = ur(e, f, c)),
						(t.memoizedState = ar),
						Ia(null, u))
					: (nn(t), lr(t, b))
			);
		...
		if (g !== null && ((b = g.dehydrated), b !== null)) {
			if (i)
				...
				if (((f = b.nextSibling && b.nextSibling.dataset), f))
					var y = f.dgst;
				((f = y),
					(u = Error(_(419))),
					(u.stack = ''),
				...
				if (
					((f = _e),
					f !== null &&
						((u = li(f, c)), u !== 0 && u !== g.retryLane))
				)
					throw ((g.retryLane = u), xn(e, u), We(f, e, u), tr);
				(Gr(b) || su(), (t = rr(e, t, c)));
			} else
				Gr(b)
		...
		return r
			? (an(),
				...
				(g = e.child),
				(y = g.sibling),
				(u = Dt(g, { mode: 'hidden', children: u.children })),
				(u.subtreeFlags = g.subtreeFlags & 65011712),
				y !== null
					? (b = Dt(y, b))
					: ((b = En(b, r, c, null)), (b.flags |= 2)),
				(b.return = t),
				(u.return = t),
				(u.sibling = b),
				(t.child = u),
							...
							? ((g = pe._currentValue),
								(r =
									r.parent !== g
										...
										: r))
							: (r = i_()),
						(b = { baseLanes: b.baseLanes | c, cachePool: r })),
				(u.memoizedState = b),
				(u.childLanes = ur(e, f, c)),
				(t.memoizedState = ar),
				Ia(e.child, u))
			: (nn(t),
				(c = e.child),
				(e = c.sibling),
				(c = Dt(c, { mode: 'visible', children: u.children })),
				(c.return = t),
				(c.sibling = null),
				e !== null &&
					((f = t.deletions),
	...
	function vf(e, t, c) {
		...
		switch (r) {
			case 'forwards':
				for (c = t.child, r = null; c !== null; )
					((e = c.alternate),
						e !== null && Zc(e) === null && (r = c),
						(c = c.sibling));
				((c = r),
					c === null
						? ((r = t.child), (t.child = null))
						: ((r = c.sibling), (c.sibling = null)),
					ir(t, false, r, c, i, u));
				break;
			case 'backwards':
	...
	function Ut(e, t, c) {
		...
		if (t.child !== null) {
			for (
				e = t.child,
					c = Dt(e, e.pendingProps),
					t.child = c,
					c.return = t;
				e.sibling !== null;
			)
				((e = e.sibling),
					(c = c.sibling = Dt(e, e.pendingProps)),
					(c.return = t));
			c.sibling = null;
		}
		return t.child;
	...
	function vs(e, t, c) {
		switch (t.tag) {
			...
			case 19:
				...
				if (
					((u = (c & t.childLanes) !== 0),
					u || (na(e, t, c, false), (u = (c & t.childLanes) !== 0)),
					r)
				) {
	...
	function Sf(e, t, c) {
		if (e !== null)
			if (e.memoizedProps !== t.pendingProps) we = true;
			else {
				if (!_r(e, c) && (t.flags & 128) === 0)
					return ((we = false), vs(e, t, c));
				we = (e.flags & 131072) !== 0;
			}
		else
			((we = false),
				I && (t.flags & 1048576) !== 0 && t_(t, La, t.index));
		switch (((t.lanes = 0), t.tag)) {
			...
			case 26:
				return (
					au(e, t),
					e === null
						? (c = Uo(t.type, null, t.pendingProps, null))
							? (t.memoizedState = c)
							: I ||
								((c = t.type),
								(e = t.pendingProps),
								(u = wu(W.current).createElement(c)),
								(u[Ae] = t),
								(u[qe] = e),
								Re(u, c, e),
								Se(u),
			...
			case 27:
				return (
					...
					e === null &&
						I &&
						((u = t.stateNode =
							zo(t.type, t.pendingProps, W.current)),
						(Te = t),
						(ft = true),
						(r = fe),
						bn(t.type)
							? ((Yr = r), (fe = bt(u.firstChild)))
							: (fe = r)),
					De(e, t, t.pendingProps.children, c),
					au(e, t),
			...
			case 5:
				return (
					e === null &&
						I &&
						((r = u = fe) &&
							((u = Ps(u, t.type, t.pendingProps, ft)),
							u !== null
								? ((t.stateNode = u),
									(Te = t),
									(fe = bt(u.firstChild)),
			...
			case 4:
				return (
					Ce(t, t.stateNode.containerInfo),
					(u = t.pendingProps),
					e === null ? (t.child = zn(t, null, u, c)) : De(e, t, u, c),
					t.child
				);
			case 11:
					...
					e === null
						? ((r = El()),
							r === null &&
								...
								(r.pooledCache = i),
								i.refCount++,
								i !== null && (r.pooledCacheLanes |= c),
								(r = i)),
							(t.memoizedState = { parent: u, cache: r }),
							Tl(t),
							$t(t, pe, r))
						: ((e.lanes & c) !== 0 &&
								(Ml(e, t), Za(t, null, null, c), Wa()),
							(r = e.memoizedState),
							(i = t.memoizedState),
							r.parent !== u
								? ((r = { parent: u, cache: u }),
	...
	function $a(e, t) {
		if (!I)
			switch (e.tailMode) {
				...
				case 'collapsed':
					c = e.tail;
					for (var u = null; c !== null; )
						(c.alternate !== null && (u = c), (c = c.sibling));
					u === null
						? t || e.tail === null
							? (e.tail = null)
							: (e.tail.sibling = null)
	...
	function Ss(e, t, c) {
		...
		switch ((pl(t), t.tag)) {
			...
			case 24:
				return (
					(c = null),
					e !== null && (c = e.memoizedState.cache),
					t.memoizedState.cache !== c && (t.flags |= 2048),
					zt(pe),
					oe(t),
					null
				);
			...
			((e = e.stateNode),
				t
					...
					: ((t =
						...
						c != null || t.onclick !== null || (t.onclick = Tt)));
		else if (
			u !== 4 &&
			(u === 27 && bn(e.type) && ((c = e.stateNode), (t = null)),
			(e = e.child),
			e !== null)
		)
			for (sr(e, t, c), e = e.sibling; e !== null; )
				(sr(e, t, c), (e = e.sibling));
	}
	function lu(e, t, c) {
		var u = e.tag;
		if (u === 5 || u === 6)
			...
			u !== 4 &&
			(u === 27 && bn(e.type) && (c = e.stateNode),
			(e = e.child),
			e !== null)
		)
			for (lu(e, t, c), e = e.sibling; e !== null; )
				(lu(e, t, c), (e = e.sibling));
	}
	function Rf(e) {
		var t = e.stateNode,
			c = e.memoizedProps;
	...
	function Es(e, t) {
		...
		for (
			Ur = { focusedElem: e, selectionRange: c }, Au = false, xe = t;
			xe !== null;
		)
			if (
				((t = xe),
				...
				for (; xe !== null; ) {
					switch (
						((t = xe), (i = t.alternate), (e = t.flags), t.tag)
					) {
						case 0:
							if (
								(e & 4) !== 0 &&
			...
			case 13:
				(Gt(e, c),
					...
					u & 64 &&
						...
						e !== null &&
							((e = e.dehydrated),
							e !== null && ((c = Ns.bind(null, c)), tg(e, c)))));
				break;
			case 22:
				if (((u = c.memoizedState !== null || Lt), !u)) {
					((t = (t !== null && t.memoizedState !== null) || ye),
						(r = Lt));
					var i = ye;
					((Lt = u),
						(ye = t) && !i
							? Vt(e, c, (c.subtreeFlags & 8772) !== 0)
							: Gt(e, c),
						(Lt = r),
						(ye = i));
				}
	...
	function Nf(e, t, c) {
		...
		switch (c.tag) {
			...
			case 27:
				...
				var u = be,
					r = Ve;
				(bn(c.type) && ((be = c.stateNode), (Ve = false)),
					qt(e, t, c),
					_c(c.stateNode),
					(be = u),
					(Ve = r));
			...
			case 1:
				(ye ||
					(vt(c, t),
					(u = c.stateNode),
					typeof u.componentWillUnmount == 'function' && Tf(c, t, u)),
					qt(e, t, c));
				break;
			case 21:
				qt(e, t, c);
		...
		switch (e.tag) {
			...
			case 15:
				(Ye(t, e),
					Xe(e),
					u & 4 &&
						(cn(3, e, e.return), Pa(3, e), cn(5, e, e.return)));
				break;
			case 1:
				(Ye(t, e),
					Xe(e),
					u & 512 && (ye || c === null || vt(c, c.return)),
					u & 64 &&
						Lt &&
						((e = e.updateQueue),
						e !== null &&
				...
				if (
					...
					if (((u = e.memoizedState), c === null))
						...
						i !== u
							...
							: u === null &&
								e.stateNode !== null &&
								or(e, e.memoizedProps, c.memoizedProps);
				}
				break;
			case 27:
				(Ye(t, e),
			...
			case 5:
				...
				(u & 4 &&
					e.stateNode != null &&
					((r = e.memoizedProps),
					or(e, r, c !== null ? c.memoizedProps : r)),
					u & 1024 && (gr = true));
				break;
			case 6:
				if ((Ye(t, e), Xe(e), u & 4)) {
			...
			case 3:
				if (
					((vu = null),
					(r = mt),
					(mt = yu(t.containerInfo)),
					Ye(t, e),
					(mt = r),
					Xe(e),
					u & 4 && c !== null && c.memoizedState.isDehydrated)
				)
					try {
						ha(t.containerInfo);
					} catch (N) {
			...
			case 4:
				((u = mt),
					(mt = yu(e.stateNode.containerInfo)),
					Ye(t, e),
					Xe(e),
					(mt = u));
				break;
			...
			case 22:
				...
				u & 4 &&
					...
					u !== null &&
						((c = u.retryQueue),
						c !== null && ((u.retryQueue = null), ru(e, c))));
				break;
			case 19:
				(Ye(t, e),
					Xe(e),
	...
	function Vt(e, t, c) {
		for (
			c = c && (t.subtreeFlags & 8772) !== 0, t = t.child;
			t !== null;
		) {
			var u = t.alternate,
				r = e,
	...
	function dr(e, t) {
		...
		(e !== null &&
			...
			e !== c && (e != null && e.refCount++, c != null && Ga(c)));
	}
	function mr(e, t) {
		((e = null),
	...
	function Ot(e, t, c, u) {
		if (t.subtreeFlags & 10256)
			for (t = t.child; t !== null; ) (Gf(e, t, c, u), (t = t.sibling));
	}
	function Gf(e, t, c, u) {
		var r = t.flags;
		switch (t.tag) {
				...
				case 22:
					...
					(f.memoizedState !== null
						? E._visibility & 2
							? oa(i, f, b, g, r)
							: tc(i, f)
						: ((E._visibility |= 2), oa(i, f, b, g, r)),
						r && y & 2048 && dr(f.alternate, f));
					break;
				case 24:
	...
	function ba(e, t, c) {
		if (e.subtreeFlags & nc)
			for (e = e.child; e !== null; ) (Vf(e, t, c), (e = e.sibling));
	}
	function Vf(e, t, c) {
		switch (e.tag) {
			case 26:
				(ba(e, t, c),
					e.flags & nc &&
						e.memoizedState !== null &&
						sg(c, mt, e.memoizedState, e.memoizedProps));
				break;
			case 5:
				ba(e, t, c);
				break;
			...
			case 22:
				e.memoizedState === null &&
					...
					u !== null && u.memoizedState !== null
						? ((u = nc), (nc = 16777216), ba(e, t, c), (nc = u))
						: ba(e, t, c));
				break;
			default:
				ba(e, t, c);
	...
	function iu(e) {
		...
		for (e = e.child; e !== null; ) {
			switch (((t = e), t.tag)) {
				...
				case 22:
					((c = t.stateNode),
						c._visibility & 2 && ((c._visibility &= -3), iu(t)));
					break;
				default:
					iu(t);
			}
	...
	function We(e, t, c) {
		(((e === _e && (ne === 2 || ne === 9)) ||
			...
			(ma(e, 0), fn(e, K, tt, false)),
			Ea(e, c),
			((ee & 2) === 0 || e !== _e) &&
				(e === _e &&
					((ee & 2) === 0 && (Bn |= c),
					ge === 4 && fn(e, K, tt, false)),
				St(e)));
	}
	function Kf(e, t, c) {
		if ((ee & 6) !== 0) throw Error(_(327));
		var u =
				(!c && (t & 127) === 0 && (t & e.expiredLanes) === 0) ||
				xa(e, t),
			r = u ? Hs(e, t) : Sr(e, t, true),
			i = u;
		do {
			if (r === 0) {
				sa && !u && fn(e, t, 0, false);
	...
	function ma(e, t) {
		...
		(c !== -1 && ((e.timeoutHandle = -1), ks(c)),
			(c = e.cancelPendingCommit),
			c !== null && ((e.cancelPendingCommit = null), c()),
			(Xt = 0),
			vr(),
			(_e = e),
			(Z = c = Dt(e.current, null)),
			(K = t),
			(ne = 0),
			(et = null),
			(un = false),
					...
					: (ne =
							t === tr
								...
								: t !== null &&
									...
									: 1),
			(et = t),
			Z === null && ((ge = 1), tu(e, rt(t, e.current))));
	}
	function If() {
		var e = $e.current;
		return e === null
	...
	function su() {
		((ge = 4),
			un || ((K & 4194048) !== K && $e.current !== null) || (sa = true),
			...
			if ((t.subtreeFlags & 13878) !== 0 || c) {
				...
				try {
					...
					if (
						...
						b &&
						b.ownerDocument &&
						Yi(b.ownerDocument.documentElement, b)
					) {
						if (g !== null && rl(b)) {
							var y = g.start,
								E = g.end;
							if (
								(E === void 0 && (E = y), 'selectionStart' in b)
							)
								((b.selectionStart = y),
								...
								if (h.getSelection) {
									var x = h.getSelection(),
										N = b.textContent.length,
										q = Math.min(g.start, N),
										re =
											g.end === void 0
												? q
												: Math.min(g.end, N);
									...
									if (
										...
										(w.setStart(p.node, p.offset),
											...
											q > re
												...
												: (w.setEnd(d.node, d.offset),
													x.addRange(w)));
									}
								}
							}
						}
						for (M = [], x = b; (x = x.parentNode); )
							x.nodeType === 1 &&
								M.push({
									element: x,
									left: x.scrollLeft,
	...
	function lo() {
		if (he === 4 || he === 3) {
			...
			(t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
				? (he = 5)
				: ((he = 0), (da = _n = null), ro(e, e.pendingLanes));
	...
	function io() {
		...
		try {
			...
			var i = _n,
				f = Xt;
			if (((he = 0), (da = _n = null), (Xt = 0), (ee & 6) !== 0))
				throw Error(_(331));
			var b = ee;
			if (
				((ee |= 4),
	...
	function xr(e, t, c) {
		...
		r.has(c) ||
			((Or = true), r.add(c), (e = Cs.bind(null, e, t, c)), t.then(e, e));
	}
	function Cs(e, t, c) {
		var u = e.pingCache;
		(u !== null && u.delete(t),
	...
	function oo() {
		...
		for (var t = Fe(), c = null, u = mu; u !== null; ) {
			...
			(i === 0
				? ((u.next = null),
					c === null ? (mu = r) : (c.next = r),
					r === null && (pa = c))
				: ((c = u), (e !== 0 || (i & 3) !== 0) && (Ou = true)),
				(u = r));
		}
	...
	function bo(e, t) {
		for (
			...
			var f = 31 - Je(i),
				...
				g = r[f];
			(g === -1
				? ((b & c) === 0 || (b & u) !== 0) && (r[f] = ob(b, t))
				: g <= t && (e.expiredLanes |= b),
				(i &= ~b));
		}
		if (
			((t = _e),
	...
	function so(e, t) {
		...
		return (
			...
			u === 0
				...
				: (Kf(e, u, t),
					bo(e, Fe()),
					e.callbackNode != null && e.callbackNode === c
						? so.bind(null, e)
						: null)
		);
	}
	...
	for (var Mr = 0; Mr < ol.length; Mr++) {
		var Dr = ol[Mr],
			Vs = Dr.toLowerCase(),
			Ys = Dr[0].toUpperCase() + Dr.slice(1);
		dt(Vs, 'on' + Ys);
	}
	(dt(Zi, 'onAnimationEnd'),
	...
	function Hr(e) {
		if (!e[pu]) {
			((e[pu] = true),
					...
					c !== 'selectionchange' &&
						(Xs.has(c) || Rr(c, false, e), Rr(c, true, e));
				}));
	...
	function jo(e, t, c, u) {
		...
		((c = r.bind(null, t, c, e)),
			...
			u
				? r !== void 0
					? e.addEventListener(t, c, { capture: true, passive: r })
					: e.addEventListener(t, c, true)
				: r !== void 0
					? e.addEventListener(t, c, { passive: r })
		...
		hi(function () {
			...
			if ((t & 7) === 0) {
				e: {
					...
					if (
						...
						if (
							...
							(re = x == null ? h : Ta(x)),
							(w = N == null ? h : Ta(N)),
							(h = new q(T, d + 'leave', x, c, E)),
							(h.target = re),
							(h.relatedTarget = w),
							(T = null),
							Gn(E) === y &&
								((q = new q(p, d + 'enter', N, c, E)),
								(q.target = w),
								(q.relatedTarget = re),
								(T = q)),
							(re = T),
						...
						(x !== null && wo(M, h, x, q, false),
							N !== null && re !== null && wo(M, re, N, q, true));
					}
				}
				e: {
					if (
				...
				(J &&
					...
					(B = ju(y, J)),
					0 < B.length &&
						((J = new Ei(J, e, null, c, E)),
						M.push({ event: J, listeners: B }),
						X
							? (J.data = X)
							: ((X = Hi(c)), X !== null && (J.data = X)))),
					(X = Fb ? Kb(e, c) : Jb(e, c)) &&
						((J = ju(y, 'onBeforeInput')),
						0 < J.length &&
							((B = new Ei(
								'onBeforeInput',
								'beforeinput',
	...
	function wo(e, t, c, u, r) {
		for (var i = t._reactName, f = []; c !== null && c !== u; ) {
			...
			((b !== 5 && b !== 26 && b !== 27) ||
				...
				((g = y),
				r
					? ((y = Ma(c, i)), y != null && f.unshift(ic(c, y, g)))
					: r || ((y = Ma(c, i)), y != null && f.push(ic(c, y, g)))),
				(c = c.return));
		}
...
`,
	...
	function Cr(e, t, c, u, r, i) {
		switch (c) {
			...
			case 'textContent':
				break;
			default:
				if (!oi.hasOwnProperty(c))
					e: {
						if (
							c[0] === 'o' &&
							c[1] === 'n' &&
							((r = c.endsWith('Capture')),
							(t = c.slice(2, r ? c.length - 7 : void 0)),
							(i = e[qe] || null),
							(i = i != null ? i[c] : null),
							typeof i == 'function' &&
	...
	function Re(e, t, c) {
		switch (t) {
			...
			case 'img':
				...
				(r && le(e, t, 'srcSet', c.srcSet, c, null),
					u && le(e, t, 'src', c.src, c, null));
				return;
			case 'input':
				F('invalid', e);
				var b = (i = f = r = null),
			...
			case 'select':
				...
				for (r in c)
					if (c.hasOwnProperty(r) && ((b = c[r]), b != null))
						switch (r) {
							case 'value':
								i = b;
								break;
				...
				((t = i),
					...
					t != null
						? Qn(e, !!u, t, false)
						: c != null && Qn(e, !!u, c, true));
				return;
			case 'textarea':
				(F('invalid', e), (i = r = u = null));
				for (f in c)
					if (c.hasOwnProperty(f) && ((b = c[f]), b != null))
						switch (f) {
							case 'value':
								u = b;
								break;
			...
			case 'option':
				for (g in c)
					if (c.hasOwnProperty(g) && ((u = c[g]), u != null))
						switch (g) {
							case 'selected':
								e.selected =
									u &&
			...
			case 'menuitem':
				for (y in c)
					if (c.hasOwnProperty(y) && ((u = c[y]), u != null))
						switch (y) {
							case 'children':
							case 'dangerouslySetInnerHTML':
								throw Error(_(137, t));
			...
			default:
				if (Ku(t)) {
					for (E in c)
						c.hasOwnProperty(E) &&
							((u = c[E]),
							u !== void 0 && Cr(e, t, E, u, c, void 0));
					return;
				}
		}
		for (b in c)
			c.hasOwnProperty(b) &&
				((u = c[b]), u != null && le(e, t, b, u, c, null));
	}
	function Fs(e, t, c, u) {
		switch (t) {
			case 'div':
			...
			case 'input':
				...
				for (var h in u) {
					...
					if (
						((M = c[h]),
						u.hasOwnProperty(h) && (x != null || M != null))
					)
						switch (h) {
							case 'type':
								i = x;
			...
			case 'select':
				x = f = b = h = null;
				for (i in c)
					if (((g = c[i]), c.hasOwnProperty(i) && g != null))
						switch (i) {
							case 'value':
								break;
							case 'multiple':
				...
				for (r in u)
					if (
						((i = u[r]),
						(g = c[r]),
						u.hasOwnProperty(r) && (i != null || g != null))
					)
						switch (r) {
							case 'value':
								h = i;
	...
	function To(e, t) {
		...
		do {
			var r = c.nextSibling;
			if ((e.removeChild(c), r && r.nodeType === 8))
				if (((c = r.data), c === '/$' || c === '/&')) {
					if (u === 0) {
	...
	function Mo(e, t) {
		...
		do {
			...
			if (
				(c.nodeType === 1
					? t
						? ((c._stashedDisplay = c.style.display),
	...
	function No(e, t, c) {
		...
		if (u && typeof t == 'string' && t) {
			var r = ut(t);
			((r = 'link[rel="' + e + '"][href="' + r + '"]'),
				typeof c == 'string' && (r += '[crossorigin="' + c + '"]'),
				Co.has(r) ||
					(Co.add(r),
					(e = { rel: e, crossOrigin: c, href: t }),
	...
	function lg(e, t, c) {
		...
		if (u && e && t) {
			...
			t === 'image' && c && c.imageSrcSet
				? ((r += '[imagesrcset="' + ut(c.imageSrcSet) + '"]'),
					typeof c.imageSizes == 'string' &&
						(r += '[imagesizes="' + ut(c.imageSizes) + '"]'))
				: (r += '[href="' + ut(e) + '"]');
			var i = r;
			switch (t) {
				case 'style':
			...
			st.has(i) ||
				((e = R(
					{
						rel: 'preload',
						href: t === 'image' && c && c.imageSrcSet ? void 0 : e,
						as: t,
					},
					c,
				)),
	...
	function ig(e, t, c) {
		...
		if (u && e) {
			...
			if (!f) {
				...
				((f = { type: 'stylesheet', instance: f, count: 1, state: b }),
					r.set(i, f));
			}
		}
	}
	function _g(e, t) {
		...
		var c = ja;
		if (c && e) {
			var u = Yn(c).hoistableScripts,
				r = ya(e),
				i = u.get(r);
			i ||
				((i = c.querySelector(oc(r))),
				i ||
	...
	function Uo(e, t, c, u) {
		...
		switch (e) {
			...
			case 'title':
				return null;
			case 'style':
				return typeof c.precedence == 'string' &&
					typeof c.href == 'string'
					? ((t = wa(c.href)),
						(c = Yn(r).hoistableStyles),
						(u = c.get(t)),
						u ||
							((u = {
								type: 'style',
	...
	function qo(e, t, c) {
		if (vu === null) {
			...
			((r = vu),
				(u = r.get(c)),
				u || ((u = /* @__PURE__ */ new Map()), r.set(c, u)));
		if (u.has(e)) return u;
		for (
			u.set(e, null), c = c.getElementsByTagName(e), r = 0;
			r < c.length;
			r++
		) {
			var i = c[r];
			...
			if (c) var u = c.get(null);
				...
				for (
					...
					(f.nodeName === 'LINK' ||
						...
						(c.set(f.dataset.precedence, f), (u = f));
				}
				u && c.set(null, u);
			}
			((r = t.instance),
	...
	function Yo(e, t, c, u, r, i, f, b, g, y, E, M) {
		return (
			...
			(e.pooledCache = t),
			t.refCount++,
			(i.memoizedState = { element: u, isDehydrated: c, cache: t }),
			Tl(i),
			e
		);
	}
		...
		if (Au) {
			...
			if (r === null) (zr(e, t, u, Tu, c), Jo(e, u));
				...
				for (; r !== null; ) {
					...
					if (
						((i = Kr(u)), i === null && zr(e, t, u, Tu, c), i === r)
					)
						break;
					r = i;
				}
	...
	function wg(e, t, c, u, r) {
		switch (t) {
			...
			case 'gotpointercapture':
				return (
					(i = r.pointerId),
					gc.set(i, dc(gc.get(i) || null, e, t, c, u, r)),
					true
				);
		}
		return false;
	...
	function Du(e, t) {
		e.blockedOn === t &&
			...
			kr ||
				((kr = true),
				n.unstable_scheduleCallback(n.unstable_NormalPriority, yg)));
	}
	var Ru = null;
	function $o(e) {
		Ru !== e &&
	...
	function ha(e) {
		...
		for (; 0 < mn.length && ((c = mn[0]), c.blockedOn === null); )
			(ko(c), c.blockedOn === null && mn.shift());
		if (((c = (e.ownerDocument || e).$$reactFormReplay), c != null))
	...
	((Hu.prototype.render = Ir.prototype.render =
		function (e) {
		...
		(Hu.prototype.unmount = Ir.prototype.unmount =
			function () {
				var e = this._internalRoot;
				if (e !== null) {
					this._internalRoot = null;
					var t = e.containerInfo;
					(Qo(e.current, 2, null, e, null, null),
						bu(),
						(t[qn] = null));
				}
			}));
	...
	Hu.prototype.unstable_scheduleHydration = function (e) {
		if (e) {
			...
			for (
				var c = 0;
				c < mn.length && t !== 0 && t < mn[c].priority;
				c++
			);
	...
	return (
		...
		(reactDomClient_production.hydrateRoot = function (e, t, c) {
			...
			return (
				c != null &&
					(c.unstable_strictMode === true && (u = true),
					c.identifierPrefix !== void 0 && (r = c.identifierPrefix),
					c.onUncaughtError !== void 0 && (i = c.onUncaughtError),
					c.onCaughtError !== void 0 && (f = c.onCaughtError),
					c.onRecoverableError !== void 0 &&
						(b = c.onRecoverableError),
					c.formState !== void 0 && (g = c.formState)),
				(t = Yo(e, 1, true, t, c ?? null, u, r, g, i, f, b, Po)),
				(t.context = Xo(null)),
				(c = t.current),
				(u = nt()),
				(u = Vu(u)),
...
class EventBus {
	...
	on(a, l) {
		this.listeners.has(a) ||
			this.listeners.set(a, /* @__PURE__ */ new Set());
	...
	return (
		reactExports.useEffect(() => {
			const _ = gameEvents.on(
					'toast:show',
					({ message: j, severity: S, duration: v }) => {
						l({
							type: 'ADD',
							toast: {
								...
								message: j,
								severity: S,
								duration: v ?? SEVERITY_DURATIONS[S],
								createdAt: Date.now(),
								exiting: false,
							},
						});
...
const ModalStateContext = reactExports.createContext(initialState),
...
function ModalProvider({ children: n }) {
	...
	return (
		reactExports.useEffect(() => {
			const _ = gameEvents.on(
					'modal:open',
					({ id: s, title: j, content: S, size: v, onClose: O }) => {
						l({
							type: 'OPEN',
							modal: {
...
function getPortalRoot(n) {
	...
	return (
		(!a || !document.body.contains(a)) &&
			((a = document.createElement('div')),
			(a.id = n),
			(a.style.position = 'fixed'),
			(a.style.inset = '0'),
			(a.style.pointerEvents = 'none'),
			(a.style.zIndex = Z_INDEX[n] ?? '50'),
...
function ToastContainer() {
	const { toasts: n } = reactExports.useContext(ToastStateContext),
		a = reactExports.useContext(ToastDispatchContext),
		l = reactExports.useCallback(
			(_) => {
				var _a;
				((_a = n.find((s) => s.id === _)) == null ? void 0 : _a.exiting)
					? a({ type: 'REMOVE', id: _ })
					: a({ type: 'MARK_EXITING', id: _ });
			},
			[n, a],
		);
	return n.length === 0
...
function ModalOverlay() {
	const { stack: n, isOpen: a } = reactExports.useContext(ModalStateContext),
...
function KeyboardRouter() {
	const n = reactExports.useContext(ModalStateContext),
		a = reactExports.useContext(ModalDispatchContext),
		l = reactExports.useRef(false),
		_ = n.isOpen;
	reactExports.useEffect(() => {
...
function GameUIProvider({ children: n }) {
	return jsxRuntimeExports.jsx(ToastProvider, {
		children: jsxRuntimeExports.jsxs(ModalProvider, {
			children: [
...
function get_hovered_object_json() {
	try {
		...
		var n = getDataViewMemory0().getInt32(l + 0, true),
			a = getDataViewMemory0().getInt32(l + 4, true);
		let _;
		return (
			n !== 0 &&
				((_ = getStringFromWasm0(n, a).slice()),
				wasm.__wbindgen_export4(n, a * 1, 1)),
			_
		);
	} finally {
...
function greet(n) {
	...
	try {
		const s = wasm.__wbindgen_add_to_stack_pointer(-16),
			...
			S = WASM_VECTOR_LEN;
		wasm.greet(s, j, S);
		var _ = getDataViewMemory0().getInt32(s + 0, true),
			o = getDataViewMemory0().getInt32(s + 4, true);
		return ((a = _), (l = o), getStringFromWasm0(_, o));
	} finally {
		(wasm.__wbindgen_add_to_stack_pointer(16),
			wasm.__wbindgen_export4(a, l, 1));
	}
}
	...
	const import0 = {
		...
		__wbg___wbindgen_string_get_395e606bd0ee4427: function (n, a) {
			...
			var o = isLikeNone(_)
				...
				s = WASM_VECTOR_LEN;
			(getDataViewMemory0().setInt32(n + 4, s, true),
		...
		__wbg_createIndex_323cb0213cc21d9b: function () {
			return handleError(function (n, a, l, _, o) {
				const s = getObject(n).createIndex(
					getStringFromWasm0(a, l),
					getObject(_),
					getObject(o),
				);
		...
		__wbg_createObjectStore_4709de9339ffc6c0: function () {
			return handleError(function (n, a, l, _) {
				const o = getObject(n).createObjectStore(
					getStringFromWasm0(a, l),
					getObject(_),
				);
				return addHeapObject(o);
		...
		__wbg_createObjectURL_f141426bcc1f70aa: function () {
			return handleError(function (n, a) {
				const l = URL.createObjectURL(getObject(a)),
					_ = passStringToWasm0(
						l,
						wasm.__wbindgen_export,
						wasm.__wbindgen_export2,
		...
		__wbg_getItem_a7cc1d4f154f2e6f: function () {
			return handleError(function (n, a, l, _) {
				...
				(getDataViewMemory0().setInt32(n + 4, j, true),
					getDataViewMemory0().setInt32(n + 0, s, true));
			}, arguments);
		},
		...
		__wbg_getPropertyValue_d2181532557839cf: function () {
			return handleError(function (n, a, l, _) {
				const o = getObject(a).getPropertyValue(
		...
		__wbg_log_0c201ade58bb55e1: function (n, a, l, _, o, s, j, S) {
			...
			try {
				((v = n),
					(O = a),
					console.log(
						getStringFromWasm0(n, a),
						getStringFromWasm0(l, _),
						getStringFromWasm0(o, s),
						getStringFromWasm0(j, S),
					));
			} finally {
		...
		__wbg_measure_84362959e621a2c1: function () {
			return handleError(function (n, a, l, _) {
				...
				try {
					...
					(wasm.__wbindgen_export4(o, s, 1),
						wasm.__wbindgen_export4(j, S, 1));
				}
			}, arguments);
		},
		__wbg_media_91e147d0112e864c: function (n, a) {
			const l = getObject(a).media,
				_ = passStringToWasm0(
					l,
					wasm.__wbindgen_export,
					wasm.__wbindgen_export2,
			...
			try {
				var l = { a: n, b: a },
					_ = (s, j) => {
						...
						l.a = 0;
						try {
							return __wasm_bindgen_func_elem_194003(
								S,
								l.b,
								s,
								j,
		...
		__wbg_pointerType_02525bef1df5f79c: function (n, a) {
			const l = getObject(a).pointerType,
				_ = passStringToWasm0(
					l,
					wasm.__wbindgen_export,
					wasm.__wbindgen_export2,
		...
		__wbg_removeProperty_5b3523637b608633: function () {
			return handleError(function (n, a, l, _) {
				const o = getObject(a).removeProperty(getStringFromWasm0(l, _)),
					s = passStringToWasm0(
						o,
						wasm.__wbindgen_export,
						wasm.__wbindgen_export2,
		...
		__wbg_set_option_congestion_control_4478d1afecc84e6f: function (n, a) {
			getObject(n).congestionControl =
				__wbindgen_enum_WebTransportCongestionControl[a];
		},
		...
		__wbg_set_option_server_certificate_hashes_ca5163033476c253: function (
			...
			let _;
			(a !== 0 &&
				((_ = getArrayJsValueFromWasm0(a, l).slice()),
				wasm.__wbindgen_export4(a, l * 4, 4)),
		...
		__wbg_set_power_preference_a4ce891b22ea2b05: function (n, a) {
			getObject(n).powerPreference =
				__wbindgen_enum_GpuPowerPreference[a];
		},
		...
		__wbg_set_view_dimension_49cfda500f1dea55: function (n, a) {
			getObject(n).viewDimension =
				__wbindgen_enum_GpuTextureViewDimension[a];
		},
		...
		__wbg_transaction_3223f7c8d0f40129: function () {
			return handleError(function (n, a, l) {
				const _ = getObject(n).transaction(
					getObject(a),
					__wbindgen_enum_IdbTransactionMode[l],
				);
				return addHeapObject(_);
			}, arguments);
		},
		...
		__wbindgen_cast_0000000000000001: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_13680,
				__wasm_bindgen_func_elem_13699,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000002: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_13680,
				__wasm_bindgen_func_elem_13699_1,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000003: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_13680,
				__wasm_bindgen_func_elem_13699_2,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000004: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_128212,
				__wasm_bindgen_func_elem_128217,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000005: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_14616,
				__wasm_bindgen_func_elem_14638,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000006: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_14616,
				__wasm_bindgen_func_elem_14640,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000007: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_14920,
				__wasm_bindgen_func_elem_14922,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000008: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_165380,
				__wasm_bindgen_func_elem_165405,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000009: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_179956,
				__wasm_bindgen_func_elem_179959,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000a: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_190420,
				__wasm_bindgen_func_elem_190422,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000b: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_190420,
				__wasm_bindgen_func_elem_190424,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000c: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000d: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63462,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000e: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_13,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000000f: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_14,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000010: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_15,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000011: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_16,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000012: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_17,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000013: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_18,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000014: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63458_19,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000015: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63457,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000016: function (n, a) {
			const l = makeMutClosure(
				...
				a,
				wasm.__wasm_bindgen_func_elem_63453,
				__wasm_bindgen_func_elem_63470,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000017: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_9374,
				__wasm_bindgen_func_elem_9378,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000018: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_9411,
				__wasm_bindgen_func_elem_9414,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_0000000000000019: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_12525,
				__wasm_bindgen_func_elem_12527,
			);
			return addHeapObject(l);
		},
		__wbindgen_cast_000000000000001a: function (n, a) {
			const l = makeMutClosure(
				n,
				a,
				wasm.__wasm_bindgen_func_elem_117734,
				__wasm_bindgen_func_elem_117743,
			);
			return addHeapObject(l);
		},
...
const lAudioContext =
	typeof AudioContext < 'u'
		...
		: typeof webkitAudioContext < 'u'
			? webkitAudioContext
			: void 0;
function __wasm_bindgen_func_elem_14922(n, a) {
	wasm.__wasm_bindgen_func_elem_14922(n, a);
}
function __wasm_bindgen_func_elem_179959(n, a) {
	wasm.__wasm_bindgen_func_elem_179959(n, a);
}
function __wasm_bindgen_func_elem_63470(n, a) {
	wasm.__wasm_bindgen_func_elem_63470(n, a);
}
function __wasm_bindgen_func_elem_117743(n, a) {
	wasm.__wasm_bindgen_func_elem_117743(n, a);
}
function __wasm_bindgen_func_elem_13699(n, a, l) {
	wasm.__wasm_bindgen_func_elem_13699(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_13699_1(n, a, l) {
	wasm.__wasm_bindgen_func_elem_13699_1(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_13699_2(n, a, l) {
	wasm.__wasm_bindgen_func_elem_13699_2(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_128217(n, a, l) {
	wasm.__wasm_bindgen_func_elem_128217(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_14638(n, a, l) {
	wasm.__wasm_bindgen_func_elem_14638(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_165405(n, a, l) {
	wasm.__wasm_bindgen_func_elem_165405(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_190424(n, a, l) {
	wasm.__wasm_bindgen_func_elem_190424(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_13(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_13(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_14(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_14(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_15(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_15(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_16(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_16(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_17(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_17(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_18(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_18(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63458_19(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63458_19(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_63457(n, a, l) {
	wasm.__wasm_bindgen_func_elem_63457(
		n,
		a,
		isLikeNone(l) ? 0 : addHeapObject(l),
	);
}
function __wasm_bindgen_func_elem_9378(n, a, l) {
	wasm.__wasm_bindgen_func_elem_9378(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_9414(n, a, l) {
	wasm.__wasm_bindgen_func_elem_9414(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_12527(n, a, l) {
	wasm.__wasm_bindgen_func_elem_12527(n, a, addHeapObject(l));
}
function __wasm_bindgen_func_elem_14640(n, a, l) {
	try {
		const s = wasm.__wbindgen_add_to_stack_pointer(-16);
		wasm.__wasm_bindgen_func_elem_14640(s, n, a, addHeapObject(l));
		var _ = getDataViewMemory0().getInt32(s + 0, true),
			o = getDataViewMemory0().getInt32(s + 4, true);
...
function __wasm_bindgen_func_elem_190422(n, a, l) {
	try {
		const s = wasm.__wbindgen_add_to_stack_pointer(-16);
		wasm.__wasm_bindgen_func_elem_190422(s, n, a, addHeapObject(l));
		var _ = getDataViewMemory0().getInt32(s + 0, true),
			o = getDataViewMemory0().getInt32(s + 4, true);
		if (o) throw takeObject(_);
	} finally {
...
function __wasm_bindgen_func_elem_63462(n, a, l, _) {
	wasm.__wasm_bindgen_func_elem_63462(
		n,
		a,
		addHeapObject(l),
		addHeapObject(_),
...
function __wasm_bindgen_func_elem_194003(n, a, l, _) {
	wasm.__wasm_bindgen_func_elem_194003(
		n,
		a,
		addHeapObject(l),
		addHeapObject(_),
...
const __wbindgen_enum_BinaryType = ['blob', 'arraybuffer'],
	...
	__wbindgen_enum_IdbTransactionMode = [
		'readonly',
		'readwrite',
		'versionchange',
		'readwriteflush',
...
function makeMutClosure(n, a, l, _) {
	...
	return (
		...
		CLOSURE_DTORS.register(s, o, o),
		s
	);
}
function passStringToWasm0(n, a, l) {
	if (l === void 0) {
		const S = cachedTextEncoder.encode(n),
			v = a(S.length, 1) >>> 0;
		return (
			getUint8ArrayMemory0()
				.subarray(v, v + S.length)
				.set(S),
	...
	if (j !== _) {
		...
		const S = getUint8ArrayMemory0().subarray(o + j, o + _),
			v = cachedTextEncoder.encodeInto(n, S);
...
function decodeText(n, a) {
	return (
		...
		numBytesDecoded >= MAX_SAFARI_DECODE_BYTES &&
			...
			(numBytesDecoded = a)),
		cachedTextDecoder.decode(getUint8ArrayMemory0().slice(n, n + a))
	);
}
const cachedTextEncoder = typeof TextEncoder < 'u' ? new TextEncoder() : void 0;
cachedTextEncoder &&
	(cachedTextEncoder.encodeInto = function (n, a) {
...
function initSync(n, a) {
	...
	n !== void 0 &&
		(Object.getPrototypeOf(n) === Object.prototype
			? ({ module: n, memory: a, thread_stack_size: l } = n)
			: console.warn(
...
async function __wbg_init(n, a) {
	...
	(n !== void 0 &&
		(Object.getPrototypeOf(n) === Object.prototype
			? ({ module_or_path: n, memory: a, thread_stack_size: l } = n)
			: console.warn(
...
function GlassPanel({ children: n, className: a = '' }) {
	return jsxRuntimeExports.jsx('div', {
		className: `bg-glass backdrop-blur-[4px] rounded-glass border border-glass-border shadow-glass pointer-events-auto ${a}`,
		children: n,
	});
}
function HUD() {
...
function worldToScreen(n, a, l, _) {
	const o = [n[0] - a[0], n[1] - a[1], n[2] - a[2]],
		s = VIEWPORT_HEIGHT / 2,
		j = l / _,
		S = s * j,
		v = dot(o, AXES.right) / S,
		O = dot(o, AXES.up) / s;
		...
		reactExports.useEffect(() => {
			const l = setInterval(() => {
				try {
					...
					(o.kind === 'flower' &&
						o.sub_kind &&
						(H = FLOWER_NAMES[o.sub_kind] ?? H),
						o.kind === 'rock' &&
							o.sub_kind &&
							(H = ROCK_NAMES[o.sub_kind] ?? H),
						o.kind === 'mushroom' &&
							o.sub_kind &&
							(H = MUSHROOM_NAMES[o.sub_kind] ?? H),
						a({ name: H, screenX: O.x, screenY: O.y }));
				} catch {
					a(null);
				}
			}, 50);
...
async function fetchSignInState() {
	...
	try {
		const a = (
			await __vitePreload(
				() => Promise.resolve().then(() => isometric_game),
				void 0,
			)
		).get_signin_state_json;
...
function UsernameModal() {
	const [n, a] = reactExports.useState(null),
		[l, _] = reactExports.useState(''),
		[o, s] = reactExports.useState(null),
		[j, S] = reactExports.useState(false);
	reactExports.useEffect(() => {
		let O = false;
		const H = async () => {
	...
	return !n || !n.jwt_valid || n.username
		? null
		: jsxRuntimeExports.jsx('div', {
				className:
					'fixed inset-0 z-[200] flex items-center justify-center bg-black/70 pointer-events-auto',
				children: jsxRuntimeExports.jsxs(GlassPanel, {
					className: 'px-6 py-5 max-w-sm w-[92%] flex flex-col gap-3',
					children: [
						jsxRuntimeExports.jsx('h2', {
							className: 'text-base font-semibold',
							children: 'Choose your KBVE username',
						}),
						jsxRuntimeExports.jsx('p', {
							className: 'text-xs text-text-muted',
							children:
								'This is the name other players will see in chat and on the leaderboards. 3\u201320 characters, letters / numbers / underscore.',
						}),
						jsxRuntimeExports.jsxs('form', {
							...
							children: [
								jsxRuntimeExports.jsx('input', {
									...
									className:
										'bg-black/40 border border-glass-border rounded-glass px-3 py-2 text-sm outline-none focus:border-accent',
									disabled: j,
								}),
								o &&
									jsxRuntimeExports.jsx('div', {
								...
								jsxRuntimeExports.jsx('button', {
									...
									disabled: j || !l.trim(),
									className:
										'bg-accent/80 hover:bg-accent disabled:opacity-50 text-white text-sm font-medium rounded-glass px-4 py-2 transition',
									children: j
										? 'Submitting\u2026'
										: 'Set username',
								}),
	...
	reactExports.useEffect(() => {
		...
		const _ = setInterval(() => {
			...
			o = setInterval(() => {
				...
				s &&
					xzDistance(s, a.current) > MODAL_CLOSE_DISTANCE &&
					gameEvents.emit('modal:close');
			}, 250);
		return () => {
	...
	return (
		...
		jsxRuntimeExports.jsxs('div', {
			...
			children: [
				...
				jsxRuntimeExports.jsx(UsernameModal, {}),
			],
		})
	);
}
...
async function bootstrap() {
	...
	const o = await _(),
		s = window.__KBVE_SESSION_PROBE__,
		j = s ? await s : null;
	if (j && typeof l.set_signed_in == 'function')
		try {
			l.set_signed_in(j);
		} catch (S) {
	...
	if (typeof SharedArrayBuffer < 'u' && 'worker_entry_point' in o) {
		...
		const v = new URL(
			...
			O = o.memory,
			H = new URL('/isometric/assets/isometric_game.js', import.meta.url)
				.href;
		try {
			const R = await WebAssembly.compileStreaming(fetch(v)),
				Q = '/isometric/';
			for (let ve = 0; ve < S; ve++)
				new Worker(`${Q}wasm-worker.js`, {
					type: 'module',
				}).postMessage({ module: R, memory: O, bindgenUrl: H });
