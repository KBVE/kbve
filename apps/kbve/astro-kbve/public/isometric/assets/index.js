...
const scriptRel = "modulepreload", assetsURL = function(a) {
  ...
  if (i && i.length > 0) {
    let y = function(p) {
      return Promise.all(p.map((z) => Promise.resolve(z).then((R) => ({ status: "fulfilled", value: R }), (R) => ({ status: "rejected", reason: R }))));
    };
    ...
    _ = y(i.map((p) => {
      ...
      seen[p] = true;
      const z = p.endsWith(".css"), R = z ? '[rel="stylesheet"]' : "";
...
function requireReact_production() {
  ...
  function A(m, D, H, U, V) {
    ...
    te = 0;
    var He = U === "" ? "." : U + ":";
    if (Ot(m)) for (var ge = 0; ge < m.length; ge++) U = m[ge], Q = He + Et(U, ge), te += A(U, D, H, Q, V);
    else if (ge = Ce(m), typeof ge == "function") for (m = ge.call(m), ge = 0; !(U = m.next()).done; ) U = U.value, Q = He + Et(U, ge++), te += A(U, D, H, Q, V);
    else if (Q === "object") {
  ...
  var ce = typeof reportError == "function" ? reportError : function(m) {
    ...
    console.error(m);
  }, re = { map: C, forEach: function(m, D, H) {
    C(m, function() {
...
function requireScheduler_production() {
  return hasRequiredScheduler_production || (hasRequiredScheduler_production = 1, (function(a) {
    ...
    var v = [], p = [], z = 1, R = null, J = 3, Ce = false, De = false, ze = false, St = false, Fe = typeof setTimeout == "function" ? setTimeout : null, Zt = typeof clearTimeout == "function" ? clearTimeout : null, Re = typeof setImmediate < "u" ? setImmediate : null;
    function at(A) {
      for (var C = i(p); C !== null; ) {
        if (C.callback === null) f(p);
        else if (C.startTime <= A) f(p), C.sortIndex = C.expirationTime, c(v, C);
        else break;
        C = i(p);
      }
    }
            ...
            try {
              t: {
                ...
                if (R !== null) C = true;
                  ...
                  var m = i(p);
                  m !== null && dt(Ot, m.startTime - A), C = false;
                }
              }
              break e;
            } finally {
    ...
    a.unstable_IdlePriority = 5, a.unstable_ImmediatePriority = 1, a.unstable_LowPriority = 4, a.unstable_NormalPriority = 3, a.unstable_Profiling = null, a.unstable_UserBlockingPriority = 2, a.unstable_cancelCallback = function(A) {
      ...
      return re = q + re, A = { id: z++, callback: C, priorityLevel: A, startTime: q, expirationTime: re, sortIndex: -1 }, q > ce ? (A.sortIndex = q, c(p, A), i(v) === null && A === i(p) && (ze ? (Zt(k), k = -1) : ze = true, dt(Ot, q - ce))) : (A.sortIndex = re, c(v, A), De || Ce || (De = true, Ue || (Ue = true, Le()))), A;
...
function requireReactDom_production() {
  ...
  function b(v, p, z) {
    ...
    return { $$typeof: _, key: R == null ? null : "" + R, children: v, containerInfo: p, implementation: z };
  }
  ...
  return reactDom_production.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = f, reactDom_production.createPortal = function(v, p) {
    ...
    if (typeof v == "string" && p && typeof p.as == "string") {
      var z = p.as, R = x(z, p.crossOrigin), J = typeof p.integrity == "string" ? p.integrity : void 0, Ce = typeof p.fetchPriority == "string" ? p.fetchPriority : void 0;
      z === "style" ? f.d.S(v, typeof p.precedence == "string" ? p.precedence : void 0, { crossOrigin: R, integrity: J, fetchPriority: Ce }) : z === "script" && f.d.X(v, { crossOrigin: R, integrity: J, fetchPriority: Ce, nonce: typeof p.nonce == "string" ? p.nonce : void 0 });
    }
    ...
    if (typeof v == "string" && typeof p == "object" && p !== null && typeof p.as == "string") {
      var z = p.as, R = x(z, p.crossOrigin);
...
function requireReactDomClient_production() {
  ...
  var dt = Array.isArray, A = c.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, C = i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, q = { pending: false, data: null, method: null, action: null }, ce = [], re = -1;
  function m(e) {
    return { current: e };
  }
  function D(e) {
...
` + u.stack;
  ...
  }, deltaZ: 0, deltaMode: 0 }), Xs = qe(Ys), Qs = R({}, wn, { newState: 0, oldState: 0 }), Zs = qe(Qs), Fs = [9, 13, 27, 32], cl = Mt && "CompositionEvent" in window, za = null;
  ...
  function Kf(e, t, n, u, l) {
    ...
    try {
      ...
      C.p = r, o !== null && s.types !== null && (o.types = s.types), A.T = o;
    }
  }
  function Ob() {
  }
  ...
  function xb(e, t, n) {
    ...
    switch (Ol(t), t.tag) {
      ...
      case 19:
        ...
        return u.tail !== null ? (e = u.tail, u.rendering = e, u.tail = e.sibling, u.renderingStartTime = We(), e.sibling = null, n = me.current, H(me, l ? n & 1 | 2 : n & 1), I && Rt(t, u.treeForkCount), e) : (_e(t), null);
      case 22:
      case 23:
  ...
  function c_(e, t, n, u, l, r, o, s, d) {
    ...
    if (t !== null) {
      ...
      if (r = t.lanes | t.childLanes, r |= sl, ss(e, n, r, o, s, d), e === fe && (Z = fe = null, W = 0), ga = t, fn = e, Xt = n, ji = r, hi = l, Wo = u, (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, Bb(pc, function() {
        ...
        u = A.T, A.T = null, l = C.p, C.p = 2, o = ee, ee |= 4;
        try {
          Eb(e, t, n);
        } finally {
          ee = o, C.p = l, A.T = u;
...
function __wbg_get_imports() {
  const import0 = { __proto__: null, __wbg_Window_1535697a053fe988: function(a) {
  ...
  }, __wbg_compressedTexSubImage3D_77a6ab77487aa211: function(a, c, i, f, _, b, y, x, v, p, z, R) {
    getObject(a).compressedTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z, R);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z, R) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z >>> 0, getObject(R));
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z, R) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z >>> 0, R);
    }, arguments);
    ...
    const f = setInterval(() => {
      try {
        ...
        for (const [v, p] of y) {
          const z = x.get(v) ?? 0;
          if (p > z) {
            const R = p - z, J = ITEM_NAMES[v] ?? v;
            gameEvents.emit("toast:show", { message: `+${R} ${J}`, severity: "loot" });
          }
        }
        i.current = y;
      } catch {
...
function GoOnlineButton() {
  ...
  const y = async () => {
    if (!(a || i)) {
      f(true);
      try {
        const v = await getSupabaseJwt(), p = window.location.hostname, R = p === "localhost" || p === "127.0.0.1" ? "ws://127.0.0.1:5000" : `wss://${p}/ws`;
        go_online(R, v);
      } catch {
        f(false);
      }
