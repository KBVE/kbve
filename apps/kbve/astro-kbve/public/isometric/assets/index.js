...
(function() {
  ...
  for (const _ of document.querySelectorAll('link[rel="modulepreload"]')) f(_);
  new MutationObserver((_) => {
    for (const b of _) if (b.type === "childList") for (const y of b.addedNodes) y.tagName === "LINK" && y.rel === "modulepreload" && f(y);
  }).observe(document, { childList: true, subtree: true });
  function i(_) {
    const b = {};
    return _.integrity && (b.integrity = _.integrity), _.referrerPolicy && (b.referrerPolicy = _.referrerPolicy), _.crossOrigin === "use-credentials" ? b.credentials = "include" : _.crossOrigin === "anonymous" ? b.credentials = "omit" : b.credentials = "same-origin", b;
  }
  function f(_) {
    if (_.ep) return;
    _.ep = true;
...
const scriptRel = "modulepreload", assetsURL = function(a) {
  return "/isometric/" + a;
}, seen = {}, __vitePreload = function(c, i, f) {
  let _ = Promise.resolve();
  if (i && i.length > 0) {
    let y = function(p) {
      return Promise.all(p.map((C) => Promise.resolve(C).then((R) => ({ status: "fulfilled", value: R }), (R) => ({ status: "rejected", reason: R }))));
    };
    document.getElementsByTagName("link");
    const x = document.querySelector("meta[property=csp-nonce]"), v = (x == null ? void 0 : x.nonce) || (x == null ? void 0 : x.getAttribute("nonce"));
    _ = y(i.map((p) => {
      if (p = assetsURL(p), p in seen) return;
      seen[p] = true;
      const C = p.endsWith(".css"), R = C ? '[rel="stylesheet"]' : "";
      if (document.querySelector(`link[href="${p}"]${R}`)) return;
      const Q = document.createElement("link");
      if (Q.rel = C ? "stylesheet" : scriptRel, C || (Q.as = "script"), Q.crossOrigin = "", Q.href = p, v && Q.setAttribute("nonce", v), document.head.appendChild(Q), C) return new Promise((Ce, De) => {
        Q.addEventListener("load", Ce), Q.addEventListener("error", () => De(new Error(`Unable to preload CSS for ${p}`)));
      });
    }));
  }
  function b(y) {
    const x = new Event("vite:preloadError", { cancelable: true });
    if (x.payload = y, window.dispatchEvent(x), !x.defaultPrevented) throw y;
  }
  return _.then((y) => {
...
function requireReactJsxRuntime_production() {
  ...
  function i(f, _, b) {
    var y = null;
    if (b !== void 0 && (y = "" + b), _.key !== void 0 && (y = "" + _.key), "key" in _) {
      b = {};
      for (var x in _) x !== "key" && (b[x] = _[x]);
    } else b = _;
    return _ = b.ref, { $$typeof: a, type: f, key: y, ref: _ !== void 0 ? _ : null, props: b };
  }
  return reactJsxRuntime_production.Fragment = c, reactJsxRuntime_production.jsx = i, reactJsxRuntime_production.jsxs = i, reactJsxRuntime_production;
}
...
function requireReact_production() {
  ...
  var a = Symbol.for("react.transitional.element"), c = Symbol.for("react.portal"), i = Symbol.for("react.fragment"), f = Symbol.for("react.strict_mode"), _ = Symbol.for("react.profiler"), b = Symbol.for("react.consumer"), y = Symbol.for("react.context"), x = Symbol.for("react.forward_ref"), v = Symbol.for("react.suspense"), p = Symbol.for("react.memo"), C = Symbol.for("react.lazy"), R = Symbol.for("react.activity"), Q = Symbol.iterator;
  function Ce(m) {
  ...
  function We(m, D, H) {
    this.props = m, this.context = D, this.refs = St, this.updater = H || De;
  }
  ...
  at.constructor = Re, ze(at, We.prototype), at.isPureReactComponent = true;
  ...
  function yt(m, D, H) {
    var U = H.ref;
    return { $$typeof: a, type: m, key: D, ref: U !== void 0 ? U : null, props: H };
  }
  function Ln(m, D) {
      ...
      case "object":
        switch (m.$$typeof) {
          ...
          case c:
            ...
            break;
          case C:
            return te = m._init, A(te(m._payload), D, H, U, V);
        }
    }
    if (te) return V = V(m), te = U === "" ? "." + Et(m, 0) : U, Ot(V) ? (H = "", te != null && (H = te.replace(On, "$&/") + "/"), A(V, D, H, "", function(va) {
      return va;
    })) : V != null && (jt(V) && (V = Ln(V, H + (V.key == null || m && m.key === V.key ? "" : ("" + V.key).replace(On, "$&/") + "/") + te)), D.push(V)), 1;
    te = 0;
    var He = U === "" ? "." : U + ":";
    if (Ot(m)) for (var ge = 0; ge < m.length; ge++) U = m[ge], Z = He + Et(U, ge), te += A(U, D, H, Z, V);
    else if (ge = Ce(m), typeof ge == "function") for (m = ge.call(m), ge = 0; !(U = m.next()).done; ) U = U.value, Z = He + Et(U, ge++), te += A(U, D, H, Z, V);
    else if (Z === "object") {
  ...
  var ce = typeof reportError == "function" ? reportError : function(m) {
    ...
    console.error(m);
  }, re = { map: z, forEach: function(m, D, H) {
    z(m, function() {
    ...
    return z(m, function(D) {
      return D;
    }) || [];
  }, only: function(m) {
    if (!jt(m)) throw Error("React.Children.only expected to receive a single React element child.");
    return m;
  } };
  return react_production.Activity = R, react_production.Children = re, react_production.Component = We, react_production.Fragment = i, react_production.Profiler = _, react_production.PureComponent = Re, react_production.StrictMode = f, react_production.Suspense = v, react_production.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = k, react_production.__COMPILER_RUNTIME = { __proto__: null, c: function(m) {
    ...
    var U = ze({}, m.props), V = m.key;
    if (D != null) for (Z in D.key !== void 0 && (V = "" + D.key), D) !Be.call(D, Z) || Z === "key" || Z === "__self" || Z === "__source" || Z === "ref" && D.ref === void 0 || (U[Z] = D[Z]);
    var Z = arguments.length - 2;
    if (Z === 1) U.children = H;
    else if (1 < Z) {
      for (var te = Array(Z), He = 0; He < Z; He++) te[He] = arguments[He + 2];
      U.children = te;
    }
    return yt(m.type, V, U);
  }, react_production.createContext = function(m) {
    return m = { $$typeof: y, _currentValue: m, _currentValue2: m, _threadCount: 0, Provider: null, Consumer: null }, m.Provider = m, m.Consumer = { $$typeof: b, _context: m }, m;
  }, react_production.createElement = function(m, D, H) {
    var U, V = {}, Z = null;
    if (D != null) for (U in D.key !== void 0 && (Z = "" + D.key), D) Be.call(D, U) && U !== "key" && U !== "__self" && U !== "__source" && (V[U] = D[U]);
    var te = arguments.length - 2;
    if (te === 1) V.children = H;
    else if (1 < te) {
      for (var He = Array(te), ge = 0; ge < te; ge++) He[ge] = arguments[ge + 2];
      V.children = He;
    }
  ...
  }, react_production.isValidElement = jt, react_production.lazy = function(m) {
    return { $$typeof: C, _payload: { _status: -1, _result: m }, _init: q };
    ...
    try {
      var U = m(), V = k.S;
      V !== null && V(H, U), typeof U == "object" && U !== null && typeof U.then == "function" && U.then(Ue, ce);
    } catch (Z) {
      ce(Z);
    } finally {
      D !== null && H.types !== null && (D.types = H.types), k.T = D;
    }
...
function requireScheduler_production() {
  return hasRequiredScheduler_production || (hasRequiredScheduler_production = 1, (function(a) {
    function c(A, z) {
      var q = A.length;
      A.push(z);
      e: for (; 0 < q; ) {
        var ce = q - 1 >>> 1, re = A[ce];
        if (0 < _(re, z)) A[ce] = z, A[q] = re, q = ce;
        else break e;
      }
    }
    function i(A) {
    ...
    function f(A) {
      ...
      if (q !== z) {
        A[0] = q;
        e: for (var ce = 0, re = A.length, m = re >>> 1; ce < m; ) {
          var D = 2 * (ce + 1) - 1, H = A[D], U = D + 1, V = A[U];
          if (0 > _(H, q)) U < re && 0 > _(V, H) ? (A[ce] = V, A[U] = q, ce = U) : (A[ce] = H, A[D] = q, ce = D);
          else if (U < re && 0 > _(V, q)) A[ce] = V, A[U] = q, ce = U;
          else break e;
        }
      }
      return z;
    ...
    var v = [], p = [], C = 1, R = null, Q = 3, Ce = false, De = false, ze = false, St = false, We = typeof setTimeout == "function" ? setTimeout : null, Zt = typeof clearTimeout == "function" ? clearTimeout : null, Re = typeof setImmediate < "u" ? setImmediate : null;
    function at(A) {
      for (var z = i(p); z !== null; ) {
        if (z.callback === null) f(p);
        else if (z.startTime <= A) f(p), z.sortIndex = z.expirationTime, c(v, z);
        else break;
        z = i(p);
      }
    }
    function Ot(A) {
      if (ze = false, at(A), !De) if (i(v) !== null) De = true, Ue || (Ue = true, Le());
      else {
        var z = i(p);
        z !== null && dt(Ot, z.startTime - A);
      }
    }
    var Ue = false, k = -1, Be = 5, yt = -1;
    function Ln() {
    ...
    function jt() {
      if (St = false, Ue) {
        ...
        try {
          e: {
            De = false, ze && (ze = false, Zt(k), k = -1), Ce = true;
            var q = Q;
            try {
              t: {
                for (at(A), R = i(v); R !== null && !(R.expirationTime > A && Ln()); ) {
                  var ce = R.callback;
                  if (typeof ce == "function") {
                    R.callback = null, Q = R.priorityLevel;
                    var re = ce(R.expirationTime <= A);
                    if (A = a.unstable_now(), typeof re == "function") {
                      R.callback = re, at(A), z = true;
                      break t;
                    }
                    R === i(v) && f(v), at(A);
                  } else f(v);
                ...
                if (R !== null) z = true;
                  ...
                  var m = i(p);
                  m !== null && dt(Ot, m.startTime - A), z = false;
                }
              }
              break e;
            } finally {
    ...
    if (typeof Re == "function") Le = function() {
      ...
      var On = new MessageChannel(), Et = On.port2;
      On.port1.onmessage = jt, Le = function() {
        Et.postMessage(null);
      };
    } else Le = function() {
      We(jt, 0);
    ...
    a.unstable_IdlePriority = 5, a.unstable_ImmediatePriority = 1, a.unstable_LowPriority = 4, a.unstable_NormalPriority = 3, a.unstable_Profiling = null, a.unstable_UserBlockingPriority = 2, a.unstable_cancelCallback = function(A) {
      ...
      St = true;
    }, a.unstable_runWithPriority = function(A, z) {
      switch (A) {
        case 1:
        case 2:
        case 3:
    ...
    }, a.unstable_scheduleCallback = function(A, z, q) {
      var ce = a.unstable_now();
      switch (typeof q == "object" && q !== null ? (q = q.delay, q = typeof q == "number" && 0 < q ? ce + q : ce) : q = ce, A) {
        case 1:
          var re = -1;
          break;
        case 2:
      ...
      return re = q + re, A = { id: C++, callback: z, priorityLevel: A, startTime: q, expirationTime: re, sortIndex: -1 }, q > ce ? (A.sortIndex = q, c(p, A), i(v) === null && A === i(p) && (ze ? (Zt(k), k = -1) : ze = true, dt(Ot, q - ce))) : (A.sortIndex = re, c(v, A), De || Ce || (De = true, Ue || (Ue = true, Le()))), A;
    }, a.unstable_shouldYield = Ln, a.unstable_wrapCallback = function(A) {
      var z = Q;
      return function() {
        var q = Q;
        Q = z;
...
function requireReactDom_production() {
  ...
  function c(v) {
    ...
    if (1 < arguments.length) {
      ...
      for (var C = 2; C < arguments.length; C++) p += "&args[]=" + encodeURIComponent(arguments[C]);
    }
  ...
  var f = { d: { f: i, r: function() {
    throw Error(c(522));
  }, D: i, C: i, L: i, m: i, X: i, S: i, M: i }, p: 0, findDOMNode: null }, _ = Symbol.for("react.portal");
  function b(v, p, C) {
    var R = 3 < arguments.length && arguments[3] !== void 0 ? arguments[3] : null;
    return { $$typeof: _, key: R == null ? null : "" + R, children: v, containerInfo: p, implementation: C };
  }
  ...
  return reactDom_production.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = f, reactDom_production.createPortal = function(v, p) {
...
function requireReactDom() {
  ...
  return a(), reactDom.exports = requireReactDom_production(), reactDom.exports;
}
/**
* @license React
...
function requireReactDomClient_production() {
  ...
  var a = requireScheduler(), c = requireReact(), i = requireReactDom();
  function f(e) {
  ...
  var R = Object.assign, Q = Symbol.for("react.element"), Ce = Symbol.for("react.transitional.element"), De = Symbol.for("react.portal"), ze = Symbol.for("react.fragment"), St = Symbol.for("react.strict_mode"), We = Symbol.for("react.profiler"), Zt = Symbol.for("react.consumer"), Re = Symbol.for("react.context"), at = Symbol.for("react.forward_ref"), Ot = Symbol.for("react.suspense"), Ue = Symbol.for("react.suspense_list"), k = Symbol.for("react.memo"), Be = Symbol.for("react.lazy"), yt = Symbol.for("react.activity"), Ln = Symbol.for("react.memo_cache_sentinel"), jt = Symbol.iterator;
  function Le(e) {
  ...
  function Et(e) {
    ...
    if (typeof e == "function") return e.$$typeof === On ? null : e.displayName || e.name || null;
  ...
  var dt = Array.isArray, A = c.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, z = i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, q = { pending: false, data: null, method: null, action: null }, ce = [], re = -1;
  function m(e) {
    return { current: e };
  }
  function D(e) {
  ...
  var U = m(null), V = m(null), Z = m(null), te = m(null);
  function He(e, t) {
    switch (H(Z, t), H(V, e), H(U, null), t.nodeType) {
      ...
      case 11:
        ...
        break;
      default:
        if (e = t.tagName, t = t.namespaceURI) t = x_(t), e = S_(t, e);
        else switch (e) {
          case "svg":
            e = 1;
            break;
  ...
  function va(e) {
    ...
    var t = U.current, n = S_(t, e.type);
    t !== n && (H(V, e), H(U, n));
  }
  function mc(e) {
    V.current === e && (D(U), D(V)), te.current === e && (D(te), sc._currentValue = q);
  }
  var Hu, $i;
  function yn(e) {
    if (Hu === void 0) try {
    ...
    try {
      var u = { DetermineComponentFrameRoot: function() {
        try {
          ...
          if (S && w && typeof S.stack == "string") return [S.stack, w.stack];
        }
        return [null, null];
      } };
      ...
      var r = u.DetermineComponentFrameRoot(), o = r[0], s = r[1];
      if (o && s) {
        var d = o.split(`
`), h = s.split(`
`);
        ...
        if (u === d.length || l === h.length) for (u = d.length - 1, l = h.length - 1; 1 <= u && 0 <= l && d[u] !== h[l]; ) l--;
        for (; 1 <= u && 0 <= l; u--, l--) if (d[u] !== h[l]) {
          if (u !== 1 || l !== 1) do
            if (u--, l--, 0 > l || d[u] !== h[l]) {
              var E = `
...
` + u.stack;
  ...
  function hc(e, t, n) {
    ...
    if (u === 0) return 0;
    var l = 0, r = e.suspendedLanes, o = e.pingedLanes;
    e = e.warmLanes;
    var s = u & 134217727;
    return s !== 0 ? (u = s & ~r, u !== 0 ? l = jn(u) : (o &= s, o !== 0 ? l = jn(o) : n || (n = s & ~e, n !== 0 && (l = jn(n))))) : (s = u & ~r, s !== 0 ? l = jn(s) : o !== 0 ? l = jn(o) : n || (n = u & ~e, n !== 0 && (l = jn(n)))), l === 0 ? 0 : t !== 0 && t !== l && (t & r) === 0 && (r = l & -l, n = t & -t, r >= n || r === 32 && (n & 4194048) !== 0) ? t : l;
  }
  function Sa(e, t) {
  ...
  function ss(e, t, n, u, l, r) {
    ...
    var s = e.entanglements, d = e.expirationTimes, h = e.hiddenUpdates;
    for (n = o & ~n; 0 < n; ) {
      var E = 31 - Je(n), M = 1 << E;
      s[E] = 0, d[E] = -1;
      var w = h[E];
      if (w !== null) for (h[E] = null, E = 0; E < w.length; E++) {
        var S = w[E];
        S !== null && (S.lane &= -536870913);
      }
      n &= ~M;
    }
    u !== 0 && cr(e, u, 0), r !== 0 && l === 0 && e.tag !== 0 && (e.suspendedLanes |= r & ~(o & ~t));
  }
  function cr(e, t, n) {
  ...
  function lr(e, t) {
    var n = t & -t;
    return n = (n & 42) !== 0 ? 1 : Vu(n), (n & (e.suspendedLanes | t)) !== 0 ? 0 : n;
  }
  function Vu(e) {
    switch (e) {
      case 2:
  ...
  function ir() {
    var e = z.p;
    return e !== 0 ? e : (e = window.event, e === void 0 ? 32 : K_(e.type));
  }
  function rr(e, t) {
    var n = z.p;
    try {
  ...
  var Ft = Math.random().toString(36).slice(2), Se = "__reactFiber$" + Ft, Ge = "__reactProps$" + Ft, Gn = "__reactContainer$" + Ft, Xu = "__reactEvents$" + Ft, bs = "__reactListeners$" + Ft, ds = "__reactHandles$" + Ft, fr = "__reactResources$" + Ft, Aa = "__reactMarker$" + Ft;
  function Qu(e) {
  ...
  function qn(e) {
    ...
    for (var n = e.parentNode; n; ) {
      if (t = n[Gn] || n[Se]) {
        if (n = t.alternate, t.child !== null || n !== null && n.child !== null) for (e = C_(e); e !== null; ) {
          if (n = e[Se]) return n;
          e = C_(e);
        }
        return t;
  ...
  function Yn(e) {
    var t = e[fr];
    return t || (t = e[fr] = { hoistableStyles: /* @__PURE__ */ new Map(), hoistableScripts: /* @__PURE__ */ new Map() }), t;
  }
  function ve(e) {
    e[Aa] = true;
  }
  ...
  var gs = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), sr = {}, br = {};
  function ms(e) {
    return Bu.call(br, e) ? true : Bu.call(sr, e) ? false : gs.test(e) ? br[e] = true : (sr[e] = true, false);
  }
  function wc(e, t, n) {
    if (ms(t)) if (n === null) e.removeAttribute(t);
    else {
      switch (typeof n) {
        case "undefined":
        case "function":
  ...
  function gr(e) {
    ...
    if (!t) return true;
    var n = t.getValue(), u = "";
    return e && (u = dr(e) ? e.checked ? "true" : "false" : e.value), e = u, e !== n ? (t.setValue(e), true) : false;
  }
  function xc(e) {
  ...
  function Wu(e, t, n, u, l, r, o, s) {
    e.name = "", o != null && typeof o != "function" && typeof o != "symbol" && typeof o != "boolean" ? e.type = o : e.removeAttribute("type"), t != null ? o === "number" ? (t === 0 && e.value === "" || e.value != t) && (e.value = "" + ct(t)) : e.value !== "" + ct(t) && (e.value = "" + ct(t)) : o !== "submit" && o !== "reset" || e.removeAttribute("value"), t != null ? Fu(e, o, ct(t)) : n != null ? Fu(e, o, ct(n)) : u != null && e.removeAttribute("value"), l == null && r != null && (e.defaultChecked = !!r), l != null && (e.checked = l && typeof l != "function" && typeof l != "symbol"), s != null && typeof s != "function" && typeof s != "symbol" && typeof s != "boolean" ? e.name = "" + ct(s) : e.removeAttribute("name");
  }
  function mr(e, t, n, u, l, r, o, s) {
    if (r != null && typeof r != "function" && typeof r != "symbol" && typeof r != "boolean" && (e.type = r), t != null || n != null) {
      ...
      n = n != null ? "" + ct(n) : "", t = t != null ? "" + ct(t) : n, s || t === e.value || (e.value = t), e.defaultValue = t;
    }
    u = u ?? l, u = typeof u != "function" && typeof u != "symbol" && !!u, e.checked = s ? e.checked : !!u, e.defaultChecked = !!u, o != null && typeof o != "function" && typeof o != "symbol" && typeof o != "boolean" && (e.name = o), Zu(e);
  }
  function Fu(e, t, n) {
    t === "number" && xc(e.ownerDocument) === e || e.defaultValue === "" + n || (e.defaultValue = "" + n);
  }
  function Qn(e, t, n, u) {
    if (e = e.options, t) {
      t = {};
      for (var l = 0; l < n.length; l++) t["$" + n[l]] = true;
      for (n = 0; n < e.length; n++) l = t.hasOwnProperty("$" + e[n].value), e[n].selected !== l && (e[n].selected = l), l && u && (e[n].defaultSelected = true);
    } else {
  ...
  function Or(e, t, n, u) {
    ...
    n = ct(t), e.defaultValue = n, u = e.textContent, u === n && u !== "" && u !== null && (e.value = u), Zu(e);
  }
  function Zn(e, t) {
    if (t) {
      var n = e.firstChild;
  ...
  function yr(e, t, n) {
    var u = t.indexOf("--") === 0;
    n == null || typeof n == "boolean" || n === "" ? u ? e.setProperty(t, "") : t === "float" ? e.cssFloat = "" : e[t] = "" : u ? e.setProperty(t, n) : typeof n != "number" || n === 0 || ys.has(t) ? t === "float" ? e.cssFloat = n : e[t] = ("" + n).trim() : e[t] = n + "px";
  }
  function jr(e, t, n) {
    if (t != null && typeof t != "object") throw Error(f(62));
    if (e = e.style, n != null) {
      for (var u in n) !n.hasOwnProperty(u) || t != null && t.hasOwnProperty(u) || (u.indexOf("--") === 0 ? e.setProperty(u, "") : u === "float" ? e.cssFloat = "" : e[u] = "");
      for (var l in t) u = t[l], t.hasOwnProperty(l) && n[l] !== u && yr(e, l, u);
  ...
  function hr(e) {
    ...
    if (t && (e = t.stateNode)) {
      ...
      e: switch (e = t.stateNode, t.type) {
        case "input":
          if (Wu(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name), t = n.name, n.type === "radio" && t != null) {
            ...
            for (n = n.querySelectorAll('input[name="' + ut("" + t) + '"][type="radio"]'), t = 0; t < n.length; t++) {
              ...
              if (u !== e && u.form === e.form) {
                ...
                Wu(u, l.value, l.defaultValue, l.defaultValue, l.checked, l.defaultChecked, l.type, l.name);
              }
            }
            for (t = 0; t < n.length; t++) u = n[t], u.form === e.form && gr(u);
          }
          break e;
        case "textarea":
  ...
  function wr(e, t, n) {
    ...
    try {
      ...
      if (Iu = false, (Wn !== null || Fn !== null) && (su(), Wn && (t = Wn, e = Fn, Fn = Wn = null, hr(t), e))) for (t = 0; t < e.length; t++) hr(e[t]);
    }
  }
  function Ma(e, t) {
    var n = e.stateNode;
  ...
  function vr() {
    if (Ec) return Ec;
    var e, t = Pu, n = t.length, u, l = "value" in Kt ? Kt.value : Kt.textContent, r = l.length;
  ...
  function qe(e) {
    function t(n, u, l, r, o) {
      this._reactName = n, this._targetInst = l, this.type = u, this.nativeEvent = r, this.target = o, this.currentTarget = null;
      for (var s in e) e.hasOwnProperty(s) && (n = e[s], this[s] = n ? n(r) : r[s]);
    ...
    return R(t.prototype, { preventDefault: function() {
      ...
      n && (n.preventDefault ? n.preventDefault() : typeof n.returnValue != "unknown" && (n.returnValue = false), this.isDefaultPrevented = Tc);
    }, stopPropagation: function() {
      var n = this.nativeEvent;
      n && (n.stopPropagation ? n.stopPropagation() : typeof n.cancelBubble != "unknown" && (n.cancelBubble = true), this.isPropagationStopped = Tc);
    }, persist: function() {
    }, isPersistent: Tc }), t;
  }
  var wn = { eventPhase: 0, bubbles: 0, cancelable: 0, timeStamp: function(e) {
    return e.timeStamp || Date.now();
  }, defaultPrevented: 0, isTrusted: 0 }, Mc = qe(wn), Ra = R({}, wn, { view: 0, detail: 0 }), ws = qe(Ra), el, tl, Ca, Dc = R({}, Ra, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: al, button: 0, buttons: 0, relatedTarget: function(e) {
  ...
  } }), Sr = qe(Dc), vs = R({}, Dc, { dataTransfer: 0 }), xs = qe(vs), Ss = R({}, Ra, { relatedTarget: 0 }), nl = qe(Ss), Es = R({}, wn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), As = qe(Es), Ts = R({}, wn, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), Ms = qe(Ts), Ds = R({}, wn, { data: 0 }), Er = qe(Ds), Rs = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" }, Cs = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Delete", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" }, zs = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };
  function Hs(e) {
    var t = this.nativeEvent;
    return t.getModifierState ? t.getModifierState(e) : (e = zs[e]) ? !!t[e] : false;
  }
  function al() {
    return Hs;
  }
  var Ns = R({}, Ra, { key: function(e) {
    if (e.key) {
  ...
  } }), Us = qe(Ns), Bs = R({}, Dc, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Ar = qe(Bs), Ls = R({}, Ra, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: al }), Gs = qe(Ls), qs = R({}, wn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Vs = qe(qs), Ys = R({}, Dc, { deltaX: function(e) {
    return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
  }, deltaY: function(e) {
    return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
  }, deltaZ: 0, deltaMode: 0 }), Xs = qe(Ys), Qs = R({}, wn, { newState: 0, oldState: 0 }), Zs = qe(Qs), Ws = [9, 13, 27, 32], cl = Mt && "CompositionEvent" in window, za = null;
  Mt && "documentMode" in document && (za = document.documentMode);
  var Fs = Mt && "TextEvent" in window && !za, Tr = Mt && (!cl || za && 8 < za && 11 >= za), Mr = " ", Dr = false;
  function Rr(e, t) {
    switch (e) {
      case "keyup":
  ...
  function Js(e, t) {
    if (Kn) return e === "compositionend" || !cl && Rr(e, t) ? (e = vr(), Ec = Pu = Kt = null, Kn = false, e) : null;
    switch (e) {
      case "paste":
        return null;
      case "keypress":
  ...
  var ks = { color: true, date: true, datetime: true, "datetime-local": true, email: true, month: true, number: true, password: true, range: true, search: true, tel: true, text: true, time: true, url: true, week: true };
  function zr(e) {
    var t = e && e.nodeName && e.nodeName.toLowerCase();
    return t === "input" ? !!ks[e.type] : t === "textarea";
  }
  function Hr(e, t, n, u) {
    Wn ? Fn ? Fn.push(u) : Fn = [u] : Wn = u, t = yu(t, "onChange"), 0 < t.length && (n = new Mc("onChange", "change", null, n, u), e.push({ event: n, listeners: t }));
  }
  var Ha = null, Na = null;
  function Is(e) {
    O_(e, 0);
  ...
  if (Mt) {
    ...
    if (Mt) {
      ...
      if (!ll) {
        ...
        Br.setAttribute("oninput", "return;"), ll = typeof Br.oninput == "function";
      }
      ul = ll;
    } else ul = false;
  ...
  function $s(e, t, n) {
    e === "focusin" ? (Lr(), Ha = t, Na = n, Ha.attachEvent("onpropertychange", Gr)) : e === "focusout" && Lr();
  }
  function Ps(e) {
  ...
  function Yr(e, t) {
    return e && t ? e === t ? true : e && e.nodeType === 3 ? false : t && t.nodeType === 3 ? Yr(e, t.parentNode) : "contains" in e ? e.contains(t) : e.compareDocumentPosition ? !!(e.compareDocumentPosition(t) & 16) : false : false;
  }
  function Xr(e) {
  ...
  var ab = Mt && "documentMode" in document && 11 >= document.documentMode, Jn = null, rl = null, Ba = null, fl = false;
  function Qr(e, t, n) {
    var u = n.window === n ? n.document : n.nodeType === 9 ? n : n.ownerDocument;
    fl || Jn == null || Jn !== xc(u) || (u = Jn, "selectionStart" in u && il(u) ? u = { start: u.selectionStart, end: u.selectionEnd } : (u = (u.ownerDocument && u.ownerDocument.defaultView || window).getSelection(), u = { anchorNode: u.anchorNode, anchorOffset: u.anchorOffset, focusNode: u.focusNode, focusOffset: u.focusOffset }), Ba && Ua(Ba, u) || (Ba = u, u = yu(rl, "onSelect"), 0 < u.length && (t = new Mc("onSelect", "select", null, t, n), e.push({ event: t, listeners: u }), t.target = Jn)));
  }
  function vn(e, t) {
    var n = {};
  ...
  Mt && (Zr = document.createElement("div").style, "AnimationEvent" in window || (delete kn.animationend.animation, delete kn.animationiteration.animation, delete kn.animationstart.animation), "TransitionEvent" in window || delete kn.transitionend.transition);
  function xn(e) {
    if (ol[e]) return ol[e];
    if (!kn[e]) return e;
    var t = kn[e], n;
  ...
  function zc() {
    for (var e = In, t = sl = In = 0; t < e; ) {
      ...
      if (lt[t++] = null, u !== null && l !== null) {
        var o = u.pending;
        o === null ? l.next = l : (l.next = o.next, o.next = l), u.pending = l;
      }
      r !== 0 && Ir(n, l, r);
    }
  }
  function Hc(e, t, n, u) {
    lt[In++] = e, lt[In++] = t, lt[In++] = n, lt[In++] = u, sl |= u, e.lanes |= u, e = e.alternate, e !== null && (e.lanes |= u);
  }
  function bl(e, t, n, u) {
  ...
  function Ir(e, t, n) {
    ...
    var u = e.alternate;
    u !== null && (u.lanes |= n);
    for (var l = false, r = e.return; r !== null; ) r.childLanes |= n, u = r.alternate, u !== null && (u.childLanes |= n), r.tag === 22 && (e = r.stateNode, e === null || e._visibility & 1 || (l = true)), e = r, r = r.return;
    return e.tag === 3 ? (r = e.stateNode, l && t !== null && (l = 31 - Je(n), e = r.hiddenUpdates, u = e[l], u === null ? e[l] = [t] : u.push(t), t.lane = n | 536870912), r) : null;
  }
  function Nc(e) {
  ...
  function Uc(e, t, n, u, l, r) {
    ...
    if (u = e, typeof e == "function") dl(e) && (o = 1);
    else if (typeof e == "string") o = sd(e, n, U.current) ? 26 : e === "html" || e === "head" || e === "body" ? 27 : 5;
    else e: switch (e) {
      case yt:
        return e = Ie(31, n, t, l), e.elementType = yt, e.lanes = r, e;
      case ze:
      ...
      case St:
        ...
        break;
      case We:
        return e = Ie(12, n, t, l | 2), e.elementType = We, e.lanes = r, e;
      case Ot:
        return e = Ie(13, n, t, l), e.elementType = Ot, e.lanes = r, e;
      case Ue:
        return e = Ie(19, n, t, l), e.elementType = Ue, e.lanes = r, e;
      default:
        ...
        o = 29, n = Error(f(130, e === null ? "null" : typeof e, "")), u = null;
    }
    return t = Ie(o, n, t, l), t.elementType = e, t.type = u, t.lanes = r, t;
  }
  function En(e, t, n, u) {
  ...
  function it(e, t) {
    if (typeof e == "object" && e !== null) {
      var n = ef.get(e);
      return n !== void 0 ? n : (t = { value: e, source: t, stack: Pi(t) }, ef.set(e, t), t);
    }
    return { value: e, source: t, stack: Pi(t) };
  }
  var Pn = [], ea = 0, Bc = null, La = 0, rt = [], ft = 0, Jt = null, ht = 1, wt = "";
  function Rt(e, t) {
  ...
  function tf(e, t, n) {
    ...
    if (30 < r) {
      var o = l - l % 5;
      r = (u & (1 << o) - 1).toString(32), u >>= o, l -= o, ht = 1 << 32 - Je(t) + l | n << l | u, wt = r + e;
  ...
  function Ol(e) {
    ...
    for (; e === Jt; ) Jt = rt[--ft], rt[ft] = null, wt = rt[--ft], rt[ft] = null, ht = rt[--ft], rt[ft] = null;
  }
  function nf(e, t) {
    rt[ft++] = ht, rt[ft++] = wt, rt[ft++] = Jt, ht = t.id, wt = t.overflow, Jt = e;
  }
  var Ee = null, oe = null, I = false, kt = null, ot = false, yl = Error(f(519));
  function It(e) {
  ...
  function af(e) {
    ...
    switch (t[Se] = e, t[Ge] = u, n) {
      ...
      case "details":
        ...
        break;
      case "input":
        F("invalid", t), mr(t, u.value, u.defaultValue, u.checked, u.defaultChecked, u.type, u.name, true);
        break;
      case "select":
        F("invalid", t);
        break;
    ...
    n = u.children, typeof n != "string" && typeof n != "number" && typeof n != "bigint" || t.textContent === "" + n || u.suppressHydrationWarning === true || w_(t.textContent, n) ? (u.popover != null && (F("beforetoggle", t), F("toggle", t)), u.onScroll != null && F("scroll", t), u.onScrollEnd != null && F("scrollend", t), u.onClick != null && (t.onclick = Tt), t = true) : t = false, t || It(e, true);
  }
  function cf(e) {
  ...
  function ta(e) {
    ...
    var t = e.tag, n;
    if ((n = t !== 3 && t !== 27) && ((n = t === 5) && (n = e.type, n = !(n !== "form" && n !== "button") || Bi(e.type, e.memoizedProps)), n = !n), n && oe && It(e), cf(e), t === 13) {
      if (e = e.memoizedState, e = e !== null ? e.dehydrated : null, !e) throw Error(f(317));
      oe = R_(e);
    } else if (t === 31) {
      if (e = e.memoizedState, e = e !== null ? e.dehydrated : null, !e) throw Error(f(317));
      oe = R_(e);
    } else t === 27 ? (t = oe, sn(e.type) ? (e = Yi, Yi = null, oe = e) : oe = t) : oe = Ee ? st(e.stateNode.nextSibling) : null;
    return true;
  }
  function An() {
    oe = Ee = null, I = false;
      ...
      if (r !== null) {
        ...
        e: for (; r !== null; ) {
          ...
          for (var d = 0; d < t.length; d++) if (s.context === t[d]) {
            r.lanes |= n, s = r.alternate, s !== null && (s.lanes |= n), wl(r.return, n, e), u || (o = null);
            break e;
          }
          r = s.next;
        }
        ...
        o.lanes |= n, r = o.alternate, r !== null && (r.lanes |= n), wl(o, n, e), o = null;
      } else o = l.child;
    ...
    for (var l = t, r = false; l !== null; ) {
      ...
      if (l.tag === 10) {
        ...
        if (o = o.memoizedProps, o !== null) {
          var s = l.type;
          ke(l.pendingProps.value, o.value) || (e !== null ? e.push(s) : e = [s]);
        }
      } else if (l === te.current) {
        if (o = l.alternate, o === null) throw Error(f(387));
        o.memoizedState.memoizedState !== l.memoizedState.memoizedState && (e !== null ? e.push(sc) : e = [sc]);
      }
      l = l.return;
    }
  ...
  var rb = typeof AbortController < "u" ? AbortController : function() {
    var e = [], t = this.signal = { aborted: false, addEventListener: function(n, u) {
      e.push(u);
    } };
    this.abort = function() {
  ...
  }, fb = a.unstable_scheduleCallback, ob = a.unstable_NormalPriority, Oe = { $$typeof: Re, Consumer: null, Provider: null, _currentValue: null, _currentValue2: null, _threadCount: 0 };
  function xl() {
    return { controller: new rb(), data: /* @__PURE__ */ new Map(), refCount: 0 };
  }
  function qa(e) {
    e.refCount--, e.refCount === 0 && fb(ob, function() {
      e.controller.abort();
    });
  }
  var Va = null, Sl = 0, aa = 0, ca = null;
  function _b(e, t) {
    if (Va === null) {
      var n = Va = [];
      Sl = 0, aa = Ti(), ca = { status: "pending", value: void 0, then: function(u) {
        n.push(u);
      } };
    }
  ...
  function sb(e, t) {
    var n = [], u = { status: "pending", value: null, reason: null, then: function(l) {
      n.push(l);
    } };
    return e.then(function() {
      ...
      for (u.status = "rejected", u.reason = l, l = 0; l < n.length; l++) (0, n[l])(void 0);
    }), u;
  }
  var rf = A.S;
  A.S = function(e, t) {
    Wo = Fe(), typeof t == "object" && t !== null && typeof t.then == "function" && _b(e, t), rf !== null && rf(e, t);
  };
  var Dn = m(null);
  function El() {
    var e = Dn.current;
  ...
  var ua = Error(f(460)), Al = Error(f(474)), Vc = Error(f(542)), Yc = { then: function() {
  } };
  function of(e) {
    return e = e.status, e === "fulfilled" || e === "rejected";
  }
  function _f(e, t, n) {
    switch (n = e[n], n === void 0 ? e.push(t) : n !== t && (t.then(Tt, Tt), t = n), t.status) {
      case "fulfilled":
        return t.value;
      case "rejected":
      ...
      default:
        if (typeof t.status == "string") t.then(Tt, Tt);
          ...
          if (e = fe, e !== null && 100 < e.shellSuspendCounter) throw Error(f(482));
  ...
  function Rn(e) {
    try {
      ...
      throw n !== null && typeof n == "object" && typeof n.then == "function" ? (Cn = n, ua) : n;
    }
  }
  var Cn = null;
  function sf() {
  ...
  function Qc(e, t) {
    throw t.$$typeof === Q ? Error(f(525)) : (e = Object.prototype.toString.call(t), Error(f(31, e === "[object Object]" ? "object with keys {" + Object.keys(t).join(", ") + "}" : e)));
  }
  function df(e) {
    function t(O, g) {
      if (e) {
    ...
    function r(O, g, j) {
      return O.index = j, e ? (j = O.alternate, j !== null ? (j = j.index, j < g ? (O.flags |= 67108866, g) : j) : (O.flags |= 67108866, g)) : (O.flags |= 1048576, g);
    }
    function o(O) {
      return e && O.alternate === null && (O.flags |= 67108866), O;
    }
    function s(O, g, j, T) {
      return g === null || g.tag !== 6 ? (g = gl(j, O.mode, T), g.return = O, g) : (g = l(g, j), g.return = O, g);
    }
    function d(O, g, j, T) {
      var L = j.type;
      return L === ze ? E(O, g, j.props.children, T, j.key) : g !== null && (g.elementType === L || typeof L == "object" && L !== null && L.$$typeof === Be && Rn(L) === g.type) ? (g = l(g, j.props), Xa(g, j), g.return = O, g) : (g = Uc(j.type, j.key, j.props, null, O.mode, T), Xa(g, j), g.return = O, g);
    }
    function h(O, g, j, T) {
      return g === null || g.tag !== 4 || g.stateNode.containerInfo !== j.containerInfo || g.stateNode.implementation !== j.implementation ? (g = ml(j, O.mode, T), g.return = O, g) : (g = l(g, j.children || []), g.return = O, g);
    }
    function E(O, g, j, T, L) {
      return g === null || g.tag !== 7 ? (g = En(j, O.mode, T, L), g.return = O, g) : (g = l(g, j), g.return = O, g);
    }
    function M(O, g, j) {
      if (typeof g == "string" && g !== "" || typeof g == "number" || typeof g == "bigint") return g = gl("" + g, O.mode, j), g.return = O, g;
      if (typeof g == "object" && g !== null) {
        switch (g.$$typeof) {
          case Ce:
            return j = Uc(g.type, g.key, g.props, null, O.mode, j), Xa(j, g), j.return = O, j;
          case De:
            return g = ml(g, O.mode, j), g.return = O, g;
          case Be:
            return g = Rn(g), M(O, g, j);
        }
        if (dt(g) || Le(g)) return g = En(g, O.mode, j, null), g.return = O, g;
    ...
    function w(O, g, j, T) {
      ...
      if (typeof j == "string" && j !== "" || typeof j == "number" || typeof j == "bigint") return L !== null ? null : s(O, g, "" + j, T);
      if (typeof j == "object" && j !== null) {
        ...
        if (dt(j) || Le(j)) return L !== null ? null : E(O, g, j, T, null);
    ...
    function S(O, g, j, T, L) {
      if (typeof T == "string" && T !== "" || typeof T == "number" || typeof T == "bigint") return O = O.get(j) || null, s(g, O, "" + T, L);
      if (typeof T == "object" && T !== null) {
        switch (T.$$typeof) {
          case Ce:
            return O = O.get(T.key === null ? j : T.key) || null, d(g, O, T, L);
          case De:
            return O = O.get(T.key === null ? j : T.key) || null, h(g, O, T, L);
          case Be:
            return T = Rn(T), S(O, g, j, T, L);
        }
        if (dt(T) || Le(T)) return O = O.get(j) || null, E(g, O, T, L, null);
    ...
    function N(O, g, j, T) {
      for (var L = null, $ = null, B = g, X = g = 0, J = null; B !== null && X < j.length; X++) {
        ...
        e && B && P.alternate === null && t(O, B), g = r(P, g, X), $ === null ? L = P : $.sibling = P, $ = P, B = J;
      }
      if (X === j.length) return n(O, B), I && Rt(O, X), L;
      if (B === null) {
        for (; X < j.length; X++) B = M(O, j[X], T), B !== null && (g = r(B, g, X), $ === null ? L = B : $.sibling = B, $ = B);
        return I && Rt(O, X), L;
      }
      for (B = u(B); X < j.length; X++) J = S(B, O, X, j[X], T), J !== null && (e && J.alternate !== null && B.delete(J.key === null ? X : J.key), g = r(J, g, X), $ === null ? L = J : $.sibling = J, $ = J);
    ...
    function G(O, g, j, T) {
      ...
      for (var L = null, $ = null, B = g, X = g = 0, J = null, P = j.next(); B !== null && !P.done; X++, P = j.next()) {
        B.index > X ? (J = B, B = null) : J = B.sibling;
        ...
        e && B && pn.alternate === null && t(O, B), g = r(pn, g, X), $ === null ? L = pn : $.sibling = pn, $ = pn, B = J;
      }
      if (P.done) return n(O, B), I && Rt(O, X), L;
      if (B === null) {
        for (; !P.done; X++, P = j.next()) P = M(O, P.value, T), P !== null && (g = r(P, g, X), $ === null ? L = P : $.sibling = P, $ = P);
        return I && Rt(O, X), L;
      }
      for (B = u(B); !P.done; X++, P = j.next()) P = S(B, O, X, P.value, T), P !== null && (e && P.alternate !== null && B.delete(P.key === null ? X : P.key), g = r(P, g, X), $ === null ? L = P : $.sibling = P, $ = P);
      return e && B.forEach(function(vd) {
        return t(O, vd);
      }), I && Rt(O, X), L;
    }
    function ie(O, g, j, T) {
      if (typeof j == "object" && j !== null && j.type === ze && j.key === null && (j = j.props.children), typeof j == "object" && j !== null) {
        switch (j.$$typeof) {
          case Ce:
            e: {
              for (var L = j.key; g !== null; ) {
                if (g.key === L) {
                  if (L = j.type, L === ze) {
                    if (g.tag === 7) {
                      n(O, g.sibling), T = l(g, j.props.children), T.return = O, O = T;
                      break e;
                    }
                  } else if (g.elementType === L || typeof L == "object" && L !== null && L.$$typeof === Be && Rn(L) === g.type) {
                    n(O, g.sibling), T = l(g, j.props), Xa(T, j), T.return = O, O = T;
                    break e;
                  }
                  n(O, g);
                  break;
              ...
              j.type === ze ? (T = En(j.props.children, O.mode, T, j.key), T.return = O, O = T) : (T = Uc(j.type, j.key, j.props, null, O.mode, T), Xa(T, j), T.return = O, O = T);
            }
            return o(O);
          case De:
            e: {
              for (L = j.key; g !== null; ) {
                if (g.key === L) if (g.tag === 4 && g.stateNode.containerInfo === j.containerInfo && g.stateNode.implementation === j.implementation) {
                  n(O, g.sibling), T = l(g, j.children || []), T.return = O, O = T;
                  break e;
                } else {
                  n(O, g);
                  break;
        ...
        if (Le(j)) {
          if (L = Le(j), typeof L != "function") throw Error(f(150));
      ...
      return typeof j == "string" && j !== "" || typeof j == "number" || typeof j == "bigint" ? (j = "" + j, g !== null && g.tag === 6 ? (n(O, g.sibling), T = l(g, j), T.return = O, O = T) : (n(O, g), T = gl(j, O.mode, T), T.return = O, O = T), o(O)) : n(O, g);
    }
  ...
  var zn = df(true), gf = df(false), Pt = false;
  function Tl(e) {
  ...
  function tn(e, t, n) {
    ...
    if (u = u.shared, (ee & 2) !== 0) {
      var l = u.pending;
      return l === null ? t.next = t : (t.next = l.next, l.next = t), u.pending = t, t = Nc(e), Ir(e, null, n), t;
    }
  ...
  function Dl(e, t) {
    ...
    if (u !== null && (u = u.updateQueue, n === u)) {
      ...
      n = { baseState: u.baseState, firstBaseUpdate: l, lastBaseUpdate: r, shared: u.shared, callbacks: u.callbacks }, e.updateQueue = n;
      return;
    }
  ...
  function Wa(e, t, n, u) {
    ...
    var l = e.updateQueue;
    Pt = false;
    var r = l.firstBaseUpdate, o = l.lastBaseUpdate, s = l.shared.pending;
    if (s !== null) {
      l.shared.pending = null;
      var d = s, h = d.next;
      d.next = null, o === null ? r = h : o.next = h, o = d;
      var E = e.alternate;
      E !== null && (E = E.updateQueue, s = E.lastBaseUpdate, s !== o && (s === null ? E.firstBaseUpdate = h : s.next = h, E.lastBaseUpdate = d));
    }
    if (r !== null) {
      var M = l.baseState;
      o = 0, E = h = d = null, s = r;
      do {
        var w = s.lane & -536870913, S = w !== s.lane;
        if (S ? (K & w) === w : (u & w) === w) {
          w !== 0 && w === aa && (Rl = true), E !== null && (E = E.next = { lane: 0, tag: s.tag, payload: s.payload, callback: null, next: null });
          e: {
            var N = e, G = s;
            w = t;
            var ie = n;
            switch (G.tag) {
              ...
              case 0:
                if (N = G.payload, w = typeof N == "function" ? N.call(ie, M, w) : N, w == null) break e;
                M = R({}, M, w);
                break e;
              case 2:
                Pt = true;
          ...
          w = s.callback, w !== null && (e.flags |= 64, S && (e.flags |= 8192), S = l.callbacks, S === null ? l.callbacks = [w] : S.push(w));
        } else S = { lane: w, tag: s.tag, payload: s.payload, callback: s.callback, next: null }, E === null ? (h = E = S, d = M) : E = E.next = S, o |= w;
        if (s = s.next, s === null) {
          if (s = l.shared.pending, s === null) break;
          S = s, s = S.next, S.next = null, l.lastBaseUpdate = S, l.shared.pending = null;
        }
      } while (true);
      E === null && (d = M), l.baseState = d, l.firstBaseUpdate = h, l.lastBaseUpdate = E, r === null && (l.shared.lanes = 0), ln |= o, e.lanes = o, e.memoizedState = M;
    }
  }
  function mf(e, t) {
  ...
  var $e = m(null), _t = null;
  function nn(e) {
    var t = e.alternate;
    H(me, me.current & 1), H($e, e), _t === null && (t === null || ia.current !== null || t.memoizedState !== null) && (_t = e);
  }
  function Hl(e) {
    H(me, me.current), H($e, e), _t === null && (_t = e);
  }
  function yf(e) {
    e.tag === 22 ? (H(me, me.current), H($e, e), _t === null && (_t = e)) : an();
  }
  function an() {
  ...
  function Wc(e) {
    for (var t = e; t !== null; ) {
      if (t.tag === 13) {
        ...
        if (n !== null && (n = n.dehydrated, n === null || qi(n) || Vi(n))) return t;
  ...
  var Ht = 0, Y = null, ue = null, ye = null, Fc = false, ra = false, Hn = false, Kc = 0, Fa = 0, fa = null, bb = 0;
  function be() {
    throw Error(f(321));
  }
  function Nl(e, t) {
    if (t === null) return false;
    for (var n = 0; n < t.length && n < e.length; n++) if (!ke(e[n], t[n])) return false;
    return true;
  }
  function Ul(e, t, n, u, l, r) {
    return Ht = r, Y = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, A.H = e === null || e.memoizedState === null ? no : Il, Hn = false, r = n(u, l), Hn = false, ra && (r = hf(t, n, u, l)), jf(e), r;
  }
  function jf(e) {
    A.H = ka;
    var t = ue !== null && ue.next !== null;
    if (Ht = 0, ye = ue = Y = null, Fc = false, Fa = 0, fa = null, t) throw Error(f(300));
  ...
  function hf(e, t, n, u) {
    ...
    var l = 0;
    do {
      if (ra && (fa = null), Fa = 0, ra = false, 25 <= l) throw Error(f(301));
  ...
  function Gl(e) {
    ...
    Ht = 0, ye = ue = Y = null, ra = false, Fa = Kc = 0, fa = null;
  }
  function Ne() {
    var e = { memoizedState: null, baseState: null, baseQueue: null, queue: null, next: null };
    return ye === null ? Y.memoizedState = ye = e : ye = ye.next = e, ye;
  }
  function pe() {
    if (ue === null) {
      var e = Y.alternate;
    ...
    if (t !== null) ye = t, ue = e;
      ...
      if (e === null) throw Y.alternate === null ? Error(f(467)) : Error(f(310));
      ue = e, e = { memoizedState: ue.memoizedState, baseState: ue.baseState, baseQueue: ue.baseQueue, queue: ue.queue, next: null }, ye === null ? Y.memoizedState = ye = e : ye = ye.next = e;
    }
    return ye;
  }
  function Jc() {
  ...
  function Ka(e) {
    var t = Fa;
    return Fa += 1, fa === null && (fa = []), e = _f(fa, e, t), t = Y, (ye === null ? t.memoizedState : ye.next) === null && (t = t.alternate, A.H = t === null || t.memoizedState === null ? no : Il), e;
  }
  function kc(e) {
  ...
  function ql(e) {
    ...
    if (t == null && (t = { data: [], index: 0 }), n === null && (n = Jc(), Y.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), u = 0; u < e; u++) n[u] = Ln;
    return t.index++, n;
  }
  function Nt(e, t) {
  ...
  function Vl(e, t, n) {
    ...
    if (r = e.baseState, l === null) e.memoizedState = r;
      ...
      t = l.next;
      var s = o = null, d = null, h = t, E = false;
      do {
        var M = h.lane & -536870913;
        if (M !== h.lane ? (K & M) === M : (Ht & M) === M) {
          var w = h.revertLane;
          if (w === 0) d !== null && (d = d.next = { lane: 0, revertLane: 0, gesture: null, action: h.action, hasEagerState: h.hasEagerState, eagerState: h.eagerState, next: null }), M === aa && (E = true);
          else if ((Ht & w) === w) {
            h = h.next, w === aa && (E = true);
            continue;
          } else M = { lane: 0, revertLane: h.revertLane, gesture: null, action: h.action, hasEagerState: h.hasEagerState, eagerState: h.eagerState, next: null }, d === null ? (s = d = M, o = r) : d = d.next = M, Y.lanes |= w, ln |= w;
          M = h.action, Hn && n(r, M), r = h.hasEagerState ? h.eagerState : n(r, M);
        } else w = { lane: M, revertLane: h.revertLane, gesture: h.gesture, action: h.action, hasEagerState: h.hasEagerState, eagerState: h.eagerState, next: null }, d === null ? (s = d = w, o = r) : d = d.next = w, Y.lanes |= M, ln |= M;
        h = h.next;
      } while (h !== null && h !== t);
      if (d === null ? o = r : d.next = s, !ke(r, e.memoizedState) && (je = true, E && (n = ca, n !== null))) throw n;
      e.memoizedState = r, e.baseState = o, e.baseQueue = d, u.lastRenderedState = r;
    }
  ...
  function Yl(e) {
    ...
    var u = n.dispatch, l = n.pending, r = t.memoizedState;
    if (l !== null) {
      n.pending = null;
      var o = l = l.next;
      do
      ...
      while (o !== l);
      ke(r, t.memoizedState) || (je = true), t.memoizedState = r, t.baseQueue === null && (t.baseState = r), n.lastRenderedState = r;
    }
    return [r, u];
  }
  function wf(e, t, n) {
    ...
    if (o && (l.memoizedState = n, je = true), l = l.queue, Zl(Sf.bind(null, u, l, e), [e]), l.getSnapshot !== t || o || ye !== null && ye.memoizedState.tag & 1) {
      if (u.flags |= 2048, oa(9, { destroy: void 0 }, xf.bind(null, u, l, n, t), null), fe === null) throw Error(f(349));
      r || (Ht & 127) !== 0 || vf(u, t, n);
    }
    return n;
  }
  function vf(e, t, n) {
    e.flags |= 16384, e = { getSnapshot: t, value: n }, t = Y.updateQueue, t === null ? (t = Jc(), Y.updateQueue = t, t.stores = [e]) : (n = t.stores, n === null ? t.stores = [e] : n.push(e));
  }
  function xf(e, t, n, u) {
  ...
  function gb(e, t, n, u, l) {
    ...
    if (e = t.action, e !== null) {
      var r = { payload: l, action: e, next: null, isTransition: true, status: "pending", value: null, reason: null, listeners: [], then: function(o) {
        r.listeners.push(o);
      } };
      A.T !== null ? n(true) : r.isTransition = false, u(r), n = t.pending, n === null ? (r.next = t.pending = r, Mf(t, r)) : (r.next = n.next, t.pending = n.next = r);
    }
  }
  function Mf(e, t) {
    var n = t.action, u = t.payload, l = e.state;
    if (t.isTransition) {
      var r = A.T, o = {};
      A.T = o;
      try {
        ...
        r !== null && o.types !== null && (r.types = o.types), A.T = r;
      }
    } else try {
      r = n(l, u), Df(e, t, r);
    } catch (h) {
  ...
  function Df(e, t, n) {
    n !== null && typeof n == "object" && typeof n.then == "function" ? n.then(function(u) {
      Rf(e, t, u);
    }, function(u) {
      return Ql(e, t, u);
    }) : Rf(e, t, n);
  ...
  function Rf(e, t, n) {
    t.status = "fulfilled", t.value = n, Cf(t), e.state = n, t = e.pending, t !== null && (n = t.next, n === t ? e.pending = null : (n = n.next, t.next = n, Mf(e, n)));
  }
  function Ql(e, t, n) {
    var u = e.pending;
  ...
  function Uf(e, t, n) {
    if (t = Vl(e, t, zf)[0], e = Ic(Nt)[0], typeof t == "object" && t !== null && typeof t.then == "function") try {
      var u = Ka(t);
    } catch (o) {
      throw o === ua ? Vc : o;
    }
    ...
    return n !== t.memoizedState && (Y.flags |= 2048, oa(9, { destroy: void 0 }, mb.bind(null, l, n), null)), [u, r, e];
  }
  function mb(e, t) {
    e.action = t;
  }
  ...
  function oa(e, t, n, u) {
    return e = { tag: e, create: n, deps: u, inst: t, next: null }, t = Y.updateQueue, t === null && (t = Jc(), Y.updateQueue = t), n = t.lastEffect, n === null ? t.lastEffect = e.next = e : (u = n.next, n.next = e, e.next = u, t.lastEffect = e), e;
  }
  function Lf() {
  ...
  function $c(e, t, n, u) {
    var l = Ne();
    Y.flags |= e, l.memoizedState = oa(1 | t, { destroy: void 0 }, n, u === void 0 ? null : u);
  }
  function Pc(e, t, n, u) {
    var l = pe();
    u = u === void 0 ? null : u;
    var r = l.memoizedState.inst;
    ue !== null && u !== null && Nl(u, ue.memoizedState.deps) ? l.memoizedState = oa(t, r, n, u) : (Y.flags |= e, l.memoizedState = oa(1 | t, r, n, u));
  }
  function Gf(e, t) {
    $c(8390656, 8, e, t);
  }
  ...
  function Qf(e, t, n) {
    n = n != null ? n.concat([e]) : null, Pc(4, 4, Xf.bind(null, t, e), n);
  }
  function Wl() {
  }
  function Zf(e, t) {
    ...
    return t !== null && Nl(t, u[1]) ? u[0] : (n.memoizedState = [e, t], e);
  }
  function Wf(e, t) {
    var n = pe();
    t = t === void 0 ? null : t;
  ...
  function Fl(e, t, n) {
    return n === void 0 || (Ht & 1073741824) !== 0 && (K & 261930) === 0 ? e.memoizedState = t : (e.memoizedState = n, e = Ko(), Y.lanes |= e, ln |= e, n);
  }
  function Ff(e, t, n, u) {
    return ke(n, t) ? n : ia.current !== null ? (e = Fl(e, n, u), ke(e, t) || (je = true), e) : (Ht & 42) === 0 || (Ht & 1073741824) !== 0 && (K & 261930) === 0 ? (je = true, e.memoizedState = n) : (e = Ko(), Y.lanes |= e, ln |= e, t);
  }
  function Kf(e, t, n, u, l) {
    ...
    try {
      var d = l(), h = A.S;
      if (h !== null && h(s, d), d !== null && typeof d == "object" && typeof d.then == "function") {
        var E = sb(d, u);
        Ja(e, t, E, nt(e));
      } else Ja(e, t, u, nt(e));
    } catch (M) {
      ...
      z.p = r, o !== null && s.types !== null && (o.types = s.types), A.T = o;
    }
  }
  function Ob() {
  }
  ...
  function Jf(e) {
    var t = e.memoizedState;
    if (t !== null) return t;
    t = { memoizedState: q, baseState: q, baseQueue: null, queue: { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: Nt, lastRenderedState: q }, next: null };
    var n = {};
    return t.next = { memoizedState: n, baseState: n, baseQueue: null, queue: { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: Nt, lastRenderedState: n }, next: null }, e.memoizedState = t, e = e.alternate, e !== null && (e.memoizedState = t), t;
  }
  function kf(e) {
    var t = Jf(e);
    ...
    for (var t = e.return; t !== null; ) {
      switch (t.tag) {
        ...
        case 3:
          ...
          e = en(n);
          var u = tn(t, e, n);
          u !== null && (Ze(u, t, n), Qa(u, t, n)), t = { cache: xl() }, e.payload = t;
          return;
      }
      t = t.return;
    }
  ...
  function jb(e, t, n) {
    var u = nt();
    n = { lane: u, revertLane: 0, gesture: null, action: n, hasEagerState: false, eagerState: null, next: null }, eu(e) ? eo(t, n) : (n = bl(e, t, n, u), n !== null && (Ze(n, e, u), to(n, t, u)));
  }
  function Pf(e, t, n) {
    var u = nt();
    Ja(e, t, n, u);
  ...
  function Ja(e, t, n, u) {
    var l = { lane: u, revertLane: 0, gesture: null, action: n, hasEagerState: false, eagerState: null, next: null };
    if (eu(e)) eo(t, l);
    else {
      var r = e.alternate;
      if (e.lanes === 0 && (r === null || r.lanes === 0) && (r = t.lastRenderedReducer, r !== null)) try {
        var o = t.lastRenderedState, s = r(o, n);
        if (l.hasEagerState = true, l.eagerState = s, ke(s, o)) return Hc(e, t, l, 0), fe === null && zc(), false;
      } catch {
      } finally {
      }
      if (n = bl(e, t, l, u), n !== null) return Ze(n, e, u), to(n, t, u), true;
    }
    return false;
  }
  function kl(e, t, n, u) {
    if (u = { lane: 2, revertLane: Ti(), gesture: null, action: u, hasEagerState: false, eagerState: null, next: null }, eu(e)) {
  ...
  var ka = { readContext: Ae, use: kc, useCallback: be, useContext: be, useEffect: be, useImperativeHandle: be, useLayoutEffect: be, useInsertionEffect: be, useMemo: be, useReducer: be, useRef: be, useState: be, useDebugValue: be, useDeferredValue: be, useTransition: be, useSyncExternalStore: be, useId: be, useHostTransitionStatus: be, useFormState: be, useActionState: be, useOptimistic: be, useMemoCache: be, useCacheRefresh: be };
  ka.useEffectEvent = be;
  var no = { readContext: Ae, use: kc, useCallback: function(e, t) {
    return Ne().memoizedState = [e, t === void 0 ? null : t], e;
  }, useContext: Ae, useEffect: Gf, useImperativeHandle: function(e, t, n) {
    n = n != null ? n.concat([e]) : null, $c(4194308, 4, Xf.bind(null, t, e), n);
    ...
    return u.memoizedState = u.baseState = l, e = { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: e, lastRenderedState: l }, u.queue = e, e = e.dispatch = jb.bind(null, Y, e), [u.memoizedState, e];
  }, useRef: function(e) {
    var t = Ne();
    return e = { current: e }, t.memoizedState = e;
  }, useState: function(e) {
    e = Xl(e);
    var t = e.queue, n = Pf.bind(null, Y, t);
    ...
    var e = Xl(false);
    return e = Kf.bind(null, Y, e.queue, true, false), Ne().memoizedState = e, [false, e];
    ...
    return l.queue = r, Gf(Sf.bind(null, u, r, e), [e]), u.flags |= 2048, oa(9, { destroy: void 0 }, xf.bind(null, u, r, n, t), null), n;
  }, useId: function() {
    var e = Ne(), t = fe.identifierPrefix;
    if (I) {
      var n = wt, u = ht;
      n = (u & ~(1 << 32 - Je(u) - 1)).toString(32) + n, t = "_" + t + "R_" + n, n = Kc++, 0 < n && (t += "H" + n.toString(32)), t += "_";
    } else n = bb++, t = "_" + t + "r_" + n.toString(32) + "_";
    return e.memoizedState = t;
  }, useHostTransitionStatus: Jl, useFormState: Hf, useActionState: Hf, useOptimistic: function(e) {
    var t = Ne();
    t.memoizedState = t.baseState = e;
    var n = { pending: null, lanes: 0, dispatch: null, lastRenderedReducer: null, lastRenderedState: null };
    return t.queue = n, t = kl.bind(null, Y, true, n), n.dispatch = t, [e, t];
  }, useMemoCache: ql, useCacheRefresh: function() {
  ...
  } }, Il = { readContext: Ae, use: kc, useCallback: Zf, useContext: Ae, useEffect: Zl, useImperativeHandle: Qf, useInsertionEffect: Vf, useLayoutEffect: Yf, useMemo: Wf, useReducer: Ic, useRef: Lf, useState: function() {
    return Ic(Nt);
  }, useDebugValue: Wl, useDeferredValue: function(e, t) {
    var n = pe();
    return Ff(n, ue.memoizedState, e, t);
  }, useTransition: function() {
    var e = Ic(Nt)[0], t = pe().memoizedState;
    return [typeof e == "boolean" ? e : Ka(e), t];
  }, useSyncExternalStore: wf, useId: If, useHostTransitionStatus: Jl, useFormState: Nf, useActionState: Nf, useOptimistic: function(e, t) {
    var n = pe();
    return Tf(n, ue, e, t);
  }, useMemoCache: ql, useCacheRefresh: $f };
  Il.useEffectEvent = qf;
  var ao = { readContext: Ae, use: kc, useCallback: Zf, useContext: Ae, useEffect: Zl, useImperativeHandle: Qf, useInsertionEffect: Vf, useLayoutEffect: Yf, useMemo: Wf, useReducer: Yl, useRef: Lf, useState: function() {
    return Yl(Nt);
  }, useDebugValue: Wl, useDeferredValue: function(e, t) {
    var n = pe();
    return ue === null ? Fl(n, e, t) : Ff(n, ue.memoizedState, e, t);
  }, useTransition: function() {
    var e = Yl(Nt)[0], t = pe().memoizedState;
    return [typeof e == "boolean" ? e : Ka(e), t];
  }, useSyncExternalStore: wf, useId: If, useHostTransitionStatus: Jl, useFormState: Bf, useActionState: Bf, useOptimistic: function(e, t) {
    var n = pe();
    return ue !== null ? Tf(n, ue, e, t) : (n.baseState = e, [e, n.queue.dispatch]);
  }, useMemoCache: ql, useCacheRefresh: $f };
  ao.useEffectEvent = qf;
  function $l(e, t, n, u) {
    t = e.memoizedState, n = n(u, t), n = n == null ? t : R({}, t, n), e.memoizedState = n, e.lanes === 0 && (e.updateQueue.baseState = n);
  }
  var Pl = { enqueueSetState: function(e, t, n) {
    e = e._reactInternals;
    var u = nt(), l = en(u);
    l.payload = t, n != null && (l.callback = n), t = tn(e, l, u), t !== null && (Ze(t, e, u), Qa(t, e, u));
  }, enqueueReplaceState: function(e, t, n) {
    e = e._reactInternals;
    var u = nt(), l = en(u);
    l.tag = 1, l.payload = t, n != null && (l.callback = n), t = tn(e, l, u), t !== null && (Ze(t, e, u), Qa(t, e, u));
  }, enqueueForceUpdate: function(e, t) {
    e = e._reactInternals;
    var n = nt(), u = en(n);
    u.tag = 2, t != null && (u.callback = t), t = tn(e, u, n), t !== null && (Ze(t, e, n), Qa(t, e, n));
  } };
  function co(e, t, n, u, l, r, o) {
    return e = e.stateNode, typeof e.shouldComponentUpdate == "function" ? e.shouldComponentUpdate(u, r, o) : t.prototype && t.prototype.isPureReactComponent ? !Ua(n, u) || !Ua(l, r) : true;
  }
  function uo(e, t, n, u) {
    e = t.state, typeof t.componentWillReceiveProps == "function" && t.componentWillReceiveProps(n, u), typeof t.UNSAFE_componentWillReceiveProps == "function" && t.UNSAFE_componentWillReceiveProps(n, u), t.state !== e && Pl.enqueueReplaceState(t, t.state, null);
  }
  function Nn(e, t) {
    var n = t;
    if ("ref" in t) {
  ...
  function fo(e, t, n) {
    try {
      ...
      u(n.value, { componentStack: n.stack, errorBoundary: t.tag === 1 ? t.stateNode : null });
    } catch (l) {
      setTimeout(function() {
        throw l;
      });
  ...
  function _o(e, t, n, u) {
    ...
    o !== null && typeof o.componentDidCatch == "function" && (e.callback = function() {
      fo(t, n, u), typeof l != "function" && (rn === null ? rn = /* @__PURE__ */ new Set([this]) : rn.add(this));
      var s = u.stack;
  ...
  function hb(e, t, n, u, l) {
    if (n.flags |= 32768, u !== null && typeof u == "object" && typeof u.then == "function") {
      if (t = n.alternate, t !== null && na(t, n, l, true), n = $e.current, n !== null) {
        switch (n.tag) {
          case 31:
          case 13:
            return _t === null ? bu() : n.alternate === null && de === 0 && (de = 3), n.flags &= -257, n.flags |= 65536, n.lanes = l, u === Yc ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = /* @__PURE__ */ new Set([u]) : t.add(u), Si(e, u, l)), false;
          case 22:
            return n.flags |= 65536, u === Yc ? n.flags |= 16384 : (t = n.updateQueue, t === null ? (t = { transitions: null, markerInstances: null, retryQueue: /* @__PURE__ */ new Set([u]) }, n.updateQueue = t) : (n = t.retryQueue, n === null ? t.retryQueue = /* @__PURE__ */ new Set([u]) : n.add(u)), Si(e, u, l)), false;
        }
        throw Error(f(435, n.tag));
      }
      return Si(e, u, l), bu(), false;
    }
    if (I) return t = $e.current, t !== null ? ((t.flags & 65536) === 0 && (t.flags |= 256), t.flags |= 65536, t.lanes = l, u !== yl && (e = Error(f(422), { cause: u }), Ga(it(e, n)))) : (u !== yl && (t = Error(f(423), { cause: u }), Ga(it(t, n))), e = e.current.alternate, e.flags |= 65536, l &= -l, e.lanes |= l, u = it(u, n), l = ei(e.stateNode, u, l), Dl(e, l), de !== 4 && (de = 2)), false;
    var r = Error(f(520), { cause: u });
    if (r = it(r, n), cc === null ? cc = [r] : cc.push(r), de !== 4 && (de = 2), t === null) return true;
    u = it(u, n), n = t;
    do {
      switch (n.tag) {
        case 3:
          return n.flags |= 65536, e = l & -l, n.lanes |= e, e = ei(n.stateNode, u, e), Dl(n, e), false;
        case 1:
          if (t = n.type, r = n.stateNode, (n.flags & 128) === 0 && (typeof t.getDerivedStateFromError == "function" || r !== null && typeof r.componentDidCatch == "function" && (rn === null || !rn.has(r)))) return n.flags |= 65536, l &= -l, n.lanes |= l, l = oo(l), _o(l, e, n, u), Dl(n, l), false;
      }
      n = n.return;
    } while (n !== null);
    return false;
  }
  var ti = Error(f(461)), je = false;
  function Te(e, t, n, u) {
  ...
  function so(e, t, n, u, l) {
    ...
    return Mn(t), u = Ul(e, t, n, o, r, l), s = Bl(), e !== null && !je ? (Ll(e, t, l), Ut(e, t, l)) : (I && s && pl(t), t.flags |= 1, Te(e, t, u, l), t.child);
  }
  function bo(e, t, n, u, l) {
    if (e === null) {
      var r = n.type;
      return typeof r == "function" && !dl(r) && r.defaultProps === void 0 && n.compare === null ? (t.tag = 15, t.type = r, go(e, t, r, u, l)) : (e = Uc(n.type, null, u, t, t.mode, l), e.ref = t.ref, e.return = t, t.child = e);
    }
    if (r = e.child, !fi(e, l)) {
      var o = r.memoizedProps;
      if (n = n.compare, n = n !== null ? n : Ua, n(o, u) && e.ref === t.ref) return Ut(e, t, l);
    }
    return t.flags |= 1, e = Dt(r, u), e.ref = t.ref, e.return = t, t.child = e;
  }
  function go(e, t, n, u, l) {
    if (e !== null) {
      var r = e.memoizedProps;
      if (Ua(r, u) && e.ref === t.ref) if (je = false, t.pendingProps = u = r, fi(e, l)) (e.flags & 131072) !== 0 && (je = true);
  ...
  function mo(e, t, n, u) {
    ...
    if (e === null && t.stateNode === null && (t.stateNode = { _visibility: 1, _pendingMarkers: null, _retryCache: null, _transitions: null }), u.mode === "hidden") {
      ...
      if ((n & 536870912) !== 0) t.memoizedState = { baseLanes: 0, cachePool: null }, e !== null && qc(t, r !== null ? r.cachePool : null), r !== null ? Of(t, r) : Cl(), yf(t);
      else return u = t.lanes = 536870912, po(e, t, r !== null ? r.baseLanes | n : n, n, u);
    } else r !== null ? (qc(t, r.cachePool), Of(t, r), an(), t.memoizedState = null) : (e !== null && qc(t, null), Cl(), an());
  ...
  function po(e, t, n, u, l) {
    var r = El();
    return r = r === null ? null : { parent: Oe._currentValue, pool: r }, t.memoizedState = { baseLanes: n, cachePool: r }, e !== null && qc(t, null), Cl(), yf(t), e !== null && na(e, t, u, true), t.childLanes = l, null;
  }
  function nu(e, t) {
    return t = cu({ mode: t.mode, children: t.children }, e.mode), t.ref = e.ref, e.child = t, t.return = e, t;
  }
  function Oo(e, t, n) {
    return zn(t, e.child, null, n), e = nu(t, t.pendingProps), e.flags |= 2, Pe(t), t.memoizedState = null, e;
  }
  function wb(e, t, n) {
    ...
    if (t.flags &= -129, e === null) {
      if (I) {
        ...
        if (Hl(t), (e = oe) ? (e = D_(e, ot), e = e !== null && e.data === "&" ? e : null, e !== null && (t.memoizedState = { dehydrated: e, treeContext: Jt !== null ? { id: ht, overflow: wt } : null, retryLane: 536870912, hydrationErrors: null }, n = Pr(e), n.return = t, t.child = n, Ee = t, oe = null)) : e = null, e === null) throw It(t);
    ...
    if (r !== null) {
      var o = r.dehydrated;
      if (Hl(t), l) if (t.flags & 256) t.flags &= -257, t = Oo(e, t, n);
      else if (t.memoizedState !== null) t.child = e.child, t.flags |= 128, t = null;
      else throw Error(f(558));
      else if (je || na(e, t, n, false), l = (n & e.childLanes) !== 0, je || l) {
        if (u = fe, u !== null && (o = lr(u, n), o !== 0 && o !== r.retryLane)) throw r.retryLane = o, Sn(e, o), Ze(u, e, o), ti;
        bu(), t = Oo(e, t, n);
      } else e = r.treeContext, oe = st(o.nextSibling), Ee = t, I = true, kt = null, ot = false, e !== null && nf(t, e), t = nu(t, u), t.flags |= 4096;
      return t;
    }
  ...
  function ni(e, t, n, u, l) {
    return Mn(t), n = Ul(e, t, n, u, void 0, l), u = Bl(), e !== null && !je ? (Ll(e, t, l), Ut(e, t, l)) : (I && u && pl(t), t.flags |= 1, Te(e, t, n, l), t.child);
  }
  function yo(e, t, n, u, l, r) {
    return Mn(t), t.updateQueue = null, n = hf(t, u, n, l), jf(e), u = Bl(), e !== null && !je ? (Ll(e, t, r), Ut(e, t, r)) : (I && u && pl(t), t.flags |= 1, Te(e, t, n, r), t.child);
  }
  function jo(e, t, n, u, l) {
    if (Mn(t), t.stateNode === null) {
      var r = $n, o = n.contextType;
      typeof o == "object" && o !== null && (r = Ae(o)), r = new n(u, r), t.memoizedState = r.state !== null && r.state !== void 0 ? r.state : null, r.updater = Pl, t.stateNode = r, r._reactInternals = t, r = t.stateNode, r.props = u, r.state = t.memoizedState, r.refs = {}, Tl(t), o = n.contextType, r.context = typeof o == "object" && o !== null ? Ae(o) : $n, r.state = t.memoizedState, o = n.getDerivedStateFromProps, typeof o == "function" && ($l(t, n, o, u), r.state = t.memoizedState), typeof n.getDerivedStateFromProps == "function" || typeof r.getSnapshotBeforeUpdate == "function" || typeof r.UNSAFE_componentWillMount != "function" && typeof r.componentWillMount != "function" || (o = r.state, typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount(), o !== r.state && Pl.enqueueReplaceState(r, r.state, null), Wa(t, u, r, l), Za(), r.state = t.memoizedState), typeof r.componentDidMount == "function" && (t.flags |= 4194308), u = true;
    } else if (e === null) {
      r = t.stateNode;
      var s = t.memoizedProps, d = Nn(n, s);
      r.props = d;
      var h = r.context, E = n.contextType;
      o = $n, typeof E == "object" && E !== null && (o = Ae(E));
      var M = n.getDerivedStateFromProps;
      E = typeof M == "function" || typeof r.getSnapshotBeforeUpdate == "function", s = t.pendingProps !== s, E || typeof r.UNSAFE_componentWillReceiveProps != "function" && typeof r.componentWillReceiveProps != "function" || (s || h !== o) && uo(t, r, u, o), Pt = false;
      var w = t.memoizedState;
      r.state = w, Wa(t, u, r, l), Za(), h = t.memoizedState, s || w !== h || Pt ? (typeof M == "function" && ($l(t, n, M, u), h = t.memoizedState), (d = Pt || co(t, n, d, u, w, h, o)) ? (E || typeof r.UNSAFE_componentWillMount != "function" && typeof r.componentWillMount != "function" || (typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount()), typeof r.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof r.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = u, t.memoizedState = h), r.props = u, r.state = h, r.context = o, u = d) : (typeof r.componentDidMount == "function" && (t.flags |= 4194308), u = false);
    } else {
      r = t.stateNode, Ml(e, t), o = t.memoizedProps, E = Nn(n, o), r.props = E, M = t.pendingProps, w = r.context, h = n.contextType, d = $n, typeof h == "object" && h !== null && (d = Ae(h)), s = n.getDerivedStateFromProps, (h = typeof s == "function" || typeof r.getSnapshotBeforeUpdate == "function") || typeof r.UNSAFE_componentWillReceiveProps != "function" && typeof r.componentWillReceiveProps != "function" || (o !== M || w !== d) && uo(t, r, u, d), Pt = false, w = t.memoizedState, r.state = w, Wa(t, u, r, l), Za();
      var S = t.memoizedState;
      o !== M || w !== S || Pt || e !== null && e.dependencies !== null && Lc(e.dependencies) ? (typeof s == "function" && ($l(t, n, s, u), S = t.memoizedState), (E = Pt || co(t, n, E, u, w, S, d) || e !== null && e.dependencies !== null && Lc(e.dependencies)) ? (h || typeof r.UNSAFE_componentWillUpdate != "function" && typeof r.componentWillUpdate != "function" || (typeof r.componentWillUpdate == "function" && r.componentWillUpdate(u, S, d), typeof r.UNSAFE_componentWillUpdate == "function" && r.UNSAFE_componentWillUpdate(u, S, d)), typeof r.componentDidUpdate == "function" && (t.flags |= 4), typeof r.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof r.componentDidUpdate != "function" || o === e.memoizedProps && w === e.memoizedState || (t.flags |= 4), typeof r.getSnapshotBeforeUpdate != "function" || o === e.memoizedProps && w === e.memoizedState || (t.flags |= 1024), t.memoizedProps = u, t.memoizedState = S), r.props = u, r.state = S, r.context = d, u = E) : (typeof r.componentDidUpdate != "function" || o === e.memoizedProps && w === e.memoizedState || (t.flags |= 4), typeof r.getSnapshotBeforeUpdate != "function" || o === e.memoizedProps && w === e.memoizedState || (t.flags |= 1024), u = false);
    }
    return r = u, au(e, t), u = (t.flags & 128) !== 0, r || u ? (r = t.stateNode, n = u && typeof n.getDerivedStateFromError != "function" ? null : r.render(), t.flags |= 1, e !== null && u ? (t.child = zn(t, e.child, null, l), t.child = zn(t, null, n, l)) : Te(e, t, n, l), t.memoizedState = r.state, e = t.child) : e = Ut(e, t, l), e;
  }
  function ho(e, t, n, u) {
  ...
  function wo(e, t, n) {
    var u = t.pendingProps, l = false, r = (t.flags & 128) !== 0, o;
    if ((o = r) || (o = e !== null && e.memoizedState === null ? false : (me.current & 2) !== 0), o && (l = true, t.flags &= -129), o = (t.flags & 32) !== 0, t.flags &= -33, e === null) {
      if (I) {
        if (l ? nn(t) : an(), (e = oe) ? (e = D_(e, ot), e = e !== null && e.data !== "&" ? e : null, e !== null && (t.memoizedState = { dehydrated: e, treeContext: Jt !== null ? { id: ht, overflow: wt } : null, retryLane: 536870912, hydrationErrors: null }, n = Pr(e), n.return = t, t.child = n, Ee = t, oe = null)) : e = null, e === null) throw It(t);
        return Vi(e) ? t.lanes = 32 : t.lanes = 536870912, null;
      }
      var s = u.children;
      return u = u.fallback, l ? (an(), l = t.mode, s = cu({ mode: "hidden", children: s }, l), u = En(u, l, n, null), s.return = t, u.return = t, s.sibling = u, t.child = s, u = t.child, u.memoizedState = ci(n), u.childLanes = ui(e, o, n), t.memoizedState = ai, Ia(null, u)) : (nn(t), li(t, s));
    }
    var d = e.memoizedState;
    if (d !== null && (s = d.dehydrated, s !== null)) {
      if (r) t.flags & 256 ? (nn(t), t.flags &= -257, t = ii(e, t, n)) : t.memoizedState !== null ? (an(), t.child = e.child, t.flags |= 128, t = null) : (an(), s = u.fallback, l = t.mode, u = cu({ mode: "visible", children: u.children }, l), s = En(s, l, n, null), s.flags |= 2, u.return = t, s.return = t, u.sibling = s, t.child = u, zn(t, e.child, null, n), u = t.child, u.memoizedState = ci(n), u.childLanes = ui(e, o, n), t.memoizedState = ai, t = Ia(null, u));
      else if (nn(t), Vi(s)) {
        if (o = s.nextSibling && s.nextSibling.dataset, o) var h = o.dgst;
        o = h, u = Error(f(419)), u.stack = "", u.digest = o, Ga({ value: u, source: null, stack: null }), t = ii(e, t, n);
      } else if (je || na(e, t, n, false), o = (n & e.childLanes) !== 0, je || o) {
        if (o = fe, o !== null && (u = lr(o, n), u !== 0 && u !== d.retryLane)) throw d.retryLane = u, Sn(e, u), Ze(o, e, u), ti;
        qi(s) || bu(), t = ii(e, t, n);
      } else qi(s) ? (t.flags |= 192, t.child = e.child, t = null) : (e = d.treeContext, oe = st(s.nextSibling), Ee = t, I = true, kt = null, ot = false, e !== null && nf(t, e), t = li(t, u.children), t.flags |= 4096);
      return t;
    }
  ...
  function ii(e, t, n) {
    return zn(t, e.child, null, n), e = li(t, t.pendingProps.children), e.flags |= 2, t.memoizedState = null, e;
  }
  function vo(e, t, n) {
    e.lanes |= t;
    var u = e.alternate;
  ...
  function ri(e, t, n, u, l, r) {
    ...
    o === null ? e.memoizedState = { isBackwards: t, rendering: null, renderingStartTime: 0, last: u, tail: n, tailMode: l, treeForkCount: r } : (o.isBackwards = t, o.rendering = null, o.renderingStartTime = 0, o.last = u, o.tail = n, o.tailMode = l, o.treeForkCount = r);
  }
  function xo(e, t, n) {
    var u = t.pendingProps, l = u.revealOrder, r = u.tail;
    u = u.children;
    var o = me.current, s = (o & 2) !== 0;
    if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, H(me, o), Te(e, t, u, n), u = I ? La : 0, !s && e !== null && (e.flags & 128) !== 0) e: for (e = t.child; e !== null; ) {
    ...
    switch (l) {
      case "forwards":
        for (n = t.child, l = null; n !== null; ) e = n.alternate, e !== null && Wc(e) === null && (l = n), n = n.sibling;
        n = l, n === null ? (l = t.child, t.child = null) : (l = n.sibling, n.sibling = null), ri(t, false, l, n, r, u);
        break;
      case "backwards":
  ...
  function vb(e, t, n) {
    switch (t.tag) {
      case 3:
        He(t, t.stateNode.containerInfo), $t(t, Oe, e.memoizedState.cache), An();
        break;
      case 27:
      case 5:
        va(t);
      ...
      case 10:
        ...
        break;
      case 31:
        if (t.memoizedState !== null) return t.flags |= 128, Hl(t), null;
        break;
      case 13:
        var u = t.memoizedState;
        if (u !== null) return u.dehydrated !== null ? (nn(t), t.flags |= 128, null) : (n & t.child.childLanes) !== 0 ? wo(e, t, n) : (nn(t), e = Ut(e, t, n), e !== null ? e.sibling : null);
        nn(t);
        break;
      case 19:
        var l = (e.flags & 128) !== 0;
        if (u = (n & t.childLanes) !== 0, u || (na(e, t, n, false), u = (n & t.childLanes) !== 0), l) {
          if (u) return xo(e, t, n);
          t.flags |= 128;
        }
        if (l = t.memoizedState, l !== null && (l.rendering = null, l.tail = null, l.lastEffect = null), H(me, me.current), u) break;
        return null;
      case 22:
  ...
  function So(e, t, n) {
    if (e !== null) if (e.memoizedProps !== t.pendingProps) je = true;
      ...
      if (!fi(e, n) && (t.flags & 128) === 0) return je = false, vb(e, t, n);
      je = (e.flags & 131072) !== 0;
    }
    ...
    switch (t.lanes = 0, t.tag) {
      case 16:
        e: {
          ...
          if (e = Rn(t.elementType), t.type = e, typeof e == "function") dl(e) ? (u = Nn(e, u), t.tag = 1, t = jo(null, t, e, u, n)) : (t.tag = 0, t = ni(null, t, e, u, n));
          else {
            if (e != null) {
              var l = e.$$typeof;
              if (l === at) {
      ...
      case 1:
        return u = t.type, l = Nn(u, t.pendingProps), jo(e, t, u, l, n);
      case 3:
        e: {
          if (He(t, t.stateNode.containerInfo), e === null) throw Error(f(387));
          u = t.pendingProps;
          var r = t.memoizedState;
          l = r.element, Ml(e, t), Wa(t, u, null, n);
          var o = t.memoizedState;
          if (u = o.cache, $t(t, Oe, u), u !== r.cache && vl(t, [Oe], n, true), Za(), u = o.element, r.isDehydrated) if (r = { element: u, isDehydrated: false, cache: o.cache }, t.updateQueue.baseState = r, t.memoizedState = r, t.flags & 256) {
            t = ho(e, t, u, n);
            break e;
          } else if (u !== l) {
            l = it(Error(f(424)), t), Ga(l), t = ho(e, t, u, n);
            break e;
          } else {
            ...
            for (oe = st(e.firstChild), Ee = t, I = true, kt = null, ot = true, n = gf(t, null, u, n), t.child = n; n; ) n.flags = n.flags & -3 | 4096, n = n.sibling;
          }
          else {
            if (An(), u === l) {
              t = Ut(e, t, n);
        ...
        return t;
      case 26:
        return au(e, t), e === null ? (n = U_(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : I || (n = t.type, e = t.pendingProps, u = ju(Z.current).createElement(n), u[Se] = t, u[Ge] = e, Me(u, n, e), ve(u), t.stateNode = u) : t.memoizedState = U_(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
      case 27:
        return va(t), e === null && I && (u = t.stateNode = z_(t.type, t.pendingProps, Z.current), Ee = t, ot = true, l = oe, sn(t.type) ? (Yi = l, oe = st(u.firstChild)) : oe = l), Te(e, t, t.pendingProps.children, n), au(e, t), e === null && (t.flags |= 4194304), t.child;
      case 5:
        return e === null && I && ((l = u = oe) && (u = Pb(u, t.type, t.pendingProps, ot), u !== null ? (t.stateNode = u, Ee = t, oe = st(u.firstChild), ot = false, l = true) : l = false), l || It(t)), va(t), l = t.type, r = t.pendingProps, o = e !== null ? e.memoizedProps : null, u = r.children, Bi(l, r) ? u = null : o !== null && Bi(l, o) && (t.flags |= 32), t.memoizedState !== null && (l = Ul(e, t, db, null, null, n), sc._currentValue = l), au(e, t), Te(e, t, u, n), t.child;
      case 6:
        return e === null && I && ((e = n = oe) && (n = ed(n, t.pendingProps, ot), n !== null ? (t.stateNode = n, Ee = t, oe = null, e = true) : e = false), e || It(t)), null;
      case 13:
        return wo(e, t, n);
      case 4:
        return He(t, t.stateNode.containerInfo), u = t.pendingProps, e === null ? t.child = zn(t, null, u, n) : Te(e, t, u, n), t.child;
      case 11:
      ...
      case 12:
        return Te(e, t, t.pendingProps.children, n), t.child;
      case 10:
        return u = t.pendingProps, $t(t, t.type, u.value), Te(e, t, u.children, n), t.child;
      case 9:
        return l = t.type._context, u = t.pendingProps.children, Mn(t), l = Ae(l), u = u(l), t.flags |= 1, Te(e, t, u, n), t.child;
      case 14:
      ...
      case 24:
        return Mn(t), u = Ae(Oe), e === null ? (l = El(), l === null && (l = fe, r = xl(), l.pooledCache = r, r.refCount++, r !== null && (l.pooledCacheLanes |= n), l = r), t.memoizedState = { parent: u, cache: l }, Tl(t), $t(t, Oe, l)) : ((e.lanes & n) !== 0 && (Ml(e, t), Wa(t, null, null, n), Za()), l = e.memoizedState, r = t.memoizedState, l.parent !== u ? (l = { parent: u, cache: u }, t.memoizedState = l, t.lanes === 0 && (t.memoizedState = t.updateQueue.baseState = l), $t(t, Oe, u)) : (u = r.cache, $t(t, Oe, u), u !== l.cache && vl(t, [Oe], n, true))), Te(e, t, t.pendingProps.children, n), t.child;
      case 29:
  ...
  function Eo(e, t) {
    ...
    else if (e.flags |= 16777216, !V_(t)) if ($o()) e.flags |= 8192;
    else throw Cn = Yc, Al;
  }
  function uu(e, t) {
    t !== null && (e.flags |= 4), e.flags & 16384 && (t = e.tag !== 22 ? ar() : 536870912, e.lanes |= t, da |= t);
  }
  function $a(e, t) {
  ...
  function _e(e) {
    ...
    if (t) for (var l = e.child; l !== null; ) n |= l.lanes | l.childLanes, u |= l.subtreeFlags & 65011712, u |= l.flags & 65011712, l.return = e, l = l.sibling;
    else for (l = e.child; l !== null; ) n |= l.lanes | l.childLanes, u |= l.subtreeFlags, u |= l.flags, l.return = e, l = l.sibling;
  ...
  function xb(e, t, n) {
    ...
    switch (Ol(t), t.tag) {
      ...
      case 1:
        return _e(t), null;
      case 3:
        return n = t.stateNode, u = null, e !== null && (u = e.memoizedState.cache), t.memoizedState.cache !== u && (t.flags |= 2048), zt(Oe), ge(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (ta(t) ? Bt(t) : e === null || e.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024, jl())), _e(t), null;
      case 26:
        var l = t.type, r = t.memoizedState;
        return e === null ? (Bt(t), r !== null ? (_e(t), Eo(t, r)) : (_e(t), oi(t, l, null, u, n))) : r ? r !== e.memoizedState ? (Bt(t), _e(t), Eo(t, r)) : (_e(t), t.flags &= -16777217) : (e = e.memoizedProps, e !== u && Bt(t), _e(t), oi(t, l, e, u, n)), null;
      case 27:
        if (mc(t), n = Z.current, l = t.type, e !== null && t.stateNode != null) e.memoizedProps !== u && Bt(t);
        else {
          if (!u) {
            if (t.stateNode === null) throw Error(f(166));
            return _e(t), null;
          }
          e = U.current, ta(t) ? af(t) : (e = z_(l, u, n), t.stateNode = e, Bt(t));
        }
        return _e(t), null;
      case 5:
        if (mc(t), l = t.type, e !== null && t.stateNode != null) e.memoizedProps !== u && Bt(t);
          ...
          if (r = U.current, ta(t)) af(t);
            ...
            switch (r) {
              case 1:
                r = o.createElementNS("http://www.w3.org/2000/svg", l);
                break;
              case 2:
                r = o.createElementNS("http://www.w3.org/1998/Math/MathML", l);
                break;
              default:
                switch (l) {
                  case "svg":
                  ...
                  case "script":
                    ...
                    break;
                  case "select":
                    r = typeof u.is == "string" ? o.createElement("select", { is: u.is }) : o.createElement("select"), u.multiple ? r.multiple = true : u.size && (r.size = u.size);
                    break;
                  default:
                    r = typeof u.is == "string" ? o.createElement(l, { is: u.is }) : o.createElement(l);
                }
            }
            r[Se] = t, r[Ge] = u;
            e: for (o = t.child; o !== null; ) {
              if (o.tag === 5 || o.tag === 6) r.appendChild(o.stateNode);
        ...
        return _e(t), oi(t, t.type, e === null ? null : e.memoizedProps, t.pendingProps, n), null;
      case 6:
        if (e && t.stateNode != null) e.memoizedProps !== u && Bt(t);
        else {
          if (typeof u != "string" && t.stateNode === null) throw Error(f(166));
          if (e = Z.current, ta(t)) {
            if (e = t.stateNode, n = t.memoizedProps, u = null, l = Ee, l !== null) switch (l.tag) {
              case 27:
              case 5:
                u = l.memoizedProps;
            }
            e[Se] = t, e = !!(e.nodeValue === n || u !== null && u.suppressHydrationWarning === true || w_(e.nodeValue, n)), e || It(t, true);
          } else e = ju(e).createTextNode(u), e[Se] = t, t.stateNode = e;
        }
        return _e(t), null;
      case 31:
        if (n = t.memoizedState, e === null || e.memoizedState !== null) {
          if (u = ta(t), n !== null) {
            ...
            _e(t), e = false;
          } else n = jl(), e !== null && e.memoizedState !== null && (e.memoizedState.hydrationErrors = n), e = true;
      ...
      case 13:
        if (u = t.memoizedState, e === null || e.memoizedState !== null && e.memoizedState.dehydrated !== null) {
          if (l = ta(t), u !== null && u.dehydrated !== null) {
            ...
            _e(t), l = false;
          } else l = jl(), e !== null && e.memoizedState !== null && (e.memoizedState.hydrationErrors = l), l = true;
          if (!l) return t.flags & 256 ? (Pe(t), t) : (Pe(t), null);
        }
        return Pe(t), (t.flags & 128) !== 0 ? (t.lanes = n, t) : (n = u !== null, e = e !== null && e.memoizedState !== null, n && (u = t.child, l = null, u.alternate !== null && u.alternate.memoizedState !== null && u.alternate.memoizedState.cachePool !== null && (l = u.alternate.memoizedState.cachePool.pool), r = null, u.memoizedState !== null && u.memoizedState.cachePool !== null && (r = u.memoizedState.cachePool.pool), r !== l && (u.flags |= 2048)), n !== e && n && (t.child.flags |= 8192), uu(t, t.updateQueue), _e(t), null);
      case 4:
        return ge(), e === null && Ci(t.stateNode.containerInfo), _e(t), null;
      case 10:
        return zt(t.type), _e(t), null;
      case 19:
        if (D(me), u = t.memoizedState, u === null) return _e(t), null;
        if (l = (t.flags & 128) !== 0, r = u.rendering, r === null) if (l) $a(u, false);
        else {
          if (de !== 0 || e !== null && (e.flags & 128) !== 0) for (e = t.child; e !== null; ) {
            if (r = Wc(e), r !== null) {
              for (t.flags |= 128, $a(u, false), e = r.updateQueue, t.updateQueue = e, uu(t, e), t.subtreeFlags = 0, e = n, n = t.child; n !== null; ) $r(n, e), n = n.sibling;
              return H(me, me.current & 1 | 2), I && Rt(t, u.treeForkCount), t.child;
            }
            e = e.sibling;
          }
          u.tail !== null && Fe() > ou && (t.flags |= 128, l = true, $a(u, false), t.lanes = 4194304);
        }
        else {
          if (!l) if (e = Wc(r), e !== null) {
            if (t.flags |= 128, l = true, e = e.updateQueue, t.updateQueue = e, uu(t, e), $a(u, true), u.tail === null && u.tailMode === "hidden" && !r.alternate && !I) return _e(t), null;
          } else 2 * Fe() - u.renderingStartTime > ou && n !== 536870912 && (t.flags |= 128, l = true, $a(u, false), t.lanes = 4194304);
          u.isBackwards ? (r.sibling = t.child, t.child = r) : (e = u.last, e !== null ? e.sibling = r : t.child = r, u.last = r);
        }
        return u.tail !== null ? (e = u.tail, u.rendering = e, u.tail = e.sibling, u.renderingStartTime = Fe(), e.sibling = null, n = me.current, H(me, l ? n & 1 | 2 : n & 1), I && Rt(t, u.treeForkCount), e) : (_e(t), null);
      case 22:
      case 23:
        return Pe(t), zl(), u = t.memoizedState !== null, e !== null ? e.memoizedState !== null !== u && (t.flags |= 8192) : u && (t.flags |= 8192), u ? (n & 536870912) !== 0 && (t.flags & 128) === 0 && (_e(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : _e(t), n = t.updateQueue, n !== null && uu(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), u = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (u = t.memoizedState.cachePool.pool), u !== n && (t.flags |= 2048), e !== null && D(Dn), null;
      case 24:
        return n = null, e !== null && (n = e.memoizedState.cache), t.memoizedState.cache !== n && (t.flags |= 2048), zt(Oe), _e(t), null;
      case 25:
        return null;
      case 30:
        return null;
  ...
  function Sb(e, t) {
    switch (Ol(t), t.tag) {
      ...
      case 3:
        return zt(Oe), ge(), e = t.flags, (e & 65536) !== 0 && (e & 128) === 0 ? (t.flags = e & -65537 | 128, t) : null;
      case 26:
      case 27:
      case 5:
        return mc(t), null;
      ...
      case 22:
      case 23:
        return Pe(t), zl(), e !== null && D(Dn), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
      case 24:
        return zt(Oe), null;
      case 25:
        return null;
  ...
  function vt(e, t) {
    ...
    if (n !== null) if (typeof u == "function") try {
      u();
    } catch (l) {
      ae(e, t, l);
    } finally {
  ...
  function bi(e, t, n) {
    var u = e.tag;
    if (u === 5 || u === 6) e = e.stateNode, t ? (n.nodeType === 9 ? n.body : n.nodeName === "HTML" ? n.ownerDocument.body : n).insertBefore(e, t) : (t = n.nodeType === 9 ? n.body : n.nodeName === "HTML" ? n.ownerDocument.body : n, t.appendChild(e), n = n._reactRootContainer, n != null || t.onclick !== null || (t.onclick = Tt));
    else if (u !== 4 && (u === 27 && sn(e.type) && (n = e.stateNode, t = null), e = e.child, e !== null)) for (bi(e, t, n), e = e.sibling; e !== null; ) bi(e, t, n), e = e.sibling;
  }
  function lu(e, t, n) {
    var u = e.tag;
    if (u === 5 || u === 6) e = e.stateNode, t ? n.insertBefore(e, t) : n.appendChild(e);
    else if (u !== 4 && (u === 27 && sn(e.type) && (n = e.stateNode), e = e.child, e !== null)) for (lu(e, t, n), e = e.sibling; e !== null; ) lu(e, t, n), e = e.sibling;
  }
  function Co(e) {
  ...
  var Lt = false, he = false, di = false, zo = typeof WeakSet == "function" ? WeakSet : Set, xe = null;
  function Eb(e, t) {
    if (e = e.containerInfo, Ni = Au, e = Xr(e), il(e)) {
      if ("selectionStart" in e) var n = { start: e.selectionStart, end: e.selectionEnd };
        ...
        if (u && u.rangeCount !== 0) {
          ...
          var o = 0, s = -1, d = -1, h = 0, E = 0, M = e, w = null;
          t: for (; ; ) {
            for (var S; M !== n || l !== 0 && M.nodeType !== 3 || (s = o + l), M !== r || u !== 0 && M.nodeType !== 3 || (d = o + u), M.nodeType === 3 && (o += M.nodeValue.length), (S = M.firstChild) !== null; ) w = M, M = S;
            for (; ; ) {
              if (M === e) break t;
              if (w === n && ++h === l && (s = o), w === r && ++E === u && (d = o), (S = M.nextSibling) !== null) break;
              M = w, w = M.parentNode;
            }
            M = S;
          }
    ...
    for (Ui = { focusedElem: e, selectionRange: n }, Au = false, xe = t; xe !== null; ) if (t = xe, e = t.child, (t.subtreeFlags & 1028) !== 0 && e !== null) e.return = t, xe = e;
    else for (; xe !== null; ) {
      switch (t = xe, r = t.alternate, e = t.flags, t.tag) {
        case 0:
          if ((e & 4) !== 0 && (e = t.updateQueue, e = e !== null ? e.events : null, e !== null)) for (n = 0; n < e.length; n++) l = e[n], l.ref.impl = l.nextImpl;
          break;
        case 11:
        case 15:
          break;
        case 1:
          if ((e & 1024) !== 0 && r !== null) {
            e = void 0, n = t, l = r.memoizedProps, r = r.memoizedState, u = n.stateNode;
            try {
              var N = Nn(n.type, l);
        ...
        case 3:
          if ((e & 1024) !== 0) {
            if (e = t.stateNode.containerInfo, n = e.nodeType, n === 9) Gi(e);
  ...
  function Ho(e, t, n) {
    ...
    switch (n.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        if (qt(e, n), u & 4) if (e = n.stateNode, t === null) try {
          e.componentDidMount();
        } catch (o) {
          ae(n, n.return, o);
        }
      ...
      case 26:
      case 5:
        qt(e, n), t === null && u & 4 && Do(n), u & 512 && ec(n, n.return);
        break;
      case 12:
        qt(e, n);
        break;
      case 31:
        ...
        break;
      case 13:
        qt(e, n), u & 4 && Lo(e, n), u & 64 && (e = n.memoizedState, e !== null && (e = e.dehydrated, e !== null && (n = Nb.bind(null, n), td(e, n))));
        break;
      case 22:
        if (u = n.memoizedState !== null || Lt, !u) {
          t = t !== null && t.memoizedState !== null || he, l = Lt;
          var r = he;
          Lt = u, (he = t) && !r ? Vt(e, n, (n.subtreeFlags & 8772) !== 0) : qt(e, n), Lt = l, he = r;
        }
        break;
      case 30:
        break;
  ...
  function No(e) {
    var t = e.alternate;
    t !== null && (e.alternate = null, No(t)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (t = e.stateNode, t !== null && Qu(t)), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null;
  }
  var se = null, Ve = false;
  function Gt(e, t, n) {
  ...
  function Uo(e, t, n) {
    ...
    switch (n.tag) {
      case 26:
        he || vt(n, t), Gt(e, t, n), n.memoizedState ? n.memoizedState.count-- : n.stateNode && (n = n.stateNode, n.parentNode.removeChild(n));
        break;
      case 27:
        he || vt(n, t);
        var u = se, l = Ve;
        sn(n.type) && (se = n.stateNode, Ve = false), Gt(e, t, n), fc(n.stateNode), se = u, Ve = l;
        break;
      case 5:
        he || vt(n, t);
      case 6:
        if (u = se, l = Ve, se = null, Gt(e, t, n), se = u, Ve = l, se !== null) if (Ve) try {
          (se.nodeType === 9 ? se.body : se.nodeName === "HTML" ? se.ownerDocument.body : se).removeChild(n.stateNode);
        } catch (r) {
          ae(n, t, r);
        }
        else try {
        ...
        break;
      case 18:
        se !== null && (Ve ? (e = se, T_(e.nodeType === 9 ? e.body : e.nodeName === "HTML" ? e.ownerDocument.body : e, n.stateNode), wa(e)) : T_(se, n.stateNode));
        break;
      case 4:
        u = se, l = Ve, se = n.stateNode.containerInfo, Ve = true, Gt(e, t, n), se = u, Ve = l;
        break;
      case 0:
      case 11:
      case 14:
      case 15:
        ...
        break;
      case 1:
        he || (vt(n, t), u = n.stateNode, typeof u.componentWillUnmount == "function" && Mo(n, t, u)), Gt(e, t, n);
        break;
      case 21:
        Gt(e, t, n);
        break;
      case 22:
        he = (u = he) || n.memoizedState !== null, Gt(e, t, n), he = u;
        break;
      default:
        Gt(e, t, n);
    }
  ...
  function Ab(e) {
    switch (e.tag) {
      ...
      case 22:
        return e = e.stateNode, t = e._retryCache, t === null && (t = e._retryCache = new zo()), t;
      default:
  ...
  function Ye(e, t) {
    ...
    if (n !== null) for (var u = 0; u < n.length; u++) {
      ...
      Uo(r, o, l), se = null, Ve = false, r = l.alternate, r !== null && (r.return = null), l.return = null;
    }
    if (t.subtreeFlags & 13886) for (t = t.child; t !== null; ) Go(t, e), t = t.sibling;
  }
  var mt = null;
  function Go(e, t) {
    ...
    switch (e.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Ye(t, e), Xe(e), u & 512 && (he || n === null || vt(n, n.return)), u & 64 && Lt && (e = e.updateQueue, e !== null && (u = e.callbacks, u !== null && (n = e.shared.hiddenCallbacks, e.shared.hiddenCallbacks = n === null ? u : n.concat(u))));
        break;
      case 26:
        var l = mt;
        if (Ye(t, e), Xe(e), u & 512 && (he || n === null || vt(n, n.return)), u & 4) {
          var r = n !== null ? n.memoizedState : null;
          if (u = e.memoizedState, n === null) if (u === null) if (e.stateNode === null) {
            e: {
              u = e.type, n = e.memoizedProps, l = l.ownerDocument || l;
              t: switch (u) {
                case "title":
                  r = l.getElementsByTagName("title")[0], (!r || r[Aa] || r[Se] || r.namespaceURI === "http://www.w3.org/2000/svg" || r.hasAttribute("itemprop")) && (r = l.createElement(u), l.head.insertBefore(r, l.querySelector("head > title"))), Me(r, u, n), r[Se] = e, ve(r), u = r;
                  break e;
                case "link":
                  var o = G_("link", "href", l).get(u + (n.href || ""));
                  if (o) {
                    for (var s = 0; s < o.length; s++) if (r = o[s], r.getAttribute("href") === (n.href == null || n.href === "" ? null : n.href) && r.getAttribute("rel") === (n.rel == null ? null : n.rel) && r.getAttribute("title") === (n.title == null ? null : n.title) && r.getAttribute("crossorigin") === (n.crossOrigin == null ? null : n.crossOrigin)) {
                      o.splice(s, 1);
                      break t;
                    }
                  }
                  r = l.createElement(u), Me(r, u, n), l.head.appendChild(r);
                  break;
                case "meta":
                  if (o = G_("meta", "content", l).get(u + (n.content || ""))) {
          ...
          else r !== u ? (r === null ? n.stateNode !== null && (n = n.stateNode, n.parentNode.removeChild(n)) : r.count--, u === null ? q_(l, e.type, e.stateNode) : L_(l, u, e.memoizedProps)) : u === null && e.stateNode !== null && _i(e, e.memoizedProps, n.memoizedProps);
        }
        break;
      case 27:
        Ye(t, e), Xe(e), u & 512 && (he || n === null || vt(n, n.return)), n !== null && u & 4 && _i(e, e.memoizedProps, n.memoizedProps);
        break;
      case 5:
        if (Ye(t, e), Xe(e), u & 512 && (he || n === null || vt(n, n.return)), e.flags & 32) {
          l = e.stateNode;
          try {
            Zn(l, "");
          } catch (N) {
        ...
        u & 4 && e.stateNode != null && (l = e.memoizedProps, _i(e, l, n !== null ? n.memoizedProps : l)), u & 1024 && (di = true);
        break;
      case 6:
        if (Ye(t, e), Xe(e), u & 4) {
        ...
        break;
      case 3:
        if (vu = null, l = mt, mt = hu(t.containerInfo), Ye(t, e), mt = l, Xe(e), u & 4 && n !== null && n.memoizedState.isDehydrated) try {
          wa(t.containerInfo);
        } catch (N) {
          ae(e, e.return, N);
        }
        ...
        break;
      case 4:
        u = mt, mt = hu(e.stateNode.containerInfo), Ye(t, e), Xe(e), mt = u;
        break;
      case 12:
        Ye(t, e), Xe(e);
        break;
      case 31:
        Ye(t, e), Xe(e), u & 4 && (u = e.updateQueue, u !== null && (e.updateQueue = null, iu(e, u)));
        break;
      case 13:
        Ye(t, e), Xe(e), e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && (fu = Fe()), u & 4 && (u = e.updateQueue, u !== null && (e.updateQueue = null, iu(e, u)));
        break;
      case 22:
        l = e.memoizedState !== null;
        var d = n !== null && n.memoizedState !== null, h = Lt, E = he;
        if (Lt = h || l, he = E || d, Ye(t, e), he = E, Lt = h, Xe(e), u & 8192) e: for (t = e.stateNode, t._visibility = l ? t._visibility & -2 : t._visibility | 1, l && (n === null || d || Lt || he || Un(e)), n = null, t = e; ; ) {
          if (t.tag === 5 || t.tag === 26) {
            if (n === null) {
              d = n = t;
              try {
                if (r = d.stateNode, l) o = r.style, typeof o.setProperty == "function" ? o.setProperty("display", "none", "important") : o.display = "none";
                else {
                  s = d.stateNode;
                  var M = d.memoizedProps.style, w = M != null && M.hasOwnProperty("display") ? M.display : null;
        ...
        u & 4 && (u = e.updateQueue, u !== null && (n = u.retryQueue, n !== null && (u.retryQueue = null, iu(e, n))));
        break;
      case 19:
        Ye(t, e), Xe(e), u & 4 && (u = e.updateQueue, u !== null && (e.updateQueue = null, iu(e, u)));
        break;
    ...
    if (t & 2) {
      try {
        ...
        switch (n.tag) {
          ...
          case 3:
          case 4:
            var d = n.stateNode.containerInfo, h = si(e);
            bi(e, h, d);
            break;
          default:
            throw Error(f(161));
  ...
  function qo(e) {
    if (e.subtreeFlags & 1024) for (e = e.child; e !== null; ) {
      var t = e;
      qo(t), t.tag === 5 && t.flags & 1024 && t.stateNode.reset(), e = e.sibling;
    }
  }
  function qt(e, t) {
    if (t.subtreeFlags & 8772) for (t = t.child; t !== null; ) Ho(e, t.alternate, t), t = t.sibling;
  }
  function Un(e) {
    for (e = e.child; e !== null; ) {
      var t = e;
      switch (t.tag) {
        ...
        case 1:
          vt(t, t.return);
          var n = t.stateNode;
          typeof n.componentWillUnmount == "function" && Mo(t, t.return, n), Un(t);
          break;
        case 27:
          fc(t.stateNode);
        case 26:
  ...
  function Vt(e, t, n) {
    for (n = n && (t.subtreeFlags & 8772) !== 0, t = t.child; t !== null; ) {
      var u = t.alternate, l = e, r = t, o = r.flags;
      switch (r.tag) {
        case 0:
        case 11:
        case 15:
          ...
          break;
        case 1:
          if (Vt(l, r, n), u = r, l = u.stateNode, typeof l.componentDidMount == "function") try {
            l.componentDidMount();
          } catch (h) {
            ae(u, u.return, h);
          }
          if (u = r, l = u.updateQueue, l !== null) {
            ...
            try {
              ...
              if (d !== null) for (l.shared.hiddenCallbacks = null, l = 0; l < d.length; l++) mf(d[l], s);
            } catch (h) {
              ae(u, u.return, h);
            }
          }
        ...
        case 26:
        case 5:
          Vt(l, r, n), n && u === null && o & 4 && Do(r), ec(r, r.return);
          break;
        case 12:
          Vt(l, r, n);
          break;
  ...
  function pt(e, t, n, u) {
    if (t.subtreeFlags & 10256) for (t = t.child; t !== null; ) Vo(e, t, n, u), t = t.sibling;
  }
  function Vo(e, t, n, u) {
    var l = t.flags;
    switch (t.tag) {
      ...
      case 1:
        ...
        break;
      case 3:
        pt(e, t, n, u), l & 2048 && (e = null, t.alternate !== null && (e = t.alternate.memoizedState.cache), t = t.memoizedState.cache, t !== e && (t.refCount++, e != null && qa(e)));
        break;
      case 12:
        if (l & 2048) {
      ...
      case 23:
        break;
      case 22:
        r = t.stateNode, o = t.alternate, t.memoizedState !== null ? r._visibility & 2 ? pt(e, t, n, u) : tc(e, t) : r._visibility & 2 ? pt(e, t, n, u) : (r._visibility |= 2, _a(e, t, n, u, (t.subtreeFlags & 10256) !== 0 || false)), l & 2048 && gi(o, t);
        break;
      case 24:
  ...
  function _a(e, t, n, u, l) {
    for (l = l && ((t.subtreeFlags & 10256) !== 0 || false), t = t.child; t !== null; ) {
      ...
      switch (o.tag) {
        ...
        case 22:
          var E = o.stateNode;
          o.memoizedState !== null ? E._visibility & 2 ? _a(r, o, s, d, l) : tc(r, o) : (E._visibility |= 2, _a(r, o, s, d, l)), l && h & 2048 && gi(o.alternate, o);
          break;
        case 24:
  ...
  var nc = 8192;
  function sa(e, t, n) {
    if (e.subtreeFlags & nc) for (e = e.child; e !== null; ) Yo(e, t, n), e = e.sibling;
  }
  function Yo(e, t, n) {
    switch (e.tag) {
      case 26:
        sa(e, t, n), e.flags & nc && e.memoizedState !== null && bd(n, mt, e.memoizedState, e.memoizedProps);
        break;
      case 5:
        sa(e, t, n);
        break;
      ...
      case 4:
        ...
        break;
      case 22:
        e.memoizedState === null && (u = e.alternate, u !== null && u.memoizedState !== null ? (u = nc, nc = 16777216, sa(e, t, n), nc = u) : sa(e, t, n));
        break;
      default:
        sa(e, t, n);
    }
  ...
  function ac(e) {
    ...
    if (e.subtreeFlags & 10256) for (e = e.child; e !== null; ) Qo(e), e = e.sibling;
  }
  function Qo(e) {
    switch (e.tag) {
      case 0:
  ...
  var Tb = { getCacheForType: function(e) {
    var t = Ae(Oe), n = t.data.get(e);
    return n === void 0 && (n = e(), t.data.set(e, n)), n;
  }, cacheSignal: function() {
    return Ae(Oe).controller.signal;
  } }, Mb = typeof WeakMap == "function" ? WeakMap : Map, ee = 0, fe = null, W = null, K = 0, ne = 0, et = null, un = false, ba = false, pi = false, Yt = 0, de = 0, ln = 0, Bn = 0, Oi = 0, tt = 0, da = 0, cc = null, Qe = null, yi = false, fu = 0, Wo = 0, ou = 1 / 0, _u = null, rn = null, we = 0, fn = null, ga = null, Xt = 0, ji = 0, hi = null, Fo = null, uc = 0, wi = null;
  function nt() {
    return (ee & 2) !== 0 && K !== 0 ? K & -K : A.T !== null ? Ti() : ir();
  }
  function Ko() {
    if (tt === 0) if ((K & 536870912) === 0 || I) {
      var e = yc;
  ...
  function Ze(e, t, n) {
    (e === fe && (ne === 2 || ne === 9) || e.cancelPendingCommit !== null) && (ma(e, 0), on(e, K, tt, false)), Ea(e, n), ((ee & 2) === 0 || e !== fe) && (e === fe && ((ee & 2) === 0 && (Bn |= n), de === 4 && on(e, K, tt, false)), xt(e));
  }
  function Jo(e, t, n) {
    if ((ee & 6) !== 0) throw Error(f(327));
    var u = !n && (t & 127) === 0 && (t & e.expiredLanes) === 0 || Sa(e, t), l = u ? Cb(e, t) : xi(e, t, true), r = u;
    do {
      if (l === 0) {
        ba && !u && on(e, t, 0, false);
        break;
        ...
        if (l === 2) {
          ...
          if (o !== 0) {
            ...
            e: {
              ...
              if (d && (ma(s, o).flags |= 256), o = xi(s, o, false), o !== 2) {
                if (pi && !d) {
                  s.errorRecoveryDisabledLanes |= r, Bn |= r, l = 4;
                  break e;
                }
                r = Qe, Qe = l, r !== null && (Qe === null ? Qe = r : Qe.push.apply(Qe, r));
              }
              l = o;
            }
        ...
        e: {
          ...
          if ((t & 62914560) === t && (l = fu + 300 - Fe(), 10 < l)) {
            if (on(u, t, tt, !un), hc(u, 0, true) !== 0) break e;
            Xt = t, u.timeoutHandle = E_(ko.bind(null, u, n, Qe, _u, yi, t, tt, Bn, da, un, r, "Throttled", -0, 0), l);
            break e;
          }
  ...
  function ko(e, t, n, u, l, r, o, s, d, h, E, M, w, S) {
    if (e.timeoutHandle = -1, M = t.subtreeFlags, M & 8192 || (M & 16785408) === 16785408) {
      M = { stylesheets: null, count: 0, imgCount: 0, imgBytes: 0, suspenseyImages: [], waitingForImages: true, waitingForViewTransition: false, unsuspend: Tt }, Yo(t, r, M);
      var N = (r & 62914560) === r ? fu - Fe() : (r & 4194048) === r ? Wo - Fe() : 0;
      if (N = dd(M, N), N !== null) {
        Xt = r, e.cancelPendingCommit = N(c_.bind(null, e, t, r, n, u, l, o, s, d, E, M, null, w, S)), on(e, r, o, !h);
        return;
      }
    }
  ...
  function Db(e) {
    for (var t = e; ; ) {
      var n = t.tag;
      if ((n === 0 || n === 11 || n === 15) && t.flags & 16384 && (n = t.updateQueue, n !== null && (n = n.stores, n !== null))) for (var u = 0; u < n.length; u++) {
        var l = n[u], r = l.getSnapshot;
        l = l.value;
        try {
  ...
  function vi() {
    if (W !== null) {
      ...
      else e = W, Ct = Tn = null, Gl(e), la = null, Ya = 0, e = W;
  ...
  function ma(e, t) {
    ...
    n !== -1 && (e.timeoutHandle = -1, kb(n)), n = e.cancelPendingCommit, n !== null && (e.cancelPendingCommit = null, n()), Xt = 0, vi(), fe = e, W = n = Dt(e.current, null), K = t, ne = 0, et = null, un = false, ba = Sa(e, t), pi = false, da = tt = Oi = Bn = ln = de = 0, Qe = cc = null, yi = false, (t & 8) !== 0 && (t |= t & 32);
  ...
  function Io(e, t) {
    Y = null, A.H = ka, t === ua || t === Vc ? (t = sf(), ne = 3) : t === Al ? (t = sf(), ne = 4) : ne = t === ti ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1, et = t, W === null && (de = 1, tu(e, it(t, e.current)));
  }
  function $o() {
    var e = $e.current;
    return e === null ? true : (K & 4194048) === K ? _t === null : (K & 62914560) === K || (K & 536870912) !== 0 ? e === _t : false;
  }
  function Po() {
    var e = A.H;
  ...
  function bu() {
    de = 4, un || (K & 4194048) !== K && $e.current !== null || (ba = true), (ln & 134217727) === 0 && (Bn & 134217727) === 0 || fe === null || on(fe, K, tt, false);
  }
  function xi(e, t, n) {
    var u = ee;
    ee |= 2;
    var l = Po(), r = e_();
    (fe !== e || K !== t) && (_u = null, ma(e, t)), t = false;
    var o = de;
    e: do
      try {
        if (ne !== 0 && W !== null) {
          ...
          switch (ne) {
            ...
            case 6:
              ...
              var h = ne;
              if (ne = 0, et = null, pa(e, s, d, h), n && ba) {
                o = 0;
                break e;
              }
              break;
    ...
    while (true);
    return t && e.shellSuspendCounter++, Ct = Tn = null, ee = u, A.H = l, A.A = r, W === null && (fe = null, K = 0, zc()), o;
  }
  function Rb() {
    for (; W !== null; ) t_(W);
  }
  function Cb(e, t) {
    ...
    ee |= 2;
    var u = Po(), l = e_();
    fe !== e || K !== t ? (_u = null, ou = Fe() + 500, ma(e, t)) : ba = Sa(e, t);
    e: do
      try {
        if (ne !== 0 && W !== null) {
          t = W;
          ...
          t: switch (ne) {
            ...
            case 4:
              ...
              break e;
            case 7:
              of(r) ? (ne = 0, et = null, n_(t)) : (ne = 0, et = null, pa(e, t, r, 7));
              break;
            case 5:
              var o = null;
              switch (W.tag) {
    ...
    while (true);
    return Ct = Tn = null, A.H = u, A.A = l, ee = n, W !== null ? 0 : (fe = null, K = 0, zc(), de);
  }
  function zb() {
    for (; W !== null && !ns(); ) t_(W);
  }
  ...
  function n_(e) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = yo(n, t, t.pendingProps, t.type, void 0, K);
        break;
      case 11:
        t = yo(n, t, t.pendingProps, t.type.render, t.ref, K);
        break;
      case 5:
        Gl(t);
      default:
        Ao(n, t), t = W = $r(t, Yt), t = So(n, t, Yt);
    }
    e.memoizedProps = e.pendingProps, t === null ? du(e) : W = t;
  }
  function pa(e, t, n, u) {
    ...
    try {
      if (hb(e, l, t, n, K)) {
        de = 1, tu(e, it(n, e.current)), W = null;
        return;
      }
    } catch (r) {
    ...
    t.flags & 32768 ? (I || u === 1 ? e = true : ba || (K & 536870912) !== 0 ? e = false : (un = e = true, (u === 2 || u === 9 || u === 3 || u === 6) && (u = $e.current, u !== null && u.tag === 13 && (u.flags |= 16384))), a_(t, e)) : du(t);
  }
  function du(e) {
    var t = e;
    do {
  ...
  function c_(e, t, n, u, l, r, o, s, d) {
    ...
    if (t !== null) {
      ...
      if (r = t.lanes | t.childLanes, r |= sl, ss(e, n, r, o, s, d), e === fe && (W = fe = null, K = 0), ga = t, fn = e, Xt = n, ji = r, hi = l, Fo = u, (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, Bb(pc, function() {
        return f_(), null;
      })) : (e.callbackNode = null, e.callbackPriority = 0), u = (t.flags & 13878) !== 0, (t.subtreeFlags & 13878) !== 0 || u) {
        u = A.T, A.T = null, l = z.p, z.p = 2, o = ee, ee |= 4;
        try {
          Eb(e, t, n);
        } finally {
          ee = o, z.p = l, A.T = u;
  ...
  function u_() {
    if (we === 1) {
      we = 0;
      var e = fn, t = ga, n = (t.flags & 13878) !== 0;
      if ((t.subtreeFlags & 13878) !== 0 || n) {
        ...
        try {
          Go(t, e);
          var r = Ui, o = Xr(e.containerInfo), s = r.focusedElem, d = r.selectionRange;
          if (o !== s && s && s.ownerDocument && Yr(s.ownerDocument.documentElement, s)) {
            if (d !== null && il(s)) {
              var h = d.start, E = d.end;
              if (E === void 0 && (E = h), "selectionStart" in s) s.selectionStart = h, s.selectionEnd = Math.min(E, s.value.length);
              else {
                var M = s.ownerDocument || document, w = M && M.defaultView || window;
                if (w.getSelection) {
                  var S = w.getSelection(), N = s.textContent.length, G = Math.min(d.start, N), ie = d.end === void 0 ? G : Math.min(d.end, N);
                  !S.extend && G > ie && (o = ie, ie = G, G = o);
                  var O = Vr(s, G), g = Vr(s, ie);
                  if (O && g && (S.rangeCount !== 1 || S.anchorNode !== O.node || S.anchorOffset !== O.offset || S.focusNode !== g.node || S.focusOffset !== g.offset)) {
                    var j = M.createRange();
                    j.setStart(O.node, O.offset), S.removeAllRanges(), G > ie ? (S.addRange(j), S.extend(g.node, g.offset)) : (j.setEnd(g.node, g.offset), S.addRange(j));
                  }
                }
              }
            }
            for (M = [], S = s; S = S.parentNode; ) S.nodeType === 1 && M.push({ element: S, left: S.scrollLeft, top: S.scrollTop });
  ...
  function l_() {
    if (we === 2) {
      we = 0;
      var e = fn, t = ga, n = (t.flags & 8772) !== 0;
  ...
  function i_() {
    if (we === 4 || we === 3) {
      we = 0, as();
      var e = fn, t = ga, n = Xt, u = Fo;
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? we = 5 : (we = 0, ga = fn = null, r_(e, e.pendingLanes));
      var l = e.pendingLanes;
      if (l === 0 && (rn = null), Yu(n), t = t.stateNode, Ke && typeof Ke.onCommitFiberRoot == "function") try {
        Ke.onCommitFiberRoot(xa, t, void 0, (t.current.flags & 128) === 128);
      } catch {
      }
      if (u !== null) {
        t = A.T, l = z.p, z.p = 2, A.T = null;
        try {
          for (var r = e.onRecoverableError, o = 0; o < u.length; o++) {
            var s = u[o];
      ...
      (Xt & 3) !== 0 && gu(), xt(e), l = e.pendingLanes, (n & 261930) !== 0 && (l & 42) !== 0 ? e === wi ? uc++ : (uc = 0, wi = e) : uc = 0, lc(0);
    }
  }
  function r_(e, t) {
  ...
  function f_() {
    ...
    var e = fn, t = ji;
    ji = 0;
    var n = Yu(Xt), u = A.T, l = z.p;
    try {
      z.p = 32 > n ? 32 : n, A.T = null, n = hi, hi = null;
      var r = fn, o = Xt;
      if (we = 0, ga = fn = null, Xt = 0, (ee & 6) !== 0) throw Error(f(331));
      var s = ee;
      if (ee |= 4, Qo(r.current), Vo(r, r.current, o, n), ee = s, lc(0, false), Ke && typeof Ke.onPostCommitFiberRoot == "function") try {
  ...
  function o_(e, t, n) {
    t = it(n, t), t = ei(e.stateNode, t, 2), e = tn(e, t, 2), e !== null && (Ea(e, 2), xt(e));
  }
  function ae(e, t, n) {
    if (e.tag === 3) o_(e, e, n);
    else for (; t !== null; ) {
      if (t.tag === 3) {
        ...
        if (typeof t.type.getDerivedStateFromError == "function" || typeof u.componentDidCatch == "function" && (rn === null || !rn.has(u))) {
          e = it(n, e), n = oo(2), u = tn(t, n, 2), u !== null && (_o(n, u, t, e), Ea(u, 2), xt(u));
          break;
        }
      }
      t = t.return;
  ...
  function Si(e, t, n) {
    ...
    l.has(n) || (pi = true, l.add(n), e = Hb.bind(null, e, t, n), t.then(e, e));
  }
  function Hb(e, t, n) {
    var u = e.pingCache;
    u !== null && u.delete(t), e.pingedLanes |= e.suspendedLanes & n, e.warmLanes &= ~n, fe === e && (K & n) === n && (de === 4 || de === 3 && (K & 62914560) === K && 300 > Fe() - fu ? (ee & 2) === 0 && ma(e, 0) : Oi |= n, da === K && (da = 0)), xt(e);
  }
  function __(e, t) {
  ...
  var mu = null, Oa = null, Ei = false, pu = false, Ai = false, _n = 0;
  function xt(e) {
    e !== Oa && e.next === null && (Oa === null ? mu = Oa = e : Oa = Oa.next = e), pu = true, Ei || (Ei = true, Gb());
  }
  function lc(e, t) {
    if (!Ai && pu) {
      Ai = true;
        ...
        for (var n = false, u = mu; u !== null; ) {
          if (e !== 0) {
            ...
            if (l === 0) var r = 0;
              ...
              var o = u.suspendedLanes, s = u.pingedLanes;
              r = (1 << 31 - Je(42 | e) + 1) - 1, r &= l & ~(o & ~s), r = r & 201326741 ? r & 201326741 | 1 : r ? r | 2 : 0;
            }
            r !== 0 && (n = true, g_(u, r));
          } else r = K, r = hc(u, u === fe ? r : 0, u.cancelPendingCommit !== null || u.timeoutHandle !== -1), (r & 3) === 0 || Sa(u, r) || (n = true, g_(u, r));
          u = u.next;
        }
      while (n);
      Ai = false;
  ...
  function s_() {
    ...
    var e = 0;
    _n !== 0 && Jb() && (e = _n);
    for (var t = Fe(), n = null, u = mu; u !== null; ) {
      var l = u.next, r = b_(u, t);
      r === 0 ? (u.next = null, n === null ? mu = l : n.next = l, l === null && (Oa = n)) : (n = u, (e !== 0 || (r & 3) !== 0) && (pu = true)), u = l;
    }
    we !== 0 && we !== 5 || lc(e), _n !== 0 && (_n = 0);
  }
  function b_(e, t) {
    for (var n = e.suspendedLanes, u = e.pingedLanes, l = e.expirationTimes, r = e.pendingLanes & -62914561; 0 < r; ) {
      var o = 31 - Je(r), s = 1 << o, d = l[o];
      d === -1 ? ((s & n) === 0 || (s & u) !== 0) && (l[o] = _s(s, t)) : d <= t && (e.expiredLanes |= s), r &= ~s;
    }
    if (t = fe, n = K, n = hc(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), u = e.callbackNode, n === 0 || e === t && (ne === 2 || ne === 9) || e.cancelPendingCommit !== null) return u !== null && u !== null && Gu(u), e.callbackNode = null, e.callbackPriority = 0;
    if ((n & 3) === 0 || Sa(e, n)) {
      ...
      return u = d_.bind(null, e), n = Lu(n, u), e.callbackPriority = t, e.callbackNode = n, t;
    }
  ...
  function d_(e, t) {
    ...
    var u = K;
    return u = hc(e, e === fe ? u : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), u === 0 ? null : (Jo(e, u, t), b_(e, Fe()), e.callbackNode != null && e.callbackNode === n ? d_.bind(null, e) : null);
  }
  function g_(e, t) {
    if (gu()) return null;
    Jo(e, t, true);
  ...
  function Ti() {
    if (_n === 0) {
      var e = aa;
      e === 0 && (e = Oc, Oc <<= 1, (Oc & 261888) === 0 && (Oc = 256)), _n = e;
    }
    return _n;
  }
  function m_(e) {
    return e == null || typeof e == "symbol" || typeof e == "boolean" ? null : typeof e == "function" ? e : Sc("" + e);
  }
  function p_(e, t) {
  ...
  function qb(e, t, n, u, l) {
    if (t === "submit" && n && n.stateNode === l) {
      var r = m_((l[Ge] || null).action), o = u.submitter;
      o && (t = (t = o[Ge] || null) ? m_(t.formAction) : o.getAttribute("formAction"), t !== null && (r = t, o = null));
    ...
    for (var n = 0; n < e.length; n++) {
      ...
      e: {
        ...
        if (t) for (var o = u.length - 1; 0 <= o; o--) {
          var s = u[o], d = s.instance, h = s.currentTarget;
          ...
          if (s = u[o], d = s.instance, h = s.currentTarget, s = s.listener, d !== r && l.isPropagationStopped()) break e;
          r = s, l.currentTarget = h;
          try {
            r(l);
          } catch (E) {
  ...
  function Ci(e) {
    if (!e[Ou]) {
      e[Ou] = true, or.forEach(function(n) {
        n !== "selectionchange" && (Xb.has(n) || Ri(n, false, e), Ri(n, true, e));
      });
      var t = e.nodeType === 9 ? e : e.ownerDocument;
      t === null || t[Ou] || (t[Ou] = true, Ri("selectionchange", false, t));
    }
  }
  function y_(e, t, n, u) {
    switch (K_(t)) {
    ...
    n = l.bind(null, t, n, e), l = void 0, !$u || t !== "touchstart" && t !== "touchmove" && t !== "wheel" || (l = true), u ? l !== void 0 ? e.addEventListener(t, n, { capture: true, passive: l }) : e.addEventListener(t, n, true) : l !== void 0 ? e.addEventListener(t, n, { passive: l }) : e.addEventListener(t, n, false);
  }
    ...
    if ((t & 1) === 0 && (t & 2) === 0 && u !== null) e: for (; ; ) {
      ...
      if (o === 3 || o === 4) {
        ...
        if (o === 4) for (o = u.return; o !== null; ) {
          var d = o.tag;
          if ((d === 3 || d === 4) && o.stateNode.containerInfo === l) return;
          o = o.return;
        }
        for (; s !== null; ) {
          if (o = qn(s), o === null) return;
          if (d = o.tag, d === 5 || d === 6 || d === 26 || d === 27) {
            u = r = o;
            continue e;
          }
          s = s.parentNode;
    ...
    wr(function() {
      ...
      e: {
        ...
        if (w !== void 0) {
          ...
          var G = (t & 4) !== 0, ie = !G && (e === "scroll" || e === "scrollend"), O = G ? w !== null ? w + "Capture" : null : w;
          G = [];
          for (var g = h, j; g !== null; ) {
            var T = g;
            if (j = T.stateNode, T = T.tag, T !== 5 && T !== 26 && T !== 27 || j === null || O === null || (T = Ma(g, O), T != null && G.push(rc(g, T, j))), ie) break;
            g = g.return;
          }
          0 < G.length && (w = new S(w, N, null, n, E), M.push({ event: w, listeners: G }));
        }
      }
      if ((t & 7) === 0) {
        e: {
          if (w = e === "mouseover" || e === "pointerover", S = e === "mouseout" || e === "pointerout", w && n !== Ju && (N = n.relatedTarget || n.fromElement) && (qn(N) || N[Gn])) break e;
          if ((S || w) && (w = E.window === E ? E : (w = E.ownerDocument) ? w.defaultView || w.parentWindow : window, S ? (N = n.relatedTarget || n.toElement, S = h, N = N ? qn(N) : null, N !== null && (ie = b(N), G = N.tag, N !== ie || G !== 5 && G !== 27 && G !== 6) && (N = null)) : (S = null, N = h), S !== N)) {
            if (G = Sr, T = "onMouseLeave", O = "onMouseEnter", g = "mouse", (e === "pointerout" || e === "pointerover") && (G = Ar, T = "onPointerLeave", O = "onPointerEnter", g = "pointer"), ie = S == null ? w : Ta(S), j = N == null ? w : Ta(N), w = new G(T, g + "leave", S, n, E), w.target = ie, w.relatedTarget = j, T = null, qn(E) === h && (G = new G(O, g + "enter", N, n, E), G.target = j, G.relatedTarget = ie, T = G), ie = T, S && N) t: {
              for (G = Qb, O = S, g = N, j = 0, T = O; T; T = G(T)) j++;
              T = 0;
            ...
            S !== null && j_(M, w, S, G, false), N !== null && ie !== null && j_(M, ie, N, G, true);
          }
        }
        e: {
          if (w = h ? Ta(h) : window, S = w.nodeName && w.nodeName.toLowerCase(), S === "select" || S === "input" && w.type === "file") var $ = Nr;
          else if (zr(w)) if (Ur) $ = tb;
          else {
            $ = Ps;
            var B = $s;
          }
          else S = w.nodeName, !S || S.toLowerCase() !== "input" || w.type !== "checkbox" && w.type !== "radio" ? h && Ku(h.elementType) && ($ = Nr) : $ = eb;
          if ($ && ($ = $(e, h))) {
            Hr(M, $, n, E);
            break e;
          }
          B && B(e, w, h), e === "focusout" && h && w.type === "number" && h.memoizedProps.value != null && Fu(w, "number", w.value);
        }
        switch (B = h ? Ta(h) : window, e) {
          case "focusin":
            (zr(B) || B.contentEditable === "true") && (Jn = B, rl = h, Ba = null);
            break;
          case "focusout":
            Ba = rl = Jn = null;
            break;
        ...
        else Kn ? Rr(e, n) && (J = "onCompositionEnd") : e === "keydown" && n.keyCode === 229 && (J = "onCompositionStart");
        J && (Tr && n.locale !== "ko" && (Kn || J !== "onCompositionStart" ? J === "onCompositionEnd" && Kn && (X = vr()) : (Kt = E, Pu = "value" in Kt ? Kt.value : Kt.textContent, Kn = true)), B = yu(h, J), 0 < B.length && (J = new Er(J, e, null, n, E), M.push({ event: J, listeners: B }), X ? J.data = X : (X = Cr(n), X !== null && (J.data = X)))), (X = Fs ? Ks(e, n) : Js(e, n)) && (J = yu(h, "onBeforeInput"), 0 < J.length && (B = new Er("onBeforeInput", "beforeinput", null, n, E), M.push({ event: B, listeners: J }), B.data = X)), qb(M, e, h, n, E);
      }
      O_(M, t);
    });
  }
  ...
  function yu(e, t) {
    for (var n = t + "Capture", u = []; e !== null; ) {
      ...
      if (l = l.tag, l !== 5 && l !== 26 && l !== 27 || r === null || (l = Ma(e, n), l != null && u.unshift(rc(e, l, r)), l = Ma(e, t), l != null && u.push(rc(e, l, r))), e.tag === 3) return u;
      e = e.return;
    }
    return [];
  }
  ...
  function j_(e, t, n, u, l) {
    for (var r = t._reactName, o = []; n !== null && n !== u; ) {
      var s = n, d = s.alternate, h = s.stateNode;
      if (s = s.tag, d !== null && d === u) break;
      s !== 5 && s !== 26 && s !== 27 || h === null || (d = h, l ? (h = Ma(n, r), h != null && o.unshift(rc(n, h, d))) : l || (h = Ma(n, r), h != null && o.push(rc(n, h, d)))), n = n.return;
    }
...
`).replace(Wb, "");
    ...
    switch (n) {
      ...
      case "formAction":
        if (typeof u == "function") {
          ...
          break;
        } else typeof r == "function" && (n === "formAction" ? (t !== "input" && le(e, t, "name", l.name, l, null), le(e, t, "formEncType", l.formEncType, l, null), le(e, t, "formMethod", l.formMethod, l, null), le(e, t, "formTarget", l.formTarget, l, null)) : (le(e, t, "encType", l.encType, l, null), le(e, t, "method", l.method, l, null), le(e, t, "target", l.target, l, null)));
      ...
      case "xlinkHref":
        ...
        n = Sc("" + u), e.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", n);
        break;
      ...
      case "capture":
      case "download":
        u === true ? e.setAttribute(n, "") : u !== false && u != null && typeof u != "function" && typeof u != "symbol" ? e.setAttribute(n, u) : e.removeAttribute(n);
        break;
      case "cols":
      case "rows":
      case "size":
      ...
      case "textContent":
        break;
      default:
        (!(2 < n.length) || n[0] !== "o" && n[0] !== "O" || n[1] !== "n" && n[1] !== "N") && (n = js.get(n) || n, wc(e, n, u));
    }
  }
  function Hi(e, t, n, u, l, r) {
    switch (n) {
      ...
      case "textContent":
        break;
      default:
        if (!_r.hasOwnProperty(n)) e: {
          if (n[0] === "o" && n[1] === "n" && (l = n.endsWith("Capture"), t = n.slice(2, l ? n.length - 7 : void 0), r = e[Ge] || null, r = r != null ? r[n] : null, typeof r == "function" && e.removeEventListener(t, r, l), typeof u == "function")) {
            typeof r != "function" && r !== null && (n in e ? e[n] = null : e.hasAttribute(n) && e.removeAttribute(n)), e.addEventListener(t, u, l);
            break e;
          }
          n in e ? e[n] = u : u === true ? e.setAttribute(n, "") : wc(e, n, u);
        }
    }
  }
  function Me(e, t, n) {
    switch (t) {
      ...
      case "img":
        ...
        l && le(e, t, "srcSet", n.srcSet, n, null), u && le(e, t, "src", n.src, n, null);
        return;
      case "input":
        F("invalid", e);
        var s = r = o = l = null, d = null, h = null;
      ...
      case "select":
        ...
        for (l in n) if (n.hasOwnProperty(l) && (s = n[l], s != null)) switch (l) {
          case "value":
            r = s;
            break;
          case "defaultValue":
        ...
        t = r, n = o, e.multiple = !!u, t != null ? Qn(e, !!u, t, false) : n != null && Qn(e, !!u, n, true);
        return;
      case "textarea":
        ...
        return;
      case "option":
        for (d in n) if (n.hasOwnProperty(d) && (u = n[d], u != null)) switch (d) {
          case "selected":
      ...
      case "wbr":
      case "menuitem":
        for (h in n) if (n.hasOwnProperty(h) && (u = n[h], u != null)) switch (h) {
          case "children":
          case "dangerouslySetInnerHTML":
            throw Error(f(137, t));
          default:
      ...
      default:
        if (Ku(t)) {
          for (E in n) n.hasOwnProperty(E) && (u = n[E], u !== void 0 && Hi(e, t, E, u, n, void 0));
          return;
        }
    }
    for (s in n) n.hasOwnProperty(s) && (u = n[s], u != null && le(e, t, s, u, n, null));
  }
  function Fb(e, t, n, u) {
    switch (t) {
      case "div":
      ...
      case "li":
        break;
      case "input":
        var l = null, r = null, o = null, s = null, d = null, h = null, E = null;
        for (S in n) {
          var M = n[S];
          if (n.hasOwnProperty(S) && M != null) switch (S) {
            case "checked":
              break;
            case "value":
              break;
        ...
        for (var w in u) {
          var S = u[w];
          if (M = n[w], u.hasOwnProperty(w) && (S != null || M != null)) switch (w) {
            case "type":
              r = S;
              break;
            case "name":
      ...
      case "select":
        S = o = s = w = null;
        for (r in n) if (d = n[r], n.hasOwnProperty(r) && d != null) switch (r) {
          case "value":
            break;
          case "multiple":
            S = d;
        ...
        for (l in u) if (r = u[l], d = n[l], u.hasOwnProperty(l) && (r != null || d != null)) switch (l) {
          case "value":
            w = r;
            break;
          case "defaultValue":
        ...
        t = s, n = o, u = S, w != null ? Qn(e, !!n, w, false) : !!u != !!n && (t != null ? Qn(e, !!n, t, true) : Qn(e, !!n, n ? [] : "", false));
        return;
      case "textarea":
        S = w = null;
        for (s in n) if (l = n[s], n.hasOwnProperty(s) && l != null && !u.hasOwnProperty(s)) switch (s) {
          case "value":
            break;
          case "children":
            break;
        ...
        for (o in u) if (l = u[o], r = n[o], u.hasOwnProperty(o) && (l != null || r != null)) switch (o) {
          case "value":
            w = l;
            break;
          case "defaultValue":
        ...
        return;
      case "option":
        for (var N in n) if (w = n[N], n.hasOwnProperty(N) && w != null && !u.hasOwnProperty(N)) switch (N) {
          case "selected":
            e.selected = false;
            break;
          default:
        ...
        for (d in u) if (w = u[d], S = n[d], u.hasOwnProperty(d) && w !== S && (w != null || S != null)) switch (d) {
          case "selected":
      ...
      case "wbr":
      case "menuitem":
        for (var G in n) w = n[G], n.hasOwnProperty(G) && w != null && !u.hasOwnProperty(G) && le(e, t, G, null, u, w);
        for (h in u) if (w = u[h], S = n[h], u.hasOwnProperty(h) && w !== S && (w != null || S != null)) switch (h) {
          case "children":
          case "dangerouslySetInnerHTML":
      ...
      default:
        if (Ku(t)) {
          for (var ie in n) w = n[ie], n.hasOwnProperty(ie) && w !== void 0 && !u.hasOwnProperty(ie) && Hi(e, t, ie, void 0, u, w);
          for (E in u) w = u[E], S = n[E], !u.hasOwnProperty(E) || w === S || w === void 0 && S === void 0 || Hi(e, t, E, w, u, S);
          return;
        }
    }
    for (var O in n) w = n[O], n.hasOwnProperty(O) && w != null && !u.hasOwnProperty(O) && le(e, t, O, null, u, w);
    for (M in u) w = u[M], S = n[M], !u.hasOwnProperty(M) || w === S || w == null && S == null || le(e, t, M, w, u, S);
  }
  function v_(e) {
    switch (e) {
      case "css":
  ...
  function Kb() {
    if (typeof performance.getEntriesByType == "function") {
      for (var e = 0, t = 0, n = performance.getEntriesByType("resource"), u = 0; u < n.length; u++) {
        var l = n[u], r = l.transferSize, o = l.initiatorType, s = l.duration;
        if (r && s && v_(o)) {
          for (o = 0, s = l.responseEnd, u += 1; u < n.length; u++) {
            var d = n[u], h = d.startTime;
            if (h > s) break;
            var E = d.transferSize, M = d.initiatorType;
            E && v_(M) && (d = d.responseEnd, o += E * (d < s ? 1 : (s - h) / (d - h)));
          }
          if (--u, t += 8 * (r + o) / (l.duration / 1e3), e++, 10 < e) break;
        }
      }
  ...
  function Jb() {
    var e = window.event;
    return e && e.type === "popstate" ? e === Li ? false : (Li = e, true) : (Li = null, false);
  }
  var E_ = typeof setTimeout == "function" ? setTimeout : void 0, kb = typeof clearTimeout == "function" ? clearTimeout : void 0, A_ = typeof Promise == "function" ? Promise : void 0, Ib = typeof queueMicrotask == "function" ? queueMicrotask : typeof A_ < "u" ? function(e) {
    ...
    do {
      ...
      if (e.removeChild(n), l && l.nodeType === 8) if (n = l.data, n === "/$" || n === "/&") {
        ...
        for (var r = n.firstChild; r; ) {
          ...
          r[Aa] || s === "SCRIPT" || s === "STYLE" || s === "LINK" && r.rel.toLowerCase() === "stylesheet" || n.removeChild(r), r = o;
        }
  ...
  function M_(e, t) {
    ...
    do {
      var u = n.nextSibling;
      if (n.nodeType === 1 ? t ? (n._stashedDisplay = n.style.display, n.style.display = "none") : (n.style.display = n._stashedDisplay || "", n.getAttribute("style") === "" && n.removeAttribute("style")) : n.nodeType === 3 && (t ? (n._stashedText = n.nodeValue, n.nodeValue = "") : n.nodeValue = n._stashedText || ""), u && u.nodeType === 8) if (n = u.data, n === "/$") {
        if (e === 0) break;
        e--;
      } else n !== "$" && n !== "$?" && n !== "$~" && n !== "$!" || e++;
      n = u;
  ...
  function ed(e, t, n) {
    if (t === "") return null;
    for (; e.nodeType !== 3; ) if ((e.nodeType !== 1 || e.nodeName !== "INPUT" || e.type !== "hidden") && !n || (e = st(e.nextSibling), e === null)) return null;
    return e;
  }
  function D_(e, t) {
  ...
  var bt = /* @__PURE__ */ new Map(), H_ = /* @__PURE__ */ new Set();
  function hu(e) {
    return typeof e.getRootNode == "function" ? e.getRootNode() : e.nodeType === 9 ? e : e.ownerDocument;
  }
  var Qt = z.d;
  z.d = { f: nd, r: ad, D: cd, C: ud, L: ld, m: id, X: fd, S: rd, M: od };
  function nd() {
    var e = Qt.f(), t = su();
    return e || t;
  }
  ...
  function N_(e, t, n) {
    ...
    if (u && typeof t == "string" && t) {
      var l = ut(t);
      l = 'link[rel="' + e + '"][href="' + l + '"]', typeof n == "string" && (l += '[crossorigin="' + n + '"]'), H_.has(l) || (H_.add(l), e = { rel: e, crossOrigin: n, href: t }, u.querySelector(l) === null && (t = u.createElement("link"), Me(t, "link", e), ve(t), u.head.appendChild(t)));
    }
  }
  function cd(e) {
  ...
  function ld(e, t, n) {
    ...
    if (u && e && t) {
      ...
      t === "image" && n && n.imageSrcSet ? (l += '[imagesrcset="' + ut(n.imageSrcSet) + '"]', typeof n.imageSizes == "string" && (l += '[imagesizes="' + ut(n.imageSizes) + '"]')) : l += '[href="' + ut(e) + '"]';
      var r = l;
      switch (t) {
        case "style":
          r = ja(e);
      ...
      bt.has(r) || (e = R({ rel: "preload", href: t === "image" && n && n.imageSrcSet ? void 0 : e, as: t }, n), bt.set(r, e), u.querySelector(l) !== null || t === "style" && u.querySelector(oc(r)) || t === "script" && u.querySelector(_c(r)) || (t = u.createElement("link"), Me(t, "link", e), ve(t), u.head.appendChild(t)));
    }
  }
  function id(e, t) {
    Qt.m(e, t);
    var n = ya;
    if (n && e) {
      var u = t && typeof t.as == "string" ? t.as : "script", l = 'link[rel="modulepreload"][as="' + ut(u) + '"][href="' + ut(e) + '"]', r = l;
      switch (u) {
        case "audioworklet":
        case "paintworklet":
        case "serviceworker":
      ...
      if (!bt.has(r) && (e = R({ rel: "modulepreload", href: e }, t), bt.set(r, e), n.querySelector(l) === null)) {
        switch (u) {
          case "audioworklet":
          case "paintworklet":
          case "serviceworker":
        ...
        u = n.createElement("link"), Me(u, "link", e), ve(u), n.head.appendChild(u);
      }
    }
  }
  function rd(e, t, n) {
    ...
    var u = ya;
    if (u && e) {
      var l = Yn(u).hoistableStyles, r = ja(e);
      t = t || "default";
      var o = l.get(r);
      if (!o) {
        ...
        if (o = u.querySelector(oc(r))) s.loading = 5;
          ...
          e = R({ rel: "stylesheet", href: e, "data-precedence": t }, n), (n = bt.get(r)) && Xi(e, n);
          var d = o = u.createElement("link");
          ve(d), Me(d, "link", e), d._p = new Promise(function(h, E) {
            d.onload = h, d.onerror = E;
          }), d.addEventListener("load", function() {
            s.loading |= 1;
          }), d.addEventListener("error", function() {
            s.loading |= 2;
          }), s.loading |= 4, wu(o, t, u);
        }
        o = { type: "stylesheet", instance: o, count: 1, state: s }, l.set(r, o);
      }
    }
  }
  function fd(e, t) {
    ...
    var n = ya;
    if (n && e) {
      var u = Yn(n).hoistableScripts, l = ha(e), r = u.get(l);
      r || (r = n.querySelector(_c(l)), r || (e = R({ src: e, async: true }, t), (t = bt.get(l)) && Qi(e, t), r = n.createElement("script"), ve(r), Me(r, "link", e), n.head.appendChild(r)), r = { type: "script", instance: r, count: 1, state: null }, u.set(l, r));
    }
  }
  function od(e, t) {
    Qt.M(e, t);
    ...
    if (n && e) {
      var u = Yn(n).hoistableScripts, l = ha(e), r = u.get(l);
      r || (r = n.querySelector(_c(l)), r || (e = R({ src: e, async: true, type: "module" }, t), (t = bt.get(l)) && Qi(e, t), r = n.createElement("script"), ve(r), Me(r, "link", e), n.head.appendChild(r)), r = { type: "script", instance: r, count: 1, state: null }, u.set(l, r));
    }
  }
  function U_(e, t, n, u) {
    var l = (l = Z.current) ? hu(l) : null;
    ...
    switch (e) {
      ...
      case "title":
        return null;
      case "style":
        return typeof n.precedence == "string" && typeof n.href == "string" ? (t = ja(n.href), n = Yn(l).hoistableStyles, u = n.get(t), u || (u = { type: "style", instance: null, count: 0, state: null }, n.set(t, u)), u) : { type: "void", instance: null, count: 0, state: null };
      case "link":
        if (n.rel === "stylesheet" && typeof n.href == "string" && typeof n.precedence == "string") {
          e = ja(n.href);
          var r = Yn(l).hoistableStyles, o = r.get(e);
          if (o || (l = l.ownerDocument || l, o = { type: "stylesheet", instance: null, count: 0, state: { loading: 0, preload: null } }, r.set(e, o), (r = l.querySelector(oc(e))) && !r._p && (o.instance = r, o.state.loading = 5), bt.has(e) || (n = { rel: "preload", as: "style", href: n.href, crossOrigin: n.crossOrigin, integrity: n.integrity, media: n.media, hrefLang: n.hrefLang, referrerPolicy: n.referrerPolicy }, bt.set(e, n), r || _d(l, e, n, o.state))), t && u === null) throw Error(f(528, ""));
          return o;
        }
        if (t && u !== null) throw Error(f(529, ""));
        return null;
      case "script":
        return t = n.async, n = n.src, typeof n == "string" && t && typeof t != "function" && typeof t != "symbol" ? (t = ha(n), n = Yn(l).hoistableScripts, u = n.get(t), u || (u = { type: "script", instance: null, count: 0, state: null }, n.set(t, u)), u) : { type: "void", instance: null, count: 0, state: null };
      default:
        throw Error(f(444, e));
    }
  }
  ...
  function _d(e, t, n, u) {
    e.querySelector('link[rel="preload"][as="style"][' + t + "]") ? u.loading = 1 : (t = e.createElement("link"), u.preload = t, t.addEventListener("load", function() {
      ...
      return u.loading |= 2;
    }), Me(t, "link", n), ve(t), e.head.appendChild(t));
  }
  function ha(e) {
    return '[src="' + ut(e) + '"]';
  }
  ...
  function L_(e, t, n) {
    if (t.count++, t.instance === null) switch (t.type) {
      case "style":
        var u = e.querySelector('style[data-href~="' + ut(n.href) + '"]');
        if (u) return t.instance = u, ve(u), u;
        var l = R({}, n, { "data-href": n.href, "data-precedence": n.precedence, href: null, precedence: null });
        return u = (e.ownerDocument || e).createElement("style"), ve(u), Me(u, "style", l), wu(u, n.precedence, e), t.instance = u;
      case "stylesheet":
        l = ja(n.href);
        var r = e.querySelector(oc(l));
        if (r) return t.state.loading |= 4, t.instance = r, ve(r), r;
        u = B_(n), (l = bt.get(l)) && Xi(u, l), r = (e.ownerDocument || e).createElement("link"), ve(r);
        var o = r;
        return o._p = new Promise(function(s, d) {
          o.onload = s, o.onerror = d;
        }), Me(r, "link", u), t.state.loading |= 4, wu(r, n.precedence, e), t.instance = r;
      case "script":
        return r = ha(n.src), (l = e.querySelector(_c(r))) ? (t.instance = l, ve(l), l) : (u = n, (l = bt.get(r)) && (u = R({}, n), Qi(u, l)), e = e.ownerDocument || e, l = e.createElement("script"), ve(l), Me(l, "link", u), e.head.appendChild(l), t.instance = l);
      case "void":
        return null;
      default:
        throw Error(f(443, t.type));
    }
    else t.type === "stylesheet" && (t.state.loading & 4) === 0 && (u = t.instance, t.state.loading |= 4, wu(u, n.precedence, e));
    return t.instance;
  }
  function wu(e, t, n) {
    for (var u = n.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'), l = u.length ? u[u.length - 1] : null, r = l, o = 0; o < u.length; o++) {
      var s = u[o];
  ...
  function G_(e, t, n) {
    if (vu === null) {
      ...
      l.set(n, u);
    } else l = vu, u = l.get(n), u || (u = /* @__PURE__ */ new Map(), l.set(n, u));
    if (u.has(e)) return u;
    for (u.set(e, null), n = n.getElementsByTagName(e), l = 0; l < n.length; l++) {
      var r = n[l];
      if (!(r[Aa] || r[Se] || e === "link" && r.getAttribute("rel") === "stylesheet") && r.namespaceURI !== "http://www.w3.org/2000/svg") {
  ...
  function bd(e, t, n, u) {
    if (n.type === "stylesheet" && (typeof u.media != "string" || matchMedia(u.media).matches !== false) && (n.state.loading & 4) === 0) {
      if (n.instance === null) {
        var l = ja(u.href), r = t.querySelector(oc(l));
        if (r) {
          t = r._p, t !== null && typeof t == "object" && typeof t.then == "function" && (e.count++, e = xu.bind(e), t.then(e, e)), n.state.loading |= 4, n.instance = r, ve(r);
          return;
        }
        r = t.ownerDocument || t, u = B_(u), (l = bt.get(l)) && Xi(u, l), r = r.createElement("link"), ve(r);
        var o = r;
        o._p = new Promise(function(s, d) {
          o.onload = s, o.onerror = d;
        }), Me(r, "link", u), n.instance = r;
      }
      e.stylesheets === null && (e.stylesheets = /* @__PURE__ */ new Map()), e.stylesheets.set(n, t), (t = n.state.preload) && (n.state.loading & 3) === 0 && (e.count++, n = xu.bind(e), t.addEventListener("load", n), t.addEventListener("error", n));
    }
  }
  var Zi = 0;
  function dd(e, t) {
    return e.stylesheets && e.count === 0 && Eu(e, e.stylesheets), 0 < e.count || 0 < e.imgCount ? function(n) {
  ...
  var Su = null;
  function Eu(e, t) {
    e.stylesheets = null, e.unsuspend !== null && (e.count++, Su = /* @__PURE__ */ new Map(), t.forEach(gd, e), Su = null, xu.call(e));
  }
  function gd(e, t) {
    if (!(t.state.loading & 4)) {
      ...
      if (n) var u = n.get(null);
        ...
        for (var l = e.querySelectorAll("link[data-precedence],style[data-precedence]"), r = 0; r < l.length; r++) {
          var o = l[r];
          (o.nodeName === "LINK" || o.getAttribute("media") !== "not all") && (n.set(o.dataset.precedence, o), u = o);
        }
        u && n.set(null, u);
      }
      l = t.instance, o = l.getAttribute("data-precedence"), r = n.get(o) || u, r === u && n.set(null, l), n.set(o, l), this.count++, u = xu.bind(this), l.addEventListener("load", u), l.addEventListener("error", u), r ? r.parentNode.insertBefore(l, r.nextSibling) : (e = e.nodeType === 9 ? e.head : e, e.insertBefore(l, e.firstChild)), t.state.loading |= 4;
    }
  }
  var sc = { $$typeof: Re, Provider: null, Consumer: null, _currentValue: q, _currentValue2: q, _threadCount: 0 };
  function md(e, t, n, u, l, r, o, s, d) {
    this.tag = 1, this.containerInfo = e, this.pingCache = this.current = this.pendingChildren = null, this.timeoutHandle = -1, this.callbackNode = this.next = this.pendingContext = this.context = this.cancelPendingCommit = null, this.callbackPriority = 0, this.expirationTimes = qu(-1), this.entangledLanes = this.shellSuspendCounter = this.errorRecoveryDisabledLanes = this.expiredLanes = this.warmLanes = this.pingedLanes = this.suspendedLanes = this.pendingLanes = 0, this.entanglements = qu(0), this.hiddenUpdates = qu(null), this.identifierPrefix = u, this.onUncaughtError = l, this.onCaughtError = r, this.onRecoverableError = o, this.pooledCache = null, this.pooledCacheLanes = 0, this.formState = d, this.incompleteTransitions = /* @__PURE__ */ new Map();
  }
  function Y_(e, t, n, u, l, r, o, s, d, h, E, M) {
    return e = new md(e, t, n, o, d, h, E, M, s), t = 1, r === true && (t |= 24), r = Ie(3, null, null, t), e.current = r, r.stateNode = e, t = xl(), t.refCount++, e.pooledCache = t, t.refCount++, r.memoizedState = { element: u, isDehydrated: n, cache: t }, Tl(r), e;
  }
  function X_(e) {
    return e ? (e = $n, e) : $n;
  }
  function Q_(e, t, n, u, l, r) {
    l = X_(l), u.context === null ? u.context = l : u.pendingContext = l, u = en(t), u.payload = { element: n }, r = r === void 0 ? null : r, r !== null && (u.callback = r), n = tn(e, u, t), n !== null && (Ze(n, e, t), Qa(n, e, t));
  }
  function Z_(e, t) {
              ...
              if (r = r.stateNode, r.current.memoizedState.isDehydrated) {
                ...
                if (o !== 0) {
                  ...
                  for (s.pendingLanes |= 2, s.entangledLanes |= 2; o; ) {
                    var d = 1 << 31 - Je(o);
                    s.entanglements[1] |= d, o &= ~d;
                  }
                  xt(r), (ee & 6) === 0 && (ou = Fe() + 500, lc(0));
                }
              }
              break;
            case 31:
            case 13:
              s = Sn(r, 2), s !== null && Ze(s, r, 2), su(), Wi(r, 2);
          }
          if (r = Ki(u), r === null && zi(e, t, u, Tu, n), r === l) break;
          l = r;
        }
  ...
  var ki = false, bn = null, dn = null, gn = null, bc = /* @__PURE__ */ new Map(), dc = /* @__PURE__ */ new Map(), mn = [], yd = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");
  function J_(e, t) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function gc(e, t, n, u, l, r) {
    return e === null || e.nativeEvent !== r ? (e = { blockedOn: t, domEventName: n, eventSystemFlags: u, nativeEvent: r, targetContainers: [l] }, t !== null && (t = Vn(t), t !== null && W_(t)), e) : (e.eventSystemFlags |= u, t = e.targetContainers, l !== null && t.indexOf(l) === -1 && t.push(l), e);
  }
  function jd(e, t, n, u, l) {
    switch (t) {
      ...
      case "gotpointercapture":
        return r = l.pointerId, dc.set(r, gc(dc.get(r) || null, e, t, n, u, l)), true;
    }
    return false;
  }
  function k_(e) {
    ...
    if (t !== null) {
      ...
      if (n !== null) {
        if (t = n.tag, t === 13) {
          if (t = y(n), t !== null) {
            e.blockedOn = t, rr(e.priority, function() {
              F_(n);
            });
            return;
          }
  ...
  function Mu(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return t = Vn(n), t !== null && W_(t), e.blockedOn = n, false;
      t.shift();
    }
    return true;
  }
  ...
  function hd() {
    ki = false, bn !== null && Mu(bn) && (bn = null), dn !== null && Mu(dn) && (dn = null), gn !== null && Mu(gn) && (gn = null), bc.forEach(I_), dc.forEach(I_);
  }
  function Du(e, t) {
    e.blockedOn === t && (e.blockedOn = null, ki || (ki = true, a.unstable_scheduleCallback(a.unstable_NormalPriority, hd)));
  }
  var Ru = null;
  function $_(e) {
    Ru !== e && (Ru = e, a.unstable_scheduleCallback(a.unstable_NormalPriority, function() {
      Ru === e && (Ru = null);
      for (var t = 0; t < e.length; t += 3) {
        var n = e[t], u = e[t + 1], l = e[t + 2];
        if (typeof u != "function") {
          if (Ji(u || n) === null) continue;
          break;
        }
        var r = Vn(n);
        r !== null && (e.splice(t, 3), t -= 3, Kl(r, { pending: true, data: l, method: n.method, action: u }, u, l));
      }
    }));
  }
  function wa(e) {
    ...
    for (; 0 < mn.length && (n = mn[0], n.blockedOn === null); ) k_(n), n.blockedOn === null && mn.shift();
    if (n = (e.ownerDocument || e).$$reactFormReplay, n != null) for (u = 0; u < n.length; u += 3) {
      var l = n[u], r = n[u + 1], o = l[Ge] || null;
      if (typeof r == "function") o || $_(n);
        ...
        typeof s == "function" ? n[u + 1] = s : (n.splice(u, 3), u -= 3), $_(n);
      }
    }
  }
  function P_() {
  ...
  Cu.prototype.render = Ii.prototype.render = function(e) {
    var t = this._internalRoot;
    if (t === null) throw Error(f(409));
    var n = t.current, u = nt();
    Q_(n, u, e, t, null, null);
  }, Cu.prototype.unmount = Ii.prototype.unmount = function() {
  ...
  var wd = { bundleType: 0, version: "19.2.4", rendererPackageName: "react-dom", currentDispatcherRef: A, reconcilerVersion: "19.2.4" };
  ...
  return reactDomClient_production.createRoot = function(e, t) {
    ...
    var n = false, u = "", l = lo, r = io, o = ro;
    return t != null && (t.unstable_strictMode === true && (n = true), t.identifierPrefix !== void 0 && (u = t.identifierPrefix), t.onUncaughtError !== void 0 && (l = t.onUncaughtError), t.onCaughtError !== void 0 && (r = t.onCaughtError), t.onRecoverableError !== void 0 && (o = t.onRecoverableError)), t = Y_(e, 1, false, null, null, n, u, null, l, r, o, P_), e[Gn] = t.current, Ci(e), new Ii(t);
  }, reactDomClient_production.hydrateRoot = function(e, t, n) {
    if (!_(e)) throw Error(f(299));
    var u = false, l = "", r = lo, o = io, s = ro, d = null;
    return n != null && (n.unstable_strictMode === true && (u = true), n.identifierPrefix !== void 0 && (l = n.identifierPrefix), n.onUncaughtError !== void 0 && (r = n.onUncaughtError), n.onCaughtError !== void 0 && (o = n.onCaughtError), n.onRecoverableError !== void 0 && (s = n.onRecoverableError), n.formState !== void 0 && (d = n.formState)), t = Y_(e, 1, true, t, n ?? null, u, l, d, r, o, s, P_), t.context = X_(null), n = t.current, u = nt(), u = Vu(u), l = en(u), l.callback = null, tn(n, l, u), n = u, t.current.lanes = n, Ea(t, n), xt(t), e[Gn] = t.current, Ci(e), new Cu(t);
...
function requireClient() {
  ...
  return a(), client.exports = requireReactDomClient_production(), client.exports;
}
...
class EventBus {
  ...
  on(c, i) {
    this.listeners.has(c) || this.listeners.set(c, /* @__PURE__ */ new Set());
    const f = this.listeners.get(c), _ = i;
    return f.add(_), () => {
      f.delete(_);
    };
  }
...
function toastReducer(a, c) {
  switch (c.type) {
    case "ADD": {
      ...
      return i.length > DEFAULT_TOAST_CONFIG.maxVisible && (i = i.map((f, _) => _ === 0 && !f.exiting ? { ...f, exiting: true } : f)), { toasts: i };
    }
    case "MARK_EXITING":
      return { toasts: a.toasts.map((i) => i.id === c.id ? { ...i, exiting: true } : i) };
    case "REMOVE":
...
function ToastProvider({ children: a }) {
  ...
  return reactExports.useEffect(() => {
    const f = gameEvents.on("toast:show", ({ message: y, severity: x, duration: v }) => {
      i({ type: "ADD", toast: { id: crypto.randomUUID(), message: y, severity: x, duration: v ?? SEVERITY_DURATIONS[x], createdAt: Date.now(), exiting: false } });
  ...
  }, []), jsxRuntimeExports.jsx(ToastStateContext, { value: c, children: jsxRuntimeExports.jsx(ToastDispatchContext, { value: i, children: a }) });
}
...
function modalReducer(a, c) {
  ...
  switch (c.type) {
    ...
    case "CLOSE": {
      const i = a.stack[a.stack.length - 1], f = a.stack.slice(0, -1);
      return (_a = i == null ? void 0 : i.onClose) == null ? void 0 : _a.call(i), { stack: f, isOpen: f.length > 0 };
    }
    case "CLOSE_ALL":
      return a.stack.forEach((i) => {
        var _a2;
...
function ModalProvider({ children: a }) {
  ...
  return reactExports.useEffect(() => {
    const f = gameEvents.on("modal:open", ({ id: b, title: y, content: x, size: v, onClose: p }) => {
      i({ type: "OPEN", modal: { id: b ?? crypto.randomUUID(), title: y, content: x, onClose: p, closeOnOverlayClick: true, closeOnEscape: true, size: v ?? "md" } });
  ...
  }, []), jsxRuntimeExports.jsx(ModalStateContext, { value: c, children: jsxRuntimeExports.jsx(ModalDispatchContext, { value: i, children: a }) });
}
...
function MenuProvider({ children: a }) {
  ...
  }, []), jsxRuntimeExports.jsx(MenuStateContext, { value: c, children: jsxRuntimeExports.jsx(MenuDispatchContext, { value: i, children: a }) });
}
...
function getPortalRoot(a) {
  ...
  return (!c || !document.body.contains(c)) && (c = document.createElement("div"), c.id = a, c.style.position = "fixed", c.style.inset = "0", c.style.pointerEvents = "none", c.style.zIndex = Z_INDEX[a] ?? "50", document.body.appendChild(c), portalCache.set(a, c)), c;
}
function ToastItem({ toast: a, onDismiss: c }) {
  ...
  return jsxRuntimeExports.jsxs("div", { className: `
			...
			`, onAnimationEnd: () => {
    a.exiting && c(a.id);
  }, children: [jsxRuntimeExports.jsx("span", { className: "text-[8px] md:text-xs leading-relaxed flex-1", children: a.message }), jsxRuntimeExports.jsx("button", { onClick: () => c(a.id), className: "text-text-muted hover:text-text text-[8px] md:text-xs leading-none mt-0.5 cursor-pointer", children: "\u2715" })] });
}
function ToastContainer() {
  const { toasts: a } = reactExports.useContext(ToastStateContext), c = reactExports.useContext(ToastDispatchContext), i = reactExports.useCallback((f) => {
    var _a;
    ((_a = a.find((b) => b.id === f)) == null ? void 0 : _a.exiting) ? c({ type: "REMOVE", id: f }) : c({ type: "MARK_EXITING", id: f });
  }, [a, c]);
  return a.length === 0 ? null : reactDomExports.createPortal(jsxRuntimeExports.jsx("div", { className: "fixed top-14 right-4 flex flex-col items-end pointer-events-none", children: a.map((f) => jsxRuntimeExports.jsx(ToastItem, { toast: f, onDismiss: i }, f.id)) }), getPortalRoot("toast-root"));
}
const MODAL_SIZE_CLASSES = { xs: "max-w-xs", sm: "max-w-sm", md: "max-w-md", lg: "max-w-lg" };
function ModalOverlay() {
  const { stack: a, isOpen: c } = reactExports.useContext(ModalStateContext), i = reactExports.useContext(ModalDispatchContext);
  if (!c || a.length === 0) return null;
  const f = a[a.length - 1], _ = MODAL_SIZE_CLASSES[f.size ?? "md"];
  return reactDomExports.createPortal(jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-overlay flex items-center justify-center pointer-events-auto", onClick: () => {
    f.closeOnOverlayClick !== false && i({ type: "CLOSE" });
					...
					animate-modal-in
				`, onClick: (b) => b.stopPropagation(), children: jsxRuntimeExports.jsxs("div", { className: "border-2 border-[#1a1008]", children: [jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 md:px-4 md:py-3 bg-[#1e1408] border-b border-[#5a4a2a]", children: [jsxRuntimeExports.jsx("h2", { className: "text-[10px] md:text-sm text-[#c8a832]", children: f.title }), jsxRuntimeExports.jsx("button", { onClick: () => i({ type: "CLOSE" }), className: `w-5 h-5 md:w-7 md:h-7 flex items-center justify-center
								bg-[#3d2b14] border border-[#5a4a2a]
								text-text-muted hover:text-[#c8a832] hover:border-panel-border
								text-[8px] md:text-xs leading-none cursor-pointer transition-colors`, children: "\u2715" })] }), jsxRuntimeExports.jsx("div", { className: "p-3 md:p-4 bg-panel-inner text-[8px] md:text-xs", children: f.content })] }) }) }), getPortalRoot("modal-root"));
}
...
function PauseMenu() {
  const { isOpen: a, activeCategory: c } = reactExports.useContext(MenuStateContext), i = reactExports.useContext(MenuDispatchContext);
  return a ? reactDomExports.createPortal(jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-overlay flex items-center justify-center pointer-events-auto", children: jsxRuntimeExports.jsxs("div", { className: "bg-panel border-2 border-panel-border shadow-panel w-full max-w-lg mx-4 animate-modal-in", children: [jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b-2 border-panel-border bg-panel-inner", children: [jsxRuntimeExports.jsx("h2", { className: "text-[10px]", children: "Settings" }), jsxRuntimeExports.jsx("button", { onClick: () => i({ type: "CLOSE" }), className: "text-text-muted hover:text-text text-[10px] leading-none cursor-pointer", children: "\u2715" })] }), jsxRuntimeExports.jsxs("div", { className: "flex min-h-[240px]", children: [jsxRuntimeExports.jsx("div", { className: "w-32 border-r-2 border-panel-border p-2 flex flex-col gap-1 bg-panel-inner", children: CATEGORIES.map(({ key: f, label: _ }) => jsxRuntimeExports.jsx("button", { onClick: () => i({ type: "SET_CATEGORY", category: f }), className: `
								...
								`, children: _ }, f)) }), jsxRuntimeExports.jsx("div", { className: "flex-1 p-4 bg-panel-inner", children: jsxRuntimeExports.jsx(SettingsContent, { category: c }) })] }), jsxRuntimeExports.jsx("div", { className: "flex justify-end px-3 py-2 border-t-2 border-panel-border bg-panel-inner", children: jsxRuntimeExports.jsx("button", { onClick: () => i({ type: "CLOSE" }), className: "px-4 py-1.5 text-[8px] bg-btn border border-btn-border hover:bg-btn-hover cursor-pointer transition-colors text-text", children: "Resume" }) })] }) }), getPortalRoot("menu-root")) : null;
}
...
function KeyboardRouter() {
  const a = reactExports.useContext(ModalStateContext), c = reactExports.useContext(ModalDispatchContext), i = reactExports.useContext(MenuStateContext), f = reactExports.useContext(MenuDispatchContext), _ = reactExports.useRef(false), b = a.isOpen || i.isOpen;
  reactExports.useEffect(() => {
    _.current && !b && focusCanvas(), _.current = b;
  }, [b]);
  const y = reactExports.useCallback(() => {
    a.isOpen ? c({ type: "CLOSE" }) : i.isOpen ? f({ type: "CLOSE" }) : f({ type: "OPEN" });
  }, [a.isOpen, i.isOpen, c, f]);
  return useKeyboard("Escape", y), null;
}
function GameUIProvider({ children: a }) {
  return jsxRuntimeExports.jsx(ToastProvider, { children: jsxRuntimeExports.jsx(ModalProvider, { children: jsxRuntimeExports.jsxs(MenuProvider, { children: [jsxRuntimeExports.jsx(KeyboardRouter, {}), a, jsxRuntimeExports.jsx(ToastContainer, {}), jsxRuntimeExports.jsx(ModalOverlay, {}), jsxRuntimeExports.jsx(PauseMenu, {})] }) }) });
}
function dispatch_action(a, c) {
  const i = passStringToWasm0(c, wasm.__wbindgen_export, wasm.__wbindgen_export2), f = WASM_VECTOR_LEN;
...
function get_hovered_object_json() {
  try {
    ...
    var a = getDataViewMemory0().getInt32(i + 0, true), c = getDataViewMemory0().getInt32(i + 4, true);
    let f;
    return a !== 0 && (f = getStringFromWasm0(a, c).slice(), wasm.__wbindgen_export4(a, c * 1, 1)), f;
  } finally {
...
function get_player_state_json() {
  ...
  try {
    ...
    var i = getDataViewMemory0().getInt32(_ + 0, true), f = getDataViewMemory0().getInt32(_ + 4, true);
    return a = i, c = f, getStringFromWasm0(i, f);
  } finally {
    wasm.__wbindgen_add_to_stack_pointer(16), wasm.__wbindgen_export4(a, c, 1);
  }
}
...
function go_online(a, c) {
  const i = passStringToWasm0(a, wasm.__wbindgen_export, wasm.__wbindgen_export2), f = WASM_VECTOR_LEN, _ = passStringToWasm0(c, wasm.__wbindgen_export, wasm.__wbindgen_export2), b = WASM_VECTOR_LEN;
  wasm.go_online(i, f, _, b);
}
function __wbg_get_imports() {
  const import0 = { __proto__: null, __wbg_Window_1535697a053fe988: function(a) {
    ...
    const c = getObject(a), i = typeof c == "boolean" ? c : void 0;
    return isLikeNone(i) ? 16777215 : i ? 1 : 0;
  }, __wbg___wbindgen_debug_string_5398f5bb970e0daa: function(a, c) {
    const i = debugString(getObject(c)), f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    const i = getObject(c), f = typeof i == "number" ? i : void 0;
    getDataViewMemory0().setFloat64(a + 8, isLikeNone(f) ? 0 : f, true), getDataViewMemory0().setInt32(a + 0, !isLikeNone(f), true);
  }, __wbg___wbindgen_string_get_395e606bd0ee4427: function(a, c) {
    const i = getObject(c), f = typeof i == "string" ? i : void 0;
    var _ = isLikeNone(f) ? 0 : passStringToWasm0(f, wasm.__wbindgen_export, wasm.__wbindgen_export2), b = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, b, true), getDataViewMemory0().setInt32(a + 0, _, true);
    ...
    return handleError(function(a, c, i, f) {
      getObject(a).addEventListener(getStringFromWasm0(c, i), getObject(f));
    }, arguments);
    ...
    getObject(a).bindAttribLocation(getObject(c), i >>> 0, getStringFromWasm0(f, _));
    ...
    getObject(a).blendFunc(c >>> 0, i >>> 0);
  }, __wbg_blitFramebuffer_c1a68feaca974c87: function(a, c, i, f, _, b, y, x, v, p, C) {
    getObject(a).blitFramebuffer(c, i, f, _, b, y, x, v, p >>> 0, C >>> 0);
    ...
    const i = getObject(c).brand, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    const i = getObject(c).code, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    getObject(a).compileShader(getObject(c));
  }, __wbg_compressedTexSubImage2D_593058a6f5aca176: function(a, c, i, f, _, b, y, x, v) {
    getObject(a).compressedTexSubImage2D(c >>> 0, i, f, _, b, y, x >>> 0, getObject(v));
  }, __wbg_compressedTexSubImage2D_aab12b65159c282e: function(a, c, i, f, _, b, y, x, v) {
    getObject(a).compressedTexSubImage2D(c >>> 0, i, f, _, b, y, x >>> 0, getObject(v));
  }, __wbg_compressedTexSubImage2D_f3c4ae95ef9d2420: function(a, c, i, f, _, b, y, x, v, p) {
    getObject(a).compressedTexSubImage2D(c >>> 0, i, f, _, b, y, x >>> 0, v, p);
  }, __wbg_compressedTexSubImage3D_77a6ab77487aa211: function(a, c, i, f, _, b, y, x, v, p, C, R) {
    getObject(a).compressedTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, C, R);
  }, __wbg_compressedTexSubImage3D_95f64742aae944b8: function(a, c, i, f, _, b, y, x, v, p, C) {
    getObject(a).compressedTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, getObject(C));
    ...
    return handleError(function(a, c, i, f, _) {
      getObject(a).copyBufferToBuffer(getObject(c), i, getObject(f), _);
    }, arguments);
  }, __wbg_copyBufferToBuffer_321eb0198eb9c268: function() {
    return handleError(function(a, c, i, f, _, b) {
      getObject(a).copyBufferToBuffer(getObject(c), i, getObject(f), _, b);
    }, arguments);
  }, __wbg_copyTexSubImage2D_08a10bcd45b88038: function(a, c, i, f, _, b, y, x, v) {
    getObject(a).copyTexSubImage2D(c >>> 0, i, f, _, b, y, x, v);
  }, __wbg_copyTexSubImage2D_b9a10d000c616b3e: function(a, c, i, f, _, b, y, x, v) {
    getObject(a).copyTexSubImage2D(c >>> 0, i, f, _, b, y, x, v);
  }, __wbg_copyTexSubImage3D_7fcdf7c85bc308a5: function(a, c, i, f, _, b, y, x, v, p) {
    getObject(a).copyTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p);
  }, __wbg_copyTextureToBuffer_f5501895b13306e1: function() {
    return handleError(function(a, c, i, f) {
      getObject(a).copyTextureToBuffer(getObject(c), getObject(i), getObject(f));
    }, arguments);
  }, __wbg_copyTextureToTexture_facf8ecdb9559cb0: function() {
    return handleError(function(a, c, i, f) {
      getObject(a).copyTextureToTexture(getObject(c), getObject(i), getObject(f));
    }, arguments);
    ...
    return handleError(function(a, c, i) {
      const f = getObject(a).createImageBitmap(getObject(c), getObject(i));
      return addHeapObject(f);
    }, arguments);
  }, __wbg_createObjectURL_f141426bcc1f70aa: function() {
    return handleError(function(a, c) {
      const i = URL.createObjectURL(getObject(c)), f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
      getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    }, arguments);
    ...
    console.debug(getObject(a), getObject(c), getObject(i), getObject(f));
    ...
    return isLikeNone(c) ? 0 : addHeapObject(c);
  }, __wbg_drawArraysInstancedANGLE_20ee4b8f67503b54: function(a, c, i, f, _) {
  ...
  }, __wbg_drawElementsInstancedANGLE_e9170c6414853487: function(a, c, i, f, _, b) {
    getObject(a).drawElementsInstancedANGLE(c >>> 0, i, f >>> 0, _, b);
  }, __wbg_drawElementsInstanced_2e549060a77ba831: function(a, c, i, f, _, b) {
    ...
    console.error(getObject(a), getObject(c), getObject(i), getObject(f));
  ...
  }, __wbg_framebufferRenderbuffer_7a2be23309166ad3: function(a, c, i, f, _) {
    getObject(a).framebufferRenderbuffer(c >>> 0, i >>> 0, f >>> 0, getObject(_));
  }, __wbg_framebufferRenderbuffer_d8c1d0b985bd3c51: function(a, c, i, f, _) {
    getObject(a).framebufferRenderbuffer(c >>> 0, i >>> 0, f >>> 0, getObject(_));
  }, __wbg_framebufferTexture2D_bf4d47f4027a3682: function(a, c, i, f, _, b) {
    getObject(a).framebufferTexture2D(c >>> 0, i >>> 0, f >>> 0, getObject(_), b);
  }, __wbg_framebufferTexture2D_e2f7d82e6707010e: function(a, c, i, f, _, b) {
    getObject(a).framebufferTexture2D(c >>> 0, i >>> 0, f >>> 0, getObject(_), b);
  }, __wbg_framebufferTextureLayer_01d5b9516636ccae: function(a, c, i, f, _, b) {
    getObject(a).framebufferTextureLayer(c >>> 0, i >>> 0, getObject(f), _, b);
  }, __wbg_framebufferTextureMultiviewOVR_336ea10e261ec5f6: function(a, c, i, f, _, b, y) {
    getObject(a).framebufferTextureMultiviewOVR(c >>> 0, i >>> 0, getObject(f), _, b, y);
    ...
    return handleError(function(a, c, i, f) {
      const _ = getObject(a).getContext(getStringFromWasm0(c, i), getObject(f));
    ...
    const i = Object.getOwnPropertyDescriptor(getObject(a), getObject(c));
    return addHeapObject(i);
    ...
    return handleError(function(a, c, i, f) {
      const _ = getObject(c).getPropertyValue(getStringFromWasm0(i, f)), b = passStringToWasm0(_, wasm.__wbindgen_export, wasm.__wbindgen_export2), y = WASM_VECTOR_LEN;
      getDataViewMemory0().setInt32(a + 4, y, true), getDataViewMemory0().setInt32(a + 0, b, true);
    }, arguments);
    ...
    return getObject(a).getUniformBlockIndex(getObject(c), getStringFromWasm0(i, f));
  }, __wbg_getUniformLocation_5eb08673afa04eee: function(a, c, i, f) {
    const _ = getObject(a).getUniformLocation(getObject(c), getStringFromWasm0(i, f));
    return isLikeNone(_) ? 0 : addHeapObject(_);
    ...
    const i = getObject(c).id, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    console.info(getObject(a), getObject(c), getObject(i), getObject(f));
    ...
    const i = getObject(c).key, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
  }, __wbg_label_0abc44bf8d3a3e99: function(a, c) {
    const i = getObject(c).label, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    let v, p;
    try {
      v = a, p = c, console.log(getStringFromWasm0(a, c), getStringFromWasm0(i, f), getStringFromWasm0(_, b), getStringFromWasm0(y, x));
    } finally {
  ...
  }, __wbg_maxDynamicStorageBuffersPerPipelineLayout_7155d3f7a514a157: function(a) {
    return getObject(a).maxDynamicStorageBuffersPerPipelineLayout;
  }, __wbg_maxDynamicUniformBuffersPerPipelineLayout_76dee9028eaa5322: function(a) {
    ...
    return handleError(function(a, c, i, f) {
      let _, b, y, x;
      try {
        _ = a, b = c, y = i, x = f, performance.measure(getStringFromWasm0(a, c), getStringFromWasm0(i, f));
      } finally {
        wasm.__wbindgen_export4(_, b, 1), wasm.__wbindgen_export4(y, x, 1);
      }
    }, arguments);
  }, __wbg_media_91e147d0112e864c: function(a, c) {
    const i = getObject(c).media, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
  }, __wbg_message_206e22ac85ff4937: function(a, c) {
    const i = getObject(c).message, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    const _ = new RegExp(getStringFromWasm0(a, c), getStringFromWasm0(i, f));
    return addHeapObject(_);
    ...
    const a = new Array();
    return addHeapObject(a);
  }, __wbg_new_with_byte_offset_and_length_b2ec5bf7b2f35743: function(a, c, i) {
    ...
    return handleError(function(a, c, i) {
      const f = new ImageData(getClampedArrayU8FromWasm0(a, c), i >>> 0);
      return addHeapObject(f);
    }, arguments);
    ...
    const i = getObject(c).pointerType, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    Uint8Array.prototype.set.call(getArrayU8FromWasm0(a, c), getObject(i));
    ...
    return handleError(function(a, c, i) {
      const f = getObject(a).querySelectorAll(getStringFromWasm0(c, i));
      return addHeapObject(f);
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x) {
      getObject(a).readPixels(c, i, f, _, b >>> 0, y >>> 0, getObject(x));
    }, arguments);
    ...
    const i = getObject(c).reason, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
  }, __wbg_removeEventListener_d27694700fc0df8b: function() {
    return handleError(function(a, c, i, f) {
      getObject(a).removeEventListener(getStringFromWasm0(c, i), getObject(f));
    }, arguments);
    ...
    return handleError(function(a, c, i, f) {
      const _ = getObject(c).removeProperty(getStringFromWasm0(i, f)), b = passStringToWasm0(_, wasm.__wbindgen_export, wasm.__wbindgen_export2), y = WASM_VECTOR_LEN;
      getDataViewMemory0().setInt32(a + 4, y, true), getDataViewMemory0().setInt32(a + 0, b, true);
    }, arguments);
  }, __wbg_renderbufferStorageMultisample_d999a80fbc25df5f: function(a, c, i, f, _, b) {
    getObject(a).renderbufferStorageMultisample(c >>> 0, i, f >>> 0, _, b);
    ...
    getObject(a).resolveQuerySet(getObject(c), i >>> 0, f >>> 0, getObject(_), b >>> 0);
    ...
    return handleError(function(a, c, i, f, _) {
      getObject(a).setAttribute(getStringFromWasm0(c, i), getStringFromWasm0(f, _));
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y) {
      getObject(a).setBindGroup(c >>> 0, getObject(i), getArrayU32FromWasm0(f, _), b, y >>> 0);
    }, arguments);
    ...
    getObject(a).setIndexBuffer(getObject(c), __wbindgen_enum_GpuIndexFormat[i], f, _);
  }, __wbg_setIndexBuffer_a400322dea5437f7: function(a, c, i, f) {
    getObject(a).setIndexBuffer(getObject(c), __wbindgen_enum_GpuIndexFormat[i], f);
    ...
    return handleError(function(a, c, i, f, _) {
      getObject(a).setProperty(getStringFromWasm0(c, i), getStringFromWasm0(f, _));
    }, arguments);
  ...
  }, __wbg_set_beginning_of_pass_write_index_348e7f2f53a86db0: function(a, c) {
    getObject(a).beginningOfPassWriteIndex = c >>> 0;
  }, __wbg_set_beginning_of_pass_write_index_880bdf30cfb151c3: function(a, c) {
    getObject(a).beginningOfPassWriteIndex = c >>> 0;
    ...
    getObject(a).powerPreference = __wbindgen_enum_GpuPowerPreference[c];
    ...
    getObject(a).viewDimension = __wbindgen_enum_GpuTextureViewDimension[c];
    ...
    const i = getObject(c).stack, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
    getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p) {
      getObject(a).texImage2D(c >>> 0, i, f, _, b, y, x >>> 0, v >>> 0, getObject(p));
    }, arguments);
  }, __wbg_texImage2D_d8c284c813952313: function() {
    return handleError(function(a, c, i, f, _, b, y, x, v, p) {
      getObject(a).texImage2D(c >>> 0, i, f, _, b, y, x >>> 0, v >>> 0, p);
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, C) {
      getObject(a).texImage3D(c >>> 0, i, f, _, b, y, x, v >>> 0, p >>> 0, getObject(C));
    }, arguments);
  }, __wbg_texImage3D_9a207e0459a4f276: function() {
    return handleError(function(a, c, i, f, _, b, y, x, v, p, C) {
      getObject(a).texImage3D(c >>> 0, i, f, _, b, y, x, v >>> 0, p >>> 0, C);
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p) {
      getObject(a).texSubImage2D(c >>> 0, i, f, _, b, y, x >>> 0, v >>> 0, getObject(p));
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p) {
      getObject(a).texSubImage2D(c >>> 0, i, f, _, b, y, x >>> 0, v >>> 0, p);
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, C, R) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, C >>> 0, getObject(R));
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, C, R) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, C >>> 0, R);
    }, arguments);
    ...
    return handleError(function(a, c) {
      const i = getObject(c).userAgent, f = passStringToWasm0(i, wasm.__wbindgen_export, wasm.__wbindgen_export2), _ = WASM_VECTOR_LEN;
      getDataViewMemory0().setInt32(a + 4, _, true), getDataViewMemory0().setInt32(a + 0, f, true);
    }, arguments);
  ...
  }, __wbg_vertexAttribIPointer_ecd3baef73ba0965: function(a, c, i, f, _, b) {
    getObject(a).vertexAttribIPointer(c >>> 0, i, f >>> 0, _, b);
  }, __wbg_vertexAttribPointer_ea73fc4cc5b7d647: function(a, c, i, f, _, b, y) {
    getObject(a).vertexAttribPointer(c >>> 0, i, f >>> 0, _ !== 0, b, y);
  }, __wbg_vertexAttribPointer_f63675d7fad431e6: function(a, c, i, f, _, b, y) {
    getObject(a).vertexAttribPointer(c >>> 0, i, f >>> 0, _ !== 0, b, y);
    ...
    console.warn(getObject(a), getObject(c), getObject(i), getObject(f));
    ...
    return handleError(function(a, c, i, f, _) {
      getObject(a).writeTexture(getObject(c), getObject(i), getObject(f), getObject(_));
    }, arguments);
    ...
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_119767, __wasm_bindgen_func_elem_119768);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000002: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_170551, __wasm_bindgen_func_elem_170552);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000003: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_182525, __wasm_bindgen_func_elem_182526);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000004: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000005: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56032);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000006: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_5);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000007: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_6);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000008: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_7);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000009: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_8);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000a: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_9);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000b: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_10);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000c: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56023_11);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000d: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56030);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000e: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_56022, __wasm_bindgen_func_elem_56025);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000f: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_9106, __wasm_bindgen_func_elem_9107);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000010: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_9106, __wasm_bindgen_func_elem_9107_15);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000011: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_9106, __wasm_bindgen_func_elem_9107_16);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000012: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_109423, __wasm_bindgen_func_elem_109424);
    return addHeapObject(i);
...
function getClampedArrayU8FromWasm0(a, c) {
  return a = a >>> 0, getUint8ClampedArrayMemory0().subarray(a / 1, a / 1 + c);
}
let cachedDataViewMemory0 = null;
function getDataViewMemory0() {
  return (cachedDataViewMemory0 === null || cachedDataViewMemory0.buffer.detached === true || cachedDataViewMemory0.buffer.detached === void 0 && cachedDataViewMemory0.buffer !== wasm.memory.buffer) && (cachedDataViewMemory0 = new DataView(wasm.memory.buffer)), cachedDataViewMemory0;
}
...
function getInt16ArrayMemory0() {
  return (cachedInt16ArrayMemory0 === null || cachedInt16ArrayMemory0.byteLength === 0) && (cachedInt16ArrayMemory0 = new Int16Array(wasm.memory.buffer)), cachedInt16ArrayMemory0;
}
let cachedInt32ArrayMemory0 = null;
function getInt32ArrayMemory0() {
  return (cachedInt32ArrayMemory0 === null || cachedInt32ArrayMemory0.byteLength === 0) && (cachedInt32ArrayMemory0 = new Int32Array(wasm.memory.buffer)), cachedInt32ArrayMemory0;
}
let cachedInt8ArrayMemory0 = null;
function getInt8ArrayMemory0() {
  return (cachedInt8ArrayMemory0 === null || cachedInt8ArrayMemory0.byteLength === 0) && (cachedInt8ArrayMemory0 = new Int8Array(wasm.memory.buffer)), cachedInt8ArrayMemory0;
}
...
function getUint16ArrayMemory0() {
  return (cachedUint16ArrayMemory0 === null || cachedUint16ArrayMemory0.byteLength === 0) && (cachedUint16ArrayMemory0 = new Uint16Array(wasm.memory.buffer)), cachedUint16ArrayMemory0;
}
...
function getUint8ClampedArrayMemory0() {
  return (cachedUint8ClampedArrayMemory0 === null || cachedUint8ClampedArrayMemory0.byteLength === 0) && (cachedUint8ClampedArrayMemory0 = new Uint8ClampedArray(wasm.memory.buffer)), cachedUint8ClampedArrayMemory0;
}
...
function makeMutClosure(a, c, i, f) {
  const _ = { a, b: c, cnt: 1, dtor: i }, b = (...y) => {
    _.cnt++;
    const x = _.a;
    _.a = 0;
    try {
  ...
  return b._wbg_cb_unref = () => {
    --_.cnt === 0 && (_.dtor(_.a, _.b), _.a = 0, CLOSURE_DTORS.unregister(_));
  }, CLOSURE_DTORS.register(b, _, _), b;
}
function passStringToWasm0(a, c, i) {
  if (i === void 0) {
    const x = cachedTextEncoder.encode(a), v = c(x.length, 1) >>> 0;
    return getUint8ArrayMemory0().subarray(v, v + x.length).set(x), WASM_VECTOR_LEN = x.length, v;
  }
  let f = a.length, _ = c(f, 1) >>> 0;
  ...
  if (y !== f) {
    y !== 0 && (a = a.slice(y)), _ = i(_, f, f = y + a.length * 3, 1) >>> 0;
    const x = getUint8ArrayMemory0().subarray(_ + y, _ + f), v = cachedTextEncoder.encodeInto(a, x);
...
function decodeText(a, c) {
  return numBytesDecoded += c, numBytesDecoded >= MAX_SAFARI_DECODE_BYTES && (cachedTextDecoder = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }), cachedTextDecoder.decode(), numBytesDecoded = c), cachedTextDecoder.decode(getUint8ArrayMemory0().subarray(a, a + c));
}
const cachedTextEncoder = new TextEncoder();
"encodeInto" in cachedTextEncoder || (cachedTextEncoder.encodeInto = function(a, c) {
...
async function __wbg_load(a, c) {
  if (typeof Response == "function" && a instanceof Response) {
    if (typeof WebAssembly.instantiateStreaming == "function") try {
      ...
      if (a.ok && i(a.type) && a.headers.get("Content-Type") !== "application/wasm") console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", _);
      else throw _;
    }
    ...
    return f instanceof WebAssembly.Instance ? { instance: f, module: a } : f;
  }
  function i(f) {
    switch (f) {
      case "basic":
...
async function __wbg_init(a) {
  ...
  a !== void 0 && (Object.getPrototypeOf(a) === Object.prototype ? { module_or_path: a } = a : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), a === void 0 && (a = new URL("/isometric/assets/isometric_game_bg.wasm", import.meta.url));
...
const isometric_game = Object.freeze(Object.defineProperty({ __proto__: null, default: __wbg_init, dispatch_action, get_fps, get_hovered_object_json, get_inventory_json, get_online_status, get_player_state_json, get_selected_object_json, go_online }, Symbol.toStringTag, { value: "Module" }));
function GlassPanel({ children: a, className: c = "" }) {
  return jsxRuntimeExports.jsx("div", { className: `bg-glass backdrop-blur-[4px] rounded-glass border border-glass-border shadow-glass pointer-events-auto ${c}`, children: a });
}
function HUD() {
  ...
  }, []), a ? jsxRuntimeExports.jsx(GlassPanel, { className: "absolute top-12 right-4 md:top-14 md:right-6 px-3 py-1.5 md:px-4 md:py-2 pointer-events-none", children: jsxRuntimeExports.jsxs("div", { className: "text-[7px] md:text-[9px] text-text-muted", children: ["Pos: ", a.position.map((i) => i.toFixed(1)).join(", ")] }) }) : null;
}
const ITEM_NAMES = { log: "Log", stone: "Stone", mossy_stone: "Mossy Stone", copper_ore: "Copper Ore", iron_ore: "Iron Ore", crystal_ore: "Crystal Ore", tulip: "Tulip", daisy: "Daisy", lavender: "Lavender", bellflower: "Bellflower", wildflower: "Wildflower", sunflower: "Sunflower", rose: "Rose", cornflower: "Cornflower", allium: "Allium", blue_orchid: "Blue Orchid", porcini: "Porcini", chanterelle: "Chanterelle", fly_agaric: "Fly Agaric" };
function useInventory() {
  const [a, c] = reactExports.useState(null), i = reactExports.useRef(/* @__PURE__ */ new Map());
  return reactExports.useEffect(() => {
    const f = setInterval(() => {
      try {
        ...
        for (const [v, p] of y) {
          const C = x.get(v) ?? 0;
          if (p > C) {
            const R = p - C, Q = ITEM_NAMES[v] ?? v;
            gameEvents.emit("toast:show", { message: `+${R} ${Q}`, severity: "loot" });
          }
        }
        i.current = y;
      } catch {
...
function Inventory() {
  var _a;
  const [a, c] = reactExports.useState(false), f = ((_a = useInventory()) == null ? void 0 : _a.items) ?? [];
  return jsxRuntimeExports.jsxs("div", { className: "absolute bottom-40 right-4 md:bottom-44 md:right-6 pointer-events-auto", children: [jsxRuntimeExports.jsx("button", { onClick: () => c(!a), className: `block ml-auto mb-1 px-2 py-1 text-[8px] md:text-[10px]
					bg-panel-inner border-2 border-panel-border text-[#c8a832]
					shadow-[0_0_0_1px_#1a1008,0_2px_6px_rgba(0,0,0,0.5)]
					hover:bg-[#2a1c0c] active:bg-[#1a1008] transition-colors`, children: a ? "Close" : "Bag" }), a && jsxRuntimeExports.jsx("div", { className: "border-[3px] border-panel-border shadow-[0_0_0_1px_#1a1008,0_4px_12px_rgba(0,0,0,0.6)]", children: jsxRuntimeExports.jsxs("div", { className: "border-2 border-[#1a1008] bg-panel-inner p-2 md:p-3", children: [jsxRuntimeExports.jsx("div", { className: "text-[7px] md:text-[10px] mb-1.5 md:mb-2 text-center text-[#c8a832]", children: "Inventory" }), jsxRuntimeExports.jsx("div", { className: "p-1 md:p-1.5 bg-[#1e1408] border border-[#5a4a2a]", children: jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-px md:gap-0.5", children: Array.from({ length: TOTAL_SLOTS }).map((_, b) => {
    const y = f[b];
    return jsxRuntimeExports.jsx("div", { className: `w-7 h-7 md:w-11 md:h-11 bg-[#261a0a] border border-[#3d2b14]
												...
												flex flex-col items-center justify-center relative`, children: y && jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx("span", { className: "text-[10px] md:text-[14px] leading-none", children: ITEM_ICONS[y.kind] ?? "?" }), jsxRuntimeExports.jsx("span", { className: "text-[5px] md:text-[7px] text-text-muted leading-none mt-px", children: ITEM_SHORT_NAMES[y.kind] ?? y.kind }), y.quantity > 1 && jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 right-0.5 text-[5px] md:text-[7px] text-[#c8a832] leading-none", children: y.quantity })] }) }, b);
  }) }) })] }) })] });
}
function FPSCounter() {
  ...
  return reactExports.useEffect(() => {
    ...
    return () => clearInterval(i);
  }, []), jsxRuntimeExports.jsxs("div", { className: "absolute top-12 left-4 md:top-14 md:left-6 px-2 py-1 md:px-3 md:py-1.5 bg-panel border border-panel-border text-[7px] md:text-[10px] text-text-muted pointer-events-auto", children: [a, " FPS"] });
}
const CAMERA_OFFSET = [15, 20, 15], VIEWPORT_HEIGHT = 20;
function computeCameraAxes() {
  const a = [-15, -20, -15], c = Math.sqrt(a[0] ** 2 + a[1] ** 2 + a[2] ** 2);
  a[0] /= c, a[1] /= c, a[2] /= c;
  const i = [0, 1, 0], f = [a[1] * i[2] - a[2] * i[1], a[2] * i[0] - a[0] * i[2], a[0] * i[1] - a[1] * i[0]], _ = Math.sqrt(f[0] ** 2 + f[1] ** 2 + f[2] ** 2);
  f[0] /= _, f[1] /= _, f[2] /= _;
...
function worldToScreen(a, c, i, f) {
  const _ = [a[0] - c[0], a[1] - c[1], a[2] - c[2]], b = VIEWPORT_HEIGHT / 2, y = i / f, x = b * y, v = dot(_, AXES.right) / x, p = dot(_, AXES.up) / b;
  return Math.abs(v) > 1.2 || Math.abs(p) > 1.2 ? null : { x: (v + 1) / 2 * i, y: (1 - p) / 2 * f };
}
  ...
  return reactExports.useEffect(() => {
    const i = setInterval(() => {
      try {
        ...
        const _ = JSON.parse(f), b = get_player_state_json();
        if (!b) {
          c(null);
          return;
        }
        const y = JSON.parse(b), x = [y.position[0] + CAMERA_OFFSET[0], y.position[1] + CAMERA_OFFSET[1], y.position[2] + CAMERA_OFFSET[2]], v = [_.position[0], _.position[1] + 1.5, _.position[2]], p = worldToScreen(v, x, window.innerWidth, window.innerHeight);
        if (!p) {
          c(null);
          return;
        }
        let C = OBJECT_NAMES[_.kind] ?? _.kind;
        _.kind === "flower" && _.sub_kind && (C = FLOWER_NAMES[_.sub_kind] ?? C), _.kind === "rock" && _.sub_kind && (C = ROCK_NAMES[_.sub_kind] ?? C), _.kind === "mushroom" && _.sub_kind && (C = MUSHROOM_NAMES[_.sub_kind] ?? C), c({ name: C, screenX: p.x, screenY: p.y });
      } catch {
        c(null);
      }
    }, 50);
    return () => clearInterval(i);
  }, []), a ? jsxRuntimeExports.jsx("div", { className: "absolute pointer-events-none", style: { left: a.screenX, top: a.screenY, transform: "translate(-50%, -100%)" }, children: jsxRuntimeExports.jsx("div", { className: `px-2 py-1 md:px-3 md:py-1.5 bg-[#1e1408]/90 border border-panel-border
					text-[7px] md:text-[10px] text-[#c8a832] whitespace-nowrap`, children: a.name }) }) : null;
}
async function getSupabaseJwt() {
  return new Promise((a) => {
    const c = indexedDB.open("sb-auth-v2", 1);
    c.onerror = () => a(""), c.onupgradeneeded = () => {
      var _a;
      (_a = c.transaction) == null ? void 0 : _a.abort(), a("");
    }, c.onsuccess = () => {
      const i = c.result;
      try {
        const _ = i.transaction("kv", "readonly").objectStore("kv"), b = _.get("supabase.auth.token");
        b.onsuccess = () => {
          var _a;
          if ((_a = b.result) == null ? void 0 : _a.value) try {
          ...
          y.onsuccess = () => {
            ...
            const v = x.key;
            if (v.includes("auth") && v.includes("token")) try {
              const p = JSON.parse(x.value.value);
              a((p == null ? void 0 : p.access_token) ?? "");
            } catch {
              x.continue();
            }
            else x.continue();
...
function resolveWsUrl() {
  ...
  return a === "localhost" || a === "127.0.0.1" ? "ws://127.0.0.1:5000" : `wss://${a}/ws`;
}
function GoOnlineButton() {
  const [a, c] = reactExports.useState(false), [i, f] = reactExports.useState(false), [_, b] = reactExports.useState(null), y = reactExports.useRef(false), x = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  const v = reactExports.useCallback(async () => {
    if (!x.current) {
      x.current = true;
      try {
        const R = await getSupabaseJwt(), Q = resolveWsUrl();
        go_online(Q, R);
      } finally {
        setTimeout(() => {
          x.current = false;
  ...
  reactExports.useEffect(() => {
    ...
    const R = () => {
      document.visibilityState === "visible" && y.current && setTimeout(() => {
        try {
          get_online_status() || (console.log("[GoOnlineButton] tab resumed, connection lost \u2014 auto-reconnecting"), f(true), v());
        } catch {
        }
      }, 600);
    };
  ...
  const p = async () => {
    a || i || (f(true), y.current = true, await v());
  };
  if (_ === null) return null;
  const C = a ? "Online" : i ? "Connecting..." : _ ? "Go Online" : "Go Online (Guest)";
  return jsxRuntimeExports.jsx(GlassPanel, { className: "absolute bottom-4 right-4 md:bottom-6 md:right-6", children: jsxRuntimeExports.jsxs("button", { onClick: p, disabled: a || i, className: `px-3 py-1.5 md:px-4 md:py-2 text-[9px] md:text-xs font-bold tracking-wider uppercase pointer-events-auto transition-colors ${a ? "text-green-400 cursor-default" : i ? "text-yellow-400 cursor-wait" : "text-text hover:text-white cursor-pointer"}`, children: [jsxRuntimeExports.jsx("span", { className: `inline-block w-1.5 h-1.5 rounded-full mr-1.5 ${a ? "bg-green-400" : i ? "bg-yellow-400 animate-pulse" : _ ? "bg-blue-400" : "bg-red-400"}` }), C] }) });
}
const MODAL_CLOSE_DISTANCE = 6, ACTION_DISTANCE = 3;
function xzDistance(a, c) {
  const i = a[0] - c[0], f = a[2] - c[2];
...
function ActionContent({ info: a, objectPos: c, entityId: i }) {
  return jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:space-y-3", children: [jsxRuntimeExports.jsx("div", { className: "px-2 py-1.5 md:px-3 md:py-2 bg-[#1e1408] border border-[#5a4a2a]", children: jsxRuntimeExports.jsx("p", { className: "text-[8px] md:text-xs text-text leading-relaxed", children: a.description }) }), jsxRuntimeExports.jsx("div", { className: "flex justify-center pt-1", children: jsxRuntimeExports.jsx("button", { className: `px-4 py-1.5 md:px-6 md:py-2 text-[8px] md:text-xs text-text
    ...
    if (_) {
      dispatch_action(i, _);
      const b = _ === "chop_tree" ? "Chopping" : _ === "mine_rock" ? "Mining" : "Collecting";
      gameEvents.emit("toast:show", { message: `${b} ${a.title}...`, severity: "info" });
    } else gameEvents.emit("toast:show", { message: `${a.action}: ${a.title}`, severity: "info" });
    gameEvents.emit("modal:close");
  }, children: a.action }) })] });
}
function useObjectSelection() {
  const a = reactExports.useRef(false), c = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const i = setInterval(() => {
      if (!a.current) try {
        ...
        if (b.kind === "flower" && b.sub_kind) {
          ...
          x && (y = { ...y, title: x.title, description: x.description });
        }
        if (b.kind === "rock" && b.sub_kind) {
          const x = ROCK_INFO[b.sub_kind];
          x && (y = { title: x.title, description: x.description, action: x.action });
        }
        if (b.kind === "mushroom" && b.sub_kind) {
          const x = MUSHROOM_INFO[b.sub_kind];
          x && (y = { ...y, title: x.title, description: x.description });
        }
        a.current = true, c.current = b.position, gameEvents.emit("modal:open", { title: y.title, size: "sm", content: jsxRuntimeExports.jsx(ActionContent, { info: y, objectPos: b.position, entityId: b.entity_id }), onClose: () => {
      ...
      _ && xzDistance(_, c.current) > MODAL_CLOSE_DISTANCE && gameEvents.emit("modal:close");
    }, 250);
    return () => {
...
function App() {
  return useObjectSelection(), jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 pointer-events-none font-game text-text rpg-text-shadow", children: [jsxRuntimeExports.jsx(FPSCounter, {}), jsxRuntimeExports.jsx(HUD, {}), jsxRuntimeExports.jsx(Inventory, {}), jsxRuntimeExports.jsx(ObjectLabel, {}), jsxRuntimeExports.jsx(GoOnlineButton, {})] });
}
function setLoadingProgress(a, c) {
  const i = document.getElementById("loading-status"), f = document.getElementById("loading-bar");
  i && (i.textContent = a), f && (f.style.width = c + "%");
}
function hideLoadingScreen() {
  const a = document.getElementById("game-loading");
  a && (a.style.opacity = "0", a.style.transition = "opacity 0.4s ease", setTimeout(() => a.remove(), 400));
}
async function bootstrap() {
  if (!navigator.gpu) {
    const c = document.getElementById("root");
    c && (c.innerHTML = '<div style="color:#fff;padding:2rem;text-align:center"><h2>WebGPU Not Available</h2><p>This browser does not support WebGPU (Chrome 113+, Edge 113+, Safari 18+).</p></div>', c.style.pointerEvents = "auto");
    return;
  }
  setLoadingProgress("Loading game module...", 20);
  const { default: a } = await __vitePreload(async () => {
    const { default: c } = await Promise.resolve().then(() => isometric_game);
    return { default: c };
  }, void 0);
  setLoadingProgress("Initializing WebGPU...", 60), await a(), setLoadingProgress("Starting...", 90), ReactDOM.createRoot(document.getElementById("root")).render(jsxRuntimeExports.jsx(React.StrictMode, { children: jsxRuntimeExports.jsx(GameUIProvider, { children: jsxRuntimeExports.jsx(App, {}) }) })), setLoadingProgress("Ready", 100), hideLoadingScreen();
}
bootstrap().catch((a) => {
