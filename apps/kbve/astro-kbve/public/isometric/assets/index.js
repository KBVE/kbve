...
const scriptRel = "modulepreload", assetsURL = function(a) {
  ...
  if (i && i.length > 0) {
    let y = function(p) {
      return Promise.all(p.map((z) => Promise.resolve(z).then((H) => ({ status: "fulfilled", value: H }), (H) => ({ status: "rejected", reason: H }))));
    };
    ...
    _ = y(i.map((p) => {
      ...
      seen[p] = true;
      const z = p.endsWith(".css"), H = z ? '[rel="stylesheet"]' : "";
      if (document.querySelector(`link[href="${p}"]${H}`)) return;
      const J = document.createElement("link");
      if (J.rel = z ? "stylesheet" : scriptRel, z || (J.as = "script"), J.crossOrigin = "", J.href = p, v && J.setAttribute("nonce", v), document.head.appendChild(J), z) return new Promise((Ce, De) => {
        J.addEventListener("load", Ce), J.addEventListener("error", () => De(new Error(`Unable to preload CSS for ${p}`)));
      });
    }));
  }
  function b(y) {
...
function requireReact_production() {
  ...
  function Fe(m, D, C) {
    this.props = m, this.context = D, this.refs = St, this.updater = C || De;
  }
  Fe.prototype.isReactComponent = {}, Fe.prototype.setState = function(m, D) {
  ...
  at.constructor = Re, ze(at, Fe.prototype), at.isPureReactComponent = true;
  ...
  function yt(m, D, C) {
    var U = C.ref;
    return { $$typeof: a, type: m, key: D, ref: U !== void 0 ? U : null, props: C };
  }
  function Ln(m, D) {
  ...
  function A(m, D, C, U, V) {
    ...
    if (te) return V = V(m), te = U === "" ? "." + Et(m, 0) : U, Ot(V) ? (C = "", te != null && (C = te.replace(On, "$&/") + "/"), A(V, D, C, "", function(va) {
      return va;
    })) : V != null && (jt(V) && (V = Ln(V, C + (V.key == null || m && m.key === V.key ? "" : ("" + V.key).replace(On, "$&/") + "/") + te)), D.push(V)), 1;
    te = 0;
    var He = U === "" ? "." : U + ":";
    if (Ot(m)) for (var ge = 0; ge < m.length; ge++) U = m[ge], Q = He + Et(U, ge), te += A(U, D, C, Q, V);
    else if (ge = Ce(m), typeof ge == "function") for (m = ge.call(m), ge = 0; !(U = m.next()).done; ) U = U.value, Q = He + Et(U, ge++), te += A(U, D, C, Q, V);
    else if (Q === "object") {
  ...
  var ce = typeof reportError == "function" ? reportError : function(m) {
    ...
    console.error(m);
  }, re = { map: R, forEach: function(m, D, C) {
    R(m, function() {
  ...
  return react_production.Activity = H, react_production.Children = re, react_production.Component = Fe, react_production.Fragment = i, react_production.Profiler = _, react_production.PureComponent = Re, react_production.StrictMode = f, react_production.Suspense = v, react_production.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = k, react_production.__COMPILER_RUNTIME = { __proto__: null, c: function(m) {
    ...
    if (Q === 1) U.children = C;
      ...
      for (var te = Array(Q), He = 0; He < Q; He++) te[He] = arguments[He + 2];
      U.children = te;
    }
    ...
    return { $$typeof: z, _payload: { _status: -1, _result: m }, _init: q };
    ...
    return k.H.useActionState(m, D, C);
    ...
    return k.H.useImperativeHandle(m, D, C);
    ...
    return k.H.useSyncExternalStore(m, D, C);
  ...
  return hasRequiredScheduler_production || (hasRequiredScheduler_production = 1, (function(a) {
    function c(A, R) {
      ...
      e: for (; 0 < q; ) {
        ...
        if (0 < _(re, R)) A[ce] = R, A[q] = re, q = ce;
        else break e;
      }
    }
    function i(A) {
    ...
    function f(A) {
      ...
      if (q !== R) {
        ...
        e: for (var ce = 0, re = A.length, m = re >>> 1; ce < m; ) {
          ...
          if (0 > _(C, q)) U < re && 0 > _(V, C) ? (A[ce] = V, A[U] = q, ce = U) : (A[ce] = C, A[D] = q, ce = D);
    ...
    function _(A, R) {
      var q = A.sortIndex - R.sortIndex;
      return q !== 0 ? q : A.id - R.id;
    }
    ...
    var v = [], p = [], z = 1, H = null, J = 3, Ce = false, De = false, ze = false, St = false, Fe = typeof setTimeout == "function" ? setTimeout : null, Zt = typeof clearTimeout == "function" ? clearTimeout : null, Re = typeof setImmediate < "u" ? setImmediate : null;
    function at(A) {
      for (var R = i(p); R !== null; ) {
        if (R.callback === null) f(p);
        else if (R.startTime <= A) f(p), R.sortIndex = R.expirationTime, c(v, R);
        else break;
        R = i(p);
      }
    }
      ...
      if (St = false, Ue) {
        ...
        try {
          e: {
            ...
            try {
              t: {
                for (at(A), H = i(v); H !== null && !(H.expirationTime > A && Ln()); ) {
                  var ce = H.callback;
                  if (typeof ce == "function") {
                    H.callback = null, J = H.priorityLevel;
                    var re = ce(H.expirationTime <= A);
                    if (A = a.unstable_now(), typeof re == "function") {
                      H.callback = re, at(A), R = true;
                      break t;
                    }
                    H === i(v) && f(v), at(A);
                  } else f(v);
                ...
                if (H !== null) R = true;
                  ...
                  var m = i(p);
                  m !== null && dt(Ot, m.startTime - A), R = false;
                }
              }
              break e;
            } finally {
    ...
    a.unstable_IdlePriority = 5, a.unstable_ImmediatePriority = 1, a.unstable_LowPriority = 4, a.unstable_NormalPriority = 3, a.unstable_Profiling = null, a.unstable_UserBlockingPriority = 2, a.unstable_cancelCallback = function(A) {
      ...
      St = true;
    }, a.unstable_runWithPriority = function(A, R) {
      switch (A) {
        case 1:
        case 2:
        case 3:
    ...
    }, a.unstable_scheduleCallback = function(A, R, q) {
      ...
      return re = q + re, A = { id: z++, callback: R, priorityLevel: A, startTime: q, expirationTime: re, sortIndex: -1 }, q > ce ? (A.sortIndex = q, c(p, A), i(v) === null && A === i(p) && (ze ? (Zt(k), k = -1) : ze = true, dt(Ot, q - ce))) : (A.sortIndex = re, c(v, A), De || Ce || (De = true, Ue || (Ue = true, Le()))), A;
...
function requireReactDom_production() {
  ...
  function b(v, p, z) {
    ...
    return { $$typeof: _, key: H == null ? null : "" + H, children: v, containerInfo: p, implementation: z };
  }
  ...
  return reactDom_production.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = f, reactDom_production.createPortal = function(v, p) {
    ...
    if (typeof v == "string" && p && typeof p.as == "string") {
      var z = p.as, H = x(z, p.crossOrigin), J = typeof p.integrity == "string" ? p.integrity : void 0, Ce = typeof p.fetchPriority == "string" ? p.fetchPriority : void 0;
      z === "style" ? f.d.S(v, typeof p.precedence == "string" ? p.precedence : void 0, { crossOrigin: H, integrity: J, fetchPriority: Ce }) : z === "script" && f.d.X(v, { crossOrigin: H, integrity: J, fetchPriority: Ce, nonce: typeof p.nonce == "string" ? p.nonce : void 0 });
    }
  }, reactDom_production.preinitModule = function(v, p) {
    if (typeof v == "string") if (typeof p == "object" && p !== null) {
      if (p.as == null || p.as === "script") {
        var z = x(p.as, p.crossOrigin);
        f.d.M(v, { crossOrigin: z, integrity: typeof p.integrity == "string" ? p.integrity : void 0, nonce: typeof p.nonce == "string" ? p.nonce : void 0 });
      }
    } else p == null && f.d.M(v);
  }, reactDom_production.preload = function(v, p) {
    if (typeof v == "string" && typeof p == "object" && p !== null && typeof p.as == "string") {
      var z = p.as, H = x(z, p.crossOrigin);
      f.d.L(v, z, { crossOrigin: H, integrity: typeof p.integrity == "string" ? p.integrity : void 0, nonce: typeof p.nonce == "string" ? p.nonce : void 0, type: typeof p.type == "string" ? p.type : void 0, fetchPriority: typeof p.fetchPriority == "string" ? p.fetchPriority : void 0, referrerPolicy: typeof p.referrerPolicy == "string" ? p.referrerPolicy : void 0, imageSrcSet: typeof p.imageSrcSet == "string" ? p.imageSrcSet : void 0, imageSizes: typeof p.imageSizes == "string" ? p.imageSizes : void 0, media: typeof p.media == "string" ? p.media : void 0 });
    }
  }, reactDom_production.preloadModule = function(v, p) {
    if (typeof v == "string") if (p) {
      var z = x(p.as, p.crossOrigin);
      f.d.m(v, { as: typeof p.as == "string" && p.as !== "script" ? p.as : void 0, crossOrigin: z, integrity: typeof p.integrity == "string" ? p.integrity : void 0 });
    } else f.d.m(v);
...
function requireReactDomClient_production() {
  ...
  var dt = Array.isArray, A = c.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, R = i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, q = { pending: false, data: null, method: null, action: null }, ce = [], re = -1;
  function m(e) {
    return { current: e };
  }
  function D(e) {
...
` + u.stack;
  ...
  var Wt = Math.random().toString(36).slice(2), Se = "__reactFiber$" + Wt, Ge = "__reactProps$" + Wt, Gn = "__reactContainer$" + Wt, Xu = "__reactEvents$" + Wt, bs = "__reactListeners$" + Wt, ds = "__reactHandles$" + Wt, fr = "__reactResources$" + Wt, Aa = "__reactMarker$" + Wt;
  function Qu(e) {
  ...
  function Fu(e, t, n, u, l, r, o, s) {
    e.name = "", o != null && typeof o != "function" && typeof o != "symbol" && typeof o != "boolean" ? e.type = o : e.removeAttribute("type"), t != null ? o === "number" ? (t === 0 && e.value === "" || e.value != t) && (e.value = "" + ct(t)) : e.value !== "" + ct(t) && (e.value = "" + ct(t)) : o !== "submit" && o !== "reset" || e.removeAttribute("value"), t != null ? Wu(e, o, ct(t)) : n != null ? Wu(e, o, ct(n)) : u != null && e.removeAttribute("value"), l == null && r != null && (e.defaultChecked = !!r), l != null && (e.checked = l && typeof l != "function" && typeof l != "symbol"), s != null && typeof s != "function" && typeof s != "symbol" && typeof s != "boolean" ? e.name = "" + ct(s) : e.removeAttribute("name");
  }
  ...
  function hr(e) {
    ...
    if (t && (e = t.stateNode)) {
      ...
      e: switch (e = t.stateNode, t.type) {
        case "input":
          if (Fu(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name), t = n.name, n.type === "radio" && t != null) {
  ...
  function wr(e, t, n) {
    ...
    try {
      ...
      if (Iu = false, (Fn !== null || Wn !== null) && (su(), Fn && (t = Fn, e = Wn, Wn = Fn = null, hr(t), e))) for (t = 0; t < e.length; t++) hr(e[t]);
    }
  }
  function Ma(e, t) {
    var n = e.stateNode;
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, Mc = qe(wn), Ra = H({}, wn, { view: 0, detail: 0 }), ws = qe(Ra), el, tl, Ca, Dc = H({}, Ra, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: al, button: 0, buttons: 0, relatedTarget: function(e) {
  ...
  } }), Sr = qe(Dc), vs = H({}, Dc, { dataTransfer: 0 }), xs = qe(vs), Ss = H({}, Ra, { relatedTarget: 0 }), nl = qe(Ss), Es = H({}, wn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), As = qe(Es), Ts = H({}, wn, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), Ms = qe(Ts), Ds = H({}, wn, { data: 0 }), Er = qe(Ds), Rs = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" }, Cs = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Delete", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" }, zs = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };
  function Hs(e) {
  ...
  } }), Us = qe(Ns), Bs = H({}, Dc, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Ar = qe(Bs), Ls = H({}, Ra, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: al }), Gs = qe(Ls), qs = H({}, wn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Vs = qe(qs), Ys = H({}, Dc, { deltaX: function(e) {
    return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
  }, deltaY: function(e) {
    return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
  }, deltaZ: 0, deltaMode: 0 }), Xs = qe(Ys), Qs = H({}, wn, { newState: 0, oldState: 0 }), Zs = qe(Qs), Fs = [9, 13, 27, 32], cl = Mt && "CompositionEvent" in window, za = null;
  Mt && "documentMode" in document && (za = document.documentMode);
  var Ws = Mt && "TextEvent" in window && !za, Tr = Mt && (!cl || za && 8 < za && 11 >= za), Mr = " ", Dr = false;
  function Rr(e, t) {
    switch (e) {
      case "keyup":
  ...
  function Hr(e, t, n, u) {
    Fn ? Wn ? Wn.push(u) : Wn = [u] : Fn = u, t = yu(t, "onChange"), 0 < t.length && (n = new Mc("onChange", "change", null, n, u), e.push({ event: n, listeners: t }));
  }
  var Ha = null, Na = null;
  function Is(e) {
    O_(e, 0);
  ...
  function Uc(e, t, n, u, l, r) {
    ...
    if (u = e, typeof e == "function") dl(e) && (o = 1);
      ...
      case St:
        ...
        break;
      case Fe:
        return e = Ie(12, n, t, l | 2), e.elementType = Fe, e.lanes = r, e;
      case Ot:
  ...
  function $t(e, t, n) {
    C(hl, t._currentValue), t._currentValue = n;
  }
  function zt(e) {
  ...
  var rf = A.S;
  A.S = function(e, t) {
    Fo = We(), typeof t == "object" && t !== null && typeof t.then == "function" && _b(e, t), rf !== null && rf(e, t);
  };
  var Dn = m(null);
  function El() {
    var e = Dn.current;
  ...
  function Qc(e, t) {
    throw t.$$typeof === J ? Error(f(525)) : (e = Object.prototype.toString.call(t), Error(f(31, e === "[object Object]" ? "object with keys {" + Object.keys(t).join(", ") + "}" : e)));
  }
  function df(e) {
    function t(O, g) {
      if (e) {
    ...
    function N(O, g, j, T) {
      for (var L = null, $ = null, B = g, X = g = 0, K = null; B !== null && X < j.length; X++) {
        ...
        e && B && P.alternate === null && t(O, B), g = r(P, g, X), $ === null ? L = P : $.sibling = P, $ = P, B = K;
      }
      ...
      for (B = u(B); X < j.length; X++) K = S(B, O, X, j[X], T), K !== null && (e && K.alternate !== null && B.delete(K.key === null ? X : K.key), g = r(K, g, X), $ === null ? L = K : $.sibling = K, $ = K);
    ...
    function G(O, g, j, T) {
      ...
      for (var L = null, $ = null, B = g, X = g = 0, K = null, P = j.next(); B !== null && !P.done; X++, P = j.next()) {
        B.index > X ? (K = B, B = null) : K = B.sibling;
        ...
        e && B && pn.alternate === null && t(O, B), g = r(pn, g, X), $ === null ? L = pn : $.sibling = pn, $ = pn, B = K;
      }
  ...
  function Of(e, t) {
    e = Yt, C(Zc, e), C(ia, t), Yt = e | t.baseLanes;
  }
  function Cl() {
    C(Zc, Yt), C(ia, ia.current);
  }
  function zl() {
  ...
  function nn(e) {
    var t = e.alternate;
    C(me, me.current & 1), C($e, e), _t === null && (t === null || ia.current !== null || t.memoizedState !== null) && (_t = e);
  }
  function Hl(e) {
    C(me, me.current), C($e, e), _t === null && (_t = e);
  }
  function yf(e) {
    e.tag === 22 ? (C(me, me.current), C($e, e), _t === null && (_t = e)) : an();
  }
  function an() {
  ...
  var Ht = 0, Y = null, ue = null, ye = null, Wc = false, ra = false, Hn = false, Kc = 0, Wa = 0, fa = null, bb = 0;
  function be() {
    throw Error(f(321));
  }
  function Nl(e, t) {
  ...
  function jf(e) {
    ...
    if (Ht = 0, ye = ue = Y = null, Wc = false, Wa = 0, fa = null, t) throw Error(f(300));
  ...
  function hf(e, t, n, u) {
    ...
    var l = 0;
    do {
      if (ra && (fa = null), Wa = 0, ra = false, 25 <= l) throw Error(f(301));
  ...
  function Gl(e) {
    ...
    Ht = 0, ye = ue = Y = null, ra = false, Wa = Kc = 0, fa = null;
  }
  function Ne() {
  ...
  function Ka(e) {
    var t = Wa;
    return Wa += 1, fa === null && (fa = []), e = _f(fa, e, t), t = Y, (ye === null ? t.memoizedState : ye.next) === null && (t = t.alternate, A.H = t === null || t.memoizedState === null ? no : Il), e;
  }
  function kc(e) {
  ...
  function Wl(e, t, n) {
    return n === void 0 || (Ht & 1073741824) !== 0 && (W & 261930) === 0 ? e.memoizedState = t : (e.memoizedState = n, e = Ko(), Y.lanes |= e, ln |= e, n);
  }
  function Wf(e, t, n, u) {
    return ke(n, t) ? n : ia.current !== null ? (e = Wl(e, n, u), ke(e, t) || (je = true), e) : (Ht & 42) === 0 || (Ht & 1073741824) !== 0 && (W & 261930) === 0 ? (je = true, e.memoizedState = n) : (e = Ko(), Y.lanes |= e, ln |= e, t);
  }
  function Kf(e, t, n, u, l) {
    ...
    try {
      ...
      R.p = r, o !== null && s.types !== null && (o.types = s.types), A.T = o;
    }
  }
  function Ob() {
  }
  ...
  } }, Il = { readContext: Ae, use: kc, useCallback: Zf, useContext: Ae, useEffect: Zl, useImperativeHandle: Qf, useInsertionEffect: Vf, useLayoutEffect: Yf, useMemo: Ff, useReducer: Ic, useRef: Lf, useState: function() {
    return Ic(Nt);
  }, useDebugValue: Fl, useDeferredValue: function(e, t) {
    var n = pe();
  ...
  var ao = { readContext: Ae, use: kc, useCallback: Zf, useContext: Ae, useEffect: Zl, useImperativeHandle: Qf, useInsertionEffect: Vf, useLayoutEffect: Yf, useMemo: Ff, useReducer: Yl, useRef: Lf, useState: function() {
    return Yl(Nt);
  }, useDebugValue: Fl, useDeferredValue: function(e, t) {
    var n = pe();
  ...
  function $l(e, t, n, u) {
    t = e.memoizedState, n = n(u, t), n = n == null ? t : H({}, t, n), e.memoizedState = n, e.lanes === 0 && (e.updateQueue.baseState = n);
  }
  ...
  function xo(e, t, n) {
    ...
    if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, C(me, o), Te(e, t, u, n), u = I ? La : 0, !s && e !== null && (e.flags & 128) !== 0) e: for (e = t.child; e !== null; ) {
    ...
    switch (l) {
      case "forwards":
        for (n = t.child, l = null; n !== null; ) e = n.alternate, e !== null && Fc(e) === null && (l = n), n = n.sibling;
  ...
  function vb(e, t, n) {
    switch (t.tag) {
      ...
      case 19:
        ...
        if (l = t.memoizedState, l !== null && (l.rendering = null, l.tail = null, l.lastEffect = null), C(me, me.current), u) break;
        return null;
      case 22:
  ...
  function So(e, t, n) {
    ...
    switch (t.lanes = 0, t.tag) {
      ...
      case 3:
        ...
        return t;
      case 26:
        return au(e, t), e === null ? (n = U_(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : I || (n = t.type, e = t.pendingProps, u = ju(Q.current).createElement(n), u[Se] = t, u[Ge] = e, Me(u, n, e), ve(u), t.stateNode = u) : t.memoizedState = U_(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
      case 27:
        return va(t), e === null && I && (u = t.stateNode = z_(t.type, t.pendingProps, Q.current), Ee = t, ot = true, l = oe, sn(t.type) ? (Yi = l, oe = st(u.firstChild)) : oe = l), Te(e, t, t.pendingProps.children, n), au(e, t), e === null && (t.flags |= 4194304), t.child;
      case 5:
  ...
  function xb(e, t, n) {
    ...
    switch (Ol(t), t.tag) {
      ...
      case 27:
        if (mc(t), n = Q.current, l = t.type, e !== null && t.stateNode != null) e.memoizedProps !== u && Bt(t);
        else {
          if (!u) {
        ...
        if (l = (t.flags & 128) !== 0, r = u.rendering, r === null) if (l) $a(u, false);
          ...
          if (de !== 0 || e !== null && (e.flags & 128) !== 0) for (e = t.child; e !== null; ) {
            if (r = Fc(e), r !== null) {
              ...
              return C(me, me.current & 1 | 2), I && Rt(t, u.treeForkCount), t.child;
            }
            e = e.sibling;
          }
          u.tail !== null && We() > ou && (t.flags |= 128, l = true, $a(u, false), t.lanes = 4194304);
        }
        else {
          if (!l) if (e = Fc(r), e !== null) {
          ...
          } else 2 * We() - u.renderingStartTime > ou && n !== 536870912 && (t.flags |= 128, l = true, $a(u, false), t.lanes = 4194304);
          u.isBackwards ? (r.sibling = t.child, t.child = r) : (e = u.last, e !== null ? e.sibling = r : t.child = r, u.last = r);
        }
        return u.tail !== null ? (e = u.tail, u.rendering = e, u.tail = e.sibling, u.renderingStartTime = We(), e.sibling = null, n = me.current, C(me, l ? n & 1 | 2 : n & 1), I && Rt(t, u.treeForkCount), e) : (_e(t), null);
      case 22:
      case 23:
  ...
  function Go(e, t) {
    ...
    switch (e.tag) {
      ...
      case 31:
        ...
        break;
      case 13:
        Ye(t, e), Xe(e), e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && (fu = We()), u & 4 && (u = e.updateQueue, u !== null && (e.updateQueue = null, iu(e, u)));
        break;
      case 22:
  ...
  } }, Mb = typeof WeakMap == "function" ? WeakMap : Map, ee = 0, fe = null, Z = null, W = 0, ne = 0, et = null, un = false, ba = false, pi = false, Yt = 0, de = 0, ln = 0, Bn = 0, Oi = 0, tt = 0, da = 0, cc = null, Qe = null, yi = false, fu = 0, Fo = 0, ou = 1 / 0, _u = null, rn = null, we = 0, fn = null, ga = null, Xt = 0, ji = 0, hi = null, Wo = null, uc = 0, wi = null;
  function nt() {
    return (ee & 2) !== 0 && W !== 0 ? W & -W : A.T !== null ? Ti() : ir();
  }
  function Ko() {
    if (tt === 0) if ((W & 536870912) === 0 || I) {
      var e = yc;
  ...
  function Ze(e, t, n) {
    (e === fe && (ne === 2 || ne === 9) || e.cancelPendingCommit !== null) && (ma(e, 0), on(e, W, tt, false)), Ea(e, n), ((ee & 2) === 0 || e !== fe) && (e === fe && ((ee & 2) === 0 && (Bn |= n), de === 4 && on(e, W, tt, false)), xt(e));
  }
  function Jo(e, t, n) {
    ...
    do {
      if (l === 0) {
        ...
        e: {
          ...
          if ((t & 62914560) === t && (l = fu + 300 - We(), 10 < l)) {
  ...
  function ko(e, t, n, u, l, r, o, s, d, h, E, M, w, S) {
    if (e.timeoutHandle = -1, M = t.subtreeFlags, M & 8192 || (M & 16785408) === 16785408) {
      ...
      var N = (r & 62914560) === r ? fu - We() : (r & 4194048) === r ? Fo - We() : 0;
      if (N = dd(M, N), N !== null) {
  ...
  function vi() {
    if (Z !== null) {
      ...
      else e = Z, Ct = Tn = null, Gl(e), la = null, Ya = 0, e = Z;
  ...
  function ma(e, t) {
    ...
    n !== -1 && (e.timeoutHandle = -1, kb(n)), n = e.cancelPendingCommit, n !== null && (e.cancelPendingCommit = null, n()), Xt = 0, vi(), fe = e, Z = n = Dt(e.current, null), W = t, ne = 0, et = null, un = false, ba = Sa(e, t), pi = false, da = tt = Oi = Bn = ln = de = 0, Qe = cc = null, yi = false, (t & 8) !== 0 && (t |= t & 32);
  ...
  function Io(e, t) {
    Y = null, A.H = ka, t === ua || t === Vc ? (t = sf(), ne = 3) : t === Al ? (t = sf(), ne = 4) : ne = t === ti ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1, et = t, Z === null && (de = 1, tu(e, it(t, e.current)));
  }
  function $o() {
    var e = $e.current;
    return e === null ? true : (W & 4194048) === W ? _t === null : (W & 62914560) === W || (W & 536870912) !== 0 ? e === _t : false;
  }
  function Po() {
    var e = A.H;
  ...
  function bu() {
    de = 4, un || (W & 4194048) !== W && $e.current !== null || (ba = true), (ln & 134217727) === 0 && (Bn & 134217727) === 0 || fe === null || on(fe, W, tt, false);
  }
  function xi(e, t, n) {
    var u = ee;
    ee |= 2;
    ...
    while (true);
    return t && e.shellSuspendCounter++, Ct = Tn = null, ee = u, A.H = l, A.A = r, Z === null && (fe = null, W = 0, zc()), o;
  }
  function Rb() {
    for (; Z !== null; ) t_(Z);
  }
  function Cb(e, t) {
    ...
    ee |= 2;
    var u = Po(), l = e_();
    fe !== e || W !== t ? (_u = null, ou = We() + 500, ma(e, t)) : ba = Sa(e, t);
    e: do
      try {
        if (ne !== 0 && Z !== null) {
          t = Z;
    ...
    while (true);
    return Ct = Tn = null, A.H = u, A.A = l, ee = n, Z !== null ? 0 : (fe = null, W = 0, zc(), de);
  }
  function zb() {
    for (; Z !== null && !ns(); ) t_(Z);
  }
  ...
  function pa(e, t, n, u) {
    ...
    t.flags & 32768 ? (I || u === 1 ? e = true : ba || (W & 536870912) !== 0 ? e = false : (un = e = true, (u === 2 || u === 9 || u === 3 || u === 6) && (u = $e.current, u !== null && u.tag === 13 && (u.flags |= 16384))), a_(t, e)) : du(t);
  }
  function du(e) {
    var t = e;
    do {
  ...
  function c_(e, t, n, u, l, r, o, s, d) {
    ...
    if (t !== null) {
      ...
      if (r = t.lanes | t.childLanes, r |= sl, ss(e, n, r, o, s, d), e === fe && (Z = fe = null, W = 0), ga = t, fn = e, Xt = n, ji = r, hi = l, Wo = u, (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, Bb(pc, function() {
        return f_(), null;
      })) : (e.callbackNode = null, e.callbackPriority = 0), u = (t.flags & 13878) !== 0, (t.subtreeFlags & 13878) !== 0 || u) {
        u = A.T, A.T = null, l = R.p, R.p = 2, o = ee, ee |= 4;
        try {
          Eb(e, t, n);
        } finally {
          ee = o, R.p = l, A.T = u;
  ...
  function f_() {
    ...
    var e = fn, t = ji;
    ji = 0;
    var n = Yu(Xt), u = A.T, l = R.p;
    try {
      R.p = 32 > n ? 32 : n, A.T = null, n = hi, hi = null;
      var r = fn, o = Xt;
  ...
  function Hb(e, t, n) {
    var u = e.pingCache;
    u !== null && u.delete(t), e.pingedLanes |= e.suspendedLanes & n, e.warmLanes &= ~n, fe === e && (W & n) === n && (de === 4 || de === 3 && (W & 62914560) === W && 300 > We() - fu ? (ee & 2) === 0 && ma(e, 0) : Oi |= n, da === W && (da = 0)), xt(e);
  }
  function __(e, t) {
      ...
      do
        for (var n = false, u = mu; u !== null; ) {
          if (e !== 0) {
            ...
            r !== 0 && (n = true, g_(u, r));
          } else r = W, r = hc(u, u === fe ? r : 0, u.cancelPendingCommit !== null || u.timeoutHandle !== -1), (r & 3) === 0 || Sa(u, r) || (n = true, g_(u, r));
          u = u.next;
        }
      while (n);
      Ai = false;
  ...
  function b_(e, t) {
    ...
    if (t = fe, n = W, n = hc(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), u = e.callbackNode, n === 0 || e === t && (ne === 2 || ne === 9) || e.cancelPendingCommit !== null) return u !== null && u !== null && Gu(u), e.callbackNode = null, e.callbackPriority = 0;
    if ((n & 3) === 0 || Sa(e, n)) {
  ...
  function d_(e, t) {
    ...
    var u = W;
    return u = hc(e, e === fe ? u : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), u === 0 ? null : (Jo(e, u, t), b_(e, We()), e.callbackNode != null && e.callbackNode === n ? d_.bind(null, e) : null);
  }
  function g_(e, t) {
    if (gu()) return null;
    Jo(e, t, true);
    ...
    wr(function() {
      ...
      if ((t & 7) === 0) {
        ...
        e: {
          ...
          B && B(e, w, h), e === "focusout" && h && w.type === "number" && h.memoizedProps.value != null && Wu(w, "number", w.value);
        }
        ...
        else Kn ? Rr(e, n) && (K = "onCompositionEnd") : e === "keydown" && n.keyCode === 229 && (K = "onCompositionStart");
        K && (Tr && n.locale !== "ko" && (Kn || K !== "onCompositionStart" ? K === "onCompositionEnd" && Kn && (X = vr()) : (Kt = E, Pu = "value" in Kt ? Kt.value : Kt.textContent, Kn = true)), B = yu(h, K), 0 < B.length && (K = new Er(K, e, null, n, E), M.push({ event: K, listeners: B }), X ? K.data = X : (X = Cr(n), X !== null && (K.data = X)))), (X = Ws ? Ks(e, n) : Js(e, n)) && (K = yu(h, "onBeforeInput"), 0 < K.length && (B = new Er("onBeforeInput", "beforeinput", null, n, E), M.push({ event: B, listeners: K }), B.data = X)), qb(M, e, h, n, E);
      }
      O_(M, t);
    });
  }
...
`).replace(Fb, "");
  ...
  var Qt = R.d;
  R.d = { f: nd, r: ad, D: cd, C: ud, L: ld, m: id, X: fd, S: rd, M: od };
  function nd() {
    var e = Qt.f(), t = su();
    return e || t;
  }
  ...
  function ld(e, t, n) {
    ...
    if (u && e && t) {
      ...
      bt.has(r) || (e = H({ rel: "preload", href: t === "image" && n && n.imageSrcSet ? void 0 : e, as: t }, n), bt.set(r, e), u.querySelector(l) !== null || t === "style" && u.querySelector(oc(r)) || t === "script" && u.querySelector(_c(r)) || (t = u.createElement("link"), Me(t, "link", e), ve(t), u.head.appendChild(t)));
    }
  }
  function id(e, t) {
    Qt.m(e, t);
    ...
    if (n && e) {
      ...
      if (!bt.has(r) && (e = H({ rel: "modulepreload", href: e }, t), bt.set(r, e), n.querySelector(l) === null)) {
        switch (u) {
          case "audioworklet":
          case "paintworklet":
          case "serviceworker":
    ...
    if (u && e) {
      ...
      if (!o) {
        ...
        if (o = u.querySelector(oc(r))) s.loading = 5;
          ...
          e = H({ rel: "stylesheet", href: e, "data-precedence": t }, n), (n = bt.get(r)) && Xi(e, n);
  ...
  function fd(e, t) {
    ...
    if (n && e) {
      ...
      r || (r = n.querySelector(_c(l)), r || (e = H({ src: e, async: true }, t), (t = bt.get(l)) && Qi(e, t), r = n.createElement("script"), ve(r), Me(r, "link", e), n.head.appendChild(r)), r = { type: "script", instance: r, count: 1, state: null }, u.set(l, r));
    }
  }
  function od(e, t) {
    Qt.M(e, t);
    ...
    if (n && e) {
      var u = Yn(n).hoistableScripts, l = ha(e), r = u.get(l);
      r || (r = n.querySelector(_c(l)), r || (e = H({ src: e, async: true, type: "module" }, t), (t = bt.get(l)) && Qi(e, t), r = n.createElement("script"), ve(r), Me(r, "link", e), n.head.appendChild(r)), r = { type: "script", instance: r, count: 1, state: null }, u.set(l, r));
    }
  }
  function U_(e, t, n, u) {
  ...
  function L_(e, t, n) {
    if (t.count++, t.instance === null) switch (t.type) {
      case "style":
        ...
        var l = H({}, n, { "data-href": n.href, "data-precedence": n.precedence, href: null, precedence: null });
      ...
      case "script":
        return r = ha(n.src), (l = e.querySelector(_c(r))) ? (t.instance = l, ve(l), l) : (u = n, (l = bt.get(r)) && (u = H({}, n), Qi(u, l)), e = e.ownerDocument || e, l = e.createElement("script"), ve(l), Me(l, "link", u), e.head.appendChild(l), t.instance = l);
      case "void":
        return null;
      default:
            ...
            case 3:
              if (r = r.stateNode, r.current.memoizedState.isDehydrated) {
                ...
                if (o !== 0) {
                  ...
                  xt(r), (ee & 6) === 0 && (ou = We() + 500, lc(0));
                }
              }
              break;
            case 31:
            case 13:
              s = Sn(r, 2), s !== null && Ze(s, r, 2), su(), Fi(r, 2);
          }
  ...
  function gc(e, t, n, u, l, r) {
    return e === null || e.nativeEvent !== r ? (e = { blockedOn: t, domEventName: n, eventSystemFlags: u, nativeEvent: r, targetContainers: [l] }, t !== null && (t = Vn(t), t !== null && F_(t)), e) : (e.eventSystemFlags |= u, t = e.targetContainers, l !== null && t.indexOf(l) === -1 && t.push(l), e);
  }
  ...
  function Mu(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return t = Vn(n), t !== null && F_(t), e.blockedOn = n, false;
      t.shift();
    }
    return true;
  }
...
function __wbg_get_imports() {
  const import0 = { __proto__: null, __wbg_Window_1535697a053fe988: function(a) {
    ...
    getObject(a).blendFunc(c >>> 0, i >>> 0);
  }, __wbg_blitFramebuffer_c1a68feaca974c87: function(a, c, i, f, _, b, y, x, v, p, z) {
    getObject(a).blitFramebuffer(c, i, f, _, b, y, x, v, p >>> 0, z >>> 0);
  ...
  }, __wbg_compressedTexSubImage3D_77a6ab77487aa211: function(a, c, i, f, _, b, y, x, v, p, z, H) {
    getObject(a).compressedTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z, H);
  }, __wbg_compressedTexSubImage3D_95f64742aae944b8: function(a, c, i, f, _, b, y, x, v, p, z) {
    getObject(a).compressedTexSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, getObject(z));
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z) {
      getObject(a).texImage3D(c >>> 0, i, f, _, b, y, x, v >>> 0, p >>> 0, getObject(z));
    }, arguments);
  }, __wbg_texImage3D_9a207e0459a4f276: function() {
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z) {
      getObject(a).texImage3D(c >>> 0, i, f, _, b, y, x, v >>> 0, p >>> 0, z);
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z, H) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z >>> 0, getObject(H));
    }, arguments);
    ...
    return handleError(function(a, c, i, f, _, b, y, x, v, p, z, H) {
      getObject(a).texSubImage3D(c >>> 0, i, f, _, b, y, x, v, p >>> 0, z >>> 0, H);
    }, arguments);
    ...
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_169624, __wasm_bindgen_func_elem_169625);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000002: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_181598, __wasm_bindgen_func_elem_181599);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000003: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000004: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55097);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000005: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_4);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000006: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_5);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000007: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_6);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000008: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_7);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000009: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_8);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000a: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_9);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000b: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55091_10);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000c: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55094);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000d: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_55090, __wasm_bindgen_func_elem_55103);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000e: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_8216, __wasm_bindgen_func_elem_8217);
    return addHeapObject(i);
  }, __wbindgen_cast_000000000000000f: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_8216, __wasm_bindgen_func_elem_8217_14);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000010: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_8216, __wasm_bindgen_func_elem_8217_15);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000011: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_108491, __wasm_bindgen_func_elem_108492);
    return addHeapObject(i);
  }, __wbindgen_cast_0000000000000012: function(a, c) {
    const i = makeMutClosure(a, c, wasm.__wasm_bindgen_func_elem_118835, __wasm_bindgen_func_elem_118836);
    return addHeapObject(i);
...
function __wasm_bindgen_func_elem_169625(a, c) {
  wasm.__wasm_bindgen_func_elem_169625(a, c);
}
function __wasm_bindgen_func_elem_55103(a, c) {
  wasm.__wasm_bindgen_func_elem_55103(a, c);
}
function __wasm_bindgen_func_elem_108492(a, c) {
  wasm.__wasm_bindgen_func_elem_108492(a, c);
}
function __wasm_bindgen_func_elem_55091(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_4(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_4(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_5(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_5(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_6(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_6(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_7(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_7(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_8(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_8(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_9(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_9(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55091_10(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55091_10(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_55094(a, c, i) {
  wasm.__wasm_bindgen_func_elem_55094(a, c, isLikeNone(i) ? 0 : addHeapObject(i));
}
function __wasm_bindgen_func_elem_8217(a, c, i) {
  wasm.__wasm_bindgen_func_elem_8217(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_8217_14(a, c, i) {
  wasm.__wasm_bindgen_func_elem_8217_14(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_8217_15(a, c, i) {
  wasm.__wasm_bindgen_func_elem_8217_15(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_118836(a, c, i) {
  wasm.__wasm_bindgen_func_elem_118836(a, c, addHeapObject(i));
}
function __wasm_bindgen_func_elem_181599(a, c, i) {
  try {
    const b = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.__wasm_bindgen_func_elem_181599(b, a, c, addHeapObject(i));
...
function __wasm_bindgen_func_elem_55097(a, c, i, f) {
  wasm.__wasm_bindgen_func_elem_55097(a, c, addHeapObject(i), addHeapObject(f));
}
...
function ProgressBar({ value: a, max: c, color: i, label: f }) {
  ...
  return jsxRuntimeExports.jsxs("div", { className: "mb-1.5 md:mb-2", children: [jsxRuntimeExports.jsxs("div", { className: "text-[8px] md:text-[10px] mb-0.5", children: [f, ": ", a, "/", c] }), jsxRuntimeExports.jsx("div", { className: "w-[140px] md:w-[200px] h-3 md:h-5 bg-slot border-2 border-panel-border-dark overflow-hidden", children: jsxRuntimeExports.jsx("div", { className: `h-full ${i} transition-[width] duration-300 ease-out`, style: { width: `${_}%` } }) })] });
}
function HUD() {
  ...
  }, []), a ? jsxRuntimeExports.jsxs(GlassPanel, { className: "absolute top-4 right-4 md:top-6 md:right-6 px-3 py-2 md:px-4 md:py-3 pointer-events-none", children: [jsxRuntimeExports.jsx(ProgressBar, { label: "HP", value: a.health, max: a.max_health, color: "bg-hp" }), jsxRuntimeExports.jsx(ProgressBar, { label: "MP", value: a.mana, max: a.max_mana, color: "bg-mp" }), jsxRuntimeExports.jsx(ProgressBar, { label: "EP", value: a.energy, max: a.max_energy, color: "bg-ep" }), jsxRuntimeExports.jsxs("div", { className: "text-[7px] md:text-[9px] text-text-muted mt-1", children: ["Pos: ", a.position.map((i) => i.toFixed(1)).join(", ")] })] }) : null;
}
    ...
    const f = setInterval(() => {
      try {
        ...
        for (const [v, p] of y) {
          const z = x.get(v) ?? 0;
          if (p > z) {
            const H = p - z, J = ITEM_NAMES[v] ?? v;
            gameEvents.emit("toast:show", { message: `+${H} ${J}`, severity: "loot" });
          }
        }
        i.current = y;
      } catch {
...
function FPSCounter() {
  ...
  return reactExports.useEffect(() => {
    ...
    return () => clearInterval(i);
  }, []), jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 md:top-3 md:right-3 px-2 py-1 md:px-3 md:py-1.5 bg-panel border border-panel-border text-[7px] md:text-[10px] text-text-muted pointer-events-auto", children: [a, " FPS"] });
}
  ...
  return reactExports.useEffect(() => {
    const i = setInterval(() => {
      try {
        ...
        _.kind === "flower" && _.sub_kind && (z = FLOWER_NAMES[_.sub_kind] ?? z), _.kind === "rock" && _.sub_kind && (z = ROCK_NAMES[_.sub_kind] ?? z), _.kind === "mushroom" && _.sub_kind && (z = MUSHROOM_NAMES[_.sub_kind] ?? z), c({ name: z, screenX: p.x, screenY: p.y });
      } catch {
        c(null);
      }
    }, 50);
...
function GoOnlineButton() {
  const [a, c] = reactExports.useState(false), [i, f] = reactExports.useState(false), [_, b] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  const x = a ? "Online" : i ? "Connecting..." : _ ? "Go Online" : "Go Online (Guest)";
  return jsxRuntimeExports.jsx(GlassPanel, { className: "absolute bottom-4 right-4 md:bottom-6 md:right-6", children: jsxRuntimeExports.jsxs("button", { onClick: y, disabled: a || i, className: `px-3 py-1.5 md:px-4 md:py-2 text-[9px] md:text-xs font-bold tracking-wider uppercase pointer-events-auto transition-colors ${a ? "text-green-400 cursor-default" : i ? "text-yellow-400 cursor-wait" : "text-text hover:text-white cursor-pointer"}`, children: [jsxRuntimeExports.jsx("span", { className: `inline-block w-1.5 h-1.5 rounded-full mr-1.5 ${a ? "bg-green-400" : i ? "bg-yellow-400 animate-pulse" : _ ? "bg-blue-400" : "bg-red-400"}` }), x] }) });
}
