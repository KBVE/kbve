...
/** List of all category names (excluding None) */
...
/** Convert list of names to combined bitmask */
...
/** Convert bitmask to array of category names */
...
/** Check if a bitmask includes a specific category */
