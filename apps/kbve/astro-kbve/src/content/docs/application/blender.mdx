...
The KBVE monorepo includes a Blender CI workflow at [`.github/workflows/ci-blender.yml`](.github/workflows/ci-blender.yml) that runs on macOS runners (including self-hosted MacBook Air).
