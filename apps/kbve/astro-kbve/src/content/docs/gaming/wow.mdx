...
bento:
    ...
    title: 'World of'
    accent: Warcraft.
    lede: 'Addon setup and a growing macro library for Turtle WoW — one-button rotations, weapon swaps, and class combos across warrior, mage, warlock, rogue, hunter, priest, and shaman.'
    ctas:
        - label: Macros
          href: '#macros'
          primary: true
...
<BentoProse id="addons" heading="Addons & Setup">

This is still a proof of concept guide and needs to be worked on. I am going to start the document and then reference it back when I get more information.
...
<BentoProse id="macros" heading="Macros">
