...
bento:
    ...
    title: 'League of'
    accent: Legends.
    lede: 'Hotkeys, smart-cast setup, and the full default keybind table for Riot''s 5v5 MOBA — tuned for fast, responsive play.'
    ctas:
        - label: Hotkeys
          href: '#hotkeys'
          primary: true
    ...
    related:
        - title: 'World of Warcraft'
          copy: 'Macros and class notes for Turtle WoW.'
          href: /gaming/wow/
          icon: sword
        - title: 'Gaming hub'
...
<BentoProse id="hotkeys" heading="Hotkeys">
