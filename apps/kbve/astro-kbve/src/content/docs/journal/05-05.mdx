...
bento:
    ...
    title: 'May 5,'
    accent: every year.
    lede: 'The May 5th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#quote'
          primary: true
        ...
        - label: 'May 6 →'
          href: /journal/05-06/
    related:
        - title: 'Previous · May 4'
          copy: 'Step back a day to the May 4th log.'
          href: /journal/05-04/
          icon: calendar
        - title: 'Next · May 6'
          copy: 'Jump ahead to the May 6th log.'
          href: /journal/05-06/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1583842761792-214790fc1ae0?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Minecraft BB Model Fixture

-   06:15AM

    The minecraft models for the planes did not load correctly, thus creating this pink and black shader effect.
    We were able to get some of the fixed and resolved, but will have to loop back around and handle the other aspects like animations.
    Voxel style development can continue once we have more integration setup.
