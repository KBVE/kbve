...
bento:
    ...
    title: 'March 26,'
    accent: every year.
    lede: 'The March 26th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 27 →'
          href: /journal/03-27/
    related:
        - title: 'Previous · Mar 25'
          copy: 'Step back a day to the March 25th log.'
          href: /journal/03-25/
          icon: calendar
        - title: 'Next · Mar 27'
          copy: 'Jump ahead to the March 27th log.'
          href: /journal/03-27/
          icon: arrow
        - title: 'Journal hub'
...
### ROWS Dashboard
    ...
    1:05AM
      ...
      The dashboard needs to be extended to include data from the ROWS deployment.
      I am going to start off with a basic proof of concept for the dashboard, then slowly look at bumping up the integration, making it easier to build around it.
