...
bento:
    ...
    title: 'January 29,'
    accent: every year.
    lede: 'The January 29th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 30 →'
          href: /journal/01-30/
    related:
        - title: 'Previous · Jan 28'
          copy: 'Step back a day to the January 28th log.'
          href: /journal/01-28/
          icon: calendar
        - title: 'Next · Jan 30'
          copy: 'Jump ahead to the January 30th log.'
          href: /journal/01-30/
          icon: arrow
        - title: 'Journal hub'
...
### Unreal Engine Skeleton Animation

-   09:28AM

    The skeleton knights still have this weird animation bug that I been trying to resolve!
    It has been way too long of an issue, but I am making some better progress!
    I believe it might be the C++ code that I am using to track the animation state?
