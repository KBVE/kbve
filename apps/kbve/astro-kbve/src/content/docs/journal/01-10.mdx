...
bento:
    ...
    title: 'January 10,'
    accent: every year.
    lede: 'The January 10th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 11 →'
          href: /journal/01-11/
    related:
        - title: 'Previous · Jan 9'
          copy: 'Step back a day to the January 9th log.'
          href: /journal/01-09/
          icon: calendar
        - title: 'Next · Jan 11'
          copy: 'Jump ahead to the January 11th log.'
          href: /journal/01-11/
          icon: arrow
        - title: 'Journal hub'
...
### Supabase Integration for Handy Fork

-   01:05AM

    Adding supabase integration into tauri for the rust application.
    I might even go as far as testing out the webview within the handy app.
