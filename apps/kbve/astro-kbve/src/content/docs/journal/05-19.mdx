...
bento:
    ...
    title: 'May 19,'
    accent: every year.
    lede: 'The May 19th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 20 →'
          href: /journal/05-20/
    related:
        - title: 'Previous · May 18'
          copy: 'Step back a day to the May 18th log.'
          href: /journal/05-18/
          icon: calendar
        - title: 'Next · May 20'
          copy: 'Jump ahead to the May 20th log.'
          href: /journal/05-20/
          icon: arrow
        - title: 'Journal hub'
...
-   10:00PM
    ...
    Back at the isometric and bevy flow, taking a quick break again from unity.
    My goal now will be to get the cross platform gameplay out of the way before preparing for a steam release.
    If we can get the rareicon demo out before the end of this month, then we can take all of june and july to prepare for the isometric release.
    This then gives us some time to also prepare for the chuck release, if everything goes as planned, we can have three solid demos out before the end of the year.
