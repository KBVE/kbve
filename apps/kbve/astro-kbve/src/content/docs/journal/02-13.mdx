...
bento:
    ...
    title: 'February 13,'
    accent: every year.
    lede: 'The February 13th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 14 →'
          href: /journal/02-14/
    related:
        - title: 'Previous · Feb 12'
          copy: 'Step back a day to the February 12th log.'
          href: /journal/02-12/
          icon: calendar
        - title: 'Next · Feb 14'
          copy: 'Jump ahead to the February 14th log.'
          href: /journal/02-14/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1739382445475-1cc4fcedff2c?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
