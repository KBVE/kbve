...
client: Self
unsplash: 1721297014365-5f8e043e87a5
img: https://images.unsplash.com/photo-1721297014365-5f8e043e87a5?crop=entropy&cs=srgb&fm=jpg&ixid=MnwzNjM5Nzd8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODE3NDg2ODY&ixlib=rb-4.0.3&q=85
...
bento:
    ...
    title: 'July 22,'
    accent: every year.
    lede: 'The July 22nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 23 →'
          href: /journal/07-23/
    related:
        - title: 'Previous · Jul 21'
          copy: 'Step back a day to the July 21st log.'
          href: /journal/07-21/
          icon: calendar
        - title: 'Next · Jul 23'
          copy: 'Jump ahead to the July 23rd log.'
          href: /journal/07-23/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1721297014365-5f8e043e87a5?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Palworld Native Linux

-   09:01PM

    Spent the day trying to get the native palworld unreal image to work, but ran into way too many problems.
    Tomorrow I am going to switch it over to a windows server inside of a wine eco-system.
...
### Edge Deployment - KiloEdge?

-   04:34AM

    I am thinking about what would be the best way to deploy our new supabase edge functions.
    There are two issues that we would need to resolve, the first is getting itch users to actually log into our supabase.
    Then the second would be making sure our deployment is fast and effective, might even have to alter how the self deployment would function.

### Crazy Train

-   04:40PM

    Rest in Peace to the Shadow Wizard King, Ozzy.
