...
bento:
    ...
    title: 'June 13,'
    accent: every year.
    lede: 'The June 13th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 14 →'
          href: /journal/06-14/
    related:
        - title: 'Previous · Jun 12'
          copy: 'Step back a day to the June 12th log.'
          href: /journal/06-12/
          icon: calendar
        - title: 'Next · Jun 14'
          copy: 'Jump ahead to the June 14th log.'
          href: /journal/06-14/
          icon: arrow
        - title: 'Journal hub'
...
-   09:45PM
    ...
    Ended up not taking too many notes because I was stuck working on the web workers for most of the day, then had to loop back around to finish up the unity stuff.
    So the notes are lacking for the day, honestly, the vite web worker bugs were driving me crazy.
    I never felt like wanting to go on vacation until I finished up fixing that vite issue.
    V is vite, vengence and vacation.
