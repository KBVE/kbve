...
bento:
    ...
    title: 'April 9,'
    accent: every year.
    lede: 'The April 9th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 10 →'
          href: /journal/04-10/
    related:
        - title: 'Previous · Apr 8'
          copy: 'Step back a day to the April 8th log.'
          href: /journal/04-08/
          icon: calendar
        - title: 'Next · Apr 10'
          copy: 'Jump ahead to the April 10th log.'
          href: /journal/04-10/
          icon: arrow
        - title: 'Journal hub'
