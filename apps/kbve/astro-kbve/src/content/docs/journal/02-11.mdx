...
bento:
    ...
    title: 'February 11,'
    accent: every year.
    lede: 'The February 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 12 →'
          href: /journal/02-12/
    related:
        - title: 'Previous · Feb 10'
          copy: 'Step back a day to the February 10th log.'
          href: /journal/02-10/
          icon: calendar
        - title: 'Next · Feb 12'
          copy: 'Jump ahead to the February 12th log.'
          href: /journal/02-12/
          icon: arrow
        - title: 'Journal hub'
