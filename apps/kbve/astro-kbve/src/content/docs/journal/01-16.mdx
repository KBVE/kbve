...
bento:
    ...
    title: 'January 16,'
    accent: every year.
    lede: 'The January 16th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 17 →'
          href: /journal/01-17/
    related:
        - title: 'Previous · Jan 15'
          copy: 'Step back a day to the January 15th log.'
          href: /journal/01-15/
          icon: calendar
        - title: 'Next · Jan 17'
          copy: 'Jump ahead to the January 17th log.'
          href: /journal/01-17/
          icon: arrow
        - title: 'Journal hub'
