...
bento:
    ...
    title: 'March 19,'
    accent: every year.
    lede: 'The March 19th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 20 →'
          href: /journal/03-20/
    related:
        - title: 'Previous · Mar 18'
          copy: 'Step back a day to the March 18th log.'
          href: /journal/03-18/
          icon: calendar
        - title: 'Next · Mar 20'
          copy: 'Jump ahead to the March 20th log.'
          href: /journal/03-20/
          icon: arrow
        - title: 'Journal hub'
...
-   06:30AM
    ...
    Spent the night trying my first talos upgrade, it was an interesting experience.
    I believe we are close to getting the wireguard setup resolve, then we can hook in the Pi and NUCs!
...
### Hiddencut Belt Production

-   07:40PM

    Got my 20 perfect deviate scales and now I can make my first blue item in leather working!
    Based upon my stats, I could easily make around 50 silver to 1 gold per belt that I make.
    Since the mount will cost around 100g, I might look into running WC on multiple characters and create these amazing belts.
...
Build Command: `./kbve.sh -build react-phaser-three`
Serve Command: `./kbve.sh -nx react-phaser-three:serve`
