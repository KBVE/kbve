...
bento:
    ...
    title: 'July 26,'
    accent: every year.
    lede: 'The July 26th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 27 →'
          href: /journal/07-27/
    related:
        - title: 'Previous · Jul 25'
          copy: 'Step back a day to the July 25th log.'
          href: /journal/07-25/
          icon: calendar
        - title: 'Next · Jul 27'
          copy: 'Jump ahead to the July 27th log.'
          href: /journal/07-27/
          icon: arrow
        - title: 'Journal hub'
...
### Palworld Curl + Blackjack

-   07:22PM

    It be cool to try and make a simple blackjack table in palworld.
    The command we will be trying is the !curltest next, once we can get the data flow out of the way, we can look into other areas.

### PalSchema

-   11:40PM

    Looking through all my options for the schmea, however we will need to figure out how to get it installed.
