...
bento:
    ...
    title: 'January 9,'
    accent: every year.
    lede: 'The January 9th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 10 →'
          href: /journal/01-10/
    related:
        - title: 'Previous · Jan 8'
          copy: 'Step back a day to the January 8th log.'
          href: /journal/01-08/
          icon: calendar
        - title: 'Next · Jan 10'
          copy: 'Jump ahead to the January 10th log.'
          href: /journal/01-10/
          icon: arrow
        - title: 'Journal hub'
