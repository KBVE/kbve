...
bento:
    ...
    title: 'April 18,'
    accent: every year.
    lede: 'The April 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 19 →'
          href: /journal/04-19/
    related:
        - title: 'Previous · Apr 17'
          copy: 'Step back a day to the April 17th log.'
          href: /journal/04-17/
          icon: calendar
        - title: 'Next · Apr 19'
          copy: 'Jump ahead to the April 19th log.'
          href: /journal/04-19/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1679597454485-d1d04f88b78a?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   06:37AM
    ...
    Updating the title scene for rareicon game, as it was something that was long over due and I been too lazy to finish it.
    Going to get into the habit of triggering more builds and updates, since they take 30 mins to finish up.

### Ubuntu 20 LTS

-   07:38AM

    I missed the memo that Ubuntu 20 LTS runners are no longer on github actions!
    That means I will have to update the CI Runners.
