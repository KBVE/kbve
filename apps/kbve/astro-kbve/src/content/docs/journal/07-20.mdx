...
bento:
    ...
    title: 'July 20,'
    accent: every year.
    lede: 'The July 20th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 21 →'
          href: /journal/07-21/
    related:
        - title: 'Previous · Jul 19'
          copy: 'Step back a day to the July 19th log.'
          href: /journal/07-19/
          icon: calendar
        - title: 'Next · Jul 21'
          copy: 'Jump ahead to the July 21st log.'
          href: /journal/07-21/
          icon: arrow
        - title: 'Journal hub'
...
### GameJam Stop Killing Games Community

-   04:46PM

    Loking to start the gamejam and I think it be fun to quickly whip something up.
    The repo will be https://github.com/KBVE/skg-jam-2026 and there I will try to quickly build something.
...
-   04:40PM
    ...
    This can not be.
    I am having UI issues now in Godot, I think I am legit going to go crazy with ducking user interfaces, react broke my heart, unity broke my soul and godot is about to break my will.
    Hopefully there might be a better solution out there or maybe I am just referencing the wrong things, i am not too sure, but each of these makes me want to go operate in CLI.

### UIUX

-   04:52PM

    Yeah the best solution for anything UIUX will be to hire another developer to handle the core parts of it.
    Have them do all the painful things first and then loop back around and make the adjustments.
    For example react's css issues were all about the overflows.
    The Unity issues were related to me not having Sprites.
    Godot issues are all related to how they have different structures for buttons and containers, with those containers being like div tag.
