...
bento:
    ...
    title: 'September 30,'
    accent: every year.
    lede: 'The September 30th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 1 →'
          href: /journal/10-01/
    related:
        - title: 'Previous · Sep 29'
          copy: 'Step back a day to the September 29th log.'
          href: /journal/09-29/
          icon: calendar
        - title: 'Next · Oct 1'
          copy: 'Jump ahead to the October 1st log.'
          href: /journal/10-01/
          icon: arrow
        - title: 'Journal hub'
