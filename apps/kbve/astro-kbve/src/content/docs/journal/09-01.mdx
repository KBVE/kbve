...
bento:
    ...
    title: 'September 1,'
    accent: every year.
    lede: 'The September 1st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Sep 2 →'
          href: /journal/09-02/
    related:
        - title: 'Previous · Aug 31'
          copy: 'Step back a day to the August 31st log.'
          href: /journal/08-31/
          icon: calendar
        - title: 'Next · Sep 2'
          copy: 'Jump ahead to the September 2nd log.'
          href: /journal/09-02/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1524309686920-ec0f7f2b1cc5?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   11:59PM
    ...
    End of the day notes, we spent a bunch of time on the realtime, to the point where we found out the issues were not just us but at the supabase level.
    I understand that they are also working on it actively, but the rate that they are moving is really slow.
    The biggest issue that we faced was that `realtime` was the name of our deployment and that caused a naming conflict, switching it to over to `realtime-prod` helped solve a disconnect bug.
    Fudster really showing his tech powers.
