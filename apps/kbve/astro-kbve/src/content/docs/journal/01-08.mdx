...
bento:
    ...
    title: 'January 8,'
    accent: every year.
    lede: 'The January 8th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 9 →'
          href: /journal/01-09/
    related:
        - title: 'Previous · Jan 7'
          copy: 'Step back a day to the January 7th log.'
          href: /journal/01-07/
          icon: calendar
        - title: 'Next · Jan 9'
          copy: 'Jump ahead to the January 9th log.'
          href: /journal/01-09/
          icon: arrow
        - title: 'Journal hub'
