...
bento:
    ...
    title: 'April 30,'
    accent: every year.
    lede: 'The April 30th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 1 →'
          href: /journal/05-01/
    related:
        - title: 'Previous · Apr 29'
          copy: 'Step back a day to the April 29th log.'
          href: /journal/04-29/
          icon: calendar
        - title: 'Next · May 1'
          copy: 'Jump ahead to the May 1st log.'
          href: /journal/05-01/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   12:57AM
    ...
    Getting close to launching the demo, I am a bit excited!
    We got the steam store approval, now we just need to grind through the minor bugs.
    For gameplay focus, I am thinking just more updates around the combat loop, better controls for units and fixing that drag selection bug.

### Forum Emojis

-   10:47PM

    Removing all of the extra emojis with SVGs will definitely make it feel a bit smoother.
    I am still not a huge fan of the forum, there might be more room for improvements, but I will look into it later on.
