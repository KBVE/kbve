...
bento:
    ...
    title: 'June 7,'
    accent: every year.
    lede: 'The June 7th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 8 →'
          href: /journal/06-08/
    related:
        - title: 'Previous · Jun 6'
          copy: 'Step back a day to the June 6th log.'
          href: /journal/06-06/
          icon: calendar
        - title: 'Next · Jun 8'
          copy: 'Jump ahead to the June 8th log.'
          href: /journal/06-08/
          icon: arrow
        - title: 'Journal hub'
...
-   02:06AM
    ...
    Okay, I am actually positive that we are slowly reaching the end game here with AI.
    I need to focus more on generic prompts and and item idea, then just have it spit it out.
    Maybe a tool to help me quickly build the prompts, or even better we are almost in an infinite loop.

    Here is one of the prompts that I just ran, but there are a couple more that I been using!

```

Inside of the /apps/kbve/astro-kbve/src/pages , look at the other .astro files and can you write me a new support.astro using the tailwindcss v4, I want it all inside of just 1 file aka this new "support.astro" 
Look at the other parts of this app /apps/kbve/astro-kbve/ to get references and maybe you can draw inspiration for this support page? 
make sure to match the color schemes.
...
-   05:26PM
    ...
    The HUD should provide a quick bar for mana, stamina and any other bonuses that the items would give.
    After we finish the HUD, I am thinking we could do the a panel for the character or maybe start doing the crafting?
    We still need to finish the bonus applying and also making suring that items get deployed.
