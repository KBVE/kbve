...
bento:
    ...
    title: 'January 15,'
    accent: every year.
    lede: 'The January 15th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 16 →'
          href: /journal/01-16/
    related:
        - title: 'Previous · Jan 14'
          copy: 'Step back a day to the January 14th log.'
          href: /journal/01-14/
          icon: calendar
        - title: 'Next · Jan 16'
          copy: 'Jump ahead to the January 16th log.'
          href: /journal/01-16/
          icon: arrow
        - title: 'Journal hub'
