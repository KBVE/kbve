...
bento:
    ...
    title: 'February 8,'
    accent: every year.
    lede: 'The February 8th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 9 →'
          href: /journal/02-09/
    related:
        - title: 'Previous · Feb 7'
          copy: 'Step back a day to the February 7th log.'
          href: /journal/02-07/
          icon: calendar
        - title: 'Next · Feb 9'
          copy: 'Jump ahead to the February 9th log.'
          href: /journal/02-09/
          icon: arrow
        - title: 'Journal hub'
