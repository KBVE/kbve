...
bento:
    ...
    title: 'July 11,'
    accent: every year.
    lede: 'The July 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 12 →'
          href: /journal/07-12/
    related:
        - title: 'Previous · Jul 10'
          copy: 'Step back a day to the July 10th log.'
          href: /journal/07-10/
          icon: calendar
        - title: 'Next · Jul 12'
          copy: 'Jump ahead to the July 12th log.'
          href: /journal/07-12/
          icon: arrow
        - title: 'Journal hub'
...
-   05:59PM
    ...
    Good news! We are hitting all time highes on a couple of our tech holdings, which should open up some extra capital.
    Seeing Nvidia hit $200 is also a crazy experience.
...
-   11:51PM
    ...
    We should look at seeing if Claude or any of these AI tools can take an exisiting program and turn it into a react application .
    I am going to try and run a quick dry run.
