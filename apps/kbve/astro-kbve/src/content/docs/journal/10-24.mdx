...
bento:
    ...
    title: 'October 24,'
    accent: every year.
    lede: 'The October 24th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2025'
          primary: true
        ...
        - label: 'Oct 25 →'
          href: /journal/10-25/
    related:
        - title: 'Previous · Oct 23'
          copy: 'Step back a day to the October 23rd log.'
          href: /journal/10-23/
          icon: calendar
        - title: 'Next · Oct 25'
          copy: 'Jump ahead to the October 25th log.'
          href: /journal/10-25/
          icon: arrow
        - title: 'Journal hub'
