...
bento:
    ...
    title: 'May 6,'
    accent: every year.
    lede: 'The May 6th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 7 →'
          href: /journal/05-07/
    related:
        - title: 'Previous · May 5'
          copy: 'Step back a day to the May 5th log.'
          href: /journal/05-05/
          icon: calendar
        - title: 'Next · May 7'
          copy: 'Jump ahead to the May 7th log.'
          href: /journal/05-07/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1553481187-be93c21490a9?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   06:59PM
    ...
    The firecracker ecosystem needs to run python code without running into issues that might hold us back.
    I am thinking that we could even later on hook up cloudflare token and make abstracted runner subdomains?
    Like this, `v01d-fear-factor-40.kbve.com` , which would then be the firecracker vm running the specific python script that is tasked to do the job?
    This would mean we could have our core API and then a nearly infinite sub-domain-based api that runs basically mini-virtual machines to do small tasks.
    The first task might be converting a video to a mp3 or maybe taking a PNG and making it transparent.

### Unity Rareicon Shader

-   08:18PM

    Good news is that we got the shaders operational on the android phone, but the bad news is that the performance is really bad.
    I am not too sure if the terrible performance is because of the virtual device itself or if the APK boots way too much information.
