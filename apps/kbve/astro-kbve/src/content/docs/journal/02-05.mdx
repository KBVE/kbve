...
bento:
    ...
    title: 'February 5,'
    accent: every year.
    lede: 'The February 5th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 6 →'
          href: /journal/02-06/
    related:
        - title: 'Previous · Feb 4'
          copy: 'Step back a day to the February 4th log.'
          href: /journal/02-04/
          icon: calendar
        - title: 'Next · Feb 6'
          copy: 'Jump ahead to the February 6th log.'
          href: /journal/02-06/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1738571574302-3312deda0aa3?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
