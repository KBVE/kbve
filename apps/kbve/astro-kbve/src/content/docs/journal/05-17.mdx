...
bento:
    ...
    title: 'May 17,'
    accent: every year.
    lede: 'The May 17th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 18 →'
          href: /journal/05-18/
    related:
        - title: 'Previous · May 16'
          copy: 'Step back a day to the May 16th log.'
          href: /journal/05-16/
          icon: calendar
        - title: 'Next · May 18'
          copy: 'Jump ahead to the May 18th log.'
          href: /journal/05-18/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1715545770403-9d66037a3d93?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Minecraft Item Templates

-   11:10PM

    Similar to the OSRS setup, I am thinking of building an internal wiki style of all the minecraft items.
    This way it be easier to keep track of their unique data points but also expand it to include any custom items that we will want to include in the future.
    Examples of this will be custom food dishes and our airships, but also any unique weapons and armour as well.
