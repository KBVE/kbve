...
bento:
    ...
    title: 'July 29,'
    accent: every year.
    lede: 'The July 29th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 30 →'
          href: /journal/07-30/
    related:
        - title: 'Previous · Jul 28'
          copy: 'Step back a day to the July 28th log.'
          href: /journal/07-28/
          icon: calendar
        - title: 'Next · Jul 30'
          copy: 'Jump ahead to the July 30th log.'
          href: /journal/07-30/
          icon: arrow
        - title: 'Journal hub'
...
### Palworld Server Update v1.0.2

-   3:50PM

    Looks like fudster solved it, but the update definitely ducked up my map!
    I am not going to enjoy having to find all the spots again, but I think I might be able to resolve it with either a mod or a small change.

### Reel v0.1.20

-   07:43PM

    The latest version of reel was release, I am hoping it will resolve the file streaming issue we were having.
    Turns out it was a combination of the application, networking and the overall flow of execution, but we are still very far from getting something fully complete.
...
-   06:15AM
    ...
    Building two games at the same time, or maybe just a bunch of unfinished games is terrible.
    I am aware of the issues that come with having a bunch of half donkey work floating around, but sometimes getting stuck in one area is really rough.
    Taking a break from the unity aka c# and switching back to gdscript is a great way to reset the flow.
