...
bento:
    ...
    title: 'June 21,'
    accent: every year.
    lede: 'The June 21st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Jun 22 →'
          href: /journal/06-22/
    related:
        - title: 'Previous · Jun 20'
          copy: 'Step back a day to the June 20th log.'
          href: /journal/06-20/
          icon: calendar
        - title: 'Next · Jun 22'
          copy: 'Jump ahead to the June 22nd log.'
          href: /journal/06-22/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1685110191139-eb2caaac220d?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   11:15PM
    ...
    Looks like the mac operating system pipeline is complete, so we now we have a full three build set.
    This means we can look into making improvements further down the line for iOS and android.
