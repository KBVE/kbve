...
bento:
    ...
    title: 'July 28,'
    accent: every year.
    lede: 'The July 28th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 29 →'
          href: /journal/07-29/
    related:
        - title: 'Previous · Jul 27'
          copy: 'Step back a day to the July 27th log.'
          href: /journal/07-27/
          icon: calendar
        - title: 'Next · Jul 29'
          copy: 'Jump ahead to the July 29th log.'
          href: /journal/07-29/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1690221115995-8c80b43aac01?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Github Actions + Thread Integration

-   09:50PM

    I am thinking that the Supabase functions might be the best option but then we would have to parse through each of the json message , so I will have to think it through.
    Since we have n8n, we could move it over to that call as well, so there are a couple ways that we can go about that.
