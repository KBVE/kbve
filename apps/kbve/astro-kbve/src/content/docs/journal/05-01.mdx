...
bento:
    ...
    title: 'May 1,'
    accent: every year.
    lede: 'The May 1st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 2 →'
          href: /journal/05-02/
    related:
        - title: 'Previous · Apr 30'
          copy: 'Step back a day to the April 30th log.'
          href: /journal/04-30/
          icon: calendar
        - title: 'Next · May 2'
          copy: 'Jump ahead to the May 2nd log.'
          href: /journal/05-02/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1680118534066-849f48822ece?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-	08:56PM
	...
	After finishing the talos upgrade, the first failed in the middle of the night, had to do it agian this morning.
	The issue is that we only have a single node instance, we will have to prepare to expand to a trio fairly soon, that way we can keep the cluster running through rotations.
	Anyhow, we still have a couple things to resolve until then.

### Rareicon v0.1.2

-	10:39PM

	Preparing the next build, maybe this time the windows version will be with working shaders.
