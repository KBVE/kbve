...
bento:
    ...
    title: 'June 10,'
    accent: every year.
    lede: 'The June 10th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 11 →'
          href: /journal/06-11/
    related:
        - title: 'Previous · Jun 9'
          copy: 'Step back a day to the June 9th log.'
          href: /journal/06-09/
          icon: calendar
        - title: 'Next · Jun 11'
          copy: 'Jump ahead to the June 11th log.'
          href: /journal/06-11/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1544383835-bda2bc66a55d?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
