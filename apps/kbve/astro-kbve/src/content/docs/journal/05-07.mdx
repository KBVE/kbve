...
bento:
    ...
    title: 'May 7,'
    accent: every year.
    lede: 'The May 7th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 8 →'
          href: /journal/05-08/
    related:
        - title: 'Previous · May 6'
          copy: 'Step back a day to the May 6th log.'
          href: /journal/05-06/
          icon: calendar
        - title: 'Next · May 8'
          copy: 'Jump ahead to the May 8th log.'
          href: /journal/05-08/
          icon: arrow
        - title: 'Journal hub'
...
-   04:49AM
    ...
    Looks like the discord bot seems to have a crash, I need to figure it out.
    Did it grab the wrong token when we deployed the minecraft server?
    
-   10:34AM

    Turns out that it was just an issue after we did a restart during the copyfail update.
    We should be back to normal, just need to prepare the next update.

### CityVote Website

-   04:45PM

    With the Hanta virus brewing, I was thinking that it be cool to build a custom page around it for cityvote?
    We could use claude to break down some of the papers and get a generate proper reports.
    Then we could slap a map to show some of the areas where there might be active cases?
    Ideally we would make CityVote a modern website, that would provide all that information but also make it easier to expand and grow the website.
    It would fill that gap where we need information but not make it too heavy for KBVE as well.
    I will get the flow going for it asap, since we have the time and resources for the website.
...
-   06:09PM
    ...
    Expanded the Rareicon library of icons, I am thinking that if we can continue, then it will look amazing!
    We should definitely aim to get more into the flow of presenting the SVGs?
    I am thinking of even building a UV tool around the firecracker concept but that will come to another day.
