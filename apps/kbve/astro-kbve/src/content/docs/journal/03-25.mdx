...
bento:
    ...
    title: 'March 25,'
    accent: every year.
    lede: 'The March 25th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 26 →'
          href: /journal/03-26/
    related:
        - title: 'Previous · Mar 24'
          copy: 'Step back a day to the March 24th log.'
          href: /journal/03-24/
          icon: calendar
        - title: 'Next · Mar 26'
          copy: 'Jump ahead to the March 26th log.'
          href: /journal/03-26/
          icon: arrow
        - title: 'Journal hub'
