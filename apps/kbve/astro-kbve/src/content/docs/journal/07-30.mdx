...
bento:
    ...
    title: 'July 30,'
    accent: every year.
    lede: 'The July 30th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jul 31 →'
          href: /journal/07-31/
    related:
        - title: 'Previous · Jul 29'
          copy: 'Step back a day to the July 29th log.'
          href: /journal/07-29/
          icon: calendar
        - title: 'Next · Jul 31'
          copy: 'Jump ahead to the July 31st log.'
          href: /journal/07-31/
          icon: arrow
        - title: 'Journal hub'
...
-   07:52AM
    ...
    The alpha is looking good, just needs some stream updates and better buffer controls.
    After a couple more minor tweaks, we should have a functional and ready reel ecosystem for us to use within the community.
    This then means we can easily integrate it into the discord bots, having any movie or show on repeat for us to watch.
    I will have to hook up the windmill script to help us get where we would want, but for the most part, it should be fine.
...
-   09:09PM
    ...
    After talking to a couple partners, we decided that the best move would be to just skip this gamejam submission.
    There are too many bungs and we are not too sure if AI programming was allowed for this jam, I should have asked the support over this before starting it.
    On top of all that, there is all the pirate drama, but that is just more publicity for game during the show-off.
