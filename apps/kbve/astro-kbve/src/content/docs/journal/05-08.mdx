...
bento:
    ...
    title: 'May 8,'
    accent: every year.
    lede: 'The May 8th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 9 →'
          href: /journal/05-09/
    related:
        - title: 'Previous · May 7'
          copy: 'Step back a day to the May 7th log.'
          href: /journal/05-07/
          icon: calendar
        - title: 'Next · May 9'
          copy: 'Jump ahead to the May 9th log.'
          href: /journal/05-09/
          icon: arrow
        - title: 'Journal hub'
...
-	01:37AM
	...
	There are a bunch of old phaser/laser games that I want to port over to our arcade.
	I am hoping that maybe we can also convert over some really basic games too.
