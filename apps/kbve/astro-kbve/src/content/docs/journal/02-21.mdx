...
bento:
    ...
    title: 'February 21,'
    accent: every year.
    lede: 'The February 21st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 22 →'
          href: /journal/02-22/
    related:
        - title: 'Previous · Feb 20'
          copy: 'Step back a day to the February 20th log.'
          href: /journal/02-20/
          icon: calendar
        - title: 'Next · Feb 22'
          copy: 'Jump ahead to the February 22nd log.'
          href: /journal/02-22/
          icon: arrow
        - title: 'Journal hub'
