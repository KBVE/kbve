...
bento:
    ...
    title: 'February 17,'
    accent: every year.
    lede: 'The February 17th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Feb 18 →'
          href: /journal/02-18/
    related:
        - title: 'Previous · Feb 16'
          copy: 'Step back a day to the February 16th log.'
          href: /journal/02-16/
          icon: calendar
        - title: 'Next · Feb 18'
          copy: 'Jump ahead to the February 18th log.'
          href: /journal/02-18/
          icon: arrow
        - title: 'Journal hub'
