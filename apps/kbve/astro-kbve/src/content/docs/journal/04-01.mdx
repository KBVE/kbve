...
bento:
    ...
    title: 'April 1,'
    accent: every year.
    lede: 'The April 1st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 2 →'
          href: /journal/04-02/
    related:
        - title: 'Previous · Mar 31'
          copy: 'Step back a day to the March 31st log.'
          href: /journal/03-31/
          icon: calendar
        - title: 'Next · Apr 2'
          copy: 'Jump ahead to the April 2nd log.'
          href: /journal/04-02/
          icon: arrow
        - title: 'Journal hub'
...
### Isometric Networking

- 11:10AM

  Looking at the networking for our bevy game and trying to figure out the best way to handle the base connection.
  It might be that I am trying to run the websocket and the web transport on the same netcode, thus causing this issue, damn it.
  If that is the case, then that means we did end up spending way too much time trying to resolve it.
