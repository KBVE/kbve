...
bento:
    ...
    title: 'May 20,'
    accent: every year.
    lede: 'The May 20th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 21 →'
          href: /journal/05-21/
    related:
        - title: 'Previous · May 19'
          copy: 'Step back a day to the May 19th log.'
          href: /journal/05-19/
          icon: calendar
        - title: 'Next · May 21'
          copy: 'Jump ahead to the May 21st log.'
          href: /journal/05-21/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1716112054546-3027ad687a62?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### Post Earnings Nvidia Q1 2027.

-   07:00PM

    No major surprise from the earnings, I will take my couple grand from the call options and move forward.
    I was really hoping that maybe the china trip recently would open up talks between the CCP and Nvidia, ideally getting some of the GPU flow back into action.
