...
bento:
    ...
    title: 'June 14,'
    accent: every year.
    lede: 'The June 14th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 15 →'
          href: /journal/06-15/
    related:
        - title: 'Previous · Jun 13'
          copy: 'Step back a day to the June 13th log.'
          href: /journal/06-13/
          icon: calendar
        - title: 'Next · Jun 15'
          copy: 'Jump ahead to the June 15th log.'
          href: /journal/06-15/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1559510981-10719ce4266a?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
