...
bento:
    ...
    title: 'April 2,'
    accent: every year.
    lede: 'The April 2nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 3 →'
          href: /journal/04-03/
    related:
        - title: 'Previous · Apr 1'
          copy: 'Step back a day to the April 1st log.'
          href: /journal/04-01/
          icon: calendar
        - title: 'Next · Apr 3'
          copy: 'Jump ahead to the April 3rd log.'
          href: /journal/04-03/
          icon: arrow
        - title: 'Journal hub'
...
### Rust Docker Improvements

11:15AM

These long docker build times are definitely something we can improve upon.
We added the mold earlier but I might loop back around and see if there might be another way to improve the build times.


### Faster Axum KBVE Builds

05:22PM

We should take some of the time that we spent looking through the logs and maybe find some improvements?
