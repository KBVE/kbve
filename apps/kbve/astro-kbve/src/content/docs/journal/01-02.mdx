...
bento:
    ...
    title: 'January 2,'
    accent: every year.
    lede: 'The January 2nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 3 →'
          href: /journal/01-03/
    related:
        - title: 'Previous · Jan 1'
          copy: 'Step back a day to the January 1st log.'
          href: /journal/01-01/
          icon: calendar
        - title: 'Next · Jan 3'
          copy: 'Jump ahead to the January 3rd log.'
          href: /journal/01-03/
          icon: arrow
        - title: 'Journal hub'
...
-   04:45PM
    ...
    Building a generic phaser runner to get a better understanding of movement and combat.
    I will add it into the arcade once I am done.
