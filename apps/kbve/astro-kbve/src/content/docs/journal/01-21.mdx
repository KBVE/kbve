...
bento:
    ...
    title: 'January 21,'
    accent: every year.
    lede: 'The January 21st daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Jan 22 →'
          href: /journal/01-22/
    related:
        - title: 'Previous · Jan 20'
          copy: 'Step back a day to the January 20th log.'
          href: /journal/01-20/
          icon: calendar
        - title: 'Next · Jan 22'
          copy: 'Jump ahead to the January 22nd log.'
          href: /journal/01-22/
          icon: arrow
        - title: 'Journal hub'
...
-   12:26AM
    ...
    Looking at the search impressions data and we are seeing a burst!
    This could mean that we need to further improve and tweak our website, but results are there!
    I am thinking that if we expand to all OSRS items, it will make it easier to build around crypto and stocks.
    Finally, once its all organized, we can loop back around and work on the game asset area and marketplace.
