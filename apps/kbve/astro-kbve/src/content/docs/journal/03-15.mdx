...
bento:
    ...
    title: 'March 15,'
    accent: every year.
    lede: 'The March 15th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#tasks'
          primary: true
        ...
        - label: 'Mar 16 →'
          href: /journal/03-16/
    related:
        - title: 'Previous · Mar 14'
          copy: 'Step back a day to the March 14th log.'
          href: /journal/03-14/
          icon: calendar
        - title: 'Next · Mar 16'
          copy: 'Jump ahead to the March 16th log.'
          href: /journal/03-16/
          icon: arrow
        - title: 'Journal hub'
...
-   09:15PM 
    ...
    My hand written notes on the clickhouse vector integration, the plan is to just drop the logflare and go with a vector dev and clickhouse integration.
    Later on I am thinking of developing a wasm-friendly client to quickly grab the information from the clickhouse.
    We could even turn our rareicon game into something similar as well, that is something that I was thinking about earlier.
