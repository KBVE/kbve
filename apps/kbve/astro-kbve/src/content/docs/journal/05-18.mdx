...
description: |
   May 18th - The Daily Journal. More Adventures
tags:
    - daily
template: splash
...
bento:
    ...
    title: 'May 18,'
    accent: every year.
    lede: 'The May 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 19 →'
          href: /journal/05-19/
    related:
        - title: 'Previous · May 17'
          copy: 'Step back a day to the May 17th log.'
          href: /journal/05-17/
          icon: calendar
        - title: 'Next · May 19'
          copy: 'Jump ahead to the May 19th log.'
          href: /journal/05-19/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1715997894621-e8eebc4e9278?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   01:15PM
    ...
    Preparing to sell a bunch of $235 call options, I am thinking that the stock will definitely not moon.
    There is not much else going on, I think that China's limited purchase of Nvidia hardware will hurt them in the long term.
...
-   12:25AM
    ...
    I am trying to figure out the best way to build an endless dungeon crawler style game loop.
    The concept we are going for is known as "planar drawing of a graph with minimize edge crossings", basically a collection of rooms that have certain styles.
    Instead of building just random rooms over and over, I will try to pre-generate a bunch of exisiting rooms and then fill in the empty areas with randomly generated rooms.
    This way there will be randomness in the pathing and flow but some core rooms will remain the same.
    I need to do more research before I can get this resolved.

### Spider Rose

-   02:43AM

    The idea for a spider rose type base-building concept, where instead of just having pipes, the player can use pixel-style webs to link their base.
    These webs would act like pipes but also provide defense, hmm, a bit like a spider silk pipe network?
    I am still thinking through exactly how I could implement it, this would not be something that I could do over night but we could add small steps towards it.

### Smart Toilet Pixel Art

-   03:30AM

    While watching Love, Death + Robots, there was a smart toilet and for some reason, it be perfect to have in the game.
    It would be a bit of a gag-like item but also an interesting meme-style , ah no nevermind.
    I should definitely avoid this, I just realized as I was making it... its been already done xD.

### Crawler with VContainer

-   05:10PM

    After thinking it through, maybe the best move would be to build a bunch of prefab dungeon rooms and then using injection and asset addressable, load them as needed.
    This will make it easier for multiplayer because it be the same layouts shared through the content but if we have a couple hundred random rooms, it should not be too much of an issue.
    We then just focus on linking the corridors and hallways.
...
The Resume App has been outlined and the libraries that I want to use are prepared, now it is just a moment of assembly and making sure everything works out.
There are times that I think it is best to go deep into a MVP / prototype but we did this earlier in early 2023, but I am more confident that we can get a near production ready tool out into the public.

One of the biggest objectives of the resume builder would be to automatically submit the resume on my behalf.
