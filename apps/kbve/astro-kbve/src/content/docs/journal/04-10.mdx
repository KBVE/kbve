...
bento:
    ...
    title: 'April 10,'
    accent: every year.
    lede: 'The April 10th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Apr 11 →'
          href: /journal/04-11/
    related:
        - title: 'Previous · Apr 9'
          copy: 'Step back a day to the April 9th log.'
          href: /journal/04-09/
          icon: calendar
        - title: 'Next · Apr 11'
          copy: 'Jump ahead to the April 11th log.'
          href: /journal/04-11/
          icon: arrow
        - title: 'Journal hub'
