...
bento:
    ...
    title: 'January 11,'
    accent: every year.
    lede: 'The January 11th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 12 →'
          href: /journal/01-12/
    related:
        - title: 'Previous · Jan 10'
          copy: 'Step back a day to the January 10th log.'
          href: /journal/01-10/
          icon: calendar
        - title: 'Next · Jan 12'
          copy: 'Jump ahead to the January 12th log.'
          href: /journal/01-12/
          icon: arrow
        - title: 'Journal hub'
