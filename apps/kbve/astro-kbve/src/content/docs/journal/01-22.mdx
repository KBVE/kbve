...
bento:
    ...
    title: 'January 22,'
    accent: every year.
    lede: 'The January 22nd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 23 →'
          href: /journal/01-23/
    related:
        - title: 'Previous · Jan 21'
          copy: 'Step back a day to the January 21st log.'
          href: /journal/01-21/
          icon: calendar
        - title: 'Next · Jan 23'
          copy: 'Jump ahead to the January 23rd log.'
          href: /journal/01-23/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1737047119483-1ddb4cb13540?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
