...
### PalSchema Integration

-   09:51PM

    We got the core integration running, but still need to test the PalForge linking, hopefully we find a smooth way to integrate around the PalSchema wrapper.
    There might also be an option to allow people to make suggestions later down the line in the future too.
