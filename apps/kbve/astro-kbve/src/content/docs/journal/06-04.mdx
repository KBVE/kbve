...
client: Self
unsplash: 1717580860912-cb1731f171a6
img: https://images.unsplash.com/photo-1717580860912-cb1731f171a6?crop=entropy&cs=srgb&fm=jpg&ixid=MnwzNjM5Nzd8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODE3NDg2ODY&ixlib=rb-4.0.3&q=85
description: |
   June 4th. AstroPad
tags:
    - daily
...
bento:
    ...
    title: 'June 4,'
    accent: every year.
    lede: 'The June 4th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jun 5 →'
          href: /journal/06-05/
    related:
        - title: 'Previous · Jun 3'
          copy: 'Step back a day to the June 3rd log.'
          href: /journal/06-03/
          icon: calendar
        - title: 'Next · Jun 5'
          copy: 'Jump ahead to the June 5th log.'
          href: /journal/06-05/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1717580860912-cb1731f171a6?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   12:37AM
    ...
    The rejection message for the steam store hit hard, but they are right, need to be less focused on the story and more on the game loop.

### AstroKBVE Schema 

-   03:03AM

    Making more changes to the schema for the itemdb, questdb and npcdb.
    Furthermore, I still need to migrate the older content directories over to the new astro template.
    This is making me think that I need another couple versions of me, but I am either too slow or have terrible networking skills.
    Delegating some of the work within this monorepo will be tough.
