...
bento:
    ...
    title: 'May 9,'
    accent: every year.
    lede: 'The May 9th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'May 10 →'
          href: /journal/05-10/
    related:
        - title: 'Previous · May 8'
          copy: 'Step back a day to the May 8th log.'
          href: /journal/05-08/
          icon: calendar
        - title: 'Next · May 10'
          copy: 'Jump ahead to the May 10th log.'
          href: /journal/05-10/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1664202526602-08cbc96c4b3c?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
-   03:19PM
    ...
    The goal for this week is to get the base arcade operational, maybe even try to bring back some classic flash games.
    However these are all small scoped projects, so maybe the focus should just be on targeting those small issues first, then we can make improvements past it.
    Part of me feels like the website could definitely use more improvements, but we will have to wait and see on all the minor issues first. 
    The Solitaire game is up and just needs more tweaks.

### Rareicon Website Release V0.1.4

-   04:14PM

    The JSON-LD structured data update, which will make it easier to move towards more structured data.
    Afterwards, we could polish the 404 page and then loop through all the icons and further improve upon their visual representation.
