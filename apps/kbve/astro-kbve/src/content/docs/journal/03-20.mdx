...
bento:
    ...
    title: 'March 20,'
    accent: every year.
    lede: 'The March 20th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 21 →'
          href: /journal/03-21/
    related:
        - title: 'Previous · Mar 19'
          copy: 'Step back a day to the March 19th log.'
          href: /journal/03-19/
          icon: calendar
        - title: 'Next · Mar 21'
          copy: 'Jump ahead to the March 21st log.'
          href: /journal/03-21/
          icon: arrow
        - title: 'Journal hub'
