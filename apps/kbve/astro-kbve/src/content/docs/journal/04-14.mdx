...
bento:
    ...
    title: 'April 14,'
    accent: every year.
    lede: 'The April 14th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Apr 15 →'
          href: /journal/04-15/
    related:
        - title: 'Previous · Apr 13'
          copy: 'Step back a day to the April 13th log.'
          href: /journal/04-13/
          icon: calendar
        - title: 'Next · Apr 15'
          copy: 'Jump ahead to the April 15th log.'
          href: /journal/04-15/
          icon: arrow
        - title: 'Journal hub'
