...
bento:
    ...
    title: 'January 12,'
    accent: every year.
    lede: 'The January 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Jan 13 →'
          href: /journal/01-13/
    related:
        - title: 'Previous · Jan 11'
          copy: 'Step back a day to the January 11th log.'
          href: /journal/01-11/
          icon: calendar
        - title: 'Next · Jan 13'
          copy: 'Jump ahead to the January 13th log.'
          href: /journal/01-13/
          icon: arrow
        - title: 'Journal hub'
...
-   03:13PM
    ...
    Decided to revist the godot application aka cityvote and try to resolve the deadlock for combat.
    The main issue is that we keep running into issues with combat data from the rust side and a desync from the godot side.
    I am going to try again in a couple weeks, maybe there might be a different path that I could take to help resolve it.
