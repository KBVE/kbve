...
bento:
    ...
    title: 'March 28,'
    accent: every year.
    lede: 'The March 28th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 29 →'
          href: /journal/03-29/
    related:
        - title: 'Previous · Mar 27'
          copy: 'Step back a day to the March 27th log.'
          href: /journal/03-27/
          icon: calendar
        - title: 'Next · Mar 29'
          copy: 'Jump ahead to the March 29th log.'
          href: /journal/03-29/
          icon: arrow
        - title: 'Journal hub'
...
- 10:44PM
  ...
  Finishing up some minor tweaks that were long over due for the bevy engine.
  I did need to talk a short break from the unreal side of the codebase, going back to my love and trusted bevy.
  While it is a bit slow to program in rust, I am really enjoying the flow and I hope to get so much better at the dev style.
