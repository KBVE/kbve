...
bento:
    ...
    title: 'March 18,'
    accent: every year.
    lede: 'The March 18th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Mar 19 →'
          href: /journal/03-19/
    related:
        - title: 'Previous · Mar 17'
          copy: 'Step back a day to the March 17th log.'
          href: /journal/03-17/
          icon: calendar
        - title: 'Next · Mar 19'
          copy: 'Jump ahead to the March 19th log.'
          href: /journal/03-19/
          icon: arrow
        - title: 'Journal hub'
