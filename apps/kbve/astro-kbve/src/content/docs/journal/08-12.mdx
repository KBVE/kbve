...
bento:
    ...
    title: 'August 12,'
    accent: every year.
    lede: 'The August 12th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#2026'
          primary: true
        ...
        - label: 'Aug 13 →'
          href: /journal/08-13/
    related:
        - title: 'Previous · Aug 11'
          copy: 'Step back a day to the August 11th log.'
          href: /journal/08-11/
          icon: calendar
        - title: 'Next · Aug 13'
          copy: 'Jump ahead to the August 13th log.'
          href: /journal/08-13/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1689850969146-43cd8e188bbf?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
...
### FriendSlop Animations

-   11:50PM

    The animations are all out of the way, or well at least the core parts.
    Later on I will link them up for multiplayer, and probably established a solid behavior state.
    This way we can move bytes around that represent the actual player, via postcard or something along those lines.
    I also think that it would be wise to setup a title screen for the game, but that might be better with a

### FriendSlop Lizard Fish

-   11:59PM

    We finally got our first super optimized creature on the map, this means we could probably improve the bird afterwards as well.
    The lizard fish is just half way on its journey, we will need to implement fishing afterwards so that we can capture them.
    Once the fish are in the game, we can implement another skill that would be like cooking, that way we can bridge into woodcutting and mining as a sub agent task.
...
-   03:00AM
    ...
    Late night but worth the submission!
    I am hoping to get a job as a growth engineer or maybe in their AI field.
