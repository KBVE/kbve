...
bento:
    ...
    title: 'January 28,'
    accent: every year.
    lede: 'The January 28th daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Jan 29 →'
          href: /journal/01-29/
    related:
        - title: 'Previous · Jan 27'
          copy: 'Step back a day to the January 27th log.'
          href: /journal/01-27/
          icon: calendar
        - title: 'Next · Jan 29'
          copy: 'Jump ahead to the January 29th log.'
          href: /journal/01-29/
          icon: arrow
        - title: 'Journal hub'
          ...
          icon: book
    theme:
        hero_bg: 'https://images.unsplash.com/photo-1737798388229-2524c7777c60?q=80&w=2400&auto=format&fit=crop'
        accent: '#a78bfa'
        accent2: '#f472b6'
        btn_fg: '#1e1035'
---
