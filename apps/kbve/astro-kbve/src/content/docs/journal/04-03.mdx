...
bento:
    ...
    title: 'April 3,'
    accent: every year.
    lede: 'The April 3rd daily log — notes, tasks, and quotes collected across every year of the KBVE journal.'
    ctas:
        - label: Read the log
          href: '#notes'
          primary: true
        ...
        - label: 'Apr 4 →'
          href: /journal/04-04/
    related:
        - title: 'Previous · Apr 2'
          copy: 'Step back a day to the April 2nd log.'
          href: /journal/04-02/
          icon: calendar
        - title: 'Next · Apr 4'
          copy: 'Jump ahead to the April 4th log.'
          href: /journal/04-04/
          icon: arrow
        - title: 'Journal hub'
...
- 04:45PM
  ...
  The damn websockets, what a hell ride of http 1, 2 and 3.
  I am getting closer but the amount of errors were intense, a ton of back and fourth but I was able to get closer to my goal.
  We are just a couple more days away from having our internal VMs that we can control via our own custom dashboard.
  While I am building this out, I am thinking that I should have switched to cozy stack as a baseline, but its too late now, oh well.
