...
description: "Ancient brew(3) is a 3-dose Herblore potion that boosts Magic, restores prayer, and drains melee stats. High alch: 105 GP, GE limit: 2,000."
osrs:
  id: 26342
  name: Ancient brew(3)
  slug: ancient-brew-3
  ...
  about: "Ancient brew(3) is the 3-dose variant of the high-tier magic and prayer brew, decanted from full kegs at the GE or directly produced by the herblore line. It pairs a +2 to +6 Magic boost with a flat prayer restore at the cost of melee stats, making it the go-to flask for mage-heavy PvM (Tombs of Amascut, Zulrah) where prayer pots and magic boosts compete for inventory space."
  market_strategy:
    notes:
      - "Decant arbitrage candidate against (4) and (2) at the GE."
  ...
  trading_tips:
    - "Decant (4) into (3) when single-dose premium opens."
