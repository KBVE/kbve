---
title: Gilded dresser (flatpack) | OSRS Price Data
description: "Gilded dresser (flatpack): How does it all fit in there?. High alch: 6 GP, GE limit: 500."
osrs:
  id: 8608
  name: Gilded dresser (flatpack)
  slug: gilded-dresser-flatpack
