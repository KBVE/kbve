---
title: Oak dining table (flatpack) | OSRS Price Data
description: "Oak dining table (flatpack): How does it all fit in there?. High alch: 6 GP, GE limit: 500."
osrs:
  id: 8550
  name: Oak dining table (flatpack)
  slug: oak-dining-table-flatpack
