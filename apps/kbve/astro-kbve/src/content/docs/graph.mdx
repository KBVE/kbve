...
title: Graph
description: |
    Unified, searchable graph of the KBVE monorepo — moon project dependencies,
...
export const overview = loadGraphifyOverview();
	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede">One graph fuses <strong>Graphify</strong> code analysis, <strong>moon</strong> dependency edges, and <strong>doc references</strong>. Scroll to drill from directories into files and symbols; click a node for its projects and docs.</p>
				<div class="bento-cta">
					...
					<a class="bento-btn bento-btn--ghost" href="/dashboard/graph/">Project graph</a>
		...
		<nav class="bento-jump" aria-label="On this page">
			...
			<a class="bento-chip" href="/dashboard/graph/">Projects</a>
			<a class="bento-chip" href="/dashboard/graph-explorer/">Graphify</a>
		</nav>
	</div>
</section>

<BentoShell id="hub" eyebrow="Unified · Graphify + moon + docs" heading="Explore the graph">
	<AstroGraphExplorer />
