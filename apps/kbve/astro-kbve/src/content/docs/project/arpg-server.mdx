...
Alpha — endless seeded multi-floor dungeon (stairs + key-locked descent) with one hostile kind, proving end-to-end multiplayer. World content (npcdb/itemdb, zones, loot tables) is a follow-up.
