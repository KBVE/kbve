...
version_target: apps/cryptothrone/gameserver/Cargo.toml
...
bento:
    ...
    ctas:
        - label: View source
          href: https://github.com/KBVE/kbve/tree/main/apps/cryptothrone/gameserver
          primary: true
          external: true
        - label: Sim core
          href: "#internals"
