...
**What is HerbMail?**
HerbMail.com is a global online platform for gourmet herbs and spices, offering
regional herb kits, seasonal specials, and rare hard-to-find finds delivered to
your kitchen.

**What services does HerbMail offer?**
HerbMail offers monthly spice-box subscriptions tailored to your tastes, an
AI-driven Spice Sommelier that pairs herbs and spices to your ingredients, live
online workshops with chefs, and a loyalty rewards program.

**How is HerbMail built and hosted?**
HerbMail runs on an axum (Rust) backend shipped as the `kbve/herbmail` Docker image
and deployed on the KBVE application Kubernetes stack in production.

## Related

- [API](/docs/project/api) — the KBVE core API service.
- [Edge](/docs/project/edge) — KBVE edge application services.
