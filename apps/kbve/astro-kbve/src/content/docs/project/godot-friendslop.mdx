...
<div class="grid gap-6 md:grid-cols-2 not-content">
	...
	<figure id="steam-main-capsule" class="md:col-span-2">
	...
	<figure id="steam-library-hero" class="md:col-span-2">
	...
	<figure id="steam-page-background" class="md:col-span-2">
	...
	<figure id="steam-screenshot-01" class="md:col-span-2">
	...
	<figure id="steam-screenshot-02" class="md:col-span-2">
	...
	<figure id="steam-screenshot-03" class="md:col-span-2">
	...
	<figure id="steam-screenshot-04" class="md:col-span-2">
	...
	<figure id="steam-screenshot-05" class="md:col-span-2">
