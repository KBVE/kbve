...
<CardGrid>
  <Card title="45 Apps" icon="rocket">
    @kbve/source, agones-factorio, agones-factorio-relay, angelscript, astro-chuckrpg, astro-cryptothrone + 39 more
  </Card>
  ...
  <Card title="47 Dependencies" icon="random">
    Across 108 projects in the monorepo.
  </Card>
</CardGrid>
