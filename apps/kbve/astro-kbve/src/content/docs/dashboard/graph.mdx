...
<CardGrid>
  ...
  <Card title="21 E2es" icon="approve-check-circle">
    arc-runner-e2e, aria2-proxy-e2e, astro-cryptothrone-e2e, astro-e2e, astro-kbve-e2e, astro-rareicon-e2e + 15 more
  </Card>
  ...
  <Card title="47 Dependencies" icon="random">
    Across 109 projects in the monorepo.
  </Card>
</CardGrid>
