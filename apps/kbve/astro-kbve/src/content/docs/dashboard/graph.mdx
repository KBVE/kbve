...
<CardGrid>
  ...
  <Card title="38 Libs" icon="puzzle">
    arc-runner, aria2-proxy, astro, bevy_battle, bevy_behavior, bevy_cam + 32 more
  </Card>
  <Card title="48 Dependencies" icon="random">
    Across 99 projects in the monorepo.
  </Card>
</CardGrid>
...
graph LR
    ...
    class arc_runner,aria2_proxy,astro,bevy_battle,bevy_behavior,bevy_cam,bevy_chat,bevy_db,bevy_inventory,bevy_items,bevy_kbve_net,bevy_mapdb,bevy_npc,bevy_pathfinder,bevy_player,bevy_quests,bevy_skills,bevy_statemachine,bevy_supa,bevy_tasker,chisel_ubuntu_axum,data_proto,devops,droid,erust,firecracker_node_web,firecracker_python_net,firecracker_python_web,holy,jedi,kbve,khashvault,laser,python_fudster,python_kbve,q,steamcmd_ubuntu,uniti lib
