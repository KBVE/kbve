...
<CardGrid>
  <Card title="39 Apps" icon="rocket">
    @kbve/source, angelscript, astro-chuckrpg, astro-cryptothrone, astro-discordsh, astro-herbmail + 33 more
  </Card>
  ...
  <Card title="39 Libs" icon="puzzle">
    arc-runner, aria2-proxy, astro, bevy_battle, bevy_behavior, bevy_cam + 33 more
  </Card>
  <Card title="48 Dependencies" icon="random">
    Across 100 projects in the monorepo.
  </Card>
</CardGrid>
