...
<CardGrid>
  <Card title="41 Apps" icon="rocket">
    @kbve/source, agones-factorio, angelscript, astro-chuckrpg, astro-cryptothrone, astro-discordsh + 35 more
  </Card>
  ...
  <Card title="47 Dependencies" icon="random">
    Across 103 projects in the monorepo.
  </Card>
</CardGrid>
...
graph LR
    ...
    class _kbve_source,agones_factorio,angelscript,astro_chuckrpg,astro_cryptothrone,astro_discordsh,astro_herbmail,astro_irc,astro_kbve,astro_memes,astro_rareicon,axum_chuckrpg,axum_cryptothrone,axum_discordsh,axum_herbmail,axum_kbve,axum_memes,axum_rareicon,cryptothrone,desktop_kbve,discordsh,discordsh_bot,edge,firecracker_ctl,herbmail,iot_edge_worker,irc,irc_gateway,isometric,kbve_kubectl,kilobase,mc,mc_lobby,mc_velocity,memes,nd_server,nexus_defense,notification_bot,pydesk,rows,unity_rareicon app
