...
<CardGrid>
  <Card title="44 Apps" icon="rocket">
    @kbve/source, agones-factorio, agones-factorio-relay, angelscript, astro-chuckrpg, astro-cryptothrone + 38 more
  </Card>
  ...
  <Card title="41 Libs" icon="puzzle">
    arc-runner, aria2-proxy, astro, bevy_battle, bevy_behavior, bevy_cam + 35 more
  </Card>
  <Card title="48 Dependencies" icon="random">
    Across 107 projects in the monorepo.
  </Card>
</CardGrid>
