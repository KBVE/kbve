...
<CardGrid>
  ...
  <Card title="36 Libs" icon="puzzle">
    arc-runner, aria2-proxy, astro, bevy_battle, bevy_behavior, bevy_cam + 30 more
  </Card>
  <Card title="47 Dependencies" icon="random">
    Across 97 projects in the monorepo.
  </Card>
</CardGrid>
