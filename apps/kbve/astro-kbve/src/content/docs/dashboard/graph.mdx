...
<CardGrid>
  <Card title="40 Apps" icon="rocket">
    @kbve/source, angelscript, astro-chuckrpg, astro-cryptothrone, astro-discordsh, astro-herbmail + 34 more
  </Card>
  ...
  <Card title="47 Dependencies" icon="random">
    Across 102 projects in the monorepo.
  </Card>
</CardGrid>
