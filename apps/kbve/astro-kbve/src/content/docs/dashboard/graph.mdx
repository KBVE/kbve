...
<CardGrid>
  <Card title="43 Apps" icon="rocket">
    @kbve/source, agones-factorio, agones-factorio-relay, angelscript, astro-chuckrpg, astro-cryptothrone + 37 more
  </Card>
  ...
  <Card title="47 Dependencies" icon="random">
    Across 106 projects in the monorepo.
  </Card>
</CardGrid>
