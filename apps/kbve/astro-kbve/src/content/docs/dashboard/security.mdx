...
:::note[Auto-generated]
Last generated: **2026-05-31T09:12:42Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**49** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="47 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="64 Medium" icon="information">
