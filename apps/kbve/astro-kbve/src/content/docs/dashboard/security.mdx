...
:::note[Auto-generated]
Last generated: **2026-06-15T10:18:24Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**53** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="49 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="65 Medium" icon="information">
    Medium-severity findings across all ecosystems.
  </Card>
  <Card title="30 Low" icon="approve-check-circle">
...
| Medium | `joi` | joi has an uncaught RangeError on deeply nested input thr... | [Details](https://github.com/advisories/GHSA-q7cg-457f-vx79) |
