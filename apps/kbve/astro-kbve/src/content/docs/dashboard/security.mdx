...
:::note[Auto-generated]
Last generated: **2026-06-19T09:44:41Z** — updated daily by `ci-dashboard`.
:::
...
<CardGrid>
  ...
  <Card title="26 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="52 Medium" icon="information">
    Medium-severity findings across all ecosystems.
  </Card>
  <Card title="7 Low" icon="approve-check-circle">
...
| High | `tmp` | tmp: Type-confusion bypass of _assertPath allows path tra... | [Details](https://github.com/advisories/GHSA-7c78-jf6q-g5cm) |
...
| Medium | `dompurify` | DOMPurify: Permanent `ALLOWED_ATTR` pollution via `setCon... | [Details](https://github.com/advisories/GHSA-cmwh-pvxp-8882) |
...
|----------|------|------|------|
| Medium | `js/stack-trace-exposure` | `apps/kbve/edge/functions/_shared/supabase.ts` | [Details](https://github.com/KBVE/kbve/security/code-scanning/501) |
