	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede">Last generated <strong>2026-09-08T05:51:15Z</strong>.</p>
				<div class="bento-cta">
...
<BentoShell id="ecosystems" eyebrow="Coverage" heading="Ecosystem breakdown">
	<div class="bento-board bento-board--cols-3">
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#eco-cargo">
			...
			<span class="bento-linkcard__copy">47 advisories</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
...
<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Severity" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Severity</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Severity</text><path d="M 150.00 60.00 A 110.00 110.00 0 0 1 170.82 61.99 L 162.49 105.19 A 66.00 66.00 0 0 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 170.82 61.99 A 110.00 110.00 0 0 1 212.38 260.60 L 187.43 224.36 A 66.00 66.00 0 0 0 162.49 105.19 Z" fill="#10b981" /><path d="M 212.38 260.60 A 110.00 110.00 0 1 1 102.72 70.68 L 121.63 110.41 A 66.00 66.00 0 1 0 187.43 224.36 Z" fill="#f59e0b" /><path d="M 102.72 70.68 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 121.63 110.41 Z" fill="#a78bfa" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">99</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">Critical — 3 (3.0%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">High — 37 (37.4%)</text><rect x="310" y="152" width="14" height="14" rx="3" fill="#f59e0b" /><text x="334" y="164" font-size="14" fill="currentColor">Medium — 52 (52.5%)</text><rect x="310" y="182" width="14" height="14" rx="3" fill="#a78bfa" /><text x="334" y="194" font-size="14" fill="currentColor">Low — 7 (7.1%)</text></svg></div>

### Findings by ecosystem

<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Ecosystem" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Ecosystem</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Ecosystem</text><path d="M 150.00 60.00 A 110.00 110.00 0 1 1 67.19 242.40 L 100.31 213.44 A 66.00 66.00 0 1 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 67.19 242.40 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 100.31 213.44 Z" fill="#10b981" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">129</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">npm — 82 (63.6%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">Cargo — 47 (36.4%)</text></svg></div>
