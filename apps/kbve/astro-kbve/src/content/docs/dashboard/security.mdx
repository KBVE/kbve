...
:::note[Auto-generated]
Last generated: **2026-05-10T08:47:30Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**40** critical/high severity findings across the monorepo.
:::
...
| High | `@babel/plugin-transform-modules-systemjs` | @babel/plugin-transform-modules-systemjs generates arbitr... | [Details](https://github.com/advisories/GHSA-fv7c-fp4j-7gwp) |
