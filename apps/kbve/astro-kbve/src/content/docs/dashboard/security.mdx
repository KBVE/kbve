...
:::note[Auto-generated]
Last generated: **2026-06-12T09:36:23Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**52** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="48 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="62 Medium" icon="information">
    Medium-severity findings across all ecosystems.
  </Card>
  <Card title="29 Low" icon="approve-check-circle">
