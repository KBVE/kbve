	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>65</strong> critical/high severity findings across the monorepo — triage before merge.</p>
				<p class="bento-lede">Last generated <strong>2026-09-11T06:12:13Z</strong>.</p>
				<div class="bento-cta">
...
<BentoShell id="ecosystems" eyebrow="Coverage" heading="Ecosystem breakdown">
	<div class="bento-board bento-board--cols-3">
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#eco-npm">
			...
			<span class="bento-linkcard__copy">117 advisories</span>
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#eco-cargo">
			...
			<span class="bento-linkcard__copy">36 advisories</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
...
<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Severity" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Severity</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Severity</text><path d="M 150.00 60.00 A 110.00 110.00 0 0 1 170.66 61.96 L 162.40 105.17 A 66.00 66.00 0 0 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 170.66 61.96 A 110.00 110.00 0 0 1 157.79 279.72 L 154.67 235.83 A 66.00 66.00 0 0 0 162.40 105.17 Z" fill="#10b981" /><path d="M 157.79 279.72 A 110.00 110.00 0 0 1 99.95 72.05 L 119.97 111.23 A 66.00 66.00 0 0 0 154.67 235.83 Z" fill="#f59e0b" /><path d="M 99.95 72.05 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 119.97 111.23 Z" fill="#a78bfa" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">133</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">Critical — 4 (3.0%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">High — 61 (45.9%)</text><rect x="310" y="152" width="14" height="14" rx="3" fill="#f59e0b" /><text x="334" y="164" font-size="14" fill="currentColor">Medium — 58 (43.6%)</text><rect x="310" y="182" width="14" height="14" rx="3" fill="#a78bfa" /><text x="334" y="194" font-size="14" fill="currentColor">Low — 10 (7.5%)</text></svg></div>

### Findings by ecosystem

<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Ecosystem" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Ecosystem</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Ecosystem</text><path d="M 150.00 60.00 A 110.00 110.00 0 1 1 40.47 159.85 L 84.28 163.91 A 66.00 66.00 0 1 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 40.47 159.85 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 84.28 163.91 Z" fill="#10b981" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">153</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">npm — 117 (76.5%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">Cargo — 36 (23.5%)</text></svg></div>
...
| Critical | `astro` | Astro: Remote code execution through AVIF image optimization | [Details](https://github.com/advisories/GHSA-26w7-cxv4-gfx2) |
...
| High | `tar` | node-tar: Uncontrolled recursion in mapHas/filesFilter al... | [Details](https://github.com/advisories/GHSA-r292-9mhp-454m) |
...
| High | `browserslist` | Browserslist: Unbounded memory growth (no cache eviction)... | [Details](https://github.com/advisories/GHSA-c83g-rgw3-j3cx) |
| High | `browserslist` | Browserslist: Uncaught crash / prototype write via untrus... | [Details](https://github.com/advisories/GHSA-73wf-gq98-2v4g) |
| High | `fast-uri` | fast-uri vulnerable to server-side request forgery via ma... | [Details](https://github.com/advisories/GHSA-f65p-4m7j-42xc) |
| High | `fast-uri` | fast-uri vulnerable to host confusion via percent-encoded... | [Details](https://github.com/advisories/GHSA-jqff-g426-hqxp) |
...
| High | `@xmldom/xmldom` | xmldom: HTML raw-text closing-tag case mismatch causes ou... | [Details](https://github.com/advisories/GHSA-6mj3-qw4j-hgrw) |
| High | `@xmldom/xmldom` | xmldom PI grammar regex ReDoS: quadratic backtracking on ... | [Details](https://github.com/advisories/GHSA-g53g-w8rj-fmg7) |
| High | `@xmldom/xmldom` | xmldom: Element name injection via createElement() bypass... | [Details](https://github.com/advisories/GHSA-w2rr-34g9-rvrj) |
| High | `@xmldom/xmldom` | xmldom: Element name injection via createElement() bypass... | [Details](https://github.com/advisories/GHSA-w2rr-34g9-rvrj) |
| High | `@xmldom/xmldom` | xmldom: Attribute name injection via setAttribute() bypas... | [Details](https://github.com/advisories/GHSA-4w3w-2rp5-g8jm) |
| High | `@xmldom/xmldom` | xmldom: Attribute name injection via setAttribute() bypas... | [Details](https://github.com/advisories/GHSA-4w3w-2rp5-g8jm) |
| High | `@xmldom/xmldom` | xmldom: Processing Instruction Target Injection Bypasses ... | [Details](https://github.com/advisories/GHSA-c7q8-3ch8-vqpv) |
| High | `@xmldom/xmldom` | xmldom: Processing Instruction Target Injection Bypasses ... | [Details](https://github.com/advisories/GHSA-c7q8-3ch8-vqpv) |
| High | `@xmldom/xmldom` | xmldom: DocType `name` Injection Bypasses requireWellFormed | [Details](https://github.com/advisories/GHSA-27p8-2357-5qqv) |
| High | `@xmldom/xmldom` | xmldom: DocType `name` Injection Bypasses requireWellFormed | [Details](https://github.com/advisories/GHSA-27p8-2357-5qqv) |
| High | `@xmldom/xmldom` | xmldom: Creation-time XML Name/QName validation is bypass... | [Details](https://github.com/advisories/GHSA-3px3-54cx-rmw9) |
| High | `@xmldom/xmldom` | xmldom: requireWellFormed DocType publicId/systemId valid... | [Details](https://github.com/advisories/GHSA-vr34-hp96-76pp) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-time attribute deduplication | [Details](https://github.com/advisories/GHSA-8344-3jmq-59r6) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-time attribute deduplication | [Details](https://github.com/advisories/GHSA-8344-3jmq-59r6) |
| High | `@xmldom/xmldom` | xmldom: End-tag Whitespace-Trim Regex ReDoS — quadratic b... | [Details](https://github.com/advisories/GHSA-x4fp-j954-r2f4) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-memory consumption | [Details](https://github.com/advisories/GHSA-965w-775f-mr7g) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-memory consumption | [Details](https://github.com/advisories/GHSA-965w-775f-mr7g) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-time parsing via the malformed-input re... | [Details](https://github.com/advisories/GHSA-93r5-fhx6-vmg9) |
| High | `@xmldom/xmldom` | xmldom: Quadratic-time parsing via the malformed-input re... | [Details](https://github.com/advisories/GHSA-93r5-fhx6-vmg9) |
| High | `sharp` | sharp: Vulnerabilities in libheif: GHSA-g89c-p67h-r497 an... | [Details](https://github.com/advisories/GHSA-rgj7-g3m4-5g8c) |
| High | `js-yaml` | js-yaml: maxTotalMergeKeys does not limit CPU use for emp... | [Details](https://github.com/advisories/GHSA-2883-xcg3-v3hh) |
| High | `js-yaml` | js-yaml: maxTotalMergeKeys does not limit CPU use for emp... | [Details](https://github.com/advisories/GHSA-2883-xcg3-v3hh) |
| High | `svgo` | SVGO: removeScripts allows executable links through names... | [Details](https://github.com/advisories/GHSA-w27v-7q3p-w38r) |
| High | `smol-toml` | smol-toml: Denial of Service via malformed TOML documents | [Details](https://github.com/advisories/GHSA-7w5x-hrqm-74c2) |
...
| Medium | `decode-uri-component` | decode-uri-component: Denial of service via exponential d... | [Details](https://github.com/advisories/GHSA-vcc3-ghjq-m6fr) |
| Medium | `qs` | qs array-limit bypass via bracket-key comma parsing | [Details](https://github.com/advisories/GHSA-x5fp-wj9c-mxmx) |
| Medium | `qs` | qs: Denial of Service via Attacker Controlled isBuffer | [Details](https://github.com/advisories/GHSA-4mjr-xmp4-gh2g) |
| Medium | `@xmldom/xmldom` | xmldom: XML fragment injection via invalid EntityReferenc... | [Details](https://github.com/advisories/GHSA-6gmq-8vp8-gcm6) |
| Medium | `@xmldom/xmldom` | xmldom: XML fragment injection via invalid EntityReferenc... | [Details](https://github.com/advisories/GHSA-6gmq-8vp8-gcm6) |
| Medium | `fflate` | fflate unzipSync can enter an infinite loop when parsing ... | [Details](https://github.com/advisories/GHSA-px8p-9vwx-vf98) |
| Medium | `fflate` | fflate unzipSync can enter an infinite loop when parsing ... | [Details](https://github.com/advisories/GHSA-px8p-9vwx-vf98) |
| Medium | `vitest` | Vitest: Path Traversal / Arbitrary File Read via @vitest/... | [Details](https://github.com/advisories/GHSA-82fw-gwwq-j7x9) |
| Medium | `@vitest/mocker` | Vitest: Path Traversal / Arbitrary File Read via @vitest/... | [Details](https://github.com/advisories/GHSA-82fw-gwwq-j7x9) |
| Medium | `baseline-browser-mapping` | baseline-browser-mapping process termination on invalid i... | [Details](https://github.com/advisories/GHSA-w5vr-8v7q-w6rv) |
| Medium | `@xmldom/xmldom` | xmldom: Parser silently accepts a not-well-formed end tag... | [Details](https://github.com/advisories/GHSA-6h8r-xr42-gp59) |
| Medium | `@xmldom/xmldom` | xmldom: Parser silently accepts a not-well-formed end tag... | [Details](https://github.com/advisories/GHSA-6h8r-xr42-gp59) |
| Medium | `astro` | Astro: Authorization bypass from missing path-segment bou... | [Details](https://github.com/advisories/GHSA-376h-93r7-7g6f) |
| Medium | `svgo` | SVGO: removeScripts incompletely sanitizes executable HTM... | [Details](https://github.com/advisories/GHSA-4vpr-x523-8j87) |
...
| Low | `postcss-selector-parser` | postcss-selector-parser allows denial of service through ... | [Details](https://github.com/advisories/GHSA-w9m9-85wc-3x92) |
| Low | `@ai-sdk/provider-utils` | @ai-sdk/provider-utils has an Uncontrolled Resource Consu... | [Details](https://github.com/advisories/GHSA-866g-f22w-33x8) |
| Low | `joi` | joi: Prototype pollution via a `__proto__` language key i... | [Details](https://github.com/advisories/GHSA-6w3j-5fw6-r9vr) |
| Low | `joi` | joi: object().rename() with a template target can set the... | [Details](https://github.com/advisories/GHSA-gg4h-3hg2-grpc) |
...
| Medium | `h2` | h2 unbounded empty DATA frames | [Details](https://github.com/hyperium/hyper/security/advisories/GHSA-q83h-524g-xf6h) |
| Medium | `h2` | h2 unbounded empty DATA frames | [Details](https://github.com/hyperium/hyper/security/advisories/GHSA-q83h-524g-xf6h) |
