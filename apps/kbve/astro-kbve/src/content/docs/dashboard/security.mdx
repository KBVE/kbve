...
:::note[Auto-generated]
Last generated: **2026-03-29T08:21:31Z** — updated daily by `ci-dashboard`.
:::
...
<CardGrid>
  ...
  <Card title="4 Low" icon="approve-check-circle">
...
| Severity | Package | Advisory | Link |
|----------|---------|----------|------|
| Medium | `pygments` | A security flaw has been discovered in pygments up to 2.1... | [Details](https://osv.dev/vulnerability/CVE-2026-4539) |
