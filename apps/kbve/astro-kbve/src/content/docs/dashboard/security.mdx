...
:::note[Auto-generated]
Last generated: **2026-04-25T08:30:06Z** — updated daily by `ci-dashboard`.
:::
...
<CardGrid>
  ...
  <Card title="59 Medium" icon="information">
...
| Medium | `dompurify` | DOMPurify's ADD_TAGS function form bypasses FORBID_TAGS d... | [Details](https://github.com/advisories/GHSA-39q2-94rc-95cp) |
| Medium | `axios` | Axios has a NO_PROXY Hostname Normalization Bypass that L... | [Details](https://github.com/advisories/GHSA-3p68-rc4w-qgx5) |
| Medium | `axios` | Axios has Unrestricted Cloud Metadata Exfiltration via He... | [Details](https://github.com/advisories/GHSA-fvcv-3m26-pcqx) |
...
| Medium | `dompurify` | DOMPurify: FORBID_TAGS bypassed by function-based ADD_TAG... | [Details](https://github.com/advisories/GHSA-h7mw-gpvr-xq4m) |
| Medium | `dompurify` | DOMPurify has a SAFE_FOR_TEMPLATES bypass in RETURN_DOM mode | [Details](https://github.com/advisories/GHSA-crv5-9vww-q3g8) |
| Medium | `dompurify` | DOMPurify: Prototype Pollution to XSS Bypass via CUSTOM_E... | [Details](https://github.com/advisories/GHSA-v9jr-rg53-9pgp) |
| Medium | `fast-xml-parser` | fast-xml-parser XMLBuilder: XML Comment and CDATA Injecti... | [Details](https://github.com/advisories/GHSA-gh4j-gqv2-49f6) |
...
| Severity | Package | Advisory | Link |
|----------|---------|----------|------|
| Medium | `pip` | pip handles concatenated tar and ZIP files as ZIP files r... | [Details](https://osv.dev/vulnerability/CVE-2026-3219) |
