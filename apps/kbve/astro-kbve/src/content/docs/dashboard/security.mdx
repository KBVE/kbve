...
:::note[Auto-generated]
Last generated: **2026-04-08T08:36:43Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**36** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="35 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="39 Medium" icon="information">
