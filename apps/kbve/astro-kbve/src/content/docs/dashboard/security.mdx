...
:::note[Auto-generated]
Last generated: **2026-03-26T08:28:12Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**23** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="3 Low" icon="approve-check-circle">
