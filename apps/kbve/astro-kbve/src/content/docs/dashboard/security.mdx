	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>41</strong> critical/high severity findings across the monorepo — triage before merge.</p>
				<p class="bento-lede">Last generated <strong>2026-09-05T05:31:02Z</strong>.</p>
				<div class="bento-cta">
				...
				<div class="bento-cell bento-stat bento-card bento-card--glass bento-card--interactive">
					...
					<span class="bento-stat__value">55</span>
...
<BentoShell id="ecosystems" eyebrow="Coverage" heading="Ecosystem breakdown">
	<div class="bento-board bento-board--cols-3">
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#eco-npm">
			...
			<span class="bento-linkcard__copy">85 advisories</span>
...
<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Severity" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Severity</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Severity</text><path d="M 150.00 60.00 A 110.00 110.00 0 0 1 169.83 61.80 L 161.90 105.08 A 66.00 66.00 0 0 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 169.83 61.80 A 110.00 110.00 0 0 1 217.84 256.59 L 190.70 221.95 A 66.00 66.00 0 0 0 161.90 105.08 Z" fill="#10b981" /><path d="M 217.84 256.59 A 110.00 110.00 0 1 1 98.88 72.60 L 119.33 111.56 A 66.00 66.00 0 1 0 190.70 221.95 Z" fill="#f59e0b" /><path d="M 98.88 72.60 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 119.33 111.56 Z" fill="#a78bfa" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">104</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">Critical — 3 (2.9%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">High — 38 (36.5%)</text><rect x="310" y="152" width="14" height="14" rx="3" fill="#f59e0b" /><text x="334" y="164" font-size="14" fill="currentColor">Medium — 55 (52.9%)</text><rect x="310" y="182" width="14" height="14" rx="3" fill="#a78bfa" /><text x="334" y="194" font-size="14" fill="currentColor">Low — 8 (7.7%)</text></svg></div>

### Findings by ecosystem

<div class="kbve-figure"><svg class="kbve-chart" role="img" viewBox="0 0 620 300" width="620" height="300" aria-label="Findings by Ecosystem" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: auto; max-width: 620px"><title>Findings by Ecosystem</title><text x="150.0" y="34" text-anchor="middle" font-size="16" font-weight="600" fill="currentColor">Findings by Ecosystem</text><path d="M 150.00 60.00 A 110.00 110.00 0 1 1 74.48 249.98 L 104.69 217.99 A 66.00 66.00 0 1 0 150.00 104.00 Z" fill="#3b82f6" /><path d="M 74.48 249.98 A 110.00 110.00 0 0 1 150.00 60.00 L 150.00 104.00 A 66.00 66.00 0 0 0 104.69 217.99 Z" fill="#10b981" /><text x="150.0" y="176.0" text-anchor="middle" font-size="20" font-weight="700" fill="currentColor">137</text><rect x="310" y="92" width="14" height="14" rx="3" fill="#3b82f6" /><text x="334" y="104" font-size="14" fill="currentColor">npm — 85 (62.0%)</text><rect x="310" y="122" width="14" height="14" rx="3" fill="#10b981" /><text x="334" y="134" font-size="14" fill="currentColor">Cargo — 52 (38.0%)</text></svg></div>
