...
:::note[Auto-generated]
Last generated: **2026-06-16T09:57:27Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**56** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="52 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="72 Medium" icon="information">
