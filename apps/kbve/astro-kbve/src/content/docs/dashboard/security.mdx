...
:::note[Auto-generated]
Last generated: **2026-04-01T08:38:56Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**30** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="29 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="33 Medium" icon="information">
