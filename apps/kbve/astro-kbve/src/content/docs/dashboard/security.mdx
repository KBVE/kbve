...
:::note[Auto-generated]
Last generated: **2026-06-18T09:41:20Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**57** critical/high severity findings across the monorepo.
:::

### Severity Overview

<CardGrid>
  <Card title="4 Critical" icon="warning">
    Critical-severity findings across all ecosystems.
  </Card>
  <Card title="53 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="74 Medium" icon="information">
    Medium-severity findings across all ecosystems.
  </Card>
  <Card title="34 Low" icon="approve-check-circle">
...
| High | `axios` | axios's shouldBypassProxy does not recognize IPv4-mapped ... | [Details](https://github.com/advisories/GHSA-pjwm-pj3p-43mv) |
| High | `devalue` | Svelte devalue: DoS via sparse array deserialization | [Details](https://github.com/advisories/GHSA-77vg-94rm-hx3p) |
| High | `axios` | Axios: Regular Expression Denial of Service (ReDoS) via C... | [Details](https://github.com/advisories/GHSA-hfxv-24rg-xrqf) |
| High | `axios` | Allocation of Resources Without Limits or Throttling in A... | [Details](https://github.com/advisories/GHSA-777c-7fjr-54vf) |
| High | `axios` | Axios: Proxy-Authorization Credential Leak to Origin Serv... | [Details](https://github.com/advisories/GHSA-p92q-9vqr-4j8v) |
| High | `axios` | Axios: Proxy-Authorization header leaks to redirect targe... | [Details](https://github.com/advisories/GHSA-j5f8-grm9-p9fc) |
| High | `axios` | axios Vulnerable to Credential Theft and Response Hijacki... | [Details](https://github.com/advisories/GHSA-3g43-6gmg-66jw) |
| High | `axios` | axios Vulnerable to Full Man-in-the-Middle via Prototype ... | [Details](https://github.com/advisories/GHSA-35jp-ww65-95wh) |
...
| High | `astro` | Astro: Reflected XSS via unescaped slot name | [Details](https://github.com/advisories/GHSA-8hv8-536x-4wqp) |
| High | `astro` | Astro: Host header SSRF in prerendered error page fetch | [Details](https://github.com/advisories/GHSA-2pvr-wf23-7pc7) |
...
| Medium | `axios` | axios has DoS &amp; Header Injection via Prototype Pollution ... | [Details](https://github.com/advisories/GHSA-898c-q2cr-xwhg) |
...
| Medium | `dompurify` | DOMPurify: Hook mutation of `data.allowedTags` / `data.al... | [Details](https://github.com/advisories/GHSA-76mc-f452-cxcm) |
| Medium | `dompurify` | DOMPurify: Cross-realm IN_PLACE sanitization leaves execu... | [Details](https://github.com/advisories/GHSA-hpcv-96wg-7vj8) |
| Medium | `dompurify` | DOMPurify: IN_PLACE mode preserves attributes of a clobbe... | [Details](https://github.com/advisories/GHSA-r47g-fvhr-h676) |
| Medium | `dompurify` | DOMPurify IN_PLACE Sanitization Bypass via Attached Shado... | [Details](https://github.com/advisories/GHSA-rp9w-3fw7-7cwq) |
| Medium | `astro` | Astro: XSS via Unescaped Attribute Names in Spread Props | [Details](https://github.com/advisories/GHSA-jrpj-wcv7-9fh9) |
| Medium | `webpack-dev-server` | webpack-dev-server vulnerable to HMR WebSocket intercepti... | [Details](https://github.com/advisories/GHSA-mx8g-39q3-5c79) |
...
| Low | `dompurify` | DOMPurify: `IN_PLACE` mode trusts attacker-controlled `no... | [Details](https://github.com/advisories/GHSA-x4vx-rjvf-j5p4) |
| Low | `dompurify` | DOMPurify: Trusted Types policy survives `clearConfig()` ... | [Details](https://github.com/advisories/GHSA-vxr8-fq34-vvx9) |
| Low | `dompurify` | DOMPurify: SAFE_FOR_TEMPLATES bypass - template expressio... | [Details](https://github.com/advisories/GHSA-gvmj-g25r-r7wr) |
