...
:::note[Auto-generated]
Last generated: **2026-04-16T07:55:04Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**35** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="46 Medium" icon="information">
...
| Critical | `axios` | Axios has Unrestricted Cloud Metadata Exfiltration via He... | [Details](https://github.com/advisories/GHSA-fvcv-3m26-pcqx) |
| Critical | `axios` | Axios has a NO_PROXY Hostname Normalization Bypass Leads ... | [Details](https://github.com/advisories/GHSA-3p68-rc4w-qgx5) |
