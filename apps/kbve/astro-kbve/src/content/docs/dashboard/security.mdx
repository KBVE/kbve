...
:::note[Auto-generated]
Last generated: **2026-06-17T09:49:10Z** — updated daily by `ci-dashboard`.
:::

:::caution[Action Required]
**58** critical/high severity findings across the monorepo.
:::
...
<CardGrid>
  ...
  <Card title="54 High" icon="error">
    High-severity findings across all ecosystems.
  </Card>
  <Card title="73 Medium" icon="information">
...
| High | `esbuild` | esbuild: Missing binary integrity verification in Deno mo... | [Details](https://github.com/advisories/GHSA-gv7w-rqvm-qjhr) |
