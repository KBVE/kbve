	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>95.1%</strong> success across <strong>1000</strong> runs (7d) — <strong>44</strong> failures, <strong>0</strong> flaky.</p>
				<p class="bento-lede">Last generated <strong>2026-07-21T04:15:55Z</strong>.</p>
				<div class="bento-cta">
				...
				<div class="bento-cell bento-stat bento-card bento-card--glass bento-card--interactive">
					...
					<span class="bento-stat__value">6m 2s</span>
				...
				<div class="bento-cell bento-stat bento-card bento-card--glass bento-card--interactive">
					...
					<span class="bento-stat__value">44</span>
...
<BentoShell id="workflows" eyebrow="Volume" heading="Busiest workflows">
	<div class="bento-board bento-board--cols-3">
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#health-table">
			...
			<span class="bento-linkcard__copy">219 runs · 87.9% ok</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#health-table">
			...
			<span class="bento-linkcard__copy">97 runs · 94.4% ok</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#health-table">
			...
			<span class="bento-linkcard__copy">53 runs · 97.7% ok</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#health-table">
			...
			<span class="bento-linkcard__copy">33 runs · 93.9% ok</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
...
pie showData
    ...
    "CI - CodeQL" : 337
    "CI - Dev" : 219
    "CI - Manifest Guard" : 97
    "CI - Actionlint" : 53
    "Auto-merge bot PRs" : 38
    "CI - Manifest Sync" : 33
    "CI - Bevy" : 22
    "CI - Forgejo Mirror" : 22
```

### Last 24 hours

**438** runs · **351** ok · **28** failed · **92.6%** success rate.
...
|----------|:----:|:--:|:----:|:-------:|:---:|:-----:|
| CI - CodeQL | 337 | 302 | 0 | 100.0% | 3m 43s | 0 |
| CI - Dev | 219 | 153 | 21 | 87.9% | 12m 26s | 0 |
| CI - Manifest Guard | 97 | 85 | 5 | 94.4% | 2m 31s | 0 |
| CI - Actionlint | 53 | 42 | 1 | 97.7% | 35s | 0 |
| Auto-merge bot PRs | 38 | 38 | 0 | 100.0% | 35s | 0 |
| CI - Manifest Sync | 33 | 31 | 2 | 93.9% | 3m 18s | 0 |
| CI - Bevy | 22 | 22 | 0 | 100.0% | 25s | 0 |
| CI - Forgejo Mirror | 22 | 22 | 0 | 100.0% | 1m 10s | 0 |
| CI - Main | 22 | 22 | 0 | 100.0% | 1m 50s | 0 |
| CI - dbmate validate | 22 | 20 | 2 | 90.9% | 3m 48s | 0 |
| CI - Docker / axum-kbve | 20 | 14 | 6 | 70.0% | 32m 14s | 0 |
| CI - MC Gradle Cache | 16 | 11 | 0 | 100.0% | 5m 28s | 0 |
| CI - MC Mods Cache | 16 | 12 | 0 | 100.0% | 3m 33s | 0 |
| CI - MC Smoke | 16 | 14 | 0 | 100.0% | 2m 52s | 0 |
| CI - Docker / discordsh | 8 | 8 | 0 | 100.0% | 16m 34s | 0 |
| CI - Publish / python / python-kbve | 8 | 5 | 3 | 62.5% | 4m 22s | 0 |
| Windmill Sync | 8 | 6 | 2 | 75.0% | 1m 5s | 0 |
| CI - Docker / discordsh-bot | 7 | 7 | 0 | 100.0% | 16m 41s | 0 |
| CI - Uniti | 5 | 5 | 0 | 100.0% | 8m 26s | 0 |
| Daily Content | 5 | 4 | 0 | 100.0% | 3m 16s | 0 |
| Organize Labels | 3 | 3 | 0 | 100.0% | 17s | 0 |
...
| CI - Docker / herbmail | 1 | 0 | 1 | 0.0% | 7m 2s | 0 |
...
| CI - Publish / python / python-kbve | main | workflow_dispatch | 2026-07-20 09:29 | [run](https://github.com/KBVE/kbve/actions/runs/29731347225) |
| CI - Docker / axum-kbve | main | workflow_dispatch | 2026-07-20 07:46 | [run](https://github.com/KBVE/kbve/actions/runs/29725384705) |
