...
:::note[Auto-generated]
Last synced: **2026-06-03T09:45:22.997Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>134</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11712](https://github.com/KBVE/kbve/pull/11712) | Release: 2 features, 3 fixes, 2 perfs, 2 tests, 2 chores → Main | — | — | auto-pr, dev→main |
