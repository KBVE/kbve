...
:::note[Auto-generated]
Last synced: **2026-05-24T08:58:07.861Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>175</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11321](https://github.com/KBVE/kbve/pull/11321) | Release: 10 features, 3 fixes, 1 CI, 1 test, 2 chores → Main | — | — | auto-pr, dev→main |
