...
:::note[Auto-generated]
Last synced: **2026-06-15T10:15:15.225Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>36</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>282</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12511](https://github.com/KBVE/kbve/pull/12511) | Release: 1 feature, 1 fix → Main | — | — | auto-pr, dev→main |
