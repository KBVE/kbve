...
:::note[Auto-generated]
Last synced: **2026-06-02T09:35:42.007Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>130</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11655](https://github.com/KBVE/kbve/pull/11655) | Release: 3 features, 4 fixes, 2 CI, 6 tests, 8 chores → Main | — | — | auto-pr, dev→main |
