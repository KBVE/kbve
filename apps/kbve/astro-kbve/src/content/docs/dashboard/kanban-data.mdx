...
:::note[Auto-generated]
Last synced: **2026-07-14T10:01:11.504Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Backlog --> Error
    Error["Error<br/><strong>25</strong>"]
    Error --> Support
    ...
    Review --> Done
    Done["Done<br/><strong>185</strong>"]
...
| [#14098](https://github.com/KBVE/kbve/pull/14098) | Release: 8 features, 2 fixes, 2 docs, 1 perf, 2 chores → Main | — | — | auto-pr, dev→main |
