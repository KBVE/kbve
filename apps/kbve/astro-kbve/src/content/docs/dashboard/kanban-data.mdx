...
:::note[Auto-generated]
Last synced: **2026-05-26T09:20:01.171Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>28</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>145</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11356](https://github.com/KBVE/kbve/pull/11356) | Release: 9 features, 1 fix, 2 refactors, 4 chores → Main | — | — | auto-pr, dev→main |
