...
:::note[Auto-generated]
Last synced: **2026-07-02T09:10:39.977Z** — updated daily by `ci-dashboard`.
...
pie showData
    ...
    "Blocked (Error+Support)" : 26
    "Done" : 376
    "Planning (Theory+AI+Backlog)" : 75
```
...
flowchart LR
    ...
    Theory["Theory<br/><strong>68</strong>"]
    Theory --> AI
    ...
    Backlog --> Error
    Error["Error<br/><strong>26</strong>"]
    Error --> Support
    ...
    Review --> Done
    Done["Done<br/><strong>376</strong>"]
...
| [#13687](https://github.com/KBVE/kbve/pull/13687) | Release: 3 features, 4 fixes, 1 doc, 2 chores → Main | — | — | auto-pr, dev→main |
