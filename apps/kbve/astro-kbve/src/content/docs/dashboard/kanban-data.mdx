...
:::note[Auto-generated]
Last synced: **2026-05-08T08:39:17.938Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>165</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10631](https://github.com/KBVE/kbve/pull/10631) | Release: 2 fixes, 1 chore → Main | — | — | auto-pr, dev→main |
