...
:::note[Auto-generated]
Last synced: **2026-06-07T09:09:35.479Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>157</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11978](https://github.com/KBVE/kbve/pull/11978) | Release: 1 feature, 2 chores → Main | — | — | auto-pr, dev→main |
