	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>453</strong> items on the board — <strong>29</strong> active, <strong>23</strong> blocked.</p>
				<p class="bento-lede">Last generated <strong>2026-07-26T04:26:16Z</strong>.</p>
				<div class="bento-cta">
...
<BentoShell id="columns" eyebrow="Board" heading="Column breakdown">
	<div class="bento-board bento-board--cols-3">
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#col-done">
			...
			<span class="bento-linkcard__copy">319 items</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>319</strong>"]
...
| [#14663](https://github.com/KBVE/kbve/pull/14663) | Release: 3 features, 2 chores → Main | — | — | auto-pr, dev→main |
