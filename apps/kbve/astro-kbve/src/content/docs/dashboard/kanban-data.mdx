...
:::note[Auto-generated]
Last synced: **2026-05-02T08:37:11.195Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>103</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10375](https://github.com/KBVE/kbve/pull/10375) | Release: 1 chore → Main | — | — | auto-pr, dev→main |
