...
:::note[Auto-generated]
Last synced: **2026-05-01T08:46:28.157Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>110</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10356](https://github.com/KBVE/kbve/pull/10356) | Release: 10 features, 3 fixes, 2 chores → Main | — | — | auto-pr, dev→main |
