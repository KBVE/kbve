...
:::note[Auto-generated]
Last synced: **2026-04-27T08:58:33.189Z** — updated daily by `ci-dashboard`.
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10287](https://github.com/KBVE/kbve/pull/10287) | Release: 3 features, 8 fixes, 1 refactor, 5 chores → Main | — | — | auto-pr, dev→main |
