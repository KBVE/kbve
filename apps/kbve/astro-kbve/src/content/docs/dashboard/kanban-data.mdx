...
:::note[Auto-generated]
Last synced: **2026-06-09T09:16:58.287Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>173</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12081](https://github.com/KBVE/kbve/pull/12081) | Release: 2 features, 1 chore → Main | — | — | auto-pr, dev→main |
