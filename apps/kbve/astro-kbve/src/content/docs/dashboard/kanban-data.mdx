...
:::note[Auto-generated]
Last synced: **2026-05-03T08:40:13.455Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>102</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10411](https://github.com/KBVE/kbve/pull/10411) | Release: 6 features, 7 fixes, 1 doc, 1 refactor, 3 chores → Main | — | — | auto-pr, dev→main |
