...
:::note[Auto-generated]
Last synced: **2026-05-21T09:16:37.523Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Backlog --> Error
    Error["Error<br/><strong>10</strong>"]
    Error --> Support
    ...
    Review --> Done
    Done["Done<br/><strong>182</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11238](https://github.com/KBVE/kbve/pull/11238) | Release: 3 chores → Main | — | — | auto-pr, dev→main |
