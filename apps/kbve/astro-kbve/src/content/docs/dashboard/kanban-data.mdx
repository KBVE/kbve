...
:::note[Auto-generated]
Last synced: **2026-06-26T09:14:23.778Z** — updated daily by `ci-dashboard`.
...
pie showData
    title Work State
    "Active (Todo+Staging+Review)" : 23
    "Blocked (Error+Support)" : 28
    "Done" : 457
...
flowchart LR
    ...
    Backlog --> Error
    Error["Error<br/><strong>28</strong>"]
    Error --> Support
    ...
    Review --> Done
    Done["Done<br/><strong>457</strong>"]
...
| [#13382](https://github.com/KBVE/kbve/pull/13382) | Release: 7 features, 2 fixes, 3 refactors, 1 chore → Main | — | — | auto-pr, dev→main |
