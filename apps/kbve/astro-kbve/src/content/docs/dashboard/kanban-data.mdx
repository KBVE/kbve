	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>374</strong> items on the board — <strong>29</strong> active, <strong>23</strong> blocked.</p>
				...
				<div class="bento-cell bento-stat bento-card bento-card--glass bento-card--interactive">
					...
					<span class="bento-stat__value">374</span>
...
flowchart LR
    ...
    Theory["Theory<br/><strong>73</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>242</strong>"]
...
| [#14438](https://github.com/KBVE/kbve/pull/14438) | Release: 1 fix → Main | — | — | auto-pr, dev→main |
