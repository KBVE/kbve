...
:::note[Auto-generated]
Last synced: **2026-06-12T09:33:03.446Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>188</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12184](https://github.com/KBVE/kbve/pull/12184) | Release: 9 features, 2 fixes, 1 doc, 2 CI → Main | — | — | auto-pr, dev→main |
