...
:::note[Auto-generated]
Last synced: **2026-05-28T09:24:44.294Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>138</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11422](https://github.com/KBVE/kbve/pull/11422) | Release: 1 fix, 2 chores → Main | — | — | auto-pr, dev→main |
