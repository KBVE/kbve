...
:::note[Auto-generated]
Last synced: **2026-06-19T09:41:29.370Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>48</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>361</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12832](https://github.com/KBVE/kbve/pull/12832) | Release: 1 fix, 6 chores → Main | — | — | auto-pr, dev→main |
