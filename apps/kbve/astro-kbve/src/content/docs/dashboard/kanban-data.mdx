...
:::note[Auto-generated]
Last synced: **2026-06-28T09:09:35.541Z** — updated daily by `ci-dashboard`.
...
pie showData
    title Work State
    "Active (Todo+Staging+Review)" : 22
    "Blocked (Error+Support)" : 27
    "Done" : 433
    "Planning (Theory+AI+Backlog)" : 73
```
...
flowchart LR
    ...
    Theory["Theory<br/><strong>67</strong>"]
    Theory --> AI
...
| [#13469](https://github.com/KBVE/kbve/pull/13469) | Release: 2 features, 3 fixes, 1 refactor, 3 chores → Main | — | — | auto-pr, dev→main |
