...
:::note[Auto-generated]
Last synced: **2026-06-14T09:12:53.124Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>33</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>257</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12411](https://github.com/KBVE/kbve/pull/12411) | Release: 1 chore → Main | — | — | auto-pr, dev→main |
