...
:::note[Auto-generated]
Last synced: **2026-04-19T08:26:25.466Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>24</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>200</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10210](https://github.com/KBVE/kbve/pull/10210) | Release: 1 feature, 1 chore → Main | — | — | auto-pr, dev→main |
