...
:::note[Auto-generated]
Last synced: **2026-06-21T09:22:29.579Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>359</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12951](https://github.com/KBVE/kbve/pull/12951) | Release: 5 features, 3 fixes, 2 perfs, 1 build, 4 chores → Main | — | — | auto-pr, dev→main |
