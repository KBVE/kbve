...
:::note[Auto-generated]
Last synced: **2026-06-05T09:17:15.194Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>131</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11788](https://github.com/KBVE/kbve/pull/11788) | Release: 3 fixes → Main | — | — | auto-pr, dev→main |
