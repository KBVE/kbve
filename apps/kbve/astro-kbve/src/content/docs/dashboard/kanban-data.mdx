...
:::note[Auto-generated]
Last synced: **2026-05-22T09:14:26.298Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>26</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>191</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#11273](https://github.com/KBVE/kbve/pull/11273) | Release: 1 commit → Main | — | — | auto-pr, dev→main |
