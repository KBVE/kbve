...
:::note[Auto-generated]
Last synced: **2026-06-17T09:45:36.390Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Theory["Theory<br/><strong>43</strong>"]
    Theory --> AI
    ...
    Review --> Done
    Done["Done<br/><strong>305</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#12648](https://github.com/KBVE/kbve/pull/12648) | Release: 1 feature, 3 fixes, 3 chores → Main | — | — | auto-pr, dev→main |
