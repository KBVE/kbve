...
:::note[Auto-generated]
Last synced: **2026-04-21T08:44:49.971Z** — updated daily by `ci-dashboard`.
...
flowchart LR
    ...
    Review --> Done
    Done["Done<br/><strong>180</strong>"]
...
| # | Title | Priority | Assignees | Labels |
|---|-------|----------|-----------|--------|
| [#10237](https://github.com/KBVE/kbve/pull/10237) | Release: 63 features, 31 fixes, 4 docs, 17 perfs, 24 refactors, 18 chores → Main | — | — | auto-pr, dev→main |
