...
description: |
    Weekly auto-generated security audit for the KBVE monorepo.
sidebar:
...
:::note[Auto-generated]
Last generated: **2026-03-17T11:38:17Z** — updated every Wednesday by `ci-nx-security`.
:::
...
<CardGrid>
  ...
  <Card title="21 Medium" icon="information">
    Medium-severity findings across all ecosystems.
  </Card>
  <Card title="10 Low" icon="approve-check-circle">
...
| Medium | `devalue` | devalue has prototype pollution in devalue.parse and deva... | [Details](https://github.com/advisories/GHSA-cfw5-2vxh-hr84) |
...
| Low | `devalue` | devalue affected by CPU and memory amplification from spa... | [Details](https://github.com/advisories/GHSA-33hq-fvwr-56pm) |
| Low | `devalue` | devalue `uneval`ed code can create objects with polluted ... | [Details](https://github.com/advisories/GHSA-8qm3-746x-r74r) |
| Low | `@tootallnate/once` | @tootallnate/once vulnerable to Incorrect Control Flow Sc... | [Details](https://github.com/advisories/GHSA-vpq2-c234-7xj6) |
| Low | `devalue` | Sveltejs devalue's `devalue.parse` and `devalue.unflatten... | [Details](https://github.com/advisories/GHSA-mwv9-gp5h-frr4) |
...
*Auto-generated by [ci-nx-security.yml](https://github.com/KBVE/kbve/actions/workflows/ci-nx-security.yml)*
