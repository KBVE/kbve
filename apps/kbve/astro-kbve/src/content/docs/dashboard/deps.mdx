	...
	<div class="bento-hero__frame bento-frame">
		<div class="bento-board bento-board--hero">
			<div class="bento-cell bento-hero-copy bento-card bento-card--glass">
				...
				<p class="bento-lede"><strong>185</strong> outdated dependencies — <strong>31</strong> major-version behind.</p>
				<p class="bento-lede">Last generated <strong>2026-07-27T04:40:47Z</strong>.</p>
				<div class="bento-cta">
...
<BentoShell id="ecosystems" eyebrow="Coverage" heading="Ecosystem drift">
	<div class="bento-board bento-board--cols-3">
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#npm">
			...
			<span class="bento-linkcard__copy">119 outdated · 31 major</span>
		...
		<a class="bento-cell bento-linkcard bento-card bento-card--glass bento-card--interactive" href="#cargo">
			...
			<span class="bento-linkcard__copy">66 outdated · 0 major</span>
			<span class="bento-linkcard__go" aria-hidden="true">
				<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>
			</span>
		</a>
