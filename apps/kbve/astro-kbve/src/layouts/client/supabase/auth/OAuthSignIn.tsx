...
export const GithubSignInButton: React.FC = () => {
  return (
    <button
      ...
      className="flex items-center justify-center gap-2 w-full py-2 px-4 min-h-[44px] rounded-lg bg-black text-white font-semibold shadow-md border border-gray-700 hover:bg-gray-800 hover:border-gray-600 transition-all duration-200"
      type="button"
    >
...
export const DiscordSignInButton: React.FC = () => {
  return (
    <button
      ...
      className="flex items-center justify-center gap-2 w-full py-2 px-4 min-h-[44px] rounded-lg bg-[#5865F2] text-white font-semibold shadow-md border border-[#4752c4] hover:bg-[#4752c4] hover:border-[#3c4399] transition-all duration-200"
      type="button"
    >
