...
// TODO: Make sure Private RPC for transfer is revoked.
    ...
    <div className="max-w-md mx-auto p-6 rounded-2xl shadow-xl bg-gradient-to-br from-cyan-50/80 to-purple-50/60 dark:from-cyan-900/40 dark:to-purple-900/30 border border-cyan-200 dark:border-zinc-800 backdrop-blur-md bg-white/60 dark:bg-zinc-900/60">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <div>
          ...
          <select {...register('kind')} className={twMerge('input input-bordered w-full bg-white/80 dark:bg-zinc-800/70 text-neutral-900 dark:text-neutral-100 border-cyan-300 dark:border-cyan-700 focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 px-4 py-2', errors.kind && 'border-red-400 focus:border-red-500')}>
