...
import { WowView } from '@kbve/rn/dash';
...
export default function ReactWowDashRN() {
	...
	if (!isStaff) {
		return (
			<div style={styles.centered}>
				...
				<p style={styles.sub}>
					The WoW realm control panel is restricted to KBVE staff.
				</p>
			</div>
		);
	}

	return <WowView getToken={token} baseUrl={DASH_PROXY_BASE} />;
}
