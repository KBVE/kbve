...
-   10:05PM
    ...
    I am thinking that it would make sense to build our first CDN, that layers ontop of exisiting ones like Cloudflare, part of this would be to make lottie files easier to access.
