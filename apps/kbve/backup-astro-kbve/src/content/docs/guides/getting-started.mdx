...
1. Open your WSL [Ubuntu](/application/linux/#ubuntu) terminal.
...
3. Install [Python](/application/python/) 3.10 by running the following commands:
...
4. Install [Node.js](/application/javascript/) and npm by running the following commands:
