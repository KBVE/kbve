...
#[openapi(
    ...
    paths(
        ...
        crate::transport::wallet::service_balance_discord,
        ...
        crate::transport::store::service_buy_discord,
        crate::transport::store::service_inventory_discord,
        ...
        crate::transport::store::my_purchases,
        crate::transport::store::my_inventory,
    ...
    components(
        schemas(
            ...
            crate::transport::wallet::ServiceBalanceDiscordBody,
            crate::transport::wallet::ServiceBalanceDiscordDto,
            ...
            crate::transport::store::StoreBuyDiscordBody,
            crate::transport::store::StoreItemDiscordDto,
            crate::transport::store::StoreInventoryDiscordBody,
            crate::transport::store::StoreInventoryDiscordDto,
            ...
            crate::transport::store::StorePurchaseDto,
            crate::transport::store::InventoryItemDto,
