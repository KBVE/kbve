...
use crate::{
    spellbook_generate_ulid_bytes, spellbook_hazardous_boolean_exist_via_ulid,
    spellbook_hazardous_task_fetch, spellbook_pool_conn,
};

// use crate::schema::{ auth, profile, users, apikey, n8n, appwrite, globals };
use crate::schema::{apikey, auth, n8n, profile, users};
...
pub async fn hazardous_create_profile_from_ulid(
    ...
    match insert_into(profile::table)
        .values((
