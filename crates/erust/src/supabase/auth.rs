use crate::supabase::{AuthResponse, Session, SupabaseConfig, SupabaseError};
use ehttp::Request;
...
pub fn sign_in_with_password<F>(config: &SupabaseConfig, email: &str, password: &str, callback: F)
where
