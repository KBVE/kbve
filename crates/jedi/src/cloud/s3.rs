...
pub fn summarize(
    ...
    BackupSummary {
        ...
        oldest_object_age_seconds: if oldest_ts == i64::MAX {
            0
        } else {
            now - oldest_ts
        },
...
mod tests {
    ...
    fn classifies_base_and_wal_and_reports_latest() {
        let objs = vec![
            obj(
                "barman/backup/base/20260718T040000/data.tar.gz",
                1000,
                1_000_000,
            ),
            obj(
                "barman/backup/base/20260718T040000/pgdata.tar.gz",
                200,
                1_000_050,
            ),
            obj(
                "barman/backup/base/20260711T040000/data.tar.gz",
                800,
                400_000,
            ),
